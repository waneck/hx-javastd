...
extern class Paper implements java.lang.Cloneable
{
	...
	* object's height
	*/
	@:overload @:public public function setSize(width : Float, height : Float) : Void;
	...
	* imageable area of this <code>Paper</code>
	*/
	@:overload @:public public function setImageableArea(x : Float, y : Float, width : Float, height : Float) : Void;
