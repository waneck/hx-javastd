...
extern interface InputMethodDescriptor
{
	...
	*/
	@:overload public function getInputMethodDisplayName(inputLocale : java.util.Locale, displayLanguage : java.util.Locale) : String;
	...
	*/
	@:overload public function createInputMethod() : java.awt.im.spi.InputMethod;
