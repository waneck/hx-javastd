...
@:require(java2) extern class InputSubset extends java.lang.Character.Character_Subset
{
	...
	*/
	@:public @:static @:final public static var LATIN(default, null) : java.awt.im.InputSubset;
	
	/**
	* Constant for the digits included in the BASIC_LATIN Unicode character
	* block.
	*/
	@:public @:static @:final public static var LATIN_DIGITS(default, null) : java.awt.im.InputSubset;
	...
	*/
	@:public @:static @:final public static var TRADITIONAL_HANZI(default, null) : java.awt.im.InputSubset;
	...
	* Chinese Han characters that may be defined as surrogate characters.
	*/
	@:public @:static @:final public static var SIMPLIFIED_HANZI(default, null) : java.awt.im.InputSubset;
	...
	*/
	@:public @:static @:final public static var KANJI(default, null) : java.awt.im.InputSubset;
	...
	* that may be defined as surrogate characters.
	*/
	@:public @:static @:final public static var HANJA(default, null) : java.awt.im.InputSubset;
	
	/**
	* Constant for the halfwidth katakana subset of the Unicode halfwidth and
	* fullwidth forms character block.
	*/
	@:public @:static @:final public static var HALFWIDTH_KATAKANA(default, null) : java.awt.im.InputSubset;
	...
	* @since 1.3
	*/
	@:require(java3) @:public @:static @:final public static var FULLWIDTH_LATIN(default, null) : java.awt.im.InputSubset;
	...
	* @since 1.3
	*/
	@:require(java3) @:public @:static @:final public static var FULLWIDTH_DIGITS(default, null) : java.awt.im.InputSubset;
