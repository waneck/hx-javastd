...
extern class AWTEventMulticaster implements java.awt.event.ComponentListener implements java.awt.event.ContainerListener implements java.awt.event.FocusListener implements java.awt.event.KeyListener implements java.awt.event.MouseListener implements java.awt.event.MouseMotionListener implements java.awt.event.WindowListener implements java.awt.event.WindowFocusListener implements java.awt.event.WindowStateListener implements java.awt.event.ActionListener implements java.awt.event.ItemListener implements java.awt.event.AdjustmentListener implements java.awt.event.TextListener implements java.awt.event.InputMethodListener implements java.awt.event.HierarchyListener implements java.awt.event.HierarchyBoundsListener implements java.awt.event.MouseWheelListener
{
	...
	* @since       1.1
	*/
	@:require(java1) @:protected @:final private var a(default, null) : java.util.EventListener;
	
	@:protected @:final private var b(default, null) : java.util.EventListener;
	...
	*/
	@:overload @:protected private function remove(oldl : java.util.EventListener) : java.util.EventListener;
	...
	* @param e the item event
	*/
	@:overload @:public public function inputMethodTextChanged(e : java.awt.event.InputMethodEvent) : Void;
	...
	* @param e the item event
	*/
	@:overload @:public public function caretPositionChanged(e : java.awt.event.InputMethodEvent) : Void;
	...
	* @since 1.3
	*/
	@:require(java3) @:overload @:public public function hierarchyChanged(e : java.awt.event.HierarchyEvent) : Void;
	...
	* @since 1.3
	*/
	@:require(java3) @:overload @:public public function ancestorMoved(e : java.awt.event.HierarchyEvent) : Void;
	...
	* @since 1.3
	*/
	@:require(java3) @:overload @:public public function ancestorResized(e : java.awt.event.HierarchyEvent) : Void;
	...
	*/
	@:overload @:public @:static public static function add(a : java.awt.event.ComponentListener, b : java.awt.event.ComponentListener) : java.awt.event.ComponentListener;
	...
	*/
	@:overload @:public @:static public static function add(a : java.awt.event.ContainerListener, b : java.awt.event.ContainerListener) : java.awt.event.ContainerListener;
	...
	*/
	@:overload @:public @:static public static function add(a : java.awt.event.FocusListener, b : java.awt.event.FocusListener) : java.awt.event.FocusListener;
	...
	*/
	@:overload @:public @:static public static function add(a : java.awt.event.KeyListener, b : java.awt.event.KeyListener) : java.awt.event.KeyListener;
	...
	*/
	@:overload @:public @:static public static function add(a : java.awt.event.MouseListener, b : java.awt.event.MouseListener) : java.awt.event.MouseListener;
	...
	*/
	@:overload @:public @:static public static function add(a : java.awt.event.MouseMotionListener, b : java.awt.event.MouseMotionListener) : java.awt.event.MouseMotionListener;
	...
	*/
	@:overload @:public @:static public static function add(a : java.awt.event.WindowListener, b : java.awt.event.WindowListener) : java.awt.event.WindowListener;
	...
	* @since 1.4
	*/
	@:require(java4) @:overload @:public @:static public static function add(a : java.awt.event.WindowStateListener, b : java.awt.event.WindowStateListener) : java.awt.event.WindowStateListener;
	...
	* @since 1.4
	*/
	@:require(java4) @:overload @:public @:static public static function add(a : java.awt.event.WindowFocusListener, b : java.awt.event.WindowFocusListener) : java.awt.event.WindowFocusListener;
	...
	*/
	@:overload @:public @:static public static function add(a : java.awt.event.ActionListener, b : java.awt.event.ActionListener) : java.awt.event.ActionListener;
	...
	*/
	@:overload @:public @:static public static function add(a : java.awt.event.ItemListener, b : java.awt.event.ItemListener) : java.awt.event.ItemListener;
	...
	*/
	@:overload @:public @:static public static function add(a : java.awt.event.AdjustmentListener, b : java.awt.event.AdjustmentListener) : java.awt.event.AdjustmentListener;
	
	@:overload @:public @:static public static function add(a : java.awt.event.TextListener, b : java.awt.event.TextListener) : java.awt.event.TextListener;
	...
	*/
	@:overload @:public @:static public static function add(a : java.awt.event.InputMethodListener, b : java.awt.event.InputMethodListener) : java.awt.event.InputMethodListener;
	...
	* @since 1.3
	*/
	@:require(java3) @:overload @:public @:static public static function add(a : java.awt.event.HierarchyListener, b : java.awt.event.HierarchyListener) : java.awt.event.HierarchyListener;
	...
	* @since 1.3
	*/
	@:require(java3) @:overload @:public @:static public static function add(a : java.awt.event.HierarchyBoundsListener, b : java.awt.event.HierarchyBoundsListener) : java.awt.event.HierarchyBoundsListener;
	...
	* @since 1.4
	*/
	@:require(java4) @:overload @:public @:static public static function add(a : java.awt.event.MouseWheelListener, b : java.awt.event.MouseWheelListener) : java.awt.event.MouseWheelListener;
	...
	*/
	@:native('remove') @:overload @:public @:static public static function _remove(l : java.awt.event.ComponentListener, oldl : java.awt.event.ComponentListener) : java.awt.event.ComponentListener;
	...
	*/
	@:native('remove') @:overload @:public @:static public static function _remove(l : java.awt.event.ContainerListener, oldl : java.awt.event.ContainerListener) : java.awt.event.ContainerListener;
	...
	*/
	@:native('remove') @:overload @:public @:static public static function _remove(l : java.awt.event.FocusListener, oldl : java.awt.event.FocusListener) : java.awt.event.FocusListener;
	...
	*/
	@:native('remove') @:overload @:public @:static public static function _remove(l : java.awt.event.KeyListener, oldl : java.awt.event.KeyListener) : java.awt.event.KeyListener;
	...
	*/
	@:native('remove') @:overload @:public @:static public static function _remove(l : java.awt.event.MouseListener, oldl : java.awt.event.MouseListener) : java.awt.event.MouseListener;
	...
	*/
	@:native('remove') @:overload @:public @:static public static function _remove(l : java.awt.event.MouseMotionListener, oldl : java.awt.event.MouseMotionListener) : java.awt.event.MouseMotionListener;
	...
	*/
	@:native('remove') @:overload @:public @:static public static function _remove(l : java.awt.event.WindowListener, oldl : java.awt.event.WindowListener) : java.awt.event.WindowListener;
	...
	* @since 1.4
	*/
	@:require(java4) @:native('remove') @:overload @:public @:static public static function _remove(l : java.awt.event.WindowStateListener, oldl : java.awt.event.WindowStateListener) : java.awt.event.WindowStateListener;
	...
	* @since 1.4
	*/
	@:require(java4) @:native('remove') @:overload @:public @:static public static function _remove(l : java.awt.event.WindowFocusListener, oldl : java.awt.event.WindowFocusListener) : java.awt.event.WindowFocusListener;
	...
	*/
	@:native('remove') @:overload @:public @:static public static function _remove(l : java.awt.event.ActionListener, oldl : java.awt.event.ActionListener) : java.awt.event.ActionListener;
	...
	*/
	@:native('remove') @:overload @:public @:static public static function _remove(l : java.awt.event.ItemListener, oldl : java.awt.event.ItemListener) : java.awt.event.ItemListener;
	...
	*/
	@:native('remove') @:overload @:public @:static public static function _remove(l : java.awt.event.AdjustmentListener, oldl : java.awt.event.AdjustmentListener) : java.awt.event.AdjustmentListener;
	
	@:native('remove') @:overload @:public @:static public static function _remove(l : java.awt.event.TextListener, oldl : java.awt.event.TextListener) : java.awt.event.TextListener;
	...
	*/
	@:native('remove') @:overload @:public @:static public static function _remove(l : java.awt.event.InputMethodListener, oldl : java.awt.event.InputMethodListener) : java.awt.event.InputMethodListener;
	...
	* @since 1.3
	*/
	@:require(java3) @:native('remove') @:overload @:public @:static public static function _remove(l : java.awt.event.HierarchyListener, oldl : java.awt.event.HierarchyListener) : java.awt.event.HierarchyListener;
	...
	* @since 1.3
	*/
	@:require(java3) @:native('remove') @:overload @:public @:static public static function _remove(l : java.awt.event.HierarchyBoundsListener, oldl : java.awt.event.HierarchyBoundsListener) : java.awt.event.HierarchyBoundsListener;
	...
	* @since 1.4
	*/
	@:require(java4) @:native('remove') @:overload @:public @:static public static function _remove(l : java.awt.event.MouseWheelListener, oldl : java.awt.event.MouseWheelListener) : java.awt.event.MouseWheelListener;
	...
	*/
	@:overload @:protected private function saveInternal(s : java.io.ObjectOutputStream, k : String) : Void;
	...
	* @since 1.4
	*/
	@:require(java4) @:overload @:public @:static public static function getListeners<T : java.util.EventListener>(l : java.util.EventListener, listenerType : Class<T>) : java.NativeArray<T>;
