...
extern interface FlavorMap
{
	...
	*/
	@:overload public function getNativesForFlavors(flavors : java.NativeArray<java.awt.datatransfer.DataFlavor>) : java.util.Map<java.awt.datatransfer.DataFlavor, String>;
	...
	*/
	@:overload public function getFlavorsForNatives(natives : java.NativeArray<String>) : java.util.Map<String, java.awt.datatransfer.DataFlavor>;
