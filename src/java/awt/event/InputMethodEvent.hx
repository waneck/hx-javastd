...
extern class InputMethodEvent extends java.awt.AWTEvent
{
	...
	*/
	@:public @:static @:final public static var INPUT_METHOD_FIRST(default, null) : Int;
	
	/**
	* The event type indicating changed input method text. This event is
	* generated by input methods while processing input.
	*/
	@:public @:static @:final public static var INPUT_METHOD_TEXT_CHANGED(default, null) : Int;
	...
	*/
	@:public @:static @:final public static var CARET_POSITION_CHANGED(default, null) : Int;
	
	/**
	* Marks the last integer id for the range of input method event ids.
	*/
	@:public @:static @:final public static var INPUT_METHOD_LAST(default, null) : Int;
	...
	* @since 1.4
	*/
	@:require(java4) @:overload @:public public function new(source : java.awt.Component, id : Int, when : haxe.Int64, text : java.text.AttributedCharacterIterator, committedCharacterCount : Int, caret : java.awt.font.TextHitInfo, visiblePosition : java.awt.font.TextHitInfo) : Void;
	...
	* @throws IllegalArgumentException if <code>source</code> is null
	*/
	@:overload @:public public function new(source : java.awt.Component, id : Int, text : java.text.AttributedCharacterIterator, committedCharacterCount : Int, caret : java.awt.font.TextHitInfo, visiblePosition : java.awt.font.TextHitInfo) : Void;
	...
	* @throws IllegalArgumentException if <code>source</code> is null
	*/
	@:overload @:public public function new(source : java.awt.Component, id : Int, caret : java.awt.font.TextHitInfo, visiblePosition : java.awt.font.TextHitInfo) : Void;
	...
	*/
	@:overload @:public public function getText() : java.text.AttributedCharacterIterator;
	
	/**
	* Gets the number of committed characters in the text.
	*/
	@:overload @:public public function getCommittedCharacterCount() : Int;
	...
	*/
	@:overload @:public public function getCaret() : java.awt.font.TextHitInfo;
	...
	*/
	@:overload @:public public function getVisiblePosition() : java.awt.font.TextHitInfo;
