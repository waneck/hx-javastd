...
extern class HierarchyEvent extends java.awt.AWTEvent
{
	...
	*/
	public static var HIERARCHY_FIRST(default, null) : Int;
	
	/**
	* The event id indicating that modification was made to the
	* entire hierarchy tree.
	*/
	public static var HIERARCHY_CHANGED(default, null) : Int;
	...
	*/
	public static var DISPLAYABILITY_CHANGED(default, null) : Int;
	...
	*/
	public static var SHOWING_CHANGED(default, null) : Int;
	...
	*/
	@:overload public function new(source : java.awt.Component, id : Int, changed : java.awt.Component, changedParent : java.awt.Container) : Void;
	...
	* @see #getChangeFlags()
	*/
	@:overload public function new(source : java.awt.Component, id : Int, changed : java.awt.Component, changedParent : java.awt.Container, changeFlags : haxe.Int64) : Void;
	...
	*/
	@:overload public function getChanged() : java.awt.Component;
	...
	*/
	@:overload public function getChangedParent() : java.awt.Container;
	...
	* event
	*/
	@:overload public function getChangeFlags() : haxe.Int64;
