...
* questions.
*/
extern interface TextAreaPeer extends java.awt.peer.TextComponentPeer
{
	/**
	...
	*/
	@:overload public function insert(text : String, pos : Int) : Void;
	...
	*/
	@:overload public function replaceRange(text : String, start : Int, end : Int) : Void;
	...
	*/
	@:overload public function getPreferredSize(rows : Int, columns : Int) : java.awt.Dimension;
	...
	*/
	@:overload public function getMinimumSize(rows : Int, columns : Int) : java.awt.Dimension;
