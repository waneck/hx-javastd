...
* questions.
*/
extern interface ListPeer extends java.awt.peer.ComponentPeer
{
	/**
	...
	*/
	@:overload public function delItems(start : Int, end : Int) : Void;
	...
	*/
	@:overload public function setMultipleMode(m : Bool) : Void;
