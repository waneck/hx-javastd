...
* questions.
*/
extern interface LabelPeer extends java.awt.peer.ComponentPeer
{
	/**
	...
	* @see Label#setText
	*/
	@:overload public function setText(label : String) : Void;
	...
	* @see Label#LEFT
	*/
	@:overload public function setAlignment(alignment : Int) : Void;
