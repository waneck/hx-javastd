...
* questions.
*/
extern interface TextFieldPeer extends java.awt.peer.TextComponentPeer
{
	/**
	...
	*/
	@:overload public function setEchoChar(echoChar : java.StdTypes.Char16) : Void;
	...
	*/
	@:overload public function getPreferredSize(columns : Int) : java.awt.Dimension;
	...
	*/
	@:overload public function getMinimumSize(columns : Int) : java.awt.Dimension;
