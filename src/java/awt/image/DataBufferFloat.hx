...
* @since 1.4
*/
@:require(java4) extern class DataBufferFloat extends java.awt.image.DataBuffer
{
	/**
	...
	*/
	@:overload @:public public function new(dataArray : java.NativeArray<Single>, size : Int) : Void;
	...
	*               that will be used.
	*/
	@:overload @:public public function new(dataArray : java.NativeArray<Single>, size : Int, offset : Int) : Void;
	...
	*/
	@:overload @:public public function new(dataArray : java.NativeArray<java.NativeArray<Single>>, size : Int) : Void;
	...
	*/
	@:overload @:public public function new(dataArray : java.NativeArray<java.NativeArray<Single>>, size : Int, offsets : java.NativeArray<Int>) : Void;
	...
	*/
	@:overload @:public public function getData() : java.NativeArray<Single>;
	...
	*/
	@:overload @:public public function getData(bank : Int) : java.NativeArray<Single>;
	...
	*/
	@:overload @:public public function getBankData() : java.NativeArray<java.NativeArray<Single>>;
	...
	*/
	@:overload @:public override public function getElemFloat(i : Int) : Single;
	...
	* @see #setElemFloat(int, int, float)
	*/
	@:overload @:public override public function getElemFloat(bank : Int, i : Int) : Single;
	...
	*/
	@:overload @:public override public function setElemFloat(i : Int, val : Single) : Void;
	...
	* @see #getElemFloat(int, int)
	*/
	@:overload @:public override public function setElemFloat(bank : Int, i : Int, val : Single) : Void;
	...
	*/
	@:overload @:public override public function getElemDouble(i : Int) : Float;
	...
	* @see #setElemDouble(int, int, double)
	*/
	@:overload @:public override public function getElemDouble(bank : Int, i : Int) : Float;
	...
	*/
	@:overload @:public override public function setElemDouble(i : Int, val : Float) : Void;
	...
	* @see #getElemDouble(int, int)
	*/
	@:overload @:public override public function setElemDouble(bank : Int, i : Int, val : Float) : Void;
