...
@:require(java4) extern class DataBufferFloat extends java.awt.image.DataBuffer
{
	...
	*/
	@:overload public function new(dataArray : java.NativeArray<Single>, size : Int) : Void;
	...
	*               that will be used.
	*/
	@:overload public function new(dataArray : java.NativeArray<Single>, size : Int, offset : Int) : Void;
	...
	*/
	@:overload public function new(dataArray : java.NativeArray<java.NativeArray<Single>>, size : Int) : Void;
	...
	*/
	@:overload public function new(dataArray : java.NativeArray<java.NativeArray<Single>>, size : Int, offsets : java.NativeArray<Int>) : Void;
	...
	*/
	@:overload public function getData() : java.NativeArray<Single>;
	...
	*/
	@:overload public function getData(bank : Int) : java.NativeArray<Single>;
	...
	*/
	@:overload public function getBankData() : java.NativeArray<java.NativeArray<Single>>;
