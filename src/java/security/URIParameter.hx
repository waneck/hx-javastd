...
* @since 1.6
*/
@:require(java6) extern class URIParameter implements java.security.Policy.Policy_Parameters implements javax.security.auth.login.Configuration.Configuration_Parameters
{
	/**
