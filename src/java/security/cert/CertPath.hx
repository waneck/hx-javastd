...
* questions.
*/
extern class CertPath implements java.io.Serializable
{
	/**
...
* @since 1.4
*/
@:require(java4) @:native('java$security$cert$CertPath$CertPathRep') extern class CertPath_CertPathRep implements java.io.Serializable
{
	/**
