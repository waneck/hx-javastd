...
* questions.
*/
extern interface AsynchronousByteChannel extends java.nio.channels.AsynchronousChannel
{
	/**
	...
	*/
	@:overload public function read<A>(dst : java.nio.ByteBuffer, attachment : A, handler : java.nio.channels.CompletionHandler<Null<Int>, A>) : Void;
	...
	*          and a previous read has not completed
	*/
	@:overload public function read(dst : java.nio.ByteBuffer) : java.util.concurrent.Future<Null<Int>>;
	...
	*          group} that has terminated
	*/
	@:overload public function write<A>(src : java.nio.ByteBuffer, attachment : A, handler : java.nio.channels.CompletionHandler<Null<Int>, A>) : Void;
	...
	*          and a previous write has not completed
	*/
	@:overload public function write(src : java.nio.ByteBuffer) : java.util.concurrent.Future<Null<Int>>;
