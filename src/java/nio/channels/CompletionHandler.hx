...
* @since 1.7
*/
@:require(java7) extern interface CompletionHandler<V, A>
{
	/**
	...
	*/
	@:overload public function completed(result : V, attachment : A) : Void;
	...
	*          The object attached to the I/O operation when it was initiated.
	*/
	@:overload public function failed(exc : java.lang.Throwable, attachment : A) : Void;
