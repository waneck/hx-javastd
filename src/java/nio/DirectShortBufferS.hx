...
@:internal extern class DirectShortBufferS extends java.nio.ShortBuffer implements sun.nio.ch.DirectBuffer
{
	...
	@:overload public function get() : java.StdTypes.Int16;
	
	@:overload public function get(i : Int) : java.StdTypes.Int16;
