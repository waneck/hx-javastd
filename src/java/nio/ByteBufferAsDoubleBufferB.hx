...
@:internal extern class ByteBufferAsDoubleBufferB extends java.nio.DoubleBuffer
{
	...
	@:overload public function get() : Float;
	
	@:overload public function get(i : Int) : Float;
