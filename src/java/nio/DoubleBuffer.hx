...
@:require(java4) extern class DoubleBuffer extends java.nio.Buffer implements java.lang.Comparable<java.nio.DoubleBuffer>
{
	...
	*/
	@:overload @:abstract public function get() : Float;
	...
	*/
	@:overload @:abstract public function get(index : Int) : Float;
	...
	*/
	@:overload @:final override public function array() : java.NativeArray<Float>;
	...
	*/
	@:overload @:public @:public @:public @:public @:public @:public @:public @:public public function compareTo(o : Dynamic) : Int;
