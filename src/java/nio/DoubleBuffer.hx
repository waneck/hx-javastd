...
@:require(java4) extern class DoubleBuffer extends java.nio.Buffer implements java.lang.Comparable<java.nio.DoubleBuffer>
{
	...
	*/
	@:overload @:public @:static public static function allocate(capacity : Int) : java.nio.DoubleBuffer;
	...
	*/
	@:overload @:public @:static public static function wrap(array : java.NativeArray<Float>, offset : Int, length : Int) : java.nio.DoubleBuffer;
	...
	* @return  The new double buffer
	*/
	@:overload @:public @:static public static function wrap(array : java.NativeArray<Float>) : java.nio.DoubleBuffer;
	...
	* @return  The new double buffer
	*/
	@:overload @:public @:abstract public function slice() : java.nio.DoubleBuffer;
	...
	* @return  The new double buffer
	*/
	@:overload @:public @:abstract public function duplicate() : java.nio.DoubleBuffer;
	...
	*/
	@:overload @:public @:abstract public function asReadOnlyBuffer() : java.nio.DoubleBuffer;
	...
	*/
	@:overload @:public @:abstract public function get() : Float;
	...
	*/
	@:overload @:public @:abstract public function put(d : Float) : java.nio.DoubleBuffer;
	...
	*/
	@:overload @:public @:abstract public function get(index : Int) : Float;
	...
	*          If this buffer is read-only
	*/
	@:overload @:public @:abstract public function put(index : Int, d : Float) : java.nio.DoubleBuffer;
	...
	*          parameters do not hold
	*/
	@:overload @:public public function get(dst : java.NativeArray<Float>, offset : Int, length : Int) : java.nio.DoubleBuffer;
	...
	*          remaining in this buffer
	*/
	@:overload @:public public function get(dst : java.NativeArray<Float>) : java.nio.DoubleBuffer;
	...
	*          If this buffer is read-only
	*/
	@:overload @:public public function put(src : java.nio.DoubleBuffer) : java.nio.DoubleBuffer;
	...
	*          If this buffer is read-only
	*/
	@:overload @:public public function put(src : java.NativeArray<Float>, offset : Int, length : Int) : java.nio.DoubleBuffer;
	...
	*          If this buffer is read-only
	*/
	@:overload @:public @:final public function put(src : java.NativeArray<Float>) : java.nio.DoubleBuffer;
	...
	*/
	@:overload @:public @:final override public function array() : java.NativeArray<Float>;
	...
	*          If this buffer is read-only
	*/
	@:overload @:public @:abstract public function compact() : java.nio.DoubleBuffer;
	...
	*/
	@:overload @:public public function compareTo(that : java.nio.DoubleBuffer) : Int;
