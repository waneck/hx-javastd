...
* @since 1.4
*/
@:require(java4) extern class CodingErrorAction
{
	/**
	* Action indicating that a coding error is to be handled by dropping the
	* erroneous input and resuming the coding operation.  </p>
	*/
	public static var IGNORE(default, null) : CodingErrorAction;
	...
	*/
	public static var REPLACE(default, null) : CodingErrorAction;
	...
	*/
	public static var REPORT(default, null) : CodingErrorAction;
