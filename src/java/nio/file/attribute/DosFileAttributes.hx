...
* @since 1.7
*/
@:require(java7) extern interface DosFileAttributes extends java.nio.file.attribute.BasicFileAttributes
{
	/**
	...
	*/
	@:overload public function isArchive() : Bool;
	...
	*/
	@:overload public function isSystem() : Bool;
