...
* @since 1.7
*/
@:require(java7) extern interface WatchEvent<T>
{
	/**
...
*/
@:require(java7) @:native('java$nio$file$WatchEvent$Kind') extern interface WatchEvent_Kind<T>
{
	/**
...
*/
@:require(java7) @:native('java$nio$file$WatchEvent$Modifier') extern interface WatchEvent_Modifier
{
	/**
