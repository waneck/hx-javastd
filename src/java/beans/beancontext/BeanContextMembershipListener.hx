...
* questions.
*/
extern interface BeanContextMembershipListener extends java.util.EventListener
{
	/**
	...
	*/
	@:overload public function childrenAdded(bcme : java.beans.beancontext.BeanContextMembershipEvent) : Void;
	...
	* describing the change that occurred.
	*/
	@:overload public function childrenRemoved(bcme : java.beans.beancontext.BeanContextMembershipEvent) : Void;
