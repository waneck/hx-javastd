...
extern interface AppletInitializer
{
	...
	*                       null.
	*/
	@:overload public function initialize(newAppletBean : java.applet.Applet, bCtxt : java.beans.beancontext.BeanContext) : Void;
	...
	*/
	@:overload public function activate(newApplet : java.applet.Applet) : Void;
