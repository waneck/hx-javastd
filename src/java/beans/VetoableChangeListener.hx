...
*/
extern interface VetoableChangeListener extends java.util.EventListener
{
	/**
	...
	*/
	@:overload public function vetoableChange(evt : java.beans.PropertyChangeEvent) : Void;
