...
extern class Time extends java.util.Date
{
	...
	*/
	@:overload @:public public function new(hour : Int, minute : Int, second : Int) : Void;
	...
	*/
	@:overload @:public @:static public static function valueOf(s : String) : java.sql.Time;
	...
	* @see #setDate
	*/
	@:overload @:public override public function getDate() : Int;
	...
	* @see #getYear
	*/
	@:overload @:public override public function setYear(i : Int) : Void;
	...
	* @see #getMonth
	*/
	@:overload @:public override public function setMonth(i : Int) : Void;
	...
	* @see #getDate
	*/
	@:overload @:public override public function setDate(i : Int) : Void;
