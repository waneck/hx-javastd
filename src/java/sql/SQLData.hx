...
* @since 1.2
*/
@:require(java2) extern interface SQLData
{
	/**
	...
	* @since 1.2
	*/
	@:require(java2) @:overload public function readSQL(stream : java.sql.SQLInput, typeName : String) : Void;
	...
	* @since 1.2
	*/
	@:require(java2) @:overload public function writeSQL(stream : java.sql.SQLOutput) : Void;
