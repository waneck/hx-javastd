...
* questions.
*/
extern interface Connection extends java.sql.Wrapper extends java.lang.AutoCloseable
{
	/**
	...
	*/
	@:overload public function createStatement() : java.sql.Statement;
	...
	* or this method is called on a closed connection
	*/
	@:overload public function prepareStatement(sql : String) : java.sql.PreparedStatement;
	...
	* or this method is called on a closed connection
	*/
	@:overload public function prepareCall(sql : String) : java.sql.CallableStatement;
	...
	* or this method is called on a closed connection
	*/
	@:overload public function nativeSQL(sql : String) : String;
	...
	* or this method is called on a closed connection
	*/
	@:overload public function getMetaData() : java.sql.DatabaseMetaData;
	...
	* @see #getCatalog
	*/
	@:overload public function setCatalog(catalog : String) : Void;
	...
	* @see #setCatalog
	*/
	@:overload public function getCatalog() : String;
	
	/**
	* A constant indicating that transactions are not supported.
	*/
	public var TRANSACTION_NONE : Int;
	...
	*/
	public var TRANSACTION_READ_UNCOMMITTED : Int;
	...
	*/
	public var TRANSACTION_READ_COMMITTED : Int;
	...
	*/
	public var TRANSACTION_REPEATABLE_READ : Int;
	...
	*/
	public var TRANSACTION_SERIALIZABLE : Int;
	...
	* @since 1.2
	*/
	@:require(java2) @:overload public function createStatement(resultSetType : Int, resultSetConcurrency : Int) : java.sql.Statement;
	...
	* @since 1.2
	*/
	@:require(java2) @:overload public function prepareStatement(sql : String, resultSetType : Int, resultSetConcurrency : Int) : java.sql.PreparedStatement;
	...
	* @since 1.2
	*/
	@:require(java2) @:overload public function prepareCall(sql : String, resultSetType : Int, resultSetConcurrency : Int) : java.sql.CallableStatement;
	...
	* @see #setTypeMap
	*/
	@:require(java2) @:overload public function getTypeMap() : java.util.Map<String, Class<Dynamic>>;
	...
	* @see #getTypeMap
	*/
	@:require(java2) @:overload public function setTypeMap(map : java.util.Map<String, Class<Dynamic>>) : Void;
	...
	* @since 1.4
	*/
	@:require(java4) @:overload public function setHoldability(holdability : Int) : Void;
	...
	* @since 1.4
	*/
	@:require(java4) @:overload public function getHoldability() : Int;
	...
	* @since 1.4
	*/
	@:require(java4) @:overload public function setSavepoint() : java.sql.Savepoint;
	...
	* @since 1.4
	*/
	@:require(java4) @:overload public function setSavepoint(name : String) : java.sql.Savepoint;
	...
	* @since 1.4
	*/
	@:require(java4) @:overload public function rollback(savepoint : java.sql.Savepoint) : Void;
	...
	* @since 1.4
	*/
	@:require(java4) @:overload public function releaseSavepoint(savepoint : java.sql.Savepoint) : Void;
	...
	* @since 1.4
	*/
	@:require(java4) @:overload public function createStatement(resultSetType : Int, resultSetConcurrency : Int, resultSetHoldability : Int) : java.sql.Statement;
	...
	* @since 1.4
	*/
	@:require(java4) @:overload public function prepareStatement(sql : String, resultSetType : Int, resultSetConcurrency : Int, resultSetHoldability : Int) : java.sql.PreparedStatement;
	...
	* @since 1.4
	*/
	@:require(java4) @:overload public function prepareCall(sql : String, resultSetType : Int, resultSetConcurrency : Int, resultSetHoldability : Int) : java.sql.CallableStatement;
	...
	* @since 1.4
	*/
	@:require(java4) @:overload public function prepareStatement(sql : String, autoGeneratedKeys : Int) : java.sql.PreparedStatement;
	...
	* @since 1.4
	*/
	@:require(java4) @:overload public function prepareStatement(sql : String, columnIndexes : java.NativeArray<Int>) : java.sql.PreparedStatement;
	...
	* @since 1.4
	*/
	@:require(java4) @:overload public function prepareStatement(sql : String, columnNames : java.NativeArray<String>) : java.sql.PreparedStatement;
	...
	* @since 1.6
	*/
	@:require(java6) @:overload public function createClob() : java.sql.Clob;
	...
	* @since 1.6
	*/
	@:require(java6) @:overload public function createBlob() : java.sql.Blob;
	...
	* @since 1.6
	*/
	@:require(java6) @:overload public function createNClob() : java.sql.NClob;
	...
	* @since 1.6
	*/
	@:require(java6) @:overload public function createSQLXML() : java.sql.SQLXML;
	...
	*/
	@:require(java6) @:overload public function isValid(timeout : Int) : Bool;
	...
	* @since 1.6
	*/
	@:require(java6) @:overload public function setClientInfo(name : String, value : String) : Void;
	...
	* <p>
	*/
	@:require(java6) @:overload public function setClientInfo(properties : java.util.Properties) : Void;
	...
	* @see java.sql.DatabaseMetaData#getClientInfoProperties
	*/
	@:require(java6) @:overload public function getClientInfo(name : String) : String;
	...
	* @since 1.6
	*/
	@:require(java6) @:overload public function getClientInfo() : java.util.Properties;
	...
	* @since 1.6
	*/
	@:require(java6) @:overload public function createArrayOf(typeName : String, elements : java.NativeArray<Dynamic>) : java.sql.Array;
	...
	* @since 1.6
	*/
	@:require(java6) @:overload public function createStruct(typeName : String, attributes : java.NativeArray<Dynamic>) : java.sql.Struct;
	...
	* @since 1.7
	*/
	@:require(java7) @:overload public function setSchema(schema : String) : Void;
	...
	* @since 1.7
	*/
	@:require(java7) @:overload public function getSchema() : String;
	...
	* @since 1.7
	*/
	@:require(java7) @:overload public function abort(executor : java.util.concurrent.Executor) : Void;
	...
	* @since 1.7
	*/
	@:require(java7) @:overload public function setNetworkTimeout(executor : java.util.concurrent.Executor, milliseconds : Int) : Void;
	...
	* @since 1.7
	*/
	@:require(java7) @:overload public function getNetworkTimeout() : Int;
