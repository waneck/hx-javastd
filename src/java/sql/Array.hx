...
* @since 1.2
*/
@:require(java2) extern interface Array
{
	/**
	...
	* @since 1.2
	*/
	@:require(java2) @:overload public function getBaseTypeName() : String;
	...
	* @since 1.2
	*/
	@:require(java2) @:overload public function getBaseType() : Int;
	...
	* @since 1.2
	*/
	@:require(java2) @:overload public function getArray() : Dynamic;
	...
	* @since 1.2
	*/
	@:require(java2) @:overload public function getArray(map : java.util.Map<String, Class<Dynamic>>) : Dynamic;
	...
	* @since 1.2
	*/
	@:require(java2) @:overload public function getArray(index : haxe.Int64, count : Int) : Dynamic;
	...
	* @since 1.2
	*/
	@:require(java2) @:overload public function getArray(index : haxe.Int64, count : Int, map : java.util.Map<String, Class<Dynamic>>) : Dynamic;
	...
	* @since 1.2
	*/
	@:require(java2) @:overload public function getResultSet() : java.sql.ResultSet;
	...
	* @since 1.2
	*/
	@:require(java2) @:overload public function getResultSet(map : java.util.Map<String, Class<Dynamic>>) : java.sql.ResultSet;
	...
	* @since 1.2
	*/
	@:require(java2) @:overload public function getResultSet(index : haxe.Int64, count : Int) : java.sql.ResultSet;
	...
	* @since 1.2
	*/
	@:require(java2) @:overload public function getResultSet(index : haxe.Int64, count : Int, map : java.util.Map<String, Class<Dynamic>>) : java.sql.ResultSet;
