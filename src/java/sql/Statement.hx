...
* @see ResultSet
*/
extern interface Statement extends java.sql.Wrapper extends java.lang.AutoCloseable
{
	/**
	...
	*/
	@:overload public function executeQuery(sql : String) : java.sql.ResultSet;
	...
	* the currently running {@code Statement}
	*/
	@:overload public function executeUpdate(sql : String) : Int;
	...
	*/
	@:overload public function setCursorName(name : String) : Void;
	...
	* @see #getMoreResults
	*/
	@:overload public function execute(sql : String) : Bool;
	...
	* @see #execute
	*/
	@:overload public function getUpdateCount() : Int;
	...
	* @see #execute
	*/
	@:overload public function getMoreResults() : Bool;
	...
	* @since 1.2
	*/
	@:require(java2) @:overload public function getResultSetConcurrency() : Int;
	...
	* @since 1.2
	*/
	@:require(java2) @:overload public function getResultSetType() : Int;
	...
	* @since 1.2
	*/
	@:require(java2) @:overload public function addBatch(sql : String) : Void;
	...
	* @since 1.2
	*/
	@:require(java2) @:overload public function clearBatch() : Void;
	...
	* @since 1.2
	*/
	@:require(java2) @:overload public function executeBatch() : java.NativeArray<Int>;
	...
	* @since 1.4
	*/
	@:require(java4) public var CLOSE_CURRENT_RESULT : Int;
	...
	* @since 1.4
	*/
	@:require(java4) public var KEEP_CURRENT_RESULT : Int;
	...
	* @since 1.4
	*/
	@:require(java4) public var CLOSE_ALL_RESULTS : Int;
	...
	* @since 1.4
	*/
	@:require(java4) public var SUCCESS_NO_INFO : Int;
	...
	* @since 1.4
	*/
	@:require(java4) public var EXECUTE_FAILED : Int;
	...
	* @since 1.4
	*/
	@:require(java4) public var RETURN_GENERATED_KEYS : Int;
	...
	* @since 1.4
	*/
	@:require(java4) public var NO_GENERATED_KEYS : Int;
	...
	* @see #execute
	*/
	@:require(java4) @:overload public function getMoreResults(current : Int) : Bool;
	...
	* @since 1.4
	*/
	@:require(java4) @:overload public function getGeneratedKeys() : java.sql.ResultSet;
	...
	* @since 1.4
	*/
	@:require(java4) @:overload public function executeUpdate(sql : String, autoGeneratedKeys : Int) : Int;
	...
	* @since 1.4
	*/
	@:require(java4) @:overload public function executeUpdate(sql : String, columnIndexes : java.NativeArray<Int>) : Int;
	...
	* @since 1.4
	*/
	@:require(java4) @:overload public function executeUpdate(sql : String, columnNames : java.NativeArray<String>) : Int;
	...
	* @since 1.4
	*/
	@:require(java4) @:overload public function execute(sql : String, autoGeneratedKeys : Int) : Bool;
	...
	* @since 1.4
	*/
	@:require(java4) @:overload public function execute(sql : String, columnIndexes : java.NativeArray<Int>) : Bool;
	...
	* @since 1.4
	*/
	@:require(java4) @:overload public function execute(sql : String, columnNames : java.NativeArray<String>) : Bool;
	...
	* @since 1.6
	*/
	@:require(java6) @:overload public function setPoolable(poolable : Bool) : Void;
	...
	*/
	@:require(java6) @:overload public function isPoolable() : Bool;
