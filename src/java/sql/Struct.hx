...
* @since 1.2
*/
@:require(java2) extern interface Struct
{
	/**
	...
	* @since 1.2
	*/
	@:require(java2) @:overload public function getSQLTypeName() : String;
	...
	* @since 1.2
	*/
	@:require(java2) @:overload public function getAttributes() : java.NativeArray<Dynamic>;
	...
	* @since 1.2
	*/
	@:require(java2) @:overload public function getAttributes(map : java.util.Map<String, Class<Dynamic>>) : java.NativeArray<Dynamic>;
