...
* @since 1.2
*/
@:require(java2) extern interface Ref
{
	/**
	...
	* @see #setObject
	*/
	@:require(java4) @:overload public function getObject(map : java.util.Map<String, Class<Dynamic>>) : Dynamic;
	...
	* @see #setObject
	*/
	@:require(java4) @:overload public function getObject() : Dynamic;
	...
	*/
	@:require(java4) @:overload public function setObject(value : Dynamic) : Void;
