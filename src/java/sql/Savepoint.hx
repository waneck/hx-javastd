...
* @since 1.4
*/
@:require(java4) extern interface Savepoint
{
	/**
	...
	* @since 1.4
	*/
	@:require(java4) @:overload public function getSavepointId() : Int;
	...
	* @since 1.4
	*/
	@:require(java4) @:overload public function getSavepointName() : String;
