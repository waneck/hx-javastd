...
extern interface Driver
{
	...
	*/
	@:overload public function connect(url : String, info : java.util.Properties) : java.sql.Connection;
	...
	* @exception SQLException if a database access error occurs
	*/
	@:overload public function acceptsURL(url : String) : Bool;
	...
	* @exception SQLException if a database access error occurs
	*/
	@:overload public function getPropertyInfo(url : String, info : java.util.Properties) : java.NativeArray<java.sql.DriverPropertyInfo>;
	...
	*         otherwise
	*/
	@:overload public function jdbcCompliant() : Bool;
