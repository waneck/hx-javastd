...
* @since   1.2
*/
@:require(java2) extern class HashSet<E> extends java.util.AbstractSet<E> implements java.util.Set<E> implements java.lang.Cloneable implements java.io.Serializable
{
	/**
