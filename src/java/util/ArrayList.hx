...
* @since   1.2
*/
@:require(java2) extern class ArrayList<E> extends java.util.AbstractList<E> implements java.util.List<E> implements java.util.RandomAccess implements java.lang.Cloneable implements java.io.Serializable
{
	/**
...
*/
@:native('java$util$ArrayList$ListItr') @:internal extern class ArrayList_ListItr extends ArrayList_Itr implements java.util.ListIterator<Dynamic>
{
