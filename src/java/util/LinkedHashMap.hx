...
* @since   1.4
*/
@:require(java4) extern class LinkedHashMap<K, V> extends java.util.HashMap<K, V> implements java.util.Map<K, V>
{
	/**
...
* LinkedHashMap entry.
*/
@:native('java$util$LinkedHashMap$Entry') @:internal extern class LinkedHashMap_Entry<K, V> extends java.util.HashMap.HashMap_Entry<K, V>
{
