...
* @since   1.4
*/
@:require(java4) extern class LinkedHashSet<E> extends java.util.HashSet<E> implements java.util.Set<E> implements java.lang.Cloneable implements java.io.Serializable
{
	/**
