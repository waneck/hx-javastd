...
* @since   1.4
*/
@:require(java4) extern interface PreferenceChangeListener extends java.util.EventListener
{
	/**
	...
	*/
	@:overload public function preferenceChange(evt : java.util.prefs.PreferenceChangeEvent) : Void;
