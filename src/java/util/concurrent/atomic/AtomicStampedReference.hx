...
*/
@:require(java5) extern class AtomicStampedReference<V>
{
	/**
...
@:native('java$util$concurrent$atomic$AtomicStampedReference$Pair') @:internal extern class AtomicStampedReference_Pair<T>
{
