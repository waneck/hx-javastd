...
*/
extern class AbstractQueuedSynchronizer extends java.util.concurrent.locks.AbstractOwnableSynchronizer implements java.io.Serializable
{
	/**
	...
	*/
	@:overload @:final public function owns(condition : AbstractQueuedSynchronizer_ConditionObject) : Bool;
	...
	* @throws NullPointerException if the condition is null
	*/
	@:overload @:final public function hasWaiters(condition : AbstractQueuedSynchronizer_ConditionObject) : Bool;
	...
	* @throws NullPointerException if the condition is null
	*/
	@:overload @:final public function getWaitQueueLength(condition : AbstractQueuedSynchronizer_ConditionObject) : Int;
	...
	* @throws NullPointerException if the condition is null
	*/
	@:overload @:final public function getWaitingThreads(condition : AbstractQueuedSynchronizer_ConditionObject) : java.util.Collection<java.lang.Thread>;
...
*/
@:native('java$util$concurrent$locks$AbstractQueuedSynchronizer$Node') @:internal extern class AbstractQueuedSynchronizer_Node
{
...
*/
@:native('java$util$concurrent$locks$AbstractQueuedSynchronizer$ConditionObject') extern class AbstractQueuedSynchronizer_ConditionObject implements java.util.concurrent.locks.Condition implements java.io.Serializable
{
	/**
