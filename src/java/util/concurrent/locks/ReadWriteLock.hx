...
* @author Doug Lea
*/
@:require(java5) extern interface ReadWriteLock
{
	/**
	...
	*/
	@:overload public function readLock() : java.util.concurrent.locks.Lock;
	...
	*/
	@:overload public function writeLock() : java.util.concurrent.locks.Lock;
