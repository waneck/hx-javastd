...
* @serial exclude
*/
@:require(java5) @:internal extern class RegularEnumSet<E> extends java.util.EnumSet<E>
{
	/**
...
@:native('java$util$RegularEnumSet$EnumSetIterator') @:internal extern class RegularEnumSet_EnumSetIterator<E> implements java.util.Iterator<E>
{
