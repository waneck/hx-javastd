...
extern interface LoaderHandler
{
	...
	*/
	@:require(java1) @:overload public function loadClass(name : String) : Class<Dynamic>;
	...
	* @deprecated no replacement
	*/
	@:require(java1) @:overload public function loadClass(codebase : java.net.URL, name : String) : Class<Dynamic>;
	...
	* @deprecated no replacement
	*/
	@:require(java1) @:overload public function getSecurityContext(loader : java.lang.ClassLoader) : Dynamic;
