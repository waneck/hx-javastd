...
*/
@:require(java1) extern interface RemoteRef extends java.io.Externalizable
{
	/**
	...
	*/
	@:require(java1) @:overload public function newCall(obj : java.rmi.server.RemoteObject, op : java.NativeArray<java.rmi.server.Operation>, opnum : Int, hash : haxe.Int64) : java.rmi.server.RemoteCall;
	...
	* @see #invoke(Remote,java.lang.reflect.Method,Object[],long)
	*/
	@:require(java1) @:overload public function invoke(call : java.rmi.server.RemoteCall) : Void;
	...
	* @see #invoke(Remote,java.lang.reflect.Method,Object[],long)
	*/
	@:require(java1) @:overload public function done(call : java.rmi.server.RemoteCall) : Void;
	...
	* @since JDK1.1
	*/
	@:require(java1) @:overload public function getRefClass(out : java.io.ObjectOutput) : String;
	...
	* @since JDK1.1
	*/
	@:require(java1) @:overload public function remoteHashCode() : Int;
	...
	* @since JDK1.1
	*/
	@:require(java1) @:overload public function remoteToString() : String;
