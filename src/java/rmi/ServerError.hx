...
* @since   JDK1.1
*/
@:require(java1) extern class ServerError extends java.rmi.RemoteException
{
	/**
	...
	* @since JDK1.1
	*/
	@:require(java1) @:overload @:public public function new(s : String, err : java.lang.Error) : Void;
