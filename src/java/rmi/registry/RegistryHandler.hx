...
extern interface RegistryHandler
{
	...
	*/
	@:overload public function registryStub(host : String, port : Int) : java.rmi.registry.Registry;
	...
	* @throws RemoteException if a remote error occurs
	*/
	@:overload public function registryImpl(port : Int) : java.rmi.registry.Registry;
