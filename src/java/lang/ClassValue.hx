...
*/
@:native('java$lang$ClassValue$ClassValueMap') @:internal extern class ClassValue_ClassValueMap extends java.util.WeakHashMap<ClassValue_Identity, ClassValue_Entry<Dynamic>>
{
