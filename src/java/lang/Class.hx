...
* questions.
*/
extern class Class<T> implements java.io.Serializable implements java.lang.reflect.GenericDeclaration implements java.lang.reflect.Type implements java.lang.reflect.AnnotatedElement
{
	/**
...
@:native('java$lang$Class$EnclosingMethodInfo') @:internal extern class Class_EnclosingMethodInfo
{
	
}
@:native('java$lang$Class$MethodArray') @:internal extern class Class_MethodArray
{
