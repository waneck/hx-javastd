...
* questions.
*/
extern class MutableCallSite extends java.lang.invoke.CallSite
{
	/**
	...
	*/
	@:overload @:public @:static public static function syncAll(sites : java.NativeArray<java.lang.invoke.MutableCallSite>) : Void;
