...
@:internal extern class MemberName implements java.lang.reflect.Member implements java.lang.Cloneable
{
	...
	*/
	@:overload public function getMethodType() : java.lang.invoke.MethodType;
	
	/** Return the actual type under which this method or constructor must be invoked.
	*  For non-static methods or constructors, this is the type with a leading parameter,
	*  a reference to declaring class.  For static methods, it is the same as the declared type.
	*/
	@:overload public function getInvocationType() : java.lang.invoke.MethodType;
	...
	*/
	@:overload public function getFieldType() : Class<Dynamic>;
	...
	*/
	...
	@:overload public function isInvocable() : Bool;
	
	/** Utility method to query whether this member is a method, constructor, or field. */
	@:overload public function isFieldOrMethod() : Bool;
	...
	@:overload public function isType() : Bool;
	...
	@:overload public function new(m : java.lang.reflect.Method) : Void;
	
	/** Create a name for the given reflected constructor.  The resulting name will be in a resolved state. */
	@:overload public function new(ctor : java.lang.reflect.Constructor<Dynamic>) : Void;
	
	/** Create a name for the given reflected field.  The resulting name will be in a resolved state. */
	@:overload public function new(fld : java.lang.reflect.Field) : Void;
	...
	*/
	@:overload public function new(defClass : Class<Dynamic>, name : String, type : Class<Dynamic>, modifiers : Int) : Void;
	...
	*  The resulting name will in an unresolved state.
	*/
	@:overload public function new(defClass : Class<Dynamic>, name : String, type : Class<Dynamic>) : Void;
	...
	*  The resulting name will in an unresolved state.
	*/
	@:overload public function new(defClass : Class<Dynamic>, name : String, type : java.lang.invoke.MethodType, modifiers : Int) : Void;
	...
	*  The resulting name will in an unresolved state.
	*/
	@:overload public function new(defClass : Class<Dynamic>, name : String, type : java.lang.invoke.MethodType) : Void;
	...
	*/
	@:overload public function hasReceiverTypeDispatch() : Bool;
	...
	*/
	...
	@:overload public function makeAccessException(message : String, from : Dynamic) : java.lang.IllegalAccessException;
	
	@:overload public function makeAccessException() : java.lang.ReflectiveOperationException;
