...
extern interface Instrumentation
{
	...
	* @since 1.6
	*/
	@:require(java6) @:overload public function addTransformer(transformer : java.lang.instrument.ClassFileTransformer, canRetransform : Bool) : Void;
	...
	* @throws java.lang.NullPointerException if passed a <code>null</code> transformer
	*/
	@:overload public function removeTransformer(transformer : java.lang.instrument.ClassFileTransformer) : Bool;
	...
	* @since 1.6
	*/
	@:require(java6) @:overload public function isRetransformClassesSupported() : Bool;
	...
	* @since 1.6
	*/
	@:require(java6) @:overload public function retransformClasses(classes : java.NativeArray<Class<Dynamic>>) : Void;
	...
	* @since 1.6
	*/
	@:require(java6) @:overload public function isModifiableClass(theClass : Class<Dynamic>) : Bool;
	...
	* @since 1.6
	*/
	@:require(java6) @:overload public function appendToBootstrapClassLoaderSearch(jarfile : java.util.jar.JarFile) : Void;
	...
	* @since 1.6
	*/
	@:require(java6) @:overload public function appendToSystemClassLoaderSearch(jarfile : java.util.jar.JarFile) : Void;
	...
	* @since 1.6
	*/
	@:require(java6) @:overload public function isNativeMethodPrefixSupported() : Bool;
	...
	* @since 1.6
	*/
	@:require(java6) @:overload public function setNativeMethodPrefix(transformer : java.lang.instrument.ClassFileTransformer, prefix : String) : Void;
