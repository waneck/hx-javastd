...
* @since 1.5
*/
@:require(java5) extern class LocalEventTimer extends java.util.Timer
{
	/**
	...
	*/
	@:overload @:public @:static @:synchronized public static function getInstance() : sun.jvmstat.perfdata.monitor.protocol.local.LocalEventTimer;
