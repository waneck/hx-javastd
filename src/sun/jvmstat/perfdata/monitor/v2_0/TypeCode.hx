...
{
	public static var BOOLEAN(default, null) : TypeCode;
	
	public static var CHAR(default, null) : TypeCode;
	
	public static var FLOAT(default, null) : TypeCode;
	
	public static var DOUBLE(default, null) : TypeCode;
	
	public static var BYTE(default, null) : TypeCode;
	
	public static var SHORT(default, null) : TypeCode;
	
	public static var INT(default, null) : TypeCode;
	
	public static var LONG(default, null) : TypeCode;
	
	public static var OBJECT(default, null) : TypeCode;
	
	public static var ARRAY(default, null) : TypeCode;
	
	public static var VOID(default, null) : TypeCode;
	...
	*/
	@:overload public static function toTypeCode(c : java.StdTypes.Char16) : TypeCode;
	...
	*                                  a valid Java TypeCode.
	*/
	@:overload public static function toTypeCode(b : java.StdTypes.Int8) : TypeCode;
