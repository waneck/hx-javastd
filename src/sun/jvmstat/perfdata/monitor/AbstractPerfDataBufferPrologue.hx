...
extern class AbstractPerfDataBufferPrologue
{
	...
	* @since 1.5
	*/
	@:require(java5) @:protected private var byteBuffer : java.nio.ByteBuffer;
	
	@:public @:final @:static public static var PERFDATA_MAJOR_NAME(default, null) : String;
	
	@:public @:final @:static public static var PERFDATA_MINOR_NAME(default, null) : String;
	...
	*/
	@:overload @:public @:abstract public function isAccessible() : Bool;
	...
	* @see #isAccessible()
	*/
	@:overload @:public @:abstract public function supportsAccessible() : Bool;
	...
	*/
	@:overload @:public public function majorVersionBuffer() : java.nio.IntBuffer;
	...
	*                     in the instrumentation buffer header.
	*/
	@:overload @:public public function minorVersionBuffer() : java.nio.IntBuffer;
	...
	* @return int - the magic number
	*/
	@:native('getMagic') @:overload @:public @:static public static function _getMagic(bb : java.nio.ByteBuffer) : Int;
	...
	* @return int - the major version
	*/
	@:native('getMajorVersion') @:overload @:public @:static public static function _getMajorVersion(bb : java.nio.ByteBuffer) : Int;
	...
	* @return int - the minor version
	*/
	@:native('getMinorVersion') @:overload @:public @:static public static function _getMinorVersion(bb : java.nio.ByteBuffer) : Int;
	...
	* @return int - the byte order of the instrumentation buffer
	*/
	@:native('getByteOrder') @:overload @:public @:static public static function _getByteOrder(bb : java.nio.ByteBuffer) : java.nio.ByteOrder;
