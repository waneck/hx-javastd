...
@:require(java5) extern class PerfDataBuffer extends sun.jvmstat.perfdata.monitor.PerfDataBufferImpl
{
	...
	* initialization.
	*/
	@:overload @:protected private function synchWithTarget(map : java.util.Map<String, sun.jvmstat.monitor.Monitor>) : Void;
	...
	* argument.
	*/
	@:overload @:protected private function pollFor(map : java.util.Map<String, sun.jvmstat.monitor.Monitor>, name : String, timeLimit : haxe.Int64) : sun.jvmstat.monitor.Monitor;
	...
	*/
	@:overload @:protected private function kludge(map : java.util.Map<String, sun.jvmstat.monitor.Monitor>) : Void;
