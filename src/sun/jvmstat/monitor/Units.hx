...
extern class Units implements java.io.Serializable
{
	...
	*/
	@:public @:static @:final public static var INVALID(default, null) : sun.jvmstat.monitor.Units;
	
	/**
	* Units attribute representing unit-less quantities.
	*/
	@:public @:static @:final public static var NONE(default, null) : sun.jvmstat.monitor.Units;
	
	/**
	* Units attribute representing Bytes.
	*/
	@:public @:static @:final public static var BYTES(default, null) : sun.jvmstat.monitor.Units;
	
	/**
	* Units attribute representing Ticks.
	*/
	@:public @:static @:final public static var TICKS(default, null) : sun.jvmstat.monitor.Units;
	
	/**
	* Units attribute representing a count of events.
	*/
	@:public @:static @:final public static var EVENTS(default, null) : sun.jvmstat.monitor.Units;
	...
	*/
	@:public @:static @:final public static var STRING(default, null) : sun.jvmstat.monitor.Units;
	
	/**
	* Units attribute representing Hertz (frequency).
	*/
	@:public @:static @:final public static var HERTZ(default, null) : sun.jvmstat.monitor.Units;
	...
	*/
	@:overload @:public @:static public static function toUnits(value : Int) : sun.jvmstat.monitor.Units;
