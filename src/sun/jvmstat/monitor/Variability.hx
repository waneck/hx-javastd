...
*/
extern class Variability implements java.io.Serializable
{
	/**
	* An invalid Variablity value.
	*/
	@:public @:static @:final public static var INVALID(default, null) : sun.jvmstat.monitor.Variability;
	
	/**
	* Variability attribute representing Constant counters.
	*/
	@:public @:static @:final public static var CONSTANT(default, null) : sun.jvmstat.monitor.Variability;
	
	/**
	* Variability attribute representing a Monotonically changing counters.
	*/
	@:public @:static @:final public static var MONOTONIC(default, null) : sun.jvmstat.monitor.Variability;
	
	/**
	* Variability attribute representing Variable counters.
	*/
	@:public @:static @:final public static var VARIABLE(default, null) : sun.jvmstat.monitor.Variability;
	...
	*                       if out of range.
	*/
	@:overload @:public @:static public static function toVariability(value : Int) : sun.jvmstat.monitor.Variability;
