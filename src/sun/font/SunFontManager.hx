...
{
	public static var FONTFORMAT_NONE(default, null) : Int;
	
	public static var FONTFORMAT_TRUETYPE(default, null) : Int;
	
	public static var FONTFORMAT_TYPE1(default, null) : Int;
	
	public static var FONTFORMAT_T2K(default, null) : Int;
	
	public static var FONTFORMAT_TTC(default, null) : Int;
	
	public static var FONTFORMAT_COMPOSITE(default, null) : Int;
	
	public static var FONTFORMAT_NATIVE(default, null) : Int;
	...
	*/
	private static var CHANNELPOOLSIZE(default, null) : Int;
	
	private var fontFileCache : java.NativeArray<sun.font.FileFont>;
	
	/* given a full name find the Font. Remind: there's duplication
	* here in that this contains the content of compositeFonts +
	* physicalFonts.
	*/
	private var fullNameToFont : java.util.concurrent.ConcurrentHashMap<String, sun.font.Font2D>;
	
	public static var lucidaFontName(default, null) : String;
	
	public static var jreLibDirName : String;
	
	public static var jreFontDirName : String;
	
	private var registeredFontFiles : java.util.HashSet<Dynamic>;
	...
	*/
	...
	public static var noType1Font : Bool;
	...
	*/
	...
	@:overload public function getType1Filter() : java.io.FilenameFilter;
	
	@:overload public function usingPerAppContextComposites() : Bool;
	
	@:overload public function getEUDCFont() : sun.font.TrueTypeFont;
	...
	*/
	@:overload private function addToFontList(f : sun.font.PhysicalFont, rank : Int) : sun.font.PhysicalFont;
	
	@:overload public function getRegisteredFonts() : java.NativeArray<sun.font.Font2D>;
	
	@:overload private function getPhysicalFonts() : java.NativeArray<sun.font.PhysicalFont>;
	...
	* euro fonts).
	*/
	@:overload @:synchronized private function initialiseDeferredFonts() : Void;
	
	@:overload @:synchronized private function registerDeferredJREFonts(jreDir : String) : Void;
	
	@:overload public function isDeferredFont(fileName : String) : Bool;
	...
	*/
	/*private*/
	@:overload public function findJREDeferredFont(name : String, style : Int) : sun.font.PhysicalFont;
	
	@:overload public function registerDeferredFont(fileNameKey : String, fullPathName : String, nativeNames : java.NativeArray<String>, fontFormat : Int, useJavaRasterizer : Bool, fontRank : Int) : Void;
	
	@:overload @:synchronized public function initialiseDeferredFont(fileNameKey : String) : sun.font.PhysicalFont;
	
	@:overload public function isRegisteredFontFile(name : String) : Bool;
	
	@:overload public function getRegisteredFontFile(name : String) : sun.font.PhysicalFont;
	...
	*/
	@:overload public function registerFontFile(fileName : String, nativeNames : java.NativeArray<String>, fontFormat : Int, useJavaRasterizer : Bool, fontRank : Int) : sun.font.PhysicalFont;
	
	@:overload public function registerFonts(fileNames : java.NativeArray<String>, nativeNames : java.NativeArray<java.NativeArray<String>>, fontCount : Int, fontFormat : Int, useJavaRasterizer : Bool, fontRank : Int, defer : Bool) : Void;
	...
	* the Java platform.
	*/
	@:overload public function getDefaultPhysicalFont() : sun.font.PhysicalFont;
	
	@:overload public function getDefaultLogicalFont(style : Int) : sun.font.Font2D;
	...
	*/
	@:overload private function populateFontFileNameMap(fontToFileMap : java.util.HashMap<String, String>, fontToFamilyNameMap : java.util.HashMap<String, String>, familyToFontListMap : java.util.HashMap<String, java.util.ArrayList<String>>, locale : java.util.Locale) : Void;
	...
	*/
	...
	@:overload public function gotFontsFromPlatform() : Bool;
	
	@:overload public function getFileNameForFontName(fontName : String) : String;
	...
	* installed fonts.
	*/
	@:overload private function registerOtherFontFiles(registeredFontFiles : java.util.HashSet<Dynamic>) : Void;
	
	@:overload public function getFamilyNamesFromPlatform(familyNames : java.util.TreeMap<String, String>, requestedLocale : java.util.Locale) : Bool;
	...
	*/
	@:overload public function usePlatformFontMetrics() : Bool;
	
	@:overload public function getNumFonts() : Int;
	
	@:overload @:abstract private function getFontPath(noType1Fonts : Bool) : String;
	
	private var fileCloser : java.lang.Thread;
	...
	*/
	@:overload @:synchronized public function getFullNameByFileName(fileName : String) : String;
	...
	*/
	@:overload @:synchronized public function deRegisterBadFont(font2D : sun.font.Font2D) : Void;
	
	/*
	* This encapsulates all the work that needs to be done when a
	* Font2D is replaced by a different Font2D.
	*/
	@:overload @:synchronized public function replaceFont(oldFont : sun.font.PhysicalFont, newFont : sun.font.PhysicalFont) : Void;
	...
	*/
	@:overload public function maybeUsingAlternateCompositeFonts() : Bool;
	
	@:overload public function usingAlternateCompositeFonts() : Bool;
	
	/* Modifies the behaviour of a subsequent call to preferLocaleFonts()
	* to use Mincho instead of Gothic for dialoginput in JA locales
	* on windows. Not needed on other platforms.
	*/
	@:overload @:synchronized public function useAlternateFontforJALocales() : Void;
	
	@:overload public function usingAlternateFontforJALocales() : Bool;
	
	@:overload @:synchronized public function preferLocaleFonts() : Void;
	
	@:overload @:synchronized public function preferProportionalFonts() : Void;
	...
	@:overload private function getPlatformFontDirs(noType1Fonts : Bool) : java.NativeArray<String>;
	
	/**
	* Returns an array of two strings. The first element is the
	* name of the font. The second element is the file name.
	*/
	@:overload @:abstract public function getDefaultPlatformFont() : java.NativeArray<String>;
	
	@:overload private function getNativeNames(fontFileName : String, platformName : String) : java.NativeArray<String>;
	...
	*/
	@:overload private function getFileNameFromPlatformName(platformFontName : String) : String;
	...
	* registerFontDirs(..)
	*/
	@:overload public function getPlatformFontPath(noType1Font : Bool) : String;
	
	@:overload public static function isOpenJDK() : Bool;
	
	@:overload private function loadFonts() : Void;
	
	@:overload private function registerFontDirs(pathName : String) : Void;
	
	/* Called to register fall back fonts */
	@:overload public function registerFontsInDir(dirName : String) : Void;
	
	@:overload private function registerFontsInDir(dirName : String, useJavaRasterizer : Bool, fontRank : Int, defer : Bool, resolveSymLinks : Bool) : Void;
	
	@:overload private function registerFontDir(path : String) : Void;
	
	/**
	* Returns file name for default font, either absolute
	* or relative as needed by registerFontFile.
	*/
	@:overload @:synchronized public function getDefaultFontFile() : String;
	
	/**
	* Whether registerFontFile expects absolute or relative
	* font file names.
	*/
	@:overload private function useAbsoluteFontFileNames() : Bool;
	
	/**
	* Creates this environment's FontConfiguration.
	*/
	@:overload @:abstract private function createFontConfiguration() : sun.awt.FontConfiguration;
	
	@:overload @:abstract public function createFontConfiguration(preferLocaleFonts : Bool, preferPropFonts : Bool) : sun.awt.FontConfiguration;
	...
	* for this platform.
	*/
	@:overload @:synchronized public function getDefaultFontFaceName() : String;
	
	@:overload public function loadFontFiles() : Void;
	...
	*/
	@:overload private function addFontToPlatformFontPath(platformFontName : String) : Void;
	
	@:overload private function registerFontFile(fontFileName : String, nativeNames : java.NativeArray<String>, fontRank : Int, defer : Bool) : Void;
	
	@:overload private function registerPlatformFontsUsedByFontConfiguration() : Void;
	...
	* synchronize.
	*/
	@:overload private function addToMissingFontFileList(fileName : String) : Void;
	...
	*/
	@:overload public function createCompositeFonts(altNameCache : java.util.concurrent.ConcurrentHashMap<String, sun.font.Font2D>, preferLocale : Bool, preferProportional : Bool) : Void;
	...
	*/
	...
	@:overload private function addNativeFontFamilyNames(familyNames : java.util.TreeMap<String, String>, requestedLocale : java.util.Locale) : Void;
	
	@:overload public function register1dot0Fonts() : Void;
	...
	* known fonts.
	*/
	@:overload private function getJREFontFamilyNames(familyNames : java.util.TreeMap<String, String>, requestedLocale : java.util.Locale) : Void;
	
	@:overload private function getFontConfigFUIR(family : String, style : Int, size : Int) : javax.swing.plaf.FontUIResource;
...
@:native('sun$font$SunFontManager$FamilyDescription') extern class SunFontManager_FamilyDescription
{
	...
	public var plainFullName : String;
	
	public var boldFullName : String;
	
	public var italicFullName : String;
	
	public var boldItalicFullName : String;
	
	public var plainFileName : String;
	
	public var boldFileName : String;
	
	public var italicFileName : String;
	
	public var boldItalicFileName : String;
