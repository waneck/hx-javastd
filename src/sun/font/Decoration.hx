...
extern class Decoration
{
	...
	*/
	@:overload public static function getPlainDecoration() : Decoration;
	
	@:overload public static function getDecoration(values : sun.font.AttributeValues) : Decoration;
	
	/**
	* Return a Decoration appropriate for the the given Map.
	* @param attributes the Map used to determine the Decoration
	*/
	@:overload public static function getDecoration(attributes : java.util.Map<Dynamic, Dynamic>) : Decoration;
	
	@:overload public function drawTextAndDecorations(label : Decoration_Label, g2d : java.awt.Graphics2D, x : Single, y : Single) : Void;
	
	@:overload public function getVisualBounds(label : Decoration_Label) : java.awt.geom.Rectangle2D;
	
	@:overload public function getCharVisualBounds(label : Decoration_Label, index : Int) : java.awt.geom.Rectangle2D;
...
@:native('sun$font$Decoration$DecorationImpl') @:internal extern class Decoration_DecorationImpl extends Decoration
{
	@:overload public function equals(rhs : Dynamic) : Bool;
	
	@:overload public function hashCode() : Int;
	
	@:overload override public function drawTextAndDecorations(label : Decoration_Label, g2d : java.awt.Graphics2D, x : Single, y : Single) : Void;
	
	@:overload override public function getVisualBounds(label : Decoration_Label) : java.awt.geom.Rectangle2D;
