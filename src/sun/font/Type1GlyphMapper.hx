...
extern class Type1GlyphMapper extends sun.font.CharToGlyphMapper
{
	...
	@:overload override public function canDisplay(ch : java.StdTypes.Char16) : Bool;
	
	@:overload override public function charToGlyph(ch : java.StdTypes.Char16) : Int;
	
	@:overload override public function charToGlyph(ch : Int) : Int;
