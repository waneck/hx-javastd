...
*/
extern interface ExtensionInstallationProvider
{
	/*
	* <p>
	...
	*/
	@:overload public function installExtension(requestExtInfo : sun.misc.ExtensionInfo, installedExtInfo : sun.misc.ExtensionInfo) : Bool;
