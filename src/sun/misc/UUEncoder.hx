...
extern class UUEncoder extends sun.misc.CharacterEncoder
{
	...
	* </pre>
	*/
	@:overload @:public public function new(fname : String) : Void;
	...
	* </pre>
	*/
	@:overload @:public public function new(fname : String, newMode : Int) : Void;
	...
	*/
	@:overload @:protected override private function encodeBufferSuffix(a : java.io.OutputStream) : Void;
