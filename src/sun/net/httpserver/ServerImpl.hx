...
{
	@:overload @:public public function bind(addr : java.net.InetSocketAddress, backlog : Int) : Void;
	...
	@:overload @:public public function setHttpsConfigurator(config : com.sun.net.httpserver.HttpsConfigurator) : Void;
	
	@:overload @:public public function getHttpsConfigurator() : com.sun.net.httpserver.HttpsConfigurator;
	
	@:overload @:public public function stop(delay : Int) : Void;
	
	@:overload @:public @:synchronized public function createContext(path : String, handler : com.sun.net.httpserver.HttpHandler) : sun.net.httpserver.HttpContextImpl;
	
	@:overload @:public @:synchronized public function createContext(path : String) : sun.net.httpserver.HttpContextImpl;
	
	@:overload @:public @:synchronized public function removeContext(path : String) : Void;
	
	@:overload @:public @:synchronized public function removeContext(context : com.sun.net.httpserver.HttpContext) : Void;
	
	@:overload @:public public function getAddress() : java.net.InetSocketAddress;
...
{
	@:overload @:public public function execute(task : java.lang.Runnable) : Void;
...
@:native('sun$net$httpserver$ServerImpl$Dispatcher') @:internal extern class ServerImpl_Dispatcher implements java.lang.Runnable
{
	...
	@:overload @:public public function handle(chan : java.nio.channels.SocketChannel, conn : sun.net.httpserver.HttpConnection) : Void;
...
{
	@:overload @:public public function handle(exchange : com.sun.net.httpserver.HttpExchange) : Void;
