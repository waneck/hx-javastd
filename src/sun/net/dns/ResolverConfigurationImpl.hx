...
{
	@:overload override public function searchlist() : java.util.List<String>;
...
@:internal extern class OptionsImpl extends sun.net.dns.ResolverConfiguration.ResolverConfiguration_Options
{
