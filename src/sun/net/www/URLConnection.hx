...
{
	@:protected private var properties : sun.net.www.MessageHeader;
	...
	*/
	@:overload @:public override public function new(u : java.net.URL) : Void;
	...
	* associated with them should be accessed using those methods.  */
	...
	@:overload @:public public function setProperties(properties : sun.net.www.MessageHeader) : Void;
	...
	* object.
	*/
	@:overload @:protected private function setContentLength(length : Int) : Void;
	
	/**
	* Returns true if the data associated with this URL can be cached.
	*/
	@:overload @:public public function canCache() : Bool;
	...
	*/
	...
	@:overload @:public @:synchronized @:static public static function setProxiedHost(host : String) : Void;
	
	@:overload @:public @:synchronized @:static public static function isProxiedHost(host : String) : Bool;
