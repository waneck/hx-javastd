...
extern class CharToByteISCII91 extends sun.io.CharToByteConverter
{
	...
	*/
	@:overload override public function convert(input : java.NativeArray<java.StdTypes.Char16>, inStart : Int, inEnd : Int, output : java.NativeArray<java.StdTypes.Int8>, outStart : Int, outEnd : Int) : Int;
