...
* questions.
*/
@:internal extern class UTF_16BE extends sun.nio.cs.Unicode
{
...
@:native('sun$nio$cs$UTF_16BE$Decoder') @:internal extern class UTF_16BE_Decoder extends sun.nio.cs.UnicodeDecoder
{
	@:overload @:public public function new(cs : java.nio.charset.Charset) : Void;
	
	
}
@:native('sun$nio$cs$UTF_16BE$Encoder') @:internal extern class UTF_16BE_Encoder extends sun.nio.cs.UnicodeEncoder
{
	@:overload @:public public function new(cs : java.nio.charset.Charset) : Void;
