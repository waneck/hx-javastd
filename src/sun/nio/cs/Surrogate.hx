...
*/
@:native('sun$nio$cs$Surrogate$Parser') extern class Surrogate_Parser
{
...
* pairs.
*/
@:native('sun$nio$cs$Surrogate$Generator') extern class Surrogate_Generator
{
	@:overload public function new() : Void;
