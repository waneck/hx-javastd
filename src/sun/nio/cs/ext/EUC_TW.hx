...
@:native('sun$nio$cs$ext$EUC_TW$Decoder') extern class EUC_TW_Decoder extends java.nio.charset.CharsetDecoder
{
	...
	@:overload public function toUnicode(b1 : Int, b2 : Int, p : Int) : java.NativeArray<java.StdTypes.Char16>;
...
@:native('sun$nio$cs$ext$EUC_TW$Encoder') extern class EUC_TW_Encoder extends java.nio.charset.CharsetEncoder
{
	...
	@:overload public function toEUC(hi : java.StdTypes.Char16, low : java.StdTypes.Char16, bb : java.NativeArray<java.StdTypes.Int8>) : Int;
	
	@:overload public function toEUC(c : java.StdTypes.Char16, bb : java.NativeArray<java.StdTypes.Int8>) : Int;
