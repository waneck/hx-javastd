...
extern class IBM834 extends java.nio.charset.Charset
{
...
@:native('sun$nio$cs$ext$IBM834$Encoder') extern class IBM834_Encoder extends sun.nio.cs.ext.DoubleByte.DoubleByte_Encoder_EBCDIC_DBCSONLY
{
