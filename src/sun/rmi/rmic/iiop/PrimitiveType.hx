...
extern class PrimitiveType extends sun.rmi.rmic.iiop.Type
{
	...
	*/
	@:overload public static function forPrimitive(type : sun.tools.java.Type, stack : sun.rmi.rmic.iiop.ContextStack) : PrimitiveType;
	...
	*/
	@:overload override public function getQualifiedIDLName(global : Bool) : String;
