...
extern class Type implements sun.rmi.rmic.iiop.Constants implements sun.rmi.rmic.iiop.ContextElement implements java.lang.Cloneable
{
	...
	private var stack : sun.rmi.rmic.iiop.ContextStack;
	...
	*/
	@:overload public function getIDLModuleNames() : java.NativeArray<String>;
	...
	*/
	@:overload public function getIdentifier() : sun.tools.java.Identifier;
	...
	*/
	@:overload public function getBoxedRepositoryID() : String;
	
	/**
	* Return the Class for this type.
	*/
	@:overload public function getClassInstance() : Class<Dynamic>;
	...
	*/
	@:overload public function isSpecialInterface() : Bool;
	
	/**
	* Return true if this type is-a SpecialClassType.
	*/
	@:overload public function isSpecialClass() : Bool;
	...
	*/
	@:overload public function isConforming() : Bool;
	...
	*/
	@:overload @:abstract public function getTypeDescription() : String;
	...
	* @param globalIDLNames If true and useIDLNames true, prepends "::".
	*/
	@:overload public function print(writer : sun.rmi.rmic.IndentingWriter, typeCodeFilter : Int, useQualifiedNames : Bool, useIDLNames : Bool, globalIDLNames : Bool) : Void;
	...
	* @param globalIDLNames If true and useIDLNames true, prepends "::".
	*/
	@:overload public function println(writer : sun.rmi.rmic.IndentingWriter, useQualifiedNames : Bool, useIDLNames : Bool, globalIDLNames : Bool) : Void;
	...
	* @param globalIDLNames If true and useIDLNames true, prepends "::".
	*/
	@:overload public function printTypeName(writer : sun.rmi.rmic.IndentingWriter, useQualifiedNames : Bool, useIDLNames : Bool, globalIDLNames : Bool) : Void;
	...
	* @param useIDLNames If true, print IDL names; otherwise, print java names.
	*/
	@:overload private function printPackageOpen(writer : sun.rmi.rmic.IndentingWriter, useIDLNames : Bool) : Void;
	...
	*/
	@:overload private static function removeType(key : String, stack : sun.rmi.rmic.iiop.ContextStack) : Void;
	
	/**
	* Remove a type from the table.
	*/
	@:overload private static function removeType(key : sun.tools.java.Type, stack : sun.rmi.rmic.iiop.ContextStack) : Void;
	...
	*/
	@:overload public function removeInvalidTypes() : Void;
	
	/**
	* Walk all types and tell them to update invalid types...
	*/
	@:overload private static function updateAllInvalidTypes(stack : sun.rmi.rmic.iiop.ContextStack) : Void;
	
	/**
	* Return count of previously parsed types.
	*/
	@:overload private function countTypes() : Int;
	...
	* @param useIDLNames If true, print IDL names; otherwise, print java names.
	*/
	@:overload private function printPackageClose(writer : sun.rmi.rmic.IndentingWriter, useIDLNames : Bool) : Void;
	
	/**
	* Create a Type instance for the given type. Requires that
	* setName(Identifier) be called afterward.
	*/
	@:overload private function new(stack : sun.rmi.rmic.iiop.ContextStack, fullTypeCode : Int) : Void;
	
	/**
	* Set type codes. May only be called during initialization.
	*/
	@:overload private function setTypeCode(fullTypeCode : Int) : Void;
	
	/**
	* Set name and package. May only be called during initialization.
	*/
	@:overload private function setNames(id : sun.tools.java.Identifier, idlModuleNames : java.NativeArray<String>, idlName : String) : Void;
	
	/**
	* Set IDL name. May only be called during initialization.
	*/
	@:overload private function setIDLNames(idlModuleNames : java.NativeArray<String>, idlName : String) : Void;
	
	/**
	* Report a ClassNotFoundException thru the compiler environment.
	*/
	@:overload private static function classNotFound(stack : sun.rmi.rmic.iiop.ContextStack, e : sun.tools.java.ClassNotFound) : Void;
	
	/**
	* Report a ClassNotFoundException thru the compiler environment.
	*/
	@:overload private static function classNotFound(quiet : Bool, stack : sun.rmi.rmic.iiop.ContextStack, e : sun.tools.java.ClassNotFound) : Void;
	...
	* @return false.
	*/
	@:overload private static function failedConstraint(constraintNum : Int, quiet : Bool, stack : sun.rmi.rmic.iiop.ContextStack, arg0 : Dynamic, arg1 : Dynamic, arg2 : Dynamic) : Bool;
	...
	* @return false.
	*/
	@:overload private static function failedConstraint(constraintNum : Int, quiet : Bool, stack : sun.rmi.rmic.iiop.ContextStack, arg0 : Dynamic, arg1 : Dynamic) : Bool;
	...
	* @return false.
	*/
	@:overload private static function failedConstraint(constraintNum : Int, quiet : Bool, stack : sun.rmi.rmic.iiop.ContextStack, arg0 : Dynamic) : Bool;
	...
	* @return false.
	*/
	@:overload private static function failedConstraint(constraintNum : Int, quiet : Bool, stack : sun.rmi.rmic.iiop.ContextStack) : Bool;
	...
	*/
	@:overload @:abstract private function loadClass() : Class<Dynamic>;
	
	/*
	* Set the clz and repositoryID fields. Reports error
	* and returns false if fails, returns true if succeeds.
	*/
	@:overload private function setRepositoryID() : Bool;
