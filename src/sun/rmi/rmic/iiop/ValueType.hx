...
*
*/
extern class ValueType extends sun.rmi.rmic.iiop.ClassType
{
	/**
	...
	*/
	@:overload public static function forValue(classDef : sun.tools.java.ClassDefinition, stack : sun.rmi.rmic.iiop.ContextStack, quiet : Bool) : ValueType;
