...
extern class Main implements sun.rmi.rmic.Constants
{
	...
	*/
	...
	@:overload @:public public function error(msg : String, arg1 : String) : Void;
	
	@:overload @:public public function error(msg : String, arg1 : String, arg2 : String) : Void;
	...
	*/
	@:overload @:public public function getDestinationDir() : java.io.File;
	
	/**
	* Parse the arguments for compile.
	*/
	@:overload @:public public function parseArgs(argv : java.NativeArray<String>) : Bool;
	...
	*/
	@:overload @:protected private function checkGeneratorArg(argv : java.NativeArray<String>, currentIndex : Int) : Bool;
	
	/**
	* Instantiate and add a generator to the generators array.
	*/
	@:overload @:protected private function addGenerator(arg : String) : sun.rmi.rmic.Generator;
	...
	*/
	@:overload @:protected private function getArray(name : String, mustExist : Bool) : java.NativeArray<String>;
	
	/**
	* Get the correct type of BatchEnvironment
	*/
	@:overload @:public public function getEnv() : sun.rmi.rmic.BatchEnvironment;
	
	/**
	* Do the compile with the switches and files already supplied
	*/
	@:overload @:public public function doCompile() : Bool;
	
	/*
	* Compile all classes that need to be compiled.
	*/
	@:overload @:public public function compileAllClasses(env : sun.rmi.rmic.BatchEnvironment) : Void;
	
	/*
	* Compile a single class.
	*/
	@:overload @:public public function compileClass(c : sun.tools.java.ClassDeclaration, buf : java.io.ByteArrayOutputStream, env : sun.rmi.rmic.BatchEnvironment) : Bool;
