...
extern class Main
{
	...
	**/
	@:overload public function compile(args : java.NativeArray<String>) : Bool;
	...
	**/
	@:overload public function error(msg : String, args : java.NativeArray<String>) : Void;
	...
	**/
	@:overload public static function start(rootDoc : com.sun.javadoc.RootDoc) : Bool;
