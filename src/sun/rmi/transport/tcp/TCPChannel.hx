...
extern class TCPChannel implements sun.rmi.transport.Channel
{
	...
	*/
	@:overload public function getEndpoint() : sun.rmi.transport.Endpoint;
	...
	*/
	@:overload public function newConnection() : sun.rmi.transport.Connection;
	...
	*/
	@:overload public function free(conn : sun.rmi.transport.Connection, reuse : Bool) : Void;
	
	/**
	* Closes all the connections in the cache, whether timed out or not.
	*/
	@:overload public function shedCache() : Void;
...
@:internal extern class ConnectionAcceptor implements java.lang.Runnable
{
	...
	*/
	@:overload public function new(transport : sun.rmi.transport.tcp.TCPTransport) : Void;
	
	/**
	* Start a new thread to accept connections.
	*/
	@:overload public function startNewAcceptor() : Void;
	
	/**
	* Add connection to queue of connections to be accepted.
	*/
	@:overload public function accept(conn : sun.rmi.transport.Connection) : Void;
