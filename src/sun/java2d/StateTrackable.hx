...
* @since 1.7
*/
@:require(java7) extern interface StateTrackable
{
	/**
	...
	* @since 1.7
	*/
	@:require(java7) @:overload public function getState() : StateTrackable_State;
...
* @since 1.7
*/
@:require(java7) @:native('sun$java2d$StateTrackable$State') extern enum StateTrackable_State
{
	/**
