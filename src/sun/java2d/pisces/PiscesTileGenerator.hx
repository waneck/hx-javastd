...
{
	public static var TILE_SIZE(default, null) : Int;
	
	@:overload public function new(r : sun.java2d.pisces.Renderer, maxalpha : Int) : Void;
	
	@:overload public static function getAlphaMap(maxalpha : Int) : java.NativeArray<java.StdTypes.Int8>;
	
	@:overload public function getBbox(bbox : java.NativeArray<Int>) : Void;
