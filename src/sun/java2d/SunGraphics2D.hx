...
{
	/* Paint */
	public static var PAINT_CUSTOM(default, null) : Int;
	
	/* Any other Paint object */
	public static var PAINT_TEXTURE(default, null) : Int;
	
	/* Tiled Image */
	public static var PAINT_RAD_GRADIENT(default, null) : Int;
	
	/* Color RadialGradient */
	public static var PAINT_LIN_GRADIENT(default, null) : Int;
	
	/* Color LinearGradient */
	public static var PAINT_GRADIENT(default, null) : Int;
	
	/* Color Gradient */
	public static var PAINT_ALPHACOLOR(default, null) : Int;
	
	/* Non-opaque Color */
	public static var PAINT_OPAQUECOLOR(default, null) : Int;
	
	/* Composite*/
	public static var COMP_CUSTOM(default, null) : Int;
	
	/* Custom Composite */
	public static var COMP_XOR(default, null) : Int;
	
	/* XOR Mode Composite */
	public static var COMP_ALPHA(default, null) : Int;
	
	/* AlphaComposite */
	public static var COMP_ISCOPY(default, null) : Int;
	
	/* Stroke */
	public static var STROKE_CUSTOM(default, null) : Int;
	
	/* custom Stroke */
	public static var STROKE_WIDE(default, null) : Int;
	
	/* BasicStroke */
	public static var STROKE_THINDASHED(default, null) : Int;
	
	/* BasicStroke */
	public static var STROKE_THIN(default, null) : Int;
	
	/* Transform */
	public static var TRANSFORM_GENERIC(default, null) : Int;
	
	/* any 3x2 */
	public static var TRANSFORM_TRANSLATESCALE(default, null) : Int;
	
	/* scale XY */
	public static var TRANSFORM_ANY_TRANSLATE(default, null) : Int;
	
	/* non-int translate */
	public static var TRANSFORM_INT_TRANSLATE(default, null) : Int;
	
	/* int translate */
	public static var TRANSFORM_ISIDENT(default, null) : Int;
	
	/* Clipping */
	public static var CLIP_SHAPE(default, null) : Int;
	
	/* arbitrary clip */
	public static var CLIP_RECTANGULAR(default, null) : Int;
	
	/* rectangular clip */
	public static var CLIP_DEVICE(default, null) : Int;
	
	/* The following fields are used when the current Paint is a Color. */
	public var eargb : Int;
	
	public var pixel : Int;
	
	public var surfaceData : sun.java2d.SurfaceData;
	
	public var drawpipe : sun.java2d.pipe.PixelDrawPipe;
	
	public var fillpipe : sun.java2d.pipe.PixelFillPipe;
	
	public var imagepipe : sun.java2d.pipe.DrawImagePipe;
	
	public var shapepipe : sun.java2d.pipe.ShapeDrawPipe;
	
	public var textpipe : sun.java2d.pipe.TextPipe;
	
	public var alphafill : sun.java2d.loops.MaskFill;
	
	public var loops : sun.java2d.loops.RenderLoops;
	
	public var imageComp : sun.java2d.loops.CompositeType;
	
	/* Image Transparency checked on fly */
	public var paintState : Int;
	
	public var compositeState : Int;
	
	public var strokeState : Int;
	
	public var transformState : Int;
	
	public var clipState : Int;
	
	public var foregroundColor : java.awt.Color;
	
	public var backgroundColor : java.awt.Color;
	
	public var transX : Int;
	
	public var transY : Int;
	
	private static var defaultStroke(default, null) : java.awt.Stroke;
	
	private static var defaultComposite(default, null) : java.awt.Composite;
	
	public var paint : java.awt.Paint;
	
	public var stroke : java.awt.Stroke;
	
	public var composite : java.awt.Composite;
	
	private var font : java.awt.Font;
	
	private var fontMetrics : java.awt.FontMetrics;
	
	public var renderHint : Int;
	
	public var antialiasHint : Int;
	
	public var textAntialiasHint : Int;
	
	private var fractionalMetricsHint : Int;
	
	/* A gamma adjustment to the colour used in lcd text blitting */
	public var lcdTextContrast : Int;
	
	public var strokeHint : Int;
	
	public var interpolationType : Int;
	
	public var hints : java.awt.RenderingHints;
	
	public var constrainClip : sun.java2d.pipe.Region;
	
	public var constrainX : Int;
	
	public var constrainY : Int;
	
	public var clipRegion : sun.java2d.pipe.Region;
	
	public var usrClip : java.awt.Shape;
	
	private var devClip : sun.java2d.pipe.Region;
	
	@:overload public function new(sd : sun.java2d.SurfaceData, fg : java.awt.Color, bg : java.awt.Color, f : java.awt.Font) : Void;
	...
	*/
	...
	@:overload public function setDevClip(r : java.awt.Rectangle) : Void;
	...
	*/
	...
	private static var invalidpipe : sun.java2d.pipe.ValidatePipe;
	
	/*
	* Invalidate the pipeline
	*/
	@:overload private function invalidatePipe() : Void;
	
	@:overload public function validatePipe() : Void;
	
	@:overload private static function cloneShape(s : java.awt.Shape) : java.awt.Shape;
	...
	*/
	@:overload public function getDeviceColorModel() : java.awt.image.ColorModel;
	...
	*/
	@:overload @:final public function getSurfaceData() : sun.java2d.SurfaceData;
	...
	*/
	...
	public static var MinPenSizeAA(default, null) : Float;
	
	public static var MinPenSizeAASquared(default, null) : Float;
	
	public static var MinPenSizeSquared(default, null) : Float;
	...
	* @see RenderingHints
	*/
	@:overload override public function setRenderingHint(hintKey : java.awt.RenderingHints.RenderingHints_Key, hintValue : Dynamic) : Void;
	...
	* @see RenderingHints
	*/
	@:overload override public function getRenderingHint(hintKey : java.awt.RenderingHints.RenderingHints_Key) : Dynamic;
	...
	* @see AffineTransform
	*/
	@:overload override public function transform(xform : java.awt.geom.AffineTransform) : Void;
	...
	*/
	...
	@:overload private function invalidateTransform() : Void;
	...
	* rectangle.
	*/
	@:overload public function cloneTransform() : java.awt.geom.AffineTransform;
	...
	*/
	...
	@:overload private function transformShape(s : java.awt.Shape) : java.awt.Shape;
	
	@:overload public function untransformShape(s : java.awt.Shape) : java.awt.Shape;
	
	@:native('transformShape') @:overload private static function _transformShape(tx : Int, ty : Int, s : java.awt.Shape) : java.awt.Shape;
	...
	*/
	@:overload private function transformBounds(rect : java.awt.Rectangle, tx : java.awt.geom.AffineTransform) : java.awt.Rectangle;
	
	@:overload override public function drawString(str : String, x : Int, y : Int) : Void;
	...
	*/
	@:overload public function copyImage(img : java.awt.Image, dx : Int, dy : Int, sx : Int, sy : Int, width : Int, height : Int, bgcolor : java.awt.Color, observer : java.awt.image.ImageObserver) : Bool;
	...
	* @see #setClip
	*/
	@:overload override public function drawImage(img : java.awt.Image, xform : java.awt.geom.AffineTransform, observer : java.awt.image.ImageObserver) : Bool;
	
	@:overload override public function drawImage(bImg : java.awt.image.BufferedImage, op : java.awt.image.BufferedImageOp, x : Int, y : Int) : Void;
	...
	*/
	@:overload public function getDestination() : Dynamic;
