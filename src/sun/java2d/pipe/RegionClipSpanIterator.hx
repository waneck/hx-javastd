...
extern class RegionClipSpanIterator implements sun.java2d.pipe.SpanIterator
{
	...
	*/
	@:overload public function new(rgn : sun.java2d.pipe.Region, spanIter : sun.java2d.pipe.SpanIterator) : Void;
	...
	*/
	@:overload public function nextSpan(resultbox : java.NativeArray<Int>) : Bool;
