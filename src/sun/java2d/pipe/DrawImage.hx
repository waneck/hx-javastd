...
{
	@:overload @:public public function copyImage(sg : sun.java2d.SunGraphics2D, img : java.awt.Image, x : Int, y : Int, bgColor : java.awt.Color) : Bool;
	
	@:overload @:public public function copyImage(sg : sun.java2d.SunGraphics2D, img : java.awt.Image, dx : Int, dy : Int, sx : Int, sy : Int, w : Int, h : Int, bgColor : java.awt.Color) : Bool;
	
	@:overload @:public public function scaleImage(sg : sun.java2d.SunGraphics2D, img : java.awt.Image, x : Int, y : Int, width : Int, height : Int, bgColor : java.awt.Color) : Bool;
	...
	*/
	@:overload @:protected private function transformImage(sg : sun.java2d.SunGraphics2D, img : java.awt.Image, x : Int, y : Int, extraAT : java.awt.geom.AffineTransform, interpType : Int) : Void;
	...
	*/
	@:overload @:protected private function transformImage(sg : sun.java2d.SunGraphics2D, img : java.awt.Image, tx : java.awt.geom.AffineTransform, interpType : Int, sx1 : Int, sy1 : Int, sx2 : Int, sy2 : Int, bgColor : java.awt.Color) : Void;
	...
	*/
	@:overload @:protected private function tryCopyOrScale(sg : sun.java2d.SunGraphics2D, img : java.awt.Image, sx1 : Int, sy1 : Int, sx2 : Int, sy2 : Int, bgColor : java.awt.Color, interpType : Int, coords : java.NativeArray<Float>) : Bool;
	
	@:overload @:protected private function renderImageXform(sg : sun.java2d.SunGraphics2D, img : java.awt.Image, tx : java.awt.geom.AffineTransform, interpType : Int, sx1 : Int, sy1 : Int, sx2 : Int, sy2 : Int, bgColor : java.awt.Color) : Void;
	
	@:overload @:protected private function renderImageCopy(sg : sun.java2d.SunGraphics2D, img : java.awt.Image, bgColor : java.awt.Color, dx : Int, dy : Int, sx : Int, sy : Int, w : Int, h : Int) : Bool;
	
	@:overload @:protected private function renderImageScale(sg : sun.java2d.SunGraphics2D, img : java.awt.Image, bgColor : java.awt.Color, interpType : Int, sx1 : Int, sy1 : Int, sx2 : Int, sy2 : Int, dx1 : Float, dy1 : Float, dx2 : Float, dy2 : Float) : Bool;
	
	@:overload @:public public function scaleImage(sg : sun.java2d.SunGraphics2D, img : java.awt.Image, dx1 : Int, dy1 : Int, dx2 : Int, dy2 : Int, sx1 : Int, sy1 : Int, sx2 : Int, sy2 : Int, bgColor : java.awt.Color) : Bool;
	
	@:overload @:public @:static public static function closeToInteger(i : Int, d : Float) : Bool;
	
	@:overload @:public @:static public static function isSimpleTranslate(sg : sun.java2d.SunGraphics2D) : Bool;
	
	@:overload @:protected @:static private static function isBgOperation(srcData : sun.java2d.SurfaceData, bgColor : java.awt.Color) : Bool;
	
	@:overload @:protected private function getBufferedImage(img : java.awt.Image) : java.awt.image.BufferedImage;
	
	@:overload @:protected private function blitSurfaceData(sg : sun.java2d.SunGraphics2D, clipRegion : sun.java2d.pipe.Region, srcData : sun.java2d.SurfaceData, dstData : sun.java2d.SurfaceData, srcType : sun.java2d.loops.SurfaceType, dstType : sun.java2d.loops.SurfaceType, sx : Int, sy : Int, dx : Int, dy : Int, w : Int, h : Int, bgColor : java.awt.Color) : Void;
	
	@:overload @:protected private function scaleSurfaceData(sg : sun.java2d.SunGraphics2D, clipRegion : sun.java2d.pipe.Region, srcData : sun.java2d.SurfaceData, dstData : sun.java2d.SurfaceData, srcType : sun.java2d.loops.SurfaceType, dstType : sun.java2d.loops.SurfaceType, sx1 : Int, sy1 : Int, sx2 : Int, sy2 : Int, dx1 : Float, dy1 : Float, dx2 : Float, dy2 : Float) : Bool;
	
	@:overload @:protected @:static private static function imageReady(sunimg : sun.awt.image.ToolkitImage, observer : java.awt.image.ImageObserver) : Bool;
