...
extern class ScaledBlit extends sun.java2d.loops.GraphicsPrimitive
{
	...
	*/
	...
	@:overload @:public @:static public static function locate(srctype : sun.java2d.loops.SurfaceType, comptype : sun.java2d.loops.CompositeType, dsttype : sun.java2d.loops.SurfaceType) : sun.java2d.loops.ScaledBlit;
	
	@:overload @:public @:static public static function getFromCache(src : sun.java2d.loops.SurfaceType, comp : sun.java2d.loops.CompositeType, dst : sun.java2d.loops.SurfaceType) : sun.java2d.loops.ScaledBlit;
	...
	@:overload @:public @:native public function Scale(src : sun.java2d.SurfaceData, dst : sun.java2d.SurfaceData, comp : java.awt.Composite, clip : sun.java2d.pipe.Region, sx1 : Int, sy1 : Int, sx2 : Int, sy2 : Int, dx1 : Float, dy1 : Float, dx2 : Float, dy2 : Float) : Void;
...
{
	@:overload @:public public function new(target : sun.java2d.loops.ScaledBlit) : Void;
