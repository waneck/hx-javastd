...
extern class FillPath extends sun.java2d.loops.GraphicsPrimitive
{
	...
	*/
	...
	@:overload @:public @:static public static function locate(srctype : sun.java2d.loops.SurfaceType, comptype : sun.java2d.loops.CompositeType, dsttype : sun.java2d.loops.SurfaceType) : sun.java2d.loops.FillPath;
...
{
	@:overload @:public public function new(target : sun.java2d.loops.FillPath) : Void;
