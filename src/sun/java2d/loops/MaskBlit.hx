...
extern class MaskBlit extends sun.java2d.loops.GraphicsPrimitive
{
	...
	*/
	@:overload @:native public function new(src : sun.java2d.SurfaceData, dst : sun.java2d.SurfaceData, comp : java.awt.Composite, clip : sun.java2d.pipe.Region, srcx : Int, srcy : Int, dstx : Int, dsty : Int, width : Int, height : Int, mask : java.NativeArray<java.StdTypes.Int8>, maskoff : Int, maskscan : Int) : Void;
...
@:native('sun$java2d$loops$MaskBlit$General') @:internal extern class MaskBlit_General extends sun.java2d.loops.MaskBlit implements sun.java2d.loops.GraphicsPrimitive.GraphicsPrimitive_GeneralBinaryOp
{
	...
	@:overload @:synchronized override public function MaskBlit(srcData : sun.java2d.SurfaceData, dstData : sun.java2d.SurfaceData, comp : java.awt.Composite, clip : sun.java2d.pipe.Region, srcx : Int, srcy : Int, dstx : Int, dsty : Int, width : Int, height : Int, mask : java.NativeArray<java.StdTypes.Int8>, offset : Int, scan : Int) : Void;
