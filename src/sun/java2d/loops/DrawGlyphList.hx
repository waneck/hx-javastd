...
extern class DrawGlyphList extends sun.java2d.loops.GraphicsPrimitive
{
	...
	*/
	...
	@:overload @:public @:static public static function locate(srctype : sun.java2d.loops.SurfaceType, comptype : sun.java2d.loops.CompositeType, dsttype : sun.java2d.loops.SurfaceType) : sun.java2d.loops.DrawGlyphList;
...
@:native('sun$java2d$loops$DrawGlyphList$General') @:internal extern class DrawGlyphList_General extends sun.java2d.loops.DrawGlyphList
{
	...
	@:overload @:public override public function DrawGlyphList(sg2d : sun.java2d.SunGraphics2D, dest : sun.java2d.SurfaceData, gl : sun.font.GlyphList) : Void;
...
{
	@:overload @:public public function new(target : sun.java2d.loops.DrawGlyphList) : Void;
	
	@:overload @:public override public function traceWrap() : sun.java2d.loops.GraphicsPrimitive;
	
	@:overload @:public override public function DrawGlyphList(sg2d : sun.java2d.SunGraphics2D, dest : sun.java2d.SurfaceData, glyphs : sun.font.GlyphList) : Void;
