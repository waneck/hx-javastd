...
extern class DrawPolygons extends sun.java2d.loops.GraphicsPrimitive
{
	...
	*/
	...
	@:overload public static function locate(srctype : sun.java2d.loops.SurfaceType, comptype : sun.java2d.loops.CompositeType, dsttype : sun.java2d.loops.SurfaceType) : DrawPolygons;
...
@:native('sun$java2d$loops$DrawPolygons$TraceDrawPolygons') @:internal extern class DrawPolygons_TraceDrawPolygons extends DrawPolygons
{
	@:overload public function new(target : DrawPolygons) : Void;
