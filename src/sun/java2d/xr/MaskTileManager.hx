...
{
	@:public @:static @:final public static var MASK_SIZE(default, null) : Int;
	
	@:overload @:public public function new(xrMgr : sun.java2d.xr.XRCompositeManager, parentXid : Int) : Void;
	...
	*/
	@:overload @:public public function fillMask(dst : sun.java2d.xr.XRSurfaceData) : Void;
	
	/**
	* Uploads aa geometry generated for maskblit/fill into the mask pixmap.
	*/
	@:overload @:public public function uploadMask(w : Int, h : Int, maskscan : Int, maskoff : Int, mask : java.NativeArray<java.StdTypes.Int8>) : Int;
	
	/**
	* Clears the area of the mask-pixmap used for uploading aa coverage values.
	*/
	@:overload @:public public function clearUploadMask(mask : Int, w : Int, h : Int) : Void;
	
	/**
	* Renders the rectangles provided to the mask, and does a composition
	* operation with the properties set inXRCompositeManager.
	*/
	@:overload @:protected private function compositeSingleTile(dst : sun.java2d.xr.XRSurfaceData, tile : sun.java2d.xr.MaskTile, dirtyArea : sun.java2d.xr.DirtyRegion, maskRequired : Bool, tileStartX : Int, tileStartY : Int, maskColor : sun.java2d.xr.XRColor) : Void;
	
	/**
	* Allocates enough MaskTile instances, to cover the whole
	* mask area, or resets existing ones.
	*/
	@:overload @:protected private function allocTiles(maskArea : sun.java2d.xr.DirtyRegion) : Void;
	
	/**
	* Tiles the stored rectangles, if they are larger than the MASK_SIZE
	*/
	@:overload @:protected private function tileRects() : Void;
