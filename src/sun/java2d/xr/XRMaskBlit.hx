...
extern class XRMaskBlit extends sun.java2d.loops.MaskBlit
{
	...
	@:overload @:native private function maskBlit(srcXsdo : haxe.Int64, dstxsdo : haxe.Int64, srcx : Int, srcy : Int, dstx : Int, dsty : Int, w : Int, h : Int, maskoff : Int, maskscan : Int, masklen : Int, mask : java.NativeArray<java.StdTypes.Int8>) : Void;
