...
extern class XRPMBlitLoops
{
	...
	*/
	@:overload @:protected @:static private static function cacheToTmpSurface(src : sun.java2d.SurfaceData, dst : sun.java2d.xr.XRSurfaceData, w : Int, h : Int, sx : Int, sy : Int) : sun.java2d.xr.XRSurfaceData;
	
	
}
@:internal extern class XRPMBlit extends sun.java2d.loops.Blit
{
	@:overload @:public public function new(srcType : sun.java2d.loops.SurfaceType, dstType : sun.java2d.loops.SurfaceType) : Void;
...
@:internal extern class XRPMTransformedBlit extends sun.java2d.loops.TransformBlit
{
	...
	*/
	@:overload @:public public function getCompositeBounds(tr : java.awt.geom.AffineTransform, dstx : Int, dsty : Int, width : Int, height : Int) : java.awt.Rectangle;
	
	@:overload @:public override public function Transform(src : sun.java2d.SurfaceData, dst : sun.java2d.SurfaceData, comp : java.awt.Composite, clip : sun.java2d.pipe.Region, xform : java.awt.geom.AffineTransform, hint : Int, srcx : Int, srcy : Int, dstx : Int, dsty : Int, width : Int, height : Int) : Void;
	
	/* TODO: Is mask ever omitable??? ... should be for 90 degree rotation and no shear, but we always need to use RepeatPad */
	@:overload @:protected @:static private static function isMaskOmittable(trx : java.awt.geom.AffineTransform, comp : java.awt.Composite, filter : Int) : Bool;
...
{
	@:overload @:public override public function Transform(src : sun.java2d.SurfaceData, dst : sun.java2d.SurfaceData, comp : java.awt.Composite, clip : sun.java2d.pipe.Region, xform : java.awt.geom.AffineTransform, hint : Int, sx : Int, sy : Int, dstx : Int, dsty : Int, w : Int, h : Int) : Void;
