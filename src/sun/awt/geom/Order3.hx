...
{
	@:overload @:public @:static public static function insert(curves : java.util.Vector<Dynamic>, tmp : java.NativeArray<Float>, x0 : Float, y0 : Float, cx0 : Float, cy0 : Float, cx1 : Float, cy1 : Float, x1 : Float, y1 : Float, direction : Int) : Void;
	
	@:overload @:public @:static public static function addInstance(curves : java.util.Vector<Dynamic>, x0 : Float, y0 : Float, cx0 : Float, cy0 : Float, cx1 : Float, cy1 : Float, x1 : Float, y1 : Float, direction : Int) : Void;
	...
	*/
	@:overload @:public @:static public static function getHorizontalParams(c0 : Float, cp0 : Float, cp1 : Float, c1 : Float, ret : java.NativeArray<Float>) : Int;
	...
	*/
	...
	@:overload @:public public function new(x0 : Float, y0 : Float, cx0 : Float, cy0 : Float, cx1 : Float, cy1 : Float, x1 : Float, y1 : Float, direction : Int) : Void;
	...
	@:overload @:public public function getCX1() : Float;
	
	@:overload @:public public function getCY1() : Float;
	...
	*/
	...
	@:overload @:public public function refine(a : Float, b : Float, c : Float, target : Float, t : Float) : Float;
