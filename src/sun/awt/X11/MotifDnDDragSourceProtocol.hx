...
@:internal extern class MotifDnDDragSourceProtocol extends sun.awt.X11.XDragSourceProtocol implements sun.awt.X11.XEventDispatcher
{
	...
	*/
	...
	@:overload override private function sendDropMessage(xRoot : Int, yRoot : Int, sourceAction : Int, sourceActions : Int, time : haxe.Int64) : Void;
	...
	@:overload override public function cleanupTargetInfo() : Void;
