...
extern class XkbActionMessageEvent extends sun.awt.X11.XWrapperBase
{
	...
	@:overload public function get_press() : Bool;
	
	@:overload public function set_press(v : Bool) : Void;
	
	@:overload public function get_key_event_follows() : Bool;
	
	@:overload public function set_key_event_follows(v : Bool) : Void;
	...
	@:overload public function get_message(index : Int) : java.StdTypes.Int8;
	
	@:overload public function set_message(index : Int, v : java.StdTypes.Int8) : Void;
	
	@:overload public function get_message() : haxe.Int64;
