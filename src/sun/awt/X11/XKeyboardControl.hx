...
extern class XKeyboardControl extends sun.awt.X11.XWrapperBase
{
	...
	@:overload @:public public function get_led() : Int;
	
	@:overload @:public public function set_led(v : Int) : Void;
	
	@:overload @:public public function get_led_mode() : Int;
	
	@:overload @:public public function set_led_mode(v : Int) : Void;
	
	@:overload @:public public function get_key() : Int;
	
	@:overload @:public public function set_key(v : Int) : Void;
	
	@:overload @:public public function get_auto_repeat_mode() : Int;
	
	@:overload @:public public function set_auto_repeat_mode(v : Int) : Void;
