...
* questions.
*/
extern interface XModalityProtocol
{
	/**
	...
	*/
	@:overload public function setModal(dialog : sun.awt.X11.XDialogPeer, modal : Bool) : Bool;
	...
	*/
	@:overload public function isBlocked(dialog : sun.awt.X11.XDialogPeer, win : sun.awt.X11.XWindowPeer) : Bool;
