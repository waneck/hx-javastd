...
extern class XkbCompatMapNotifyEvent extends sun.awt.X11.XWrapperBase
{
	...
	@:overload public function get_first_si() : Int;
	
	@:overload public function set_first_si(v : Int) : Void;
	
	@:overload public function get_num_si() : Int;
	
	@:overload public function set_num_si(v : Int) : Void;
	
	@:overload public function get_num_total_si() : Int;
	
	@:overload public function set_num_total_si(v : Int) : Void;
