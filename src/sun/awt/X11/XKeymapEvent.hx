...
extern class XKeymapEvent extends sun.awt.X11.XWrapperBase
{
	...
	@:overload public function get_key_vector(index : Int) : java.StdTypes.Int8;
	
	@:overload public function set_key_vector(index : Int, v : java.StdTypes.Int8) : Void;
	
	@:overload public function get_key_vector() : haxe.Int64;
