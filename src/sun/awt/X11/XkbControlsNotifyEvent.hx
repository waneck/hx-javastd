...
extern class XkbControlsNotifyEvent extends sun.awt.X11.XWrapperBase
{
	...
	@:overload public function get_changed_ctrls() : Int;
	
	@:overload public function set_changed_ctrls(v : Int) : Void;
	
	@:overload public function get_enabled_ctrls() : Int;
	
	@:overload public function set_enabled_ctrls(v : Int) : Void;
	
	@:overload public function get_enabled_ctrl_changes() : Int;
	
	@:overload public function set_enabled_ctrl_changes(v : Int) : Void;
	
	@:overload public function get_num_groups() : Int;
	
	@:overload public function set_num_groups(v : Int) : Void;
