...
@:internal extern class XDnDDropTargetProtocol extends sun.awt.X11.XDropTargetProtocol
{
	...
	*/
	...
	@:overload @:protected override private function sendEnterMessageToToplevel(toplevel : haxe.Int64, xclient : sun.awt.X11.XClientMessageEvent) : Void;
	
	@:overload @:protected override private function sendLeaveMessageToToplevel(toplevel : haxe.Int64, xclient : sun.awt.X11.XClientMessageEvent) : Void;
	
	@:overload @:protected private function sendLeaveMessageToToplevelImpl(toplevel : haxe.Int64, sourceWindow : haxe.Int64) : Void;
	...
	*/
	...
	@:overload @:public override public function adjustEventForForwarding(xclient : sun.awt.X11.XClientMessageEvent, entry : sun.awt.X11.XDropTargetProtocol.XDropTargetProtocol_EmbedderRegistryEntry) : Void;
