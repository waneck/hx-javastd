...
extern class XClientMessageEvent extends sun.awt.X11.XWrapperBase
{
	...
	@:overload public function get_message_type() : haxe.Int64;
	
	@:overload public function set_message_type(v : haxe.Int64) : Void;
	
	@:overload public function get_format() : Int;
	
	@:overload public function set_format(v : Int) : Void;
	
	@:overload public function get_data(index : Int) : haxe.Int64;
	
	@:overload public function set_data(index : Int, v : haxe.Int64) : Void;
