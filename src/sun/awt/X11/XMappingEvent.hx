...
extern class XMappingEvent extends sun.awt.X11.XWrapperBase
{
	...
	@:overload public function get_request() : Int;
	
	@:overload public function set_request(v : Int) : Void;
	
	@:overload public function get_first_keycode() : Int;
	
	@:overload public function set_first_keycode(v : Int) : Void;
