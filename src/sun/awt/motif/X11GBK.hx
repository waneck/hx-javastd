...
* questions.
*/
extern class X11GBK extends java.nio.charset.Charset
{
...
@:native('sun$awt$motif$X11GBK$Encoder') @:internal extern class X11GBK_Encoder extends sun.nio.cs.ext.DoubleByte.DoubleByte_Encoder
{
