...
* questions.
*/
extern class X11GB18030_1 extends java.nio.charset.Charset
{
...
@:native('sun$awt$motif$X11GB18030_1$Encoder') @:internal extern class X11GB18030_1_Encoder extends sun.nio.cs.ext.DoubleByteEncoder
{
