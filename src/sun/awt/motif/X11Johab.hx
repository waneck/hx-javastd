...
* questions.
*/
extern class X11Johab extends java.nio.charset.Charset
{
...
@:native('sun$awt$motif$X11Johab$Encoder') @:internal extern class X11Johab_Encoder extends sun.nio.cs.ext.DoubleByteEncoder
{
