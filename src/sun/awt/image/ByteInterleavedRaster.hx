...
* questions.
*/
extern class ByteInterleavedRaster extends sun.awt.image.ByteComponentRaster
{
	/**
	...
	*/
	@:overload @:public public function new(sampleModel : java.awt.image.SampleModel, dataBuffer : java.awt.image.DataBuffer, aRegion : java.awt.Rectangle, origin : java.awt.Point, parent : sun.awt.image.ByteInterleavedRaster) : Void;
	...
	*/
	@:overload @:public override public function getDataStorage() : java.NativeArray<java.StdTypes.Int8>;
	...
	*/
	@:overload @:public override public function getByteData(x : Int, y : Int, w : Int, h : Int, band : Int, outData : java.NativeArray<java.StdTypes.Int8>) : java.NativeArray<java.StdTypes.Int8>;
	...
	* @return         Data array with data elements for all bands.
	*/
	@:overload @:public override public function getByteData(x : Int, y : Int, w : Int, h : Int, outData : java.NativeArray<java.StdTypes.Int8>) : java.NativeArray<java.StdTypes.Int8>;
	...
	*/
	@:overload @:public override public function putByteData(x : Int, y : Int, w : Int, h : Int, band : Int, inData : java.NativeArray<java.StdTypes.Int8>) : Void;
	...
	* @param inData   The data elements to be stored.
	*/
	@:overload @:public override public function putByteData(x : Int, y : Int, w : Int, h : Int, inData : java.NativeArray<java.StdTypes.Int8>) : Void;
	
	@:overload @:public override public function getSample(x : Int, y : Int, b : Int) : Int;
	
	@:overload @:public override public function setSample(x : Int, y : Int, b : Int, s : Int) : Void;
	
	@:overload @:public override public function getSamples(x : Int, y : Int, w : Int, h : Int, b : Int, iArray : java.NativeArray<Int>) : java.NativeArray<Int>;
	
	@:overload @:public override public function setSamples(x : Int, y : Int, w : Int, h : Int, b : Int, iArray : java.NativeArray<Int>) : Void;
	
	@:overload @:public override public function getPixels(x : Int, y : Int, w : Int, h : Int, iArray : java.NativeArray<Int>) : java.NativeArray<Int>;
	
	@:overload @:public override public function setPixels(x : Int, y : Int, w : Int, h : Int, iArray : java.NativeArray<Int>) : Void;
	
	@:overload @:public override public function setRect(dx : Int, dy : Int, srcRaster : java.awt.image.Raster) : Void;
