...
* questions.
*/
extern class Symbol extends java.nio.charset.Charset
{
...
@:native('sun$awt$Symbol$Encoder') @:internal extern class Symbol_Encoder extends java.nio.charset.CharsetEncoder
{
