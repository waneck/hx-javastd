...
extern interface SymbolTable
{
	...
	*/
	@:overload public function lookup(s : String) : java.NativeArray<java.StdTypes.Char16>;
	...
	* @deprecated This is a draft API and might change in a future release of ICU.
	*/
	@:overload public function lookupMatcher(ch : Int) : sun.text.normalizer.UnicodeMatcher;
	...
	* @deprecated This is a draft API and might change in a future release of ICU.
	*/
	@:overload public function parseReference(text : String, pos : java.text.ParsePosition, limit : Int) : String;
