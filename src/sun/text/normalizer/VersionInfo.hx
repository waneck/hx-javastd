...
extern class VersionInfo
{
	...
	* @stable ICU 2.6
	*/
	@:overload public static function getInstance(version : String) : VersionInfo;
	...
	* @stable ICU 2.6
	*/
	@:overload public static function getInstance(major : Int, minor : Int, milli : Int, micro : Int) : VersionInfo;
	...
	* @stable ICU 2.6
	*/
	@:overload public function compareTo(other : VersionInfo) : Int;
