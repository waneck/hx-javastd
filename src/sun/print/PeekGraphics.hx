...
extern class PeekGraphics extends java.awt.Graphics2D implements java.awt.print.PrinterGraphics implements java.awt.image.ImageObserver implements java.lang.Cloneable
{
	...
	* times.
	*/
	@:overload public function setAWTDrawingOnly() : Void;
	
	@:overload public function getAWTDrawingOnly() : Bool;
	
	/**
	* Return a Spans instance describing the parts of the page in
	* to which drawing occurred.
	*/
	@:overload public function getDrawingArea() : sun.java2d.Spans;
	...
	* has drawn.
	*/
	@:overload public function hitsDrawingArea(rect : java.awt.Rectangle) : Bool;
	
	/**
	* Return the object holding the summary of the
	* drawing done by the printing application.
	*/
	@:overload public function getMetrics() : sun.print.PeekMetrics;
...
@:native('sun$print$PeekGraphics$ImageWaiter') extern class PeekGraphics_ImageWaiter implements java.awt.image.ImageObserver
{
	...
	@:overload @:synchronized public function imageUpdate(image : java.awt.Image, flags : Int, x : Int, y : Int, w : Int, h : Int) : Bool;
