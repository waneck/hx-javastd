...
* questions.
*/
extern class ClassScope extends sun.reflect.generics.scope.AbstractScope<Class<Dynamic>> implements sun.reflect.generics.scope.Scope
{
	/**
	...
	*/
	@:overload @:public @:static public static function make(c : Class<Dynamic>) : sun.reflect.generics.scope.ClassScope;
