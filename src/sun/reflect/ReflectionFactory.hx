...
extern class ReflectionFactory
{
	...
	*             access to the RuntimePermission "reflectionFactoryAccess".  */
	@:overload @:public @:static public static function getReflectionFactory() : sun.reflect.ReflectionFactory;
	
	/** Called only by java.lang.reflect.Modifier's static initializer */
	@:overload @:public public function setLangReflectAccess(access : sun.reflect.LangReflectAccess) : Void;
	...
	*/
	@:overload @:public public function newFieldAccessor(field : java.lang.reflect.Field, _override : Bool) : sun.reflect.FieldAccessor;
	
	@:overload @:public public function newMethodAccessor(method : java.lang.reflect.Method) : sun.reflect.MethodAccessor;
	
	@:overload @:public public function newConstructorAccessor(c : java.lang.reflect.Constructor<Dynamic>) : sun.reflect.ConstructorAccessor;
	...
	@:overload @:public public function newConstructorForSerialization(classToInstantiate : Class<Dynamic>, constructorToCall : java.lang.reflect.Constructor<Dynamic>) : java.lang.reflect.Constructor<Dynamic>;
...
{
	@:overload @:public public function run() : sun.reflect.ReflectionFactory;
