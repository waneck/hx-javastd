...
extern class EncryptionKey implements java.lang.Cloneable
{
	...
	*/
	@:public @:static @:final public static var NULL_KEY(default, null) : sun.security.krb5.EncryptionKey;
	
	@:overload @:public @:synchronized public function getEType() : Int;
	
	@:overload @:public @:final public function getKeyVersionNumber() : Null<Int>;
	...
	*/
	@:overload @:public @:static public static function acquireSecretKeys(princ : sun.security.krb5.PrincipalName, keytab : String) : java.NativeArray<sun.security.krb5.EncryptionKey>;
	...
	* @returns never null
	*/
	@:overload @:public @:static public static function acquireSecretKey(cname : sun.security.krb5.PrincipalName, password : java.NativeArray<java.StdTypes.Char16>, etype : Int, snp : sun.security.krb5.internal.PAData.PAData_SaltAndParams) : sun.security.krb5.EncryptionKey;
	...
	* @returns never null
	*/
	@:overload @:public @:static public static function acquireSecretKey(password : java.NativeArray<java.StdTypes.Char16>, salt : String, etype : Int, s2kparams : java.NativeArray<java.StdTypes.Int8>) : sun.security.krb5.EncryptionKey;
	...
	*/
	@:overload @:public @:static public static function acquireSecretKeys(password : java.NativeArray<java.StdTypes.Char16>, salt : String) : java.NativeArray<sun.security.krb5.EncryptionKey>;
	
	@:overload @:public public function new(keyValue : java.NativeArray<java.StdTypes.Int8>, keyType : Int, kvno : Null<Int>) : Void;
	...
	*
	*/
	@:overload @:public public function new(keyType : Int, keyValue : java.NativeArray<java.StdTypes.Int8>) : Void;
	
	@:overload @:public public function new(password : java.NativeArray<java.StdTypes.Char16>, salt : String, algorithm : String) : Void;
	...
	*
	*/
	@:overload @:public @:synchronized public function asn1Encode() : java.NativeArray<java.StdTypes.Int8>;
	...
	*
	*/
	@:overload @:public @:static public static function parse(data : sun.security.util.DerInputStream, explicitTag : java.StdTypes.Int8, optional : Bool) : sun.security.krb5.EncryptionKey;
	...
	*
	*/
	@:overload @:public @:synchronized public function writeKey(cos : sun.security.krb5.internal.ccache.CCacheOutputStream) : Void;
	...
	*/
	@:overload @:public @:static public static function findKey(etype : Int, keys : java.NativeArray<sun.security.krb5.EncryptionKey>) : sun.security.krb5.EncryptionKey;
	
	/**
	* Find a key with given etype and kvno
	* @param kvno if null, return any (first?) key
	*/
	@:overload @:public @:static public static function findKey(etype : Int, kvno : Null<Int>, keys : java.NativeArray<sun.security.krb5.EncryptionKey>) : sun.security.krb5.EncryptionKey;
