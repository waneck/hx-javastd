...
extern class Aes128
{
	@:overload public static function stringToKey(password : java.NativeArray<java.StdTypes.Char16>, salt : String, params : java.NativeArray<java.StdTypes.Int8>) : java.NativeArray<java.StdTypes.Int8>;
