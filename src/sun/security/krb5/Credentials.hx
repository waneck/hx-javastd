...
extern class Credentials
{
	...
	@:overload public function new(encoding : java.NativeArray<java.StdTypes.Int8>, client : String, server : String, keyBytes : java.NativeArray<java.StdTypes.Int8>, keyType : Int, flags : java.NativeArray<Bool>, authTime : java.util.Date, startTime : java.util.Date, endTime : java.util.Date, renewTill : java.util.Date, cAddrs : java.NativeArray<java.net.InetAddress>) : Void;
	...
	*/
	@:overload @:final public function getClient() : sun.security.krb5.PrincipalName;
	
	@:overload @:final public function getServer() : sun.security.krb5.PrincipalName;
	
	@:overload @:final public function getSessionKey() : sun.security.krb5.EncryptionKey;
	...
	@:overload public function isForwardable() : Bool;
	
	@:overload public function isRenewable() : Bool;
	
	@:overload public function getTicket() : sun.security.krb5.internal.Ticket;
	
	@:overload public function getTicketFlags() : sun.security.krb5.internal.TicketFlags;
	
	@:overload public function getAuthzData() : sun.security.krb5.internal.AuthorizationData;
	...
	*/
	@:overload public function checkDelegate() : Bool;
	...
	*/
	...
	@:overload public function getServiceKey() : sun.security.krb5.EncryptionKey;
