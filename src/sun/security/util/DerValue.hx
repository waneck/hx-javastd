...
{
	/** The tag class types */
	public static var TAG_UNIVERSAL(default, null) : java.StdTypes.Int8;
	
	public static var TAG_APPLICATION(default, null) : java.StdTypes.Int8;
	
	public static var TAG_CONTEXT(default, null) : java.StdTypes.Int8;
	
	public static var TAG_PRIVATE(default, null) : java.StdTypes.Int8;
	
	/** The DER tag of the value; one of the tag_ constants. */
	public var tag : java.StdTypes.Int8;
	
	private var buffer : sun.security.util.DerInputBuffer;
	
	/**
	* The DER-encoded data of the value, never null
	*/
	public var data(default, null) : sun.security.util.DerInputStream;
	
	/** Tag value indicating an ASN.1 "BOOLEAN" value. */
	public static var tag_Boolean(default, null) : java.StdTypes.Int8;
	
	/** Tag value indicating an ASN.1 "INTEGER" value. */
	public static var tag_Integer(default, null) : java.StdTypes.Int8;
	
	/** Tag value indicating an ASN.1 "BIT STRING" value. */
	public static var tag_BitString(default, null) : java.StdTypes.Int8;
	
	/** Tag value indicating an ASN.1 "OCTET STRING" value. */
	public static var tag_OctetString(default, null) : java.StdTypes.Int8;
	
	/** Tag value indicating an ASN.1 "NULL" value. */
	public static var tag_Null(default, null) : java.StdTypes.Int8;
	
	/** Tag value indicating an ASN.1 "OBJECT IDENTIFIER" value. */
	public static var tag_ObjectId(default, null) : java.StdTypes.Int8;
	
	/** Tag value including an ASN.1 "ENUMERATED" value */
	public static var tag_Enumerated(default, null) : java.StdTypes.Int8;
	
	/** Tag value indicating an ASN.1 "UTF8String" value. */
	public static var tag_UTF8String(default, null) : java.StdTypes.Int8;
	
	/** Tag value including a "printable" string */
	public static var tag_PrintableString(default, null) : java.StdTypes.Int8;
	
	/** Tag value including a "teletype" string */
	public static var tag_T61String(default, null) : java.StdTypes.Int8;
	
	/** Tag value including an ASCII string */
	public static var tag_IA5String(default, null) : java.StdTypes.Int8;
	
	/** Tag value indicating an ASN.1 "UTCTime" value. */
	public static var tag_UtcTime(default, null) : java.StdTypes.Int8;
	
	/** Tag value indicating an ASN.1 "GeneralizedTime" value. */
	public static var tag_GeneralizedTime(default, null) : java.StdTypes.Int8;
	
	/** Tag value indicating an ASN.1 "GenerallString" value. */
	public static var tag_GeneralString(default, null) : java.StdTypes.Int8;
	
	/** Tag value indicating an ASN.1 "UniversalString" value. */
	public static var tag_UniversalString(default, null) : java.StdTypes.Int8;
	
	/** Tag value indicating an ASN.1 "BMPString" value. */
	public static var tag_BMPString(default, null) : java.StdTypes.Int8;
	
	/**
	* Tag value indicating an ASN.1
	* "SEQUENCE" (zero to N elements, order is significant).
	*/
	public static var tag_Sequence(default, null) : java.StdTypes.Int8;
	
	/**
	* Tag value indicating an ASN.1
	* "SEQUENCE OF" (one to N elements, order is significant).
	*/
	public static var tag_SequenceOf(default, null) : java.StdTypes.Int8;
	
	/**
	* Tag value indicating an ASN.1
	* "SET" (zero to N members, order does not matter).
	*/
	public static var tag_Set(default, null) : java.StdTypes.Int8;
	
	/**
	* Tag value indicating an ASN.1
	* "SET OF" (one to N members, order does not matter).
	*/
	public static var tag_SetOf(default, null) : java.StdTypes.Int8;
	
	/**
	* Returns true if the tag class is UNIVERSAL.
	*/
	@:overload public function isUniversal() : Bool;
	
	/**
	* Returns true if the tag class is APPLICATION.
	*/
	@:overload public function isApplication() : Bool;
	
	/**
	* Returns true iff the CONTEXT SPECIFIC bit is set in the type tag.
	* This is associated with the ASN.1 "DEFINED BY" syntax.
	*/
	@:overload public function isContextSpecific() : Bool;
	
	/**
	* Returns true iff the CONTEXT SPECIFIC TAG matches the passed tag.
	*/
	@:overload public function isContextSpecific(cntxtTag : java.StdTypes.Int8) : Bool;
	
	/** Returns true iff the CONSTRUCTED bit is set in the type tag. */
	@:overload public function isConstructed() : Bool;
	
	/**
	* Returns true iff the CONSTRUCTED TAG matches the passed tag.
	*/
	@:overload public function isConstructed(constructedTag : java.StdTypes.Int8) : Bool;
	...
	*/
	@:overload public function new(stringTag : java.StdTypes.Int8, value : String) : Void;
	...
	*/
	@:overload public function new(tag : java.StdTypes.Int8, data : java.NativeArray<java.StdTypes.Int8>) : Void;
	...
	*/
	@:overload public function new(buf : java.NativeArray<java.StdTypes.Int8>, offset : Int, len : Int) : Void;
	...
	*/
	...
	@:overload @:final public function getData() : sun.security.util.DerInputStream;
	...
	*/
	@:overload public function getAsString() : String;
	...
	* @return the bit string held in this value
	*/
	@:overload public function getBitString(tagImplicit : Bool) : java.NativeArray<java.StdTypes.Int8>;
	...
	* @return the bit string held in this value
	*/
	@:overload public function getUnalignedBitString(tagImplicit : Bool) : sun.security.util.BitArray;
	
	/**
	* Helper routine to return all the bytes contained in the
	* DerInputStream associated with this object.
	*/
	@:overload public function getDataBytes() : java.NativeArray<java.StdTypes.Int8>;
	...
	*/
	@:overload public function toDerInputStream() : sun.security.util.DerInputStream;
	...
	*/
	@:overload public static function isPrintableStringChar(ch : java.StdTypes.Char16) : Bool;
	...
	*/
	@:overload public static function createTag(tagClass : java.StdTypes.Int8, form : Bool, val : java.StdTypes.Int8) : java.StdTypes.Int8;
	...
	*/
	@:overload public function resetTag(tag : java.StdTypes.Int8) : Void;
