...
extern class DerOutputStream extends java.io.ByteArrayOutputStream implements sun.security.util.DerEncoder
{
	...
	*/
	@:overload public function write(tag : java.StdTypes.Int8, buf : java.NativeArray<java.StdTypes.Int8>) : Void;
	...
	*/
	@:overload public function putDerValue(val : sun.security.util.DerValue) : Void;
	
	/**
	* Marshals a DER boolean on the output stream.
	*/
	@:overload public function putBoolean(val : Bool) : Void;
	
	/**
	* Marshals a DER enumerated on the output stream.
	* @param i the enumerated value.
	*/
	@:overload public function putEnumerated(i : Int) : Void;
	...
	*/
	@:overload public function putInteger(i : java.math.BigInteger) : Void;
	
	/**
	* Marshals a DER integer on the output stream.
	* @param i the integer in the form of an Integer.
	*/
	@:overload public function putInteger(i : Null<Int>) : Void;
	
	/**
	* Marshals a DER integer on the output stream.
	* @param i the integer.
	*/
	@:overload public function putInteger(i : Int) : Void;
	...
	*/
	@:overload public function putBitString(bits : java.NativeArray<java.StdTypes.Int8>) : Void;
	...
	* @param bits the bit string, MSB first
	*/
	@:overload public function putUnalignedBitString(ba : sun.security.util.BitArray) : Void;
	...
	* @param bits the bit string, MSB first
	*/
	@:overload public function putTruncatedUnalignedBitString(ba : sun.security.util.BitArray) : Void;
	...
	*/
	@:overload public function putOctetString(octets : java.NativeArray<java.StdTypes.Int8>) : Void;
	...
	*/
	@:overload public function putOID(oid : sun.security.util.ObjectIdentifier) : Void;
	...
	*/
	@:overload public function putSequence(seq : java.NativeArray<sun.security.util.DerValue>) : Void;
	...
	*/
	@:overload public function putSet(set : java.NativeArray<sun.security.util.DerValue>) : Void;
	...
	*/
	@:overload public function putOrderedSetOf(tag : java.StdTypes.Int8, set : java.NativeArray<sun.security.util.DerEncoder>) : Void;
	...
	*/
	@:overload public function putOrderedSet(tag : java.StdTypes.Int8, set : java.NativeArray<sun.security.util.DerEncoder>) : Void;
	
	/**
	* Marshals a string as a DER encoded UTF8String.
	*/
	@:overload public function putUTF8String(s : String) : Void;
	
	/**
	* Marshals a string as a DER encoded PrintableString.
	*/
	@:overload public function putPrintableString(s : String) : Void;
	
	/**
	* Marshals a string as a DER encoded T61String.
	*/
	@:overload public function putT61String(s : String) : Void;
	
	/**
	* Marshals a string as a DER encoded IA5String.
	*/
	@:overload public function putIA5String(s : String) : Void;
	
	/**
	* Marshals a string as a DER encoded BMPString.
	*/
	@:overload public function putBMPString(s : String) : Void;
	
	/**
	* Marshals a string as a DER encoded GeneralString.
	*/
	@:overload public function putGeneralString(s : String) : Void;
	...
	*/
	@:overload public function putUTCTime(d : java.util.Date) : Void;
	...
	* and with seconds (even if seconds=0) as per RFC 3280.
	*/
	@:overload public function putGeneralizedTime(d : java.util.Date) : Void;
	...
	*/
	@:overload public function putLength(len : Int) : Void;
	...
	*/
	@:overload public function putTag(tagClass : java.StdTypes.Int8, form : Bool, val : java.StdTypes.Int8) : Void;
