...
*/
@:internal extern class EphemeralKeyManager
{
...
*/
@:native('sun$security$ssl$EphemeralKeyManager$EphemeralKeyPair') @:internal extern class EphemeralKeyManager_EphemeralKeyPair
{
