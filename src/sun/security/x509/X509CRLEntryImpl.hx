...
extern class X509CRLEntryImpl extends java.security.cert.X509CRLEntry implements java.lang.Comparable<sun.security.x509.X509CRLEntryImpl>
{
	...
	*/
	@:overload @:public public function new(num : java.math.BigInteger, date : java.util.Date) : Void;
	...
	*/
	@:overload @:public public function new(num : java.math.BigInteger, date : java.util.Date, crlEntryExts : sun.security.x509.CRLExtensions) : Void;
	...
	*/
	@:overload @:public public function new(revokedCert : java.NativeArray<java.StdTypes.Int8>) : Void;
	...
	* false.
	*/
	@:overload @:public override public function hasExtensions() : Bool;
	...
	*/
	@:overload @:public public function encode(outStrm : sun.security.util.DerOutputStream) : Void;
	...
	*/
	...
	@:overload @:public override public function getCertificateIssuer() : javax.security.auth.x500.X500Principal;
	...
	*/
	@:overload @:public override public function getRevocationDate() : java.util.Date;
	...
	* cached values.
	*/
	@:overload @:public override public function getRevocationReason() : java.security.cert.CRLReason;
	
	/**
	* This static method is the default implementation of the
	* getRevocationReason method in X509CRLEntry.
	*/
	@:native('getRevocationReason') @:overload @:public @:static public static function _getRevocationReason(crlEntry : java.security.cert.X509CRLEntry) : java.security.cert.CRLReason;
	...
	*/
	@:overload @:public public function getReasonCode() : Null<Int>;
	...
	*/
	@:overload @:public public function getExtension(oid : sun.security.util.ObjectIdentifier) : sun.security.x509.Extension;
	...
	* the encoding.
	*/
	@:overload @:public @:static public static function toImpl(entry : java.security.cert.X509CRLEntry) : sun.security.x509.X509CRLEntryImpl;
	...
	*/
	...
	@:overload @:public public function compareTo(that : sun.security.x509.X509CRLEntryImpl) : Int;
