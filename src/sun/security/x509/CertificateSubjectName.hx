...
extern class CertificateSubjectName implements sun.security.x509.CertAttrSet<String>
{
	...
	*/
	...
	public static var DN_NAME(default, null) : String;
	
	public static var DN_PRINCIPAL(default, null) : String;
	...
	*/
	@:overload public function new(name : sun.security.x509.X500Name) : Void;
