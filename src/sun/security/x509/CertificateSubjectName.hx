...
* @see CertAttrSet
*/
extern class CertificateSubjectName implements sun.security.x509.CertAttrSet<String>
{
	/**
	...
	*/
	...
	@:public @:static @:final public static var DN_NAME(default, null) : String;
	
	@:public @:static @:final public static var DN_PRINCIPAL(default, null) : String;
	...
	*/
	@:overload @:public public function new(name : sun.security.x509.X500Name) : Void;
