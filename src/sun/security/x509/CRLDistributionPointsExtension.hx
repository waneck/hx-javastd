...
extern class CRLDistributionPointsExtension extends java.security.cert.Extension implements sun.security.x509.CertAttrSet<String>
{
	...
	*/
	...
	@:public @:static @:final public static var POINTS(default, null) : String;
	...
	* @throws IOException on error
	*/
	@:overload @:public public function new(isCritical : Bool, distributionPoints : java.util.List<sun.security.x509.DistributionPoint>) : Void;
	
	/**
	* Creates the extension (also called by the subclass).
	*/
	@:overload @:protected private function new(extensionId : sun.security.util.ObjectIdentifier, isCritical : Bool, distributionPoints : java.util.List<sun.security.x509.DistributionPoint>, extensionName : String) : Void;
	...
	* Creates the extension (also called by the subclass).
	*/
	@:overload @:protected private function new(extensionId : sun.security.util.ObjectIdentifier, critical : Null<Bool>, value : Dynamic, extensionName : String) : Void;
