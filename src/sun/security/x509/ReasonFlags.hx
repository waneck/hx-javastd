...
extern class ReasonFlags
{
	...
	* Reasons
	*/
	@:public @:static @:final public static var UNUSED(default, null) : String;
	
	@:public @:static @:final public static var KEY_COMPROMISE(default, null) : String;
	
	@:public @:static @:final public static var CA_COMPROMISE(default, null) : String;
	
	@:public @:static @:final public static var AFFILIATION_CHANGED(default, null) : String;
	
	@:public @:static @:final public static var SUPERSEDED(default, null) : String;
	
	@:public @:static @:final public static var CESSATION_OF_OPERATION(default, null) : String;
	
	@:public @:static @:final public static var CERTIFICATE_HOLD(default, null) : String;
	
	@:public @:static @:final public static var PRIVILEGE_WITHDRAWN(default, null) : String;
	
	@:public @:static @:final public static var AA_COMPROMISE(default, null) : String;
	...
	*/
	@:overload @:public public function new(reasons : java.NativeArray<java.StdTypes.Int8>) : Void;
	...
	* @param reasons the bits to be set for the ReasonFlags.
	*/
	@:overload @:public public function new(reasons : java.NativeArray<Bool>) : Void;
	...
	* @param reasons the bits to be set for the ReasonFlags.
	*/
	@:overload @:public public function new(reasons : sun.security.util.BitArray) : Void;
	...
	*/
	@:overload @:public public function getFlags() : java.NativeArray<Bool>;
