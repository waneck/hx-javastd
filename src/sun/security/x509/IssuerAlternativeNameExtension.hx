...
* @see CertAttrSet
*/
extern class IssuerAlternativeNameExtension extends java.security.cert.Extension implements sun.security.x509.CertAttrSet<String>
{
	/**
	...
	*/
	...
	@:public @:static @:final public static var ISSUER_NAME(default, null) : String;
