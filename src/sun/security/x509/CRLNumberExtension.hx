...
extern class CRLNumberExtension extends java.security.cert.Extension implements sun.security.x509.CertAttrSet<String>
{
	...
	*/
	@:overload private function new(extensionId : sun.security.util.ObjectIdentifier, isCritical : Bool, crlNum : java.math.BigInteger, extensionName : String, extensionLabel : String) : Void;
	...
	* Creates the extension (also called by the subclass).
	*/
	@:overload private function new(extensionId : sun.security.util.ObjectIdentifier, critical : Null<Bool>, value : Dynamic, extensionName : String, extensionLabel : String) : Void;
