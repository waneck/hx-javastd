...
extern class CertificatePolicySet
{
	...
	*/
	@:overload @:public public function new(ids : java.util.Vector<sun.security.x509.CertificatePolicyId>) : Void;
	...
	*
	*/
	@:overload @:public public function getCertPolicyIds() : java.util.List<sun.security.x509.CertificatePolicyId>;
