...
extern class TSResponse
{
	...
	*/
	public static var GRANTED(default, null) : Int;
	
	/**
	* The requested timestamp was granted with some modifications.
	*/
	public static var GRANTED_WITH_MODS(default, null) : Int;
	
	/**
	* The requested timestamp was not granted.
	*/
	public static var REJECTION(default, null) : Int;
	...
	*/
	public static var REVOCATION_WARNING(default, null) : Int;
	
	/**
	* Notification that a certificate revocation has occurred.
	*/
	public static var REVOCATION_NOTIFICATION(default, null) : Int;
	
	/**
	* Unrecognized or unsupported algorithm identifier.
	*/
	public static var BAD_ALG(default, null) : Int;
	
	/**
	* The requested transaction is not permitted or supported.
	*/
	public static var BAD_REQUEST(default, null) : Int;
	
	/**
	* The data submitted has the wrong format.
	*/
	public static var BAD_DATA_FORMAT(default, null) : Int;
	
	/**
	* The TSA's time source is not available.
	*/
	public static var TIME_NOT_AVAILABLE(default, null) : Int;
	
	/**
	* The requested TSA policy is not supported by the TSA.
	*/
	public static var UNACCEPTED_POLICY(default, null) : Int;
	
	/**
	* The requested extension is not supported by the TSA.
	*/
	public static var UNACCEPTED_EXTENSION(default, null) : Int;
	
	/**
	* The additional information requested could not be understood or is not
	* available.
	*/
	public static var ADD_INFO_NOT_AVAILABLE(default, null) : Int;
	
	/**
	* The request cannot be handled due to system failure.
	*/
	public static var SYSTEM_FAILURE(default, null) : Int;
	...
	*/
	@:overload public function getStatusMessages() : java.NativeArray<String>;
	...
	*/
	@:overload public function getFailureCode() : Int;
	
	@:overload public function getStatusCodeAsText() : String;
	
	@:overload public function getFailureCodeAsText() : String;
	...
	*/
	@:overload public function getToken() : sun.security.pkcs.PKCS7;
	...
	* @return If null then no token was received.
	*/
	@:overload public function getEncodedToken() : java.NativeArray<java.StdTypes.Int8>;
