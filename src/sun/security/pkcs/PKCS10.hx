...
extern class PKCS10
{
	...
	*/
	@:overload public function new(publicKey : java.security.PublicKey) : Void;
	...
	*/
	@:overload public function new(publicKey : java.security.PublicKey, attributes : sun.security.pkcs.PKCS10Attributes) : Void;
	...
	*/
	@:overload public function encodeAndSign(subject : sun.security.x509.X500Name, signature : java.security.Signature) : Void;
	
	/**
	* Returns the subject's name.
	*/
	@:overload public function getSubjectName() : sun.security.x509.X500Name;
	
	/**
	* Returns the subject's public key.
	*/
	@:overload public function getSubjectPublicKeyInfo() : java.security.PublicKey;
	
	/**
	* Returns the additional attributes requested.
	*/
	@:overload public function getAttributes() : sun.security.pkcs.PKCS10Attributes;
