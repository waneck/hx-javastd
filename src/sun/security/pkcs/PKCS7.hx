...
extern class PKCS7
{
	...
	*/
	@:overload public function new(digestAlgorithmIds : java.NativeArray<sun.security.x509.AlgorithmId>, contentInfo : sun.security.pkcs.ContentInfo, certificates : java.NativeArray<java.security.cert.X509Certificate>, crls : java.NativeArray<java.security.cert.X509CRL>, signerInfos : java.NativeArray<sun.security.pkcs.SignerInfo>) : Void;
	
	@:overload public function new(digestAlgorithmIds : java.NativeArray<sun.security.x509.AlgorithmId>, contentInfo : sun.security.pkcs.ContentInfo, certificates : java.NativeArray<java.security.cert.X509Certificate>, signerInfos : java.NativeArray<sun.security.pkcs.SignerInfo>) : Void;
	...
	*/
	@:overload public function encodeSignedData(out : java.io.OutputStream) : Void;
	...
	* @exception IOException on encoding errors.
	*/
	@:overload public function encodeSignedData(out : sun.security.util.DerOutputStream) : Void;
	...
	*/
	@:overload public function verify(info : sun.security.pkcs.SignerInfo, bytes : java.NativeArray<java.StdTypes.Int8>) : sun.security.pkcs.SignerInfo;
	...
	* @exception SignatureException on signature handling errors.
	*/
	@:overload public function verify(bytes : java.NativeArray<java.StdTypes.Int8>) : java.NativeArray<sun.security.pkcs.SignerInfo>;
	...
	* @exception SignatureException on signature handling errors.
	*/
	@:overload public function verify() : java.NativeArray<sun.security.pkcs.SignerInfo>;
	...
	*         for the content type.
	*/
	@:overload public function getDigestAlgorithmIds() : java.NativeArray<sun.security.x509.AlgorithmId>;
	
	/**
	* Returns the content information specified in this PKCS7 block.
	*/
	@:overload public function getContentInfo() : sun.security.pkcs.ContentInfo;
	...
	*/
	@:overload public function getCertificates() : java.NativeArray<java.security.cert.X509Certificate>;
	...
	*/
	@:overload public function getCRLs() : java.NativeArray<java.security.cert.X509CRL>;
	...
	*         for the content type.
	*/
	@:overload public function getSignerInfos() : java.NativeArray<sun.security.pkcs.SignerInfo>;
	...
	*/
	@:overload public function getCertificate(serial : java.math.BigInteger, issuerName : sun.security.x509.X500Name) : java.security.cert.X509Certificate;
	...
	* otherwise.
	*/
	@:overload public function isOldStyle() : Bool;
