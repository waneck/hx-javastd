...
@:native('sun$security$rsa$RSASignature$MD2withRSA') extern class RSASignature_MD2withRSA extends RSASignature
{
	@:overload public function new() : Void;
	
	
}
@:native('sun$security$rsa$RSASignature$MD5withRSA') extern class RSASignature_MD5withRSA extends RSASignature
{
	@:overload public function new() : Void;
	
	
}
@:native('sun$security$rsa$RSASignature$SHA1withRSA') extern class RSASignature_SHA1withRSA extends RSASignature
{
	@:overload public function new() : Void;
	
	
}
@:native('sun$security$rsa$RSASignature$SHA256withRSA') extern class RSASignature_SHA256withRSA extends RSASignature
{
	@:overload public function new() : Void;
	
	
}
@:native('sun$security$rsa$RSASignature$SHA384withRSA') extern class RSASignature_SHA384withRSA extends RSASignature
{
	@:overload public function new() : Void;
	
	
}
@:native('sun$security$rsa$RSASignature$SHA512withRSA') extern class RSASignature_SHA512withRSA extends RSASignature
{
	@:overload public function new() : Void;
