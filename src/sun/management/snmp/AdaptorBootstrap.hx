...
extern class AdaptorBootstrap
{
	...
	*
	**/
	@:overload @:synchronized public static function initialize() : AdaptorBootstrap;
	
	/**
	* Initializes and starts the SNMP Adaptor Server.
	**/
	@:overload @:synchronized public static function initialize(portStr : java.lang.String.String, props : java.util.Properties.Properties) : AdaptorBootstrap;
...
**/
@:native('sun$management$snmp$AdaptorBootstrap$DefaultValues') extern interface AdaptorBootstrap_DefaultValues
{
...
**/
@:native('sun$management$snmp$AdaptorBootstrap$PropertyNames') extern interface AdaptorBootstrap_PropertyNames
{
