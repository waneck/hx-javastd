...
*/
extern interface JvmThreadingMBean
{
	/**
	...
	*/
	@:overload public function getJvmThreadPeakCountReset() : java.lang.Long.Long;
	
	/**
	* Setter for the "JvmThreadPeakCountReset" variable.
	*/
	@:overload public function setJvmThreadPeakCountReset(x : java.lang.Long.Long) : Void;
