...
*/
extern class JvmOSMeta extends com.sun.jmx.snmp.agent.SnmpMibGroup.SnmpMibGroup implements java.io.Serializable.Serializable implements com.sun.jmx.snmp.agent.SnmpStandardMetaServer.SnmpStandardMetaServer
{
	/**
	...
	*/
	@:overload private function setInstance(_var : sun.management.snmp.jvmmib.JvmOSMBean.JvmOSMBean) : Void;
	...
	*/
	...
	private var node : sun.management.snmp.jvmmib.JvmOSMBean.JvmOSMBean;
