...
*/
extern class JvmMemManagerEntryMeta extends com.sun.jmx.snmp.agent.SnmpMibEntry.SnmpMibEntry implements java.io.Serializable.Serializable implements com.sun.jmx.snmp.agent.SnmpStandardMetaServer.SnmpStandardMetaServer
{
	/**
	...
	*/
	@:overload private function setInstance(_var : sun.management.snmp.jvmmib.JvmMemManagerEntryMBean.JvmMemManagerEntryMBean) : Void;
	...
	*/
	...
	private var node : sun.management.snmp.jvmmib.JvmMemManagerEntryMBean.JvmMemManagerEntryMBean;
