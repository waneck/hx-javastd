...
*/
extern class JvmMemMgrPoolRelEntryMeta extends com.sun.jmx.snmp.agent.SnmpMibEntry.SnmpMibEntry implements java.io.Serializable.Serializable implements com.sun.jmx.snmp.agent.SnmpStandardMetaServer.SnmpStandardMetaServer
{
	/**
	...
	*/
	@:overload private function setInstance(_var : sun.management.snmp.jvmmib.JvmMemMgrPoolRelEntryMBean.JvmMemMgrPoolRelEntryMBean) : Void;
	...
	*/
	...
	private var node : sun.management.snmp.jvmmib.JvmMemMgrPoolRelEntryMBean.JvmMemMgrPoolRelEntryMBean;
