...
*/
extern class JvmClassLoadingMeta extends com.sun.jmx.snmp.agent.SnmpMibGroup.SnmpMibGroup implements java.io.Serializable.Serializable implements com.sun.jmx.snmp.agent.SnmpStandardMetaServer.SnmpStandardMetaServer
{
	/**
	...
	*/
	@:overload private function setInstance(_var : sun.management.snmp.jvmmib.JvmClassLoadingMBean.JvmClassLoadingMBean) : Void;
	...
	*/
	...
	private var node : sun.management.snmp.jvmmib.JvmClassLoadingMBean.JvmClassLoadingMBean;
