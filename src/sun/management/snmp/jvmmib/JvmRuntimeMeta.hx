...
*/
extern class JvmRuntimeMeta extends com.sun.jmx.snmp.agent.SnmpMibGroup.SnmpMibGroup implements java.io.Serializable.Serializable implements com.sun.jmx.snmp.agent.SnmpStandardMetaServer.SnmpStandardMetaServer
{
	/**
	...
	*/
	@:overload private function setInstance(_var : sun.management.snmp.jvmmib.JvmRuntimeMBean.JvmRuntimeMBean) : Void;
	...
	*
	**/
	@:overload private function createJvmRTLibraryPathTableMetaNode(tableName : java.lang.String.String, groupName : java.lang.String.String, mib : SnmpMib, server : javax.management.MBeanServer.MBeanServer) : sun.management.snmp.jvmmib.JvmRTLibraryPathTableMeta.JvmRTLibraryPathTableMeta;
	...
	*
	**/
	@:overload private function createJvmRTClassPathTableMetaNode(tableName : java.lang.String.String, groupName : java.lang.String.String, mib : SnmpMib, server : javax.management.MBeanServer.MBeanServer) : sun.management.snmp.jvmmib.JvmRTClassPathTableMeta.JvmRTClassPathTableMeta;
	...
	*
	**/
	@:overload private function createJvmRTBootClassPathTableMetaNode(tableName : java.lang.String.String, groupName : java.lang.String.String, mib : SnmpMib, server : javax.management.MBeanServer.MBeanServer) : sun.management.snmp.jvmmib.JvmRTBootClassPathTableMeta.JvmRTBootClassPathTableMeta;
	...
	*
	**/
	@:overload private function createJvmRTInputArgsTableMetaNode(tableName : java.lang.String.String, groupName : java.lang.String.String, mib : SnmpMib, server : javax.management.MBeanServer.MBeanServer) : sun.management.snmp.jvmmib.JvmRTInputArgsTableMeta.JvmRTInputArgsTableMeta;
	
	private var node : sun.management.snmp.jvmmib.JvmRuntimeMBean.JvmRuntimeMBean;
	
	private var objectserver : com.sun.jmx.snmp.agent.SnmpStandardObjectServer.SnmpStandardObjectServer;
	
	private var tableJvmRTLibraryPathTable : sun.management.snmp.jvmmib.JvmRTLibraryPathTableMeta.JvmRTLibraryPathTableMeta;
	
	private var tableJvmRTClassPathTable : sun.management.snmp.jvmmib.JvmRTClassPathTableMeta.JvmRTClassPathTableMeta;
	
	private var tableJvmRTBootClassPathTable : sun.management.snmp.jvmmib.JvmRTBootClassPathTableMeta.JvmRTBootClassPathTableMeta;
	
	private var tableJvmRTInputArgsTable : sun.management.snmp.jvmmib.JvmRTInputArgsTableMeta.JvmRTInputArgsTableMeta;
