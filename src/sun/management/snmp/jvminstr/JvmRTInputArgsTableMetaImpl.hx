...
*/
extern class JvmRTInputArgsTableMetaImpl extends sun.management.snmp.jvmmib.JvmRTInputArgsTableMeta.JvmRTInputArgsTableMeta
{
	/**
...
* JvmRTInputArgsTable.
**/
@:native('sun$management$snmp$jvminstr$JvmRTInputArgsTableMetaImpl$JvmRTInputArgsTableCache') @:internal extern class JvmRTInputArgsTableMetaImpl_JvmRTInputArgsTableCache extends sun.management.snmp.util.SnmpTableCache.SnmpTableCache
{
	/**
