...
*/
extern class JvmRTLibraryPathTableMetaImpl extends sun.management.snmp.jvmmib.JvmRTLibraryPathTableMeta.JvmRTLibraryPathTableMeta
{
	/**
...
**/
@:native('sun$management$snmp$jvminstr$JvmRTLibraryPathTableMetaImpl$JvmRTLibraryPathTableCache') @:internal extern class JvmRTLibraryPathTableMetaImpl_JvmRTLibraryPathTableCache extends sun.management.snmp.util.SnmpTableCache.SnmpTableCache
{
	/**
