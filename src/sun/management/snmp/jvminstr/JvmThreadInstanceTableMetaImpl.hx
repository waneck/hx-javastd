...
*/
extern class JvmThreadInstanceTableMetaImpl extends sun.management.snmp.jvmmib.JvmThreadInstanceTableMeta.JvmThreadInstanceTableMeta
{
	/**
	...
	*
	**/
	public static var MAX_STACK_TRACE_DEPTH(default, null) : Int;
...
**/
@:native('sun$management$snmp$jvminstr$JvmThreadInstanceTableMetaImpl$JvmThreadInstanceTableCache') @:internal extern class JvmThreadInstanceTableMetaImpl_JvmThreadInstanceTableCache extends sun.management.snmp.util.SnmpTableCache.SnmpTableCache
{
	/**
