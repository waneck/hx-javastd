...
*/
extern class JvmRTBootClassPathTableMetaImpl extends sun.management.snmp.jvmmib.JvmRTBootClassPathTableMeta.JvmRTBootClassPathTableMeta
{
	/**
...
**/
@:native('sun$management$snmp$jvminstr$JvmRTBootClassPathTableMetaImpl$JvmRTBootClassPathTableCache') @:internal extern class JvmRTBootClassPathTableMetaImpl_JvmRTBootClassPathTableCache extends sun.management.snmp.util.SnmpTableCache.SnmpTableCache
{
	/**
