...
**/
extern class SnmpTableCache implements java.io.Serializable.Serializable
{
	/**
	* Interval of time in ms during which the cached table data
	* is considered valid.
	**/
	private var validity : haxe.Int64;
	
	/**
	* A weak refernce holding cached table data.
	**/
	@:transient private var datas : java.lang.ref.WeakReference.WeakReference<sun.management.snmp.util.SnmpCachedData.SnmpCachedData>;
	
	/**
	* true if the given cached table data is obsolete.
	**/
	@:overload private function isObsolete(cached : sun.management.snmp.util.SnmpCachedData.SnmpCachedData) : Bool;
	...
	**/
	@:overload private function getCachedDatas() : sun.management.snmp.util.SnmpCachedData.SnmpCachedData;
	...
	**/
	@:overload @:synchronized private function getTableDatas(context : java.lang.Object.Object) : sun.management.snmp.util.SnmpCachedData.SnmpCachedData;
	...
	**/
	@:overload @:abstract private function updateCachedDatas(context : java.lang.Object.Object) : sun.management.snmp.util.SnmpCachedData.SnmpCachedData;
	...
	**/
	@:overload @:abstract public function getTableHandler() : sun.management.snmp.util.SnmpTableHandler.SnmpTableHandler;
