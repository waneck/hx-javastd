...
* questions.
*/
extern class JvmContextFactory implements com.sun.jmx.snmp.agent.SnmpUserDataFactory.SnmpUserDataFactory
{
	/**
	...
	* @since Java DMK 5.0
	**/
	@:require(java0) @:overload public function allocateUserData(requestPdu : com.sun.jmx.snmp.SnmpPdu.SnmpPdu) : java.lang.Object.Object;
	...
	* @since Java DMK 5.0
	**/
	@:require(java0) @:overload public function releaseUserData(userData : java.lang.Object.Object, responsePdu : com.sun.jmx.snmp.SnmpPdu.SnmpPdu) : Void;
	
	@:overload public static function getUserData() : java.util.Map.Map<java.lang.Object.Object, java.lang.Object.Object>;
