...
extern class LazyCompositeData implements javax.management.openmbean.CompositeData implements java.io.Serializable
{
	...
	*/
	@:overload @:protected @:abstract private function getCompositeData() : javax.management.openmbean.CompositeData;
	...
	* are the same.
	*/
	@:overload @:protected @:static private static function isTypeMatched(type1 : javax.management.openmbean.CompositeType, type2 : javax.management.openmbean.CompositeType) : Bool;
	
	@:overload @:protected @:static private static function isTypeMatched(type1 : javax.management.openmbean.TabularType, type2 : javax.management.openmbean.TabularType) : Bool;
