...
extern class ClassDefinition implements sun.tools.java.Constants
{
	...
	*/
	...
	@:protected private var localName : sun.tools.java.Identifier;
	
	@:protected private var declaration : sun.tools.java.ClassDeclaration;
	
	@:protected private var superClassId : sun.tools.java.IdentifierToken;
	
	@:protected private var interfaceIds : java.NativeArray<sun.tools.java.IdentifierToken>;
	
	@:protected private var superClass : sun.tools.java.ClassDeclaration;
	
	@:protected private var interfaces : java.NativeArray<sun.tools.java.ClassDeclaration>;
	
	@:protected private var outerClass : sun.tools.java.ClassDefinition;
	
	@:protected private var outerMember : sun.tools.java.MemberDefinition;
	
	@:protected private var innerClassMember : sun.tools.java.MemberDefinition;
	
	@:protected private var firstMember : sun.tools.java.MemberDefinition;
	
	@:protected private var lastMember : sun.tools.java.MemberDefinition;
	
	@:protected private var resolved : Bool;
	
	@:protected private var documentation : String;
	
	@:protected private var error : Bool;
	
	@:protected private var nestError : Bool;
	
	@:protected private var references : sun.tools.tree.UplevelReference;
	
	@:protected private var referencesFrozen : Bool;
	
	@:protected private var classContext : sun.tools.tree.Context;
	
	@:overload @:public public function getClassContext() : sun.tools.tree.Context;
	
	/**
	* Constructor
	*/
	@:overload @:protected private function new(source : Dynamic, where : haxe.Int64, declaration : sun.tools.java.ClassDeclaration, modifiers : Int, superClass : sun.tools.java.IdentifierToken, interfaces : java.NativeArray<sun.tools.java.IdentifierToken>) : Void;
	...
	*/
	@:overload @:public @:final public function getError() : Bool;
	
	/**
	* Mark this class to be erroneous.
	*/
	@:overload @:public @:final public function setError() : Void;
	
	/**
	* Check if there were any errors in our class nest.
	*/
	@:overload @:public @:final public function getNestError() : Bool;
	
	/**
	* Mark this class, and all siblings in its class nest, to be
	* erroneous.
	*/
	@:overload @:public @:final public function setNestError() : Void;
	...
	*/
	...
	@:protected private var supersCheckStarted : Bool;
	
	/**
	* Get the class' super class
	*/
	@:overload @:public @:final public function getSuperClass() : sun.tools.java.ClassDeclaration;
	...
	*/
	@:overload @:public public function getSuperClass(env : sun.tools.java.Environment) : sun.tools.java.ClassDeclaration;
	
	/**
	* Get the class' interfaces
	*/
	@:overload @:public @:final public function getInterfaces() : java.NativeArray<sun.tools.java.ClassDeclaration>;
	
	/**
	* Get the class' enclosing class (or null if not inner)
	*/
	@:overload @:public @:final public function getOuterClass() : sun.tools.java.ClassDefinition;
	
	/**
	* Set the class' enclosing class.  Must be done at most once.
	*/
	@:overload @:protected @:final private function setOuterClass(outerClass : sun.tools.java.ClassDefinition) : Void;
	
	/**
	* Set the class' enclosing current instance pointer.
	* Must be done at most once.
	*/
	@:overload @:protected @:final private function setOuterMember(outerMember : sun.tools.java.MemberDefinition) : Void;
	...
	* its file.
	*/
	@:overload @:public @:final public function isInsideLocalOrAnonymous() : Bool;
	
	/**
	* Return a simple identifier for this class (idNull if anonymous).
	*/
	@:overload @:public public function getLocalName() : sun.tools.java.Identifier;
	
	/**
	* Set the local name of a class.  Must be a local class.
	*/
	@:overload @:public public function setLocalName(name : sun.tools.java.Identifier) : Void;
	
	/**
	* If inner, get the field for this class in the enclosing class
	*/
	@:overload @:public @:final public function getInnerClassMember() : sun.tools.java.MemberDefinition;
	
	/**
	* If inner, return an innermost uplevel self pointer, if any exists.
	* Otherwise, return null.
	*/
	@:overload @:public @:final public function findOuterMember() : sun.tools.java.MemberDefinition;
	...
	*/
	@:overload @:public @:final public function getFirstMember() : sun.tools.java.MemberDefinition;
	
	@:overload @:public @:final public function getFirstMatch(name : sun.tools.java.Identifier) : sun.tools.java.MemberDefinition;
	...
	*/
	@:overload @:public @:static public static function containsDeprecated(documentation : String) : Bool;
	
	@:overload @:public @:final public function inSamePackage(c : sun.tools.java.ClassDeclaration) : Bool;
	
	@:overload @:public @:final public function inSamePackage(c : sun.tools.java.ClassDefinition) : Bool;
	
	@:overload @:public @:final public function inSamePackage(packageName : sun.tools.java.Identifier) : Bool;
	...
	*/
	...
	@:overload @:public @:final public function hasConstructor() : Bool;
	
	/**
	* Check to see if a class must be abstract.  This method replaces
	* isAbstract(env)
	*/
	@:overload @:public @:final public function mustBeAbstract(env : sun.tools.java.Environment) : Bool;
	
	/**
	* Check if this is a super class of another class
	*/
	@:overload @:public public function superClassOf(env : sun.tools.java.Environment, otherClass : sun.tools.java.ClassDeclaration) : Bool;
	
	/**
	* Check if this is an enclosing class of another class
	*/
	@:overload @:public public function enclosingClassOf(otherClass : sun.tools.java.ClassDefinition) : Bool;
	
	/**
	* Check if this is a sub class of another class
	*/
	@:overload @:public public function subClassOf(env : sun.tools.java.Environment, otherClass : sun.tools.java.ClassDeclaration) : Bool;
	
	/**
	* Check if this class is implemented by another class
	*/
	@:overload @:public public function implementedBy(env : sun.tools.java.Environment, c : sun.tools.java.ClassDeclaration) : Bool;
	...
	* basicCheck()'ed.
	*/
	@:overload @:public public function couldImplement(intDef : sun.tools.java.ClassDefinition) : Bool;
	
	/**
	* Check if another class can be accessed from the 'extends' or 'implements'
	* clause of this class.
	*/
	@:overload @:public public function extendsCanAccess(env : sun.tools.java.Environment, c : sun.tools.java.ClassDeclaration) : Bool;
	
	/**
	* Check if another class can be accessed from within the body of this class.
	*/
	@:overload @:public public function canAccess(env : sun.tools.java.Environment, c : sun.tools.java.ClassDeclaration) : Bool;
	
	/**
	* Check if a field can be accessed from a class
	*/
	@:overload @:public public function canAccess(env : sun.tools.java.Environment, f : sun.tools.java.MemberDefinition) : Bool;
	
	/**
	* Check if a class is entitled to inline access to a class from
	* another class.
	*/
	@:overload @:public public function permitInlinedAccess(env : sun.tools.java.Environment, c : sun.tools.java.ClassDeclaration) : Bool;
	
	/**
	* Check if a class is entitled to inline access to a method from
	* another class.
	*/
	@:overload @:public public function permitInlinedAccess(env : sun.tools.java.Environment, f : sun.tools.java.MemberDefinition) : Bool;
	...
	*/
	@:overload @:public public function protectedAccess(env : sun.tools.java.Environment, f : sun.tools.java.MemberDefinition, accessorType : sun.tools.java.Type) : Bool;
	
	/**
	* Find or create an access method for a private member,
	* or return null if this is not possible.
	*/
	@:overload @:public public function getAccessMember(env : sun.tools.java.Environment, ctx : sun.tools.tree.Context, field : sun.tools.java.MemberDefinition, isSuper : Bool) : sun.tools.java.MemberDefinition;
	
	/**
	* Find or create an update method for a private member,
	* or return null if this is not possible.
	*/
	@:overload @:public public function getUpdateMember(env : sun.tools.java.Environment, ctx : sun.tools.tree.Context, field : sun.tools.java.MemberDefinition, isSuper : Bool) : sun.tools.java.MemberDefinition;
	...
	*/
	@:overload @:public public function getVariable(env : sun.tools.java.Environment, nm : sun.tools.java.Identifier, source : sun.tools.java.ClassDefinition) : sun.tools.java.MemberDefinition;
	...
	*/
	@:overload @:public public function noteUsedBy(ref : sun.tools.java.ClassDefinition, where : haxe.Int64, env : sun.tools.java.Environment) : Void;
	...
	* @see resolveName
	*/
	@:overload @:public public function getInnerClass(env : sun.tools.java.Environment, nm : sun.tools.java.Identifier) : sun.tools.java.MemberDefinition;
	...
	*/
	@:overload @:public public function matchMethod(env : sun.tools.java.Environment, accessor : sun.tools.java.ClassDefinition, methodName : sun.tools.java.Identifier, argumentTypes : java.NativeArray<sun.tools.java.Type>) : sun.tools.java.MemberDefinition;
	...
	* This mechanism cannot be used to lookup synthetic methods.
	*/
	@:overload @:public public function matchMethod(env : sun.tools.java.Environment, accessor : sun.tools.java.ClassDefinition, methodName : sun.tools.java.Identifier) : sun.tools.java.MemberDefinition;
	...
	* parameter available.
	*/
	@:overload @:public public function matchAnonConstructor(env : sun.tools.java.Environment, accessPackage : sun.tools.java.Identifier, argumentTypes : java.NativeArray<sun.tools.java.Type>) : sun.tools.java.MemberDefinition;
	...
	*/
	@:overload @:public public function findMethod(env : sun.tools.java.Environment, nm : sun.tools.java.Identifier, t : sun.tools.java.Type) : sun.tools.java.MemberDefinition;
	
	@:overload @:protected private function basicCheck(env : sun.tools.java.Environment) : Void;
	...
	*/
	...
	@:overload @:public public function checkLocalClass(env : sun.tools.java.Environment, ctx : sun.tools.tree.Context, vset : sun.tools.tree.Vset, sup : sun.tools.java.ClassDefinition, args : java.NativeArray<sun.tools.tree.Expression>, argTypes : java.NativeArray<sun.tools.java.Type>) : sun.tools.tree.Vset;
	
	/**
	* This method returns an Iterator of all abstract methods
	* in our superclasses which we are unable to implement.
	*/
	@:overload @:protected private function getPermanentlyAbstractMethods() : java.util.Iterator<Dynamic>;
	
	/**
	* A flag used by turnOffInheritanceChecks() to indicate if
	* inheritance checks are on or off.
	*/
	@:protected @:static private static var doInheritanceChecks : Bool;
	...
	* sort of workaround.
	*/
	@:overload @:public @:static public static function turnOffInheritanceChecks() : Void;
	...
	* below.
	*/
	@:overload @:protected private function collectInheritedMethods(env : sun.tools.java.Environment) : Void;
	
	/**
	* Get an Iterator of all methods which could be accessed in an
	* instance of this class.
	*/
	@:overload @:public public function getMethods(env : sun.tools.java.Environment) : java.util.Iterator<Dynamic>;
	...
	*/
	@:overload @:protected private function addMirandaMethods(env : sun.tools.java.Environment, mirandas : java.util.Iterator<Dynamic>) : Void;
	
	@:overload @:public public function inlineLocalClass(env : sun.tools.java.Environment) : Void;
	...
	*/
	@:overload @:public public function resolveName(env : sun.tools.java.Environment, name : sun.tools.java.Identifier) : sun.tools.java.Identifier;
	...
	* @see resolveName
	*/
	@:overload @:public public function resolveInnerClass(env : sun.tools.java.Environment, nm : sun.tools.java.Identifier) : sun.tools.java.Identifier;
	...
	* name exactly.)
	*/
	@:overload @:public public function innerClassExists(nm : sun.tools.java.Identifier) : Bool;
	
	/**
	* Find any method with a given name.
	*/
	@:overload @:public public function findAnyMethod(env : sun.tools.java.Environment, nm : sun.tools.java.Identifier) : sun.tools.java.MemberDefinition;
	...
	* checking.
	*/
	@:overload @:public public function diagnoseMismatch(env : sun.tools.java.Environment, nm : sun.tools.java.Identifier, argTypes : java.NativeArray<sun.tools.java.Type>, start : Int, margTypeResult : java.NativeArray<sun.tools.java.Type>) : Int;
	
	/**
	* Add a field (no checks)
	*/
	@:overload @:public public function addMember(field : sun.tools.java.MemberDefinition) : Void;
	
	/**
	* Add a field (subclasses make checks)
	*/
	@:overload @:public public function addMember(env : sun.tools.java.Environment, field : sun.tools.java.MemberDefinition) : Void;
	
	/**
	* Find or create an uplevel reference for the given target.
	*/
	@:overload @:public public function getReference(target : sun.tools.tree.LocalMember) : sun.tools.tree.UplevelReference;
	
	@:overload @:protected private function addReference(target : sun.tools.tree.LocalMember) : sun.tools.tree.UplevelReference;
	
	/**
	* Return the list of all uplevel references.
	*/
	@:overload @:public public function getReferences() : sun.tools.tree.UplevelReference;
	...
	*/
	@:overload @:public public function getReferencesFrozen() : sun.tools.tree.UplevelReference;
	
	/**
	* assertion check
	*/
	@:overload @:public @:final public function referencesMustNotBeFrozen() : Void;
	
	/**
	* Get helper method for class literal lookup.
	*/
	@:overload @:public public function getClassLiteralLookup(fwhere : haxe.Int64) : sun.tools.java.MemberDefinition;
	
	/**
	* Add a dependency
	*/
	@:overload @:public public function addDependency(c : sun.tools.java.ClassDeclaration) : Void;
	...
	*/
	@:overload @:public public function getLocalClass(name : String) : sun.tools.java.ClassDefinition;
	
	@:overload @:public public function addLocalClass(c : sun.tools.java.ClassDefinition, name : String) : Void;
