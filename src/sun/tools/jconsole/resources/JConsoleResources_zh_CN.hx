...
*/
extern class JConsoleResources_zh_CN extends sun.tools.jconsole.resources.JConsoleResources
{
	/**
	...
	*/
	@:overload override private function getContents0() : java.NativeArray<java.NativeArray<Dynamic>>;
