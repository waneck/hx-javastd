...
extern class SourceMember extends sun.tools.java.MemberDefinition implements sun.tools.java.Constants
{
	...
	*/
	@:overload @:public public function new(where : haxe.Int64, clazz : sun.tools.java.ClassDefinition, doc : String, modifiers : Int, type : sun.tools.java.Type, name : sun.tools.java.Identifier, argNames : java.util.Vector<Dynamic>, exp : java.NativeArray<sun.tools.java.IdentifierToken>, value : sun.tools.tree.Node) : Void;
	
	/**
	* Get outer instance link, or null if none.
	*/
	@:overload @:public public function getOuterThisArg() : sun.tools.tree.LocalMember;
	...
	*/
	@:overload @:public public function new(f : sun.tools.java.MemberDefinition, c : sun.tools.java.ClassDefinition, env : sun.tools.java.Environment) : Void;
	...
	*/
	@:overload @:public public function setExceptions(exp : java.NativeArray<sun.tools.java.ClassDeclaration>) : Void;
	
	/**
	* Resolve types in a field, after parsing.
	* @see ClassDefinition.resolveTypeStructure
	*/
	@:public public var resolved : Bool;
	...
	*/
	@:overload @:public override public function getDefiningClassDeclaration() : sun.tools.java.ClassDeclaration;
	...
	*/
	@:overload @:public override public function check(env : sun.tools.java.Environment, ctx : sun.tools.tree.Context, vset : sun.tools.tree.Vset) : sun.tools.tree.Vset;
	...
	*/
	@:overload @:public override public function getInitialValue() : Dynamic;
	
	/**
	* Generate code
	*/
	@:overload @:public override public function code(env : sun.tools.java.Environment, asm : sun.tools.asm.Assembler) : Void;
	
	@:overload @:public override public function codeInit(env : sun.tools.java.Environment, ctx : sun.tools.tree.Context, asm : sun.tools.asm.Assembler) : Void;
