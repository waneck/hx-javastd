...
* questions.
*/
extern class SynchronizedStatement extends sun.tools.tree.Statement
{
	/**
	* Constructor
	*/
	@:overload @:public public function new(where : haxe.Int64, expr : sun.tools.tree.Expression, body : sun.tools.tree.Statement) : Void;
