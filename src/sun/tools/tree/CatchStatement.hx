...
extern class CatchStatement extends sun.tools.tree.Statement
{
	...
	* Constructor
	*/
	@:overload public function new(where : haxe.Int64, texpr : sun.tools.tree.Expression, id : sun.tools.java.IdentifierToken, body : sun.tools.tree.Statement) : Void;
	
	/** @deprecated */
	@:overload public function new(where : haxe.Int64, texpr : sun.tools.tree.Expression, id : sun.tools.java.Identifier, body : sun.tools.tree.Statement) : Void;
