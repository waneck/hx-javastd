...
* questions.
*/
extern class AssignOpExpression extends sun.tools.tree.BinaryAssignExpression
{
	/**
	...
	*/
	@:protected private var itype : sun.tools.java.Type;
	
	@:protected private var updater : sun.tools.tree.FieldUpdater;
