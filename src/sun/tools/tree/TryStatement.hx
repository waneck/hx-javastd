...
* questions.
*/
extern class TryStatement extends sun.tools.tree.Statement
{
	/**
	* Constructor
	*/
	@:overload @:public public function new(where : haxe.Int64, body : sun.tools.tree.Statement, args : java.NativeArray<sun.tools.tree.Statement>) : Void;
