...
* questions.
*/
extern class DeclarationStatement extends sun.tools.tree.Statement
{
	/**
	* Constructor
	*/
	@:overload @:public public function new(where : haxe.Int64, mod : Int, type : sun.tools.tree.Expression, args : java.NativeArray<sun.tools.tree.Statement>) : Void;
