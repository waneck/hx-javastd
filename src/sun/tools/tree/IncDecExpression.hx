...
* questions.
*/
extern class IncDecExpression extends sun.tools.tree.UnaryExpression
{
	/**
	* Constructor
	*/
	@:overload @:public public function new(op : Int, where : haxe.Int64, right : sun.tools.tree.Expression) : Void;
