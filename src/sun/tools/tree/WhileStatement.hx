...
* questions.
*/
extern class WhileStatement extends sun.tools.tree.Statement
{
	/**
	* Constructor
	*/
	@:overload @:public public function new(where : haxe.Int64, cond : sun.tools.tree.Expression, body : sun.tools.tree.Statement) : Void;
