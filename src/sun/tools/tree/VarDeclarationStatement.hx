...
* questions.
*/
extern class VarDeclarationStatement extends sun.tools.tree.Statement
{
	/**
	* Constructor
	*/
	...
	@:overload @:public public function new(where : haxe.Int64, field : sun.tools.tree.LocalMember, expr : sun.tools.tree.Expression) : Void;
