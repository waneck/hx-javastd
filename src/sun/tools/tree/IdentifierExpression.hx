...
extern class IdentifierExpression extends sun.tools.tree.Expression
{
	...
	*/
	...
	@:overload @:public public function new(id : sun.tools.java.IdentifierToken) : Void;
	
	@:overload @:public public function new(where : haxe.Int64, field : sun.tools.java.MemberDefinition) : Void;
	...
	*/
	@:overload @:public override public function equals(id : sun.tools.java.Identifier) : Bool;
