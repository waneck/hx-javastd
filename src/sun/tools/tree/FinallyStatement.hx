...
* questions.
*/
extern class FinallyStatement extends sun.tools.tree.Statement
{
	/**
	* Constructor
	*/
	@:overload @:public public function new(where : haxe.Int64, body : sun.tools.tree.Statement, finalbody : sun.tools.tree.Statement) : Void;
