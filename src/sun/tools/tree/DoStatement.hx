...
* questions.
*/
extern class DoStatement extends sun.tools.tree.Statement
{
	/**
	* Constructor
	*/
	@:overload @:public public function new(where : haxe.Int64, body : sun.tools.tree.Statement, cond : sun.tools.tree.Expression) : Void;
