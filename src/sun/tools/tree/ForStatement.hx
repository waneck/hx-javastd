...
extern class ForStatement extends sun.tools.tree.Statement
{
	...
	* Constructor
	*/
	@:overload public function new(where : haxe.Int64, init : sun.tools.tree.Statement, cond : sun.tools.tree.Expression, inc : sun.tools.tree.Expression, body : sun.tools.tree.Statement) : Void;
