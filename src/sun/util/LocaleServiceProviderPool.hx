...
extern class LocaleServiceProviderPool
{
	...
	*/
	@:overload public static function getPool(providerClass : Class<java.util.spi.LocaleServiceProvider>) : LocaleServiceProviderPool;
	...
	*/
	@:overload public function getLocalizedObject<P, S>(getter : LocaleServiceProviderPool_LocalizedObjectGetter<P, S>, locale : java.util.Locale, params : java.NativeArray<Dynamic>) : S;
	...
	* @return provider's instance, or null.
	*/
	@:overload public function getLocalizedObject<P, S>(getter : LocaleServiceProviderPool_LocalizedObjectGetter<P, S>, locale : java.util.Locale, bundle : sun.util.resources.OpenListResourceBundle, key : String, params : java.NativeArray<Dynamic>) : S;
	...
	* @return provider's instance, or null.
	*/
	@:overload public function getLocalizedObject<P, S>(getter : LocaleServiceProviderPool_LocalizedObjectGetter<P, S>, locale : java.util.Locale, bundleKey : String, bundle : sun.util.resources.OpenListResourceBundle, key : String, params : java.NativeArray<Dynamic>) : S;
...
{
	@:overload override public function getAvailableLocales() : java.NativeArray<java.util.Locale>;
