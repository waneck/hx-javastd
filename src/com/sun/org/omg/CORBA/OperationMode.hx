...
extern class OperationMode implements org.omg.CORBA.portable.IDLEntity
{
	...
	public static var OP_NORMAL(default, null) : OperationMode;
	
	public static var _OP_ONEWAY(default, null) : Int;
	
	public static var OP_ONEWAY(default, null) : OperationMode;
	
	@:overload public function value() : Int;
	
	@:overload public static function from_int(value : Int) : OperationMode;
