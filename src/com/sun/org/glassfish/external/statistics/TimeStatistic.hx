...
*/
extern interface TimeStatistic extends com.sun.org.glassfish.external.statistics.Statistic
{
	/**
	...
	*/
	@:overload public function getTotalTime() : haxe.Int64;
