...
* questions.
*/
extern interface Stats
{
	/**
	* Get a Statistic by name.
	*/
	@:overload public function getStatistic(statisticName : String) : com.sun.org.glassfish.external.statistics.Statistic;
	...
	*/
	@:overload public function getStatisticNames() : java.NativeArray<String>;
	
	/**
	* Returns an array containing all of the Statistic objects supported by this Stats object.
	*/
	@:overload public function getStatistics() : java.NativeArray<com.sun.org.glassfish.external.statistics.Statistic>;
