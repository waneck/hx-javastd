...
{
	@:protected private var _parent : com.sun.org.apache.xalan.internal.xsltc.compiler.SyntaxTreeNode;
	
	@:protected private var _qname : com.sun.org.apache.xalan.internal.xsltc.compiler.QName;
	
	@:protected private var _attributes : org.xml.sax.helpers.AttributesImpl;
	
	@:protected @:static @:final private static var Dummy(default, null) : com.sun.org.apache.xalan.internal.xsltc.compiler.SyntaxTreeNode;
	
	@:protected @:static @:final private static var IndentIncrement(default, null) : Int;
	...
	*/
	@:overload @:public public function new(line : Int) : Void;
	...
	*/
	@:overload @:public public function new(uri : String, prefix : String, local : String) : Void;
	
	/**
	* Set the source file line number for this element
	* @param line The source file line number.
	*/
	@:overload @:protected @:final private function setLineNumber(line : Int) : Void;
	...
	*/
	@:overload @:protected private function setQName(qname : com.sun.org.apache.xalan.internal.xsltc.compiler.QName) : Void;
	...
	* @param local The element's local name
	*/
	@:overload @:protected private function setQName(uri : String, prefix : String, localname : String) : Void;
	
	/**
	* Set the QName for the SyntaxTreeNode
	* @param qname The QName for the syntax tree node
	*/
	@:overload @:protected private function getQName() : com.sun.org.apache.xalan.internal.xsltc.compiler.QName;
	...
	*/
	@:overload @:protected private function setAttributes(attributes : org.xml.sax.helpers.AttributesImpl) : Void;
	...
	*/
	@:overload @:protected private function getAttribute(qname : String) : String;
	
	@:overload @:protected private function getAttribute(prefix : String, localName : String) : String;
	
	@:overload @:protected private function hasAttribute(qname : String) : Bool;
	
	@:overload @:protected private function addAttribute(qname : String, value : String) : Void;
	...
	*/
	@:overload @:protected private function getAttributes() : org.xml.sax.Attributes;
	...
	*/
	@:overload @:protected private function setPrefixMapping(mapping : java.util.Hashtable<Dynamic, Dynamic>) : Void;
	...
	*/
	@:overload @:protected private function getPrefixMapping() : java.util.Hashtable<Dynamic, Dynamic>;
	...
	*/
	@:overload @:protected private function addPrefixMapping(prefix : String, uri : String) : Void;
	...
	*/
	@:overload @:protected private function lookupNamespace(prefix : String) : String;
	...
	*/
	@:overload @:protected private function lookupPrefix(uri : String) : String;
	...
	*/
	@:overload @:protected private function setParser(parser : com.sun.org.apache.xalan.internal.xsltc.compiler.Parser) : Void;
	...
	*/
	@:overload @:protected private function setParent(parent : com.sun.org.apache.xalan.internal.xsltc.compiler.SyntaxTreeNode) : Void;
	
	/**
	* Returns this syntax tree node's parent node.
	* @return The parent syntax tree node.
	*/
	@:overload @:protected @:final private function getParent() : com.sun.org.apache.xalan.internal.xsltc.compiler.SyntaxTreeNode;
	
	/**
	* Returns 'true' if this syntax tree node is the Sentinal node.
	* @return 'true' if this syntax tree node is the Sentinal node.
	*/
	@:overload @:protected @:final private function isDummy() : Bool;
	...
	*/
	@:overload @:protected private function getImportPrecedence() : Int;
	...
	*/
	@:overload @:protected private function getTemplate() : com.sun.org.apache.xalan.internal.xsltc.compiler.Template;
	
	/**
	* Returns a reference to the XSLTC (XSLT compiler) in use.
	* @return XSLTC - XSLT compiler.
	*/
	@:overload @:protected @:final private function getXSLTC() : com.sun.org.apache.xalan.internal.xsltc.compiler.XSLTC;
	
	/**
	* Returns the XSLT parser's symbol table.
	* @return Symbol table.
	*/
	@:overload @:protected @:final private function getSymbolTable() : com.sun.org.apache.xalan.internal.xsltc.compiler.SymbolTable;
	...
	*/
	@:overload @:public public function parseContents(parser : com.sun.org.apache.xalan.internal.xsltc.compiler.Parser) : Void;
	...
	* @param parser reference to the XSLT parser
	*/
	@:overload @:protected @:final private function parseChildren(parser : com.sun.org.apache.xalan.internal.xsltc.compiler.Parser) : Void;
	...
	*/
	@:overload @:protected private function updateScope(parser : com.sun.org.apache.xalan.internal.xsltc.compiler.Parser, node : com.sun.org.apache.xalan.internal.xsltc.compiler.SyntaxTreeNode) : com.sun.org.apache.xalan.internal.xsltc.compiler.QName;
	...
	*/
	@:overload @:public @:abstract public function typeCheck(stable : com.sun.org.apache.xalan.internal.xsltc.compiler.SymbolTable) : com.sun.org.apache.xalan.internal.xsltc.compiler.util.Type;
	
	/**
	* Call typeCheck() on all child syntax tree nodes.
	* @param stable The compiler/parser's symbol table
	*/
	@:overload @:protected private function typeCheckContents(stable : com.sun.org.apache.xalan.internal.xsltc.compiler.SymbolTable) : com.sun.org.apache.xalan.internal.xsltc.compiler.util.Type;
	...
	*/
	@:overload @:public @:abstract public function translate(classGen : com.sun.org.apache.xalan.internal.xsltc.compiler.util.ClassGenerator, methodGen : com.sun.org.apache.xalan.internal.xsltc.compiler.util.MethodGenerator) : Void;
	...
	* @param methodGen BCEL Java method generator
	*/
	@:overload @:protected private function translateContents(classGen : com.sun.org.apache.xalan.internal.xsltc.compiler.util.ClassGenerator, methodGen : com.sun.org.apache.xalan.internal.xsltc.compiler.util.MethodGenerator) : Void;
	...
	* @param methodGen BCEL Java method generator
	*/
	@:overload @:protected private function compileResultTree(classGen : com.sun.org.apache.xalan.internal.xsltc.compiler.util.ClassGenerator, methodGen : com.sun.org.apache.xalan.internal.xsltc.compiler.util.MethodGenerator) : Void;
	...
	*/
	@:overload @:protected private function contextDependent() : Bool;
	...
	*/
	@:overload @:protected private function dependentContents() : Bool;
	
	/**
	* Adds a child node to this syntax tree node.
	* @param element is the new child node.
	*/
	@:overload @:protected @:final private function addElement(element : com.sun.org.apache.xalan.internal.xsltc.compiler.SyntaxTreeNode) : Void;
	...
	* @param element is the new child node.
	*/
	@:overload @:protected @:final private function setFirstElement(element : com.sun.org.apache.xalan.internal.xsltc.compiler.SyntaxTreeNode) : Void;
	
	/**
	* Removed a child node of this syntax tree node.
	* @param element is the child node to remove.
	*/
	@:overload @:protected @:final private function removeElement(element : com.sun.org.apache.xalan.internal.xsltc.compiler.SyntaxTreeNode) : Void;
	
	/**
	* Returns a Vector containing all the child nodes of this node.
	* @return A Vector containing all the child nodes of this node.
	*/
	@:overload @:protected @:final private function getContents() : java.util.Vector<Dynamic>;
	
	/**
	* Tells you if this node has any child nodes.
	* @return 'true' if this node has any children.
	*/
	@:overload @:protected @:final private function hasContents() : Bool;
	
	/**
	* Returns the number of children this node has.
	* @return Number of child nodes.
	*/
	@:overload @:protected @:final private function elementCount() : Int;
	
	/**
	* Returns an Enumeration of all child nodes of this node.
	* @return An Enumeration of all child nodes of this node.
	*/
	@:overload @:protected @:final private function elements() : java.util.Enumeration<Dynamic>;
	...
	*/
	@:overload @:protected @:final private function elementAt(pos : Int) : Dynamic;
	
	/**
	* Returns this element's last child
	* @return The child node.
	*/
	@:overload @:protected @:final private function lastChild() : com.sun.org.apache.xalan.internal.xsltc.compiler.SyntaxTreeNode;
	...
	*/
	@:overload @:public public function display(indent : Int) : Void;
	...
	* @param indent Indentation level for syntax tree levels.
	*/
	@:overload @:protected private function displayContents(indent : Int) : Void;
	
	/**
	* Set the indentation level for debug output.
	* @param indent Indentation level for syntax tree levels.
	*/
	@:overload @:protected @:final private function indent(indent : Int) : Void;
	...
	*/
	@:overload @:protected private function reportError(element : com.sun.org.apache.xalan.internal.xsltc.compiler.SyntaxTreeNode, parser : com.sun.org.apache.xalan.internal.xsltc.compiler.Parser, errorCode : String, message : String) : Void;
	...
	* @param message Any additional error message.
	*/
	@:overload @:protected private function reportWarning(element : com.sun.org.apache.xalan.internal.xsltc.compiler.SyntaxTreeNode, parser : com.sun.org.apache.xalan.internal.xsltc.compiler.Parser, errorCode : String, message : String) : Void;
