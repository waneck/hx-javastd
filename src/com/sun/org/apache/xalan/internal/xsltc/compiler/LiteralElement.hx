...
@:internal extern class LiteralElement extends com.sun.org.apache.xalan.internal.xsltc.compiler.Instruction
{
	...
	*/
	@:overload @:public public function registerNamespace(prefix : String, uri : String, stable : com.sun.org.apache.xalan.internal.xsltc.compiler.SymbolTable, declared : Bool) : Void;
	
	/**
	* Add an attribute to this element
	*/
	@:overload @:public public function addAttribute(attribute : com.sun.org.apache.xalan.internal.xsltc.compiler.SyntaxTreeNode) : Void;
	
	/**
	* Set the first attribute of this element
	*/
	@:overload @:public public function setFirstAttribute(attribute : com.sun.org.apache.xalan.internal.xsltc.compiler.SyntaxTreeNode) : Void;
	...
	*/
	@:overload @:public public function getNamespaceScope(node : com.sun.org.apache.xalan.internal.xsltc.compiler.SyntaxTreeNode) : java.util.Enumeration<Dynamic>;
	...
	* valid HTML element.
	*/
	@:overload @:public public function getElemDesc() : com.sun.org.apache.xml.internal.serializer.ElemDesc;
	
	/**
	* Return true if all attributes of this LRE have unique names.
	*/
	@:overload @:public public function allAttributesUnique() : Bool;
