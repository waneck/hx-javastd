...
*/
@:internal extern class ContainsCall extends com.sun.org.apache.xalan.internal.xsltc.compiler.FunctionCall
{
	/**
	...
	*/
	@:overload @:public public function isBoolean() : Bool;
