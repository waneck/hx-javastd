...
{
	@:overload @:public public function new(source : com.sun.org.apache.xml.internal.dtm.DTMAxisIterator, filter : com.sun.org.apache.xml.internal.dtm.DTMFilter) : Void;
