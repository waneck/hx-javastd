...
*/
@:internal extern class UnaryOpExpr extends com.sun.org.apache.xalan.internal.xsltc.compiler.Expression
{
	@:overload @:public public function new(left : com.sun.org.apache.xalan.internal.xsltc.compiler.Expression) : Void;
