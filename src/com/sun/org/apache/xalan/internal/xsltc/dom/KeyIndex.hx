...
{
	@:overload @:public public function new(dummy : Int) : Void;
	...
	*/
	@:overload @:public public function add(value : Dynamic, node : Int, rootNode : Int) : Void;
	
	/**
	* Merge the current value's nodeset set by lookupKey() with _nodes.
	* @deprecated
	*/
	@:overload @:public public function merge(other : com.sun.org.apache.xalan.internal.xsltc.dom.KeyIndex) : Void;
	...
	* @deprecated
	*/
	@:overload @:public public function lookupId(value : Dynamic) : Void;
	...
	*/
	@:overload @:public public function getDOMNodeById(id : String) : com.sun.org.apache.xalan.internal.xsltc.util.IntegerArray;
	...
	* @deprecated
	*/
	@:overload @:public public function lookupKey(value : Dynamic) : Void;
	...
	*/
	@:overload @:public public function containsID(node : Int, value : Dynamic) : Int;
	...
	*         <code>0</code>, otherwise
	*/
	@:overload @:public public function containsKey(node : Int, value : Dynamic) : Int;
	...
	* @deprecated
	*/
	@:overload @:public override public function setStartNode(start : Int) : com.sun.org.apache.xml.internal.dtm.DTMAxisIterator;
	...
	*/
	...
	@:overload @:public public function setDom(dom : com.sun.org.apache.xalan.internal.xsltc.DOM, node : Int) : Void;
	...
	*                 <code>id</code>
	*/
	@:overload @:public public function getKeyIndexIterator(keyValue : Dynamic, isKeyCall : Bool) : com.sun.org.apache.xalan.internal.xsltc.dom.KeyIndex.KeyIndex_KeyIndexIterator;
	...
	*                 <code>id</code>
	*/
	@:overload @:public public function getKeyIndexIterator(keyValue : String, isKeyCall : Bool) : com.sun.org.apache.xalan.internal.xsltc.dom.KeyIndex.KeyIndex_KeyIndexIterator;
	...
	*                 <code>id</code>
	*/
	@:overload @:public public function getKeyIndexIterator(keyValue : com.sun.org.apache.xml.internal.dtm.DTMAxisIterator, isKeyCall : Bool) : com.sun.org.apache.xalan.internal.xsltc.dom.KeyIndex.KeyIndex_KeyIndexIterator;
...
@:native('com$sun$org$apache$xalan$internal$xsltc$dom$KeyIndex$KeyIndexIterator') extern class KeyIndex_KeyIndexIterator extends com.sun.org.apache.xalan.internal.xsltc.dom.MultiValuedNodeHeapIterator
{
	...
	*/
	@:overload @:protected private function lookupNodes(root : Int, keyValue : String) : com.sun.org.apache.xalan.internal.xsltc.util.IntegerArray;
