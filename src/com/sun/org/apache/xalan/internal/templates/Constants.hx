...
extern class Constants extends com.sun.org.apache.xml.internal.utils.Constants
{
	...
	*/
	@:public @:static @:final public static var ELEMNAME_UNDEFINED(default, null) : Int;
	
	/**
	* Literals for XSL element names.  Note that there are more
	* names than IDs, because some names map to the same ID.
	*/
	@:public @:static @:final public static var ELEMNAME_ANCHOR_STRING(default, null) : String;
	
	/**
	* Literals for EXSLT function elements.
	*/
	@:public @:static @:final public static var EXSLT_ELEMNAME_FUNCTION_STRING(default, null) : String;
	
	@:public @:static @:final public static var EXSLT_ELEMNAME_FUNCTION(default, null) : Int;
	
	/**
	* Literals for XSL attribute names.  Note that there may be more
	* names than IDs, because some names may map to the same ID.
	*/
	@:public @:static @:final public static var ATTRNAME_AMOUNT(default, null) : String;
	...
	* ALPHABETICAL ORDER!
	*/
	@:public @:static @:final public static var TATTRNAME_OUTPUT_METHOD(default, null) : Int;
	...
	* </ul>
	* */
	@:public @:static @:final public static var ATTRVAL_OUTPUT_METHOD_HTML(default, null) : String;
	
	/* For space-att*/
	@:public @:static @:final public static var ATTRVAL_PRESERVE(default, null) : Int;
	
	/** For indent-result          */
	@:public @:static @:final public static var ATTRVAL_YES(default, null) : Bool;
	
	/** For letter-value attribute (part of conversion attributes).          */
	@:public @:static @:final public static var ATTRVAL_ALPHABETIC(default, null) : String;
	
	/** For level attribute in xsl:number.          */
	@:public @:static @:final public static var ATTRVAL_SINGLE(default, null) : String;
	
	/** For Stylesheet-prefix and result-prefix in xsl:namespace-alias          */
	@:public @:static @:final public static var ATTRVAL_DEFAULT_PREFIX(default, null) : String;
	
	/** Integer equivalents for above        */
	@:public @:static @:final public static var NUMBERLETTER_ALPHABETIC(default, null) : Int;
	
	/** Integer equivelents for above        */
	@:public @:static @:final public static var NUMBERLEVEL_SINGLE(default, null) : Int;
	
	/** some stuff for my patterns-by-example         */
	@:public @:static @:final public static var ATTRVAL_THIS(default, null) : String;
	
	/** Stuff for sorting      */
	@:public @:static @:final public static var ATTRVAL_DATATYPE_TEXT(default, null) : String;
	
	/** Integer equivelents for DATATYPE attribute */
	@:public @:static @:final public static var SORTDATATYPE_TEXT(default, null) : Int;
	
	/** Integer equivelents for ORDER attribute */
	@:public @:static @:final public static var SORTORDER_ASCENDING(default, null) : Int;
	
	/** Integer equivelents for CASE-ORDER attribute */
	@:public @:static @:final public static var SORTCASEORDER_UPPERFIRST(default, null) : Int;
	
	/** some stuff for Decimal-format       */
	@:public @:static @:final public static var ATTRVAL_INFINITY(default, null) : String;
	
	/** temp dummy         */
	@:public @:static @:final public static var ATTRNAME_XXXX(default, null) : String;
