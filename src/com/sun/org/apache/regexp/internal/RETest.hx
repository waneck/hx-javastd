...
extern class RETest
{
	...
	*/
	@:overload public static function test(args : java.NativeArray<String>) : Bool;
	...
	*/
	...
	@:overload public function assertEquals(message : String, expected : String, actual : String) : Void;
	
	@:overload public function assertEquals(message : String, expected : Int, actual : Int) : Void;
...
@:internal extern class RETestCase
{
	...
	@:overload public function assertEquals(log : java.lang.StringBuffer, message : String, expected : String, actual : String) : Bool;
	
	@:overload public function assertEquals(log : java.lang.StringBuffer, message : String, expected : Int, actual : Int) : Bool;
