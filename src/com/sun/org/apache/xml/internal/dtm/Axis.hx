...
extern class Axis
{
	...
	*/
	public static var ANCESTOR(default, null) : Int;
	...
	*  root node.
	*/
	public static var ANCESTORORSELF(default, null) : Int;
	...
	*/
	...
	public static var CHILD(default, null) : Int;
	...
	*/
	public static var DESCENDANT(default, null) : Int;
	
	/**
	* The descendant-or-self axis contains the context node and the
	*  descendants of the context node.
	*/
	public static var DESCENDANTORSELF(default, null) : Int;
	...
	*/
	public static var FOLLOWING(default, null) : Int;
	...
	*/
	public static var FOLLOWINGSIBLING(default, null) : Int;
	...
	*/
	public static var NAMESPACEDECLS(default, null) : Int;
	...
	*  if there is one.
	*/
	public static var PARENT(default, null) : Int;
	...
	*/
	public static var PRECEDING(default, null) : Int;
	...
	*/
	public static var PRECEDINGSIBLING(default, null) : Int;
	
	/** The self axis contains just the context node itself. */
	public static var SELF(default, null) : Int;
	
	/**
	* A non-xpath axis, traversing the subtree including the subtree
	*  root, descendants, attributes, and namespace node decls.
	*/
	public static var ALLFROMNODE(default, null) : Int;
	...
	*/
	public static var PRECEDINGANDANCESTOR(default, null) : Int;
	...
	*/
	public static var DESCENDANTSFROMROOT(default, null) : Int;
	
	/**
	* A non-xpath axis, returns all nodes that aren't namespaces or attributes,
	* from and including the root.
	*/
	public static var DESCENDANTSORSELFFROMROOT(default, null) : Int;
	
	/**
	* A non-xpath axis, returns root only.
	*/
	public static var ROOT(default, null) : Int;
	
	/**
	* A non-xpath axis, for functions.
	*/
	public static var FILTEREDLIST(default, null) : Int;
	
	@:overload public static function isReverse(axis : Int) : Bool;
	
	@:overload public static function getNames(index : Int) : String;
	
	@:overload public static function getNamesLength() : Int;
