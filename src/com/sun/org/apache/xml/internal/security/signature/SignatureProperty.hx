...
extern class SignatureProperty extends com.sun.org.apache.xml.internal.security.utils.SignatureElementProxy
{
	...
	*/
	@:overload @:public public function new(doc : org.w3c.dom.Document, Target : String) : Void;
	...
	*/
	@:overload @:public public function new(doc : org.w3c.dom.Document, Target : String, Id : String) : Void;
