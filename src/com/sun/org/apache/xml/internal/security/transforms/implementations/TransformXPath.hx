...
@:native('com$sun$org$apache$xml$internal$security$transforms$implementations$TransformXPath$XPathNodeFilter') @:internal extern class TransformXPath_XPathNodeFilter implements com.sun.org.apache.xml.internal.security.signature.NodeFilter
{
	/**
