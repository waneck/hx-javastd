...
extern class QName implements java.io.Serializable
{
	...
	* @serial
	*/
	@:protected private var _prefix : String;
	...
	*/
	@:overload @:public public function new(namespaceURI : String, localName : String) : Void;
	...
	*/
	@:overload @:public public function new(namespaceURI : String, localName : String, validate : Bool) : Void;
	...
	*
	*/
	@:overload @:public public function new(namespaceURI : String, prefix : String, localName : String) : Void;
	...
	*                 be thrown if it is invalid.
	*/
	@:overload @:public public function new(namespaceURI : String, prefix : String, localName : String, validate : Bool) : Void;
	...
	*
	*/
	@:overload @:public public function new(localName : String) : Void;
	...
	*                 be thrown if it is invalid.
	*/
	@:overload @:public public function new(localName : String, validate : Bool) : Void;
	...
	*/
	@:overload @:public public function new(qname : String, namespaces : java.util.Stack<Dynamic>) : Void;
	...
	*                 be thrown if it is invalid.
	*/
	@:overload @:public public function new(qname : String, namespaces : java.util.Stack<Dynamic>, validate : Bool) : Void;
	...
	*/
	@:overload @:public public function new(qname : String, namespaceContext : org.w3c.dom.Element, resolver : com.sun.org.apache.xml.internal.utils.PrefixResolver) : Void;
	...
	*                 be thrown if it is invalid.
	*/
	@:overload @:public public function new(qname : String, namespaceContext : org.w3c.dom.Element, resolver : com.sun.org.apache.xml.internal.utils.PrefixResolver, validate : Bool) : Void;
	...
	* @param resolver Prefix resolver for this context
	*/
	@:overload @:public public function new(qname : String, resolver : com.sun.org.apache.xml.internal.utils.PrefixResolver) : Void;
	...
	*                 be thrown if it is invalid.
	*/
	@:overload @:public public function new(qname : String, resolver : com.sun.org.apache.xml.internal.utils.PrefixResolver, validate : Bool) : Void;
	...
	* @return the string representation of the namespace
	*/
	@:overload @:public public function toNamespacedString() : String;
	...
	*/
	@:overload @:public public function equals(ns : String, localPart : String) : Bool;
	...
	*/
	@:overload @:public @:static public static function getQNameFromString(name : String) : com.sun.org.apache.xml.internal.utils.QName;
	...
	*/
	@:overload @:public @:static public static function isXMLNSDecl(attRawName : String) : Bool;
	...
	*/
	@:overload @:public @:static public static function getPrefixFromXMLNSDecl(attRawName : String) : String;
	...
	*/
	@:native('getLocalPart') @:overload @:public @:static public static function _getLocalPart(qname : String) : String;
	...
	*/
	@:overload @:public @:static public static function getPrefixPart(qname : String) : String;
