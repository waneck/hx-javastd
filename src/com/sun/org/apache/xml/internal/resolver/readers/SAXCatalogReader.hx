...
extern class SAXCatalogReader implements com.sun.org.apache.xml.internal.resolver.readers.CatalogReader implements org.xml.sax.ContentHandler implements org.xml.sax.DocumentHandler
{
	...
	private var parserFactory : javax.xml.parsers.SAXParserFactory;
	
	/** The SAX Parser Class */
	private var parserClass : String;
	...
	*/
	@:overload public function setParserFactory(parserFactory : javax.xml.parsers.SAXParserFactory) : Void;
	
	/** Set the XML SAX Parser Class
	*/
	@:overload public function setParserClass(parserClass : String) : Void;
	
	/** Get the parser factory currently in use. */
	@:overload public function getParserFactory() : javax.xml.parsers.SAXParserFactory;
	
	/** Get the parser class currently in use. */
	@:overload public function getParserClass() : String;
	...
	*/
	private var debug : com.sun.org.apache.xml.internal.resolver.helpers.Debug;
	...
	/** The constructor */
	@:overload public function new(parserClass : String) : Void;
