...
extern class DOMNormalizer implements com.sun.org.apache.xerces.internal.xni.XMLDocumentHandler
{
	...
	@:protected @:final @:static private static var DEBUG_ND(default, null) : Bool;
	...
	@:protected @:final @:static private static var DEBUG_EVENTS(default, null) : Bool;
	...
	@:protected private var fConfiguration : com.sun.org.apache.xerces.internal.dom.DOMConfigurationImpl;
	
	@:protected private var fDocument : com.sun.org.apache.xerces.internal.dom.CoreDocumentImpl;
	
	@:protected @:final private var fAttrProxy(default, null) : com.sun.org.apache.xerces.internal.dom.DOMNormalizer.DOMNormalizer_XMLAttributesProxy;
	
	@:protected @:final private var fQName(default, null) : com.sun.org.apache.xerces.internal.xni.QName;
	
	/** Validation handler represents validator instance. */
	@:protected private var fValidationHandler : com.sun.org.apache.xerces.internal.impl.RevalidationHandler;
	
	/** symbol table */
	@:protected private var fSymbolTable : com.sun.org.apache.xerces.internal.util.SymbolTable;
	
	/** error handler. may be null. */
	@:protected private var fErrorHandler : org.w3c.dom.DOMErrorHandler;
	
	@:protected private var fNamespaceValidation : Bool;
	
	@:protected private var fPSVI : Bool;
	
	/** The namespace context of this document: stores namespaces in scope */
	@:protected @:final private var fNamespaceContext(default, null) : com.sun.org.apache.xerces.internal.xni.NamespaceContext;
	
	/** Stores all namespace bindings on the current element */
	@:protected @:final private var fLocalNSBinder(default, null) : com.sun.org.apache.xerces.internal.xni.NamespaceContext;
	
	/** list of attributes */
	@:protected @:final private var fAttributeList(default, null) : java.util.ArrayList<Dynamic>;
	
	/** DOM Locator -  for namespace fixup algorithm */
	@:protected @:final private var fLocator(default, null) : com.sun.org.apache.xerces.internal.dom.DOMLocatorImpl;
	...
	*/
	@:public @:static @:final public static var abort(default, null) : java.lang.RuntimeException;
	...
	*/
	@:overload @:protected private function normalizeDocument(document : com.sun.org.apache.xerces.internal.dom.CoreDocumentImpl, config : com.sun.org.apache.xerces.internal.dom.DOMConfigurationImpl) : Void;
	...
	*/
	@:overload @:protected private function normalizeNode(node : org.w3c.dom.Node) : org.w3c.dom.Node;
	
	@:overload @:protected @:final private function expandEntityRef(parent : org.w3c.dom.Node, reference : org.w3c.dom.Node) : Void;
	
	@:overload @:protected @:final private function namespaceFixUp(element : com.sun.org.apache.xerces.internal.dom.ElementImpl, attributes : com.sun.org.apache.xerces.internal.dom.AttributeMap) : Void;
	...
	*/
	@:overload @:protected @:final private function addNamespaceDecl(prefix : String, uri : String, element : com.sun.org.apache.xerces.internal.dom.ElementImpl) : Void;
	...
	*/
	@:overload @:public @:static @:final public static function isCDataWF(errorHandler : org.w3c.dom.DOMErrorHandler, error : com.sun.org.apache.xerces.internal.dom.DOMErrorImpl, locator : com.sun.org.apache.xerces.internal.dom.DOMLocatorImpl, datavalue : String, isXML11Version : Bool) : Void;
	...
	* @param isXML11Version = true if XML 1.1
	*/
	@:overload @:public @:static @:final public static function isXMLCharWF(errorHandler : org.w3c.dom.DOMErrorHandler, error : com.sun.org.apache.xerces.internal.dom.DOMErrorImpl, locator : com.sun.org.apache.xerces.internal.dom.DOMLocatorImpl, datavalue : String, isXML11Version : Bool) : Void;
	...
	* @param isXML11Version = true if XML 1.1
	*/
	@:overload @:public @:static @:final public static function isCommentWF(errorHandler : org.w3c.dom.DOMErrorHandler, error : com.sun.org.apache.xerces.internal.dom.DOMErrorImpl, locator : com.sun.org.apache.xerces.internal.dom.DOMLocatorImpl, datavalue : String, isXML11Version : Bool) : Void;
	...
	* @param value
	*/
	@:overload @:public @:static @:final public static function isAttrValueWF(errorHandler : org.w3c.dom.DOMErrorHandler, error : com.sun.org.apache.xerces.internal.dom.DOMErrorImpl, locator : com.sun.org.apache.xerces.internal.dom.DOMLocatorImpl, attributes : org.w3c.dom.NamedNodeMap, a : org.w3c.dom.Attr, value : String, xml11Version : Bool) : Void;
	...
	*/
	@:overload @:public @:static @:final public static function reportDOMError(errorHandler : org.w3c.dom.DOMErrorHandler, error : com.sun.org.apache.xerces.internal.dom.DOMErrorImpl, locator : com.sun.org.apache.xerces.internal.dom.DOMLocatorImpl, message : String, severity : java.StdTypes.Int16, type : String) : Void;
	
	@:overload @:protected @:final private function updateQName(node : org.w3c.dom.Node, qname : com.sun.org.apache.xerces.internal.xni.QName) : Void;
...
{
	@:protected private var fAttributes : com.sun.org.apache.xerces.internal.dom.AttributeMap;
	
	@:protected private var fDocument : com.sun.org.apache.xerces.internal.dom.CoreDocumentImpl;
	
	@:protected private var fElement : com.sun.org.apache.xerces.internal.dom.ElementImpl;
	
	@:protected @:final private var fAugmentations(default, null) : java.util.Vector<Dynamic>;
	
	@:overload @:public public function setAttributes(attributes : com.sun.org.apache.xerces.internal.dom.AttributeMap, doc : com.sun.org.apache.xerces.internal.dom.CoreDocumentImpl, elem : com.sun.org.apache.xerces.internal.dom.ElementImpl) : Void;
	...
	*/
	@:overload @:public public function addAttribute(qname : com.sun.org.apache.xerces.internal.xni.QName, attrType : String, attrValue : String) : Int;
