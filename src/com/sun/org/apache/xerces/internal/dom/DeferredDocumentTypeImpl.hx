...
*/
extern class DeferredDocumentTypeImpl extends com.sun.org.apache.xerces.internal.dom.DocumentTypeImpl implements com.sun.org.apache.xerces.internal.dom.DeferredNode
{
	/** Node index. */
