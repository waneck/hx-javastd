...
{
	/** Document type. */
	@:protected private var docType : com.sun.org.apache.xerces.internal.dom.DocumentTypeImpl;
	
	/** Document element. */
	@:protected private var docElement : com.sun.org.apache.xerces.internal.dom.ElementImpl;
	...
	@:protected private var standalone : Bool;
	
	/**Experimental DOM Level 3 feature: documentURI */
	@:protected private var fDocumentURI : String;
	
	/** Table for user data attached to this document nodes. */
	@:protected private var userData : java.util.Hashtable<Dynamic, Dynamic>;
	
	/** Identifiers. */
	@:protected private var identifiers : java.util.Hashtable<Dynamic, Dynamic>;
	
	/** Allow grammar access. */
	@:protected private var allowGrammarAccess : Bool;
	
	/** Bypass error checking. */
	@:protected private var errorChecking : Bool;
	
	/** Ancestor checking */
	@:protected private var ancestorChecking : Bool;
	
	@:protected private var xmlVersionChanged : Bool;
	...
	*/
	...
	@:overload @:final @:public override public function getOwnerDocument() : org.w3c.dom.Document;
	...
	**/
	@:overload @:protected private function cloneNode(newdoc : com.sun.org.apache.xerces.internal.dom.CoreDocumentImpl, deep : Bool) : Void;
	...
	* </ul>
	*/
	@:overload @:public public function setErrorChecking(check : Bool) : Void;
	
	/*
	* DOM Level 3 WD - Experimental.
	*/
	@:overload @:public public function setStrictErrorChecking(check : Bool) : Void;
	
	/**
	* Returns true if the DOM implementation performs error checking.
	*/
	@:overload @:public public function getErrorChecking() : Bool;
	...
	* defined in .
	*/
	@:overload @:public public function setInputEncoding(value : String) : Void;
	...
	*/
	@:overload @:public public function setEncoding(value : String) : Void;
	...
	* should never call this method.
	*/
	@:overload @:public public function setVersion(value : String) : Void;
	...
	* @since DOM Level 3
	*/
	@:overload @:public public function setXmlStandalone(value : Bool) : Void;
	...
	* should never call this method.
	*/
	@:overload @:public public function setStandalone(value : Bool) : Void;
	...
	* need to check with Mozilla and IE.
	*/
	@:overload @:public public function setAsync(async : Bool) : Void;
	...
	*/
	@:overload @:public public function load(uri : String) : Bool;
	...
	*/
	@:overload @:public public function loadXML(source : String) : Bool;
	...
	*/
	@:overload @:public public function saveXML(node : org.w3c.dom.Node) : String;
	...
	* implemented.)
	*/
	@:overload @:public public function createEntity(name : String) : org.w3c.dom.Entity;
	...
	* implemented.)
	*/
	@:overload @:public public function createNotation(name : String) : org.w3c.dom.Notation;
	
	/**
	* NON-DOM Factory method: creates an element definition. Element
	* definitions hold default attribute values.
	*/
	@:overload @:public public function createElementDefinition(name : String) : com.sun.org.apache.xerces.internal.dom.ElementDefinitionImpl;
	...
	*/
	@:overload @:protected private function getNodeNumber(node : org.w3c.dom.Node) : Int;
	...
	*/
	@:overload @:public public function importNode(source : org.w3c.dom.Node, deep : Bool) : org.w3c.dom.Node;
	...
	*
	*/
	@:overload @:protected private function undeferChildren(node : org.w3c.dom.Node) : Void;
	...
	*/
	@:overload @:protected @:final private function clearIdentifiers() : Void;
	...
	*/
	@:overload @:public public function putIdentifier(idName : String, element : org.w3c.dom.Element) : Void;
	...
	* @see #removeIdentifier
	*/
	@:overload @:public public function getIdentifier(idName : String) : org.w3c.dom.Element;
	...
	* @see #getIdentifier
	*/
	@:overload @:public public function removeIdentifier(idName : String) : Void;
	
	/** Returns an enumeration registered of identifier names. */
	@:overload @:public public function getIdentifiers() : java.util.Enumeration<Dynamic>;
	...
	*                   name contains an invalid character.
	*/
	@:overload @:public public function createElementNS(namespaceURI : String, qualifiedName : String, localpart : String) : org.w3c.dom.Element;
	...
	* name contains an invalid character.
	*/
	@:overload @:public public function createAttributeNS(namespaceURI : String, qualifiedName : String, localpart : String) : org.w3c.dom.Attr;
	...
	* utility class
	*/
	@:overload @:public @:static @:final public static function isXMLName(s : String, xml11Version : Bool) : Bool;
	...
	*/
	@:overload @:public @:static @:final public static function isValidQName(prefix : String, local : String, xml11Version : Bool) : Bool;
	
	/**
	* Uses the kidOK lookup table to check whether the proposed
	* tree structure is legal.
	*/
	@:overload @:protected private function isKidOK(parent : org.w3c.dom.Node, child : org.w3c.dom.Node) : Bool;
	
	/**
	* Denotes that this node has changed.
	*/
	@:overload @:protected override private function changed() : Void;
	
	/**
	* Returns the number of changes to this node.
	*/
	@:overload @:protected override private function changes() : Int;
	...
	*/
	@:overload @:public public function setUserData(n : org.w3c.dom.Node, key : String, data : Dynamic, handler : org.w3c.dom.UserDataHandler) : Dynamic;
	...
	* @since DOM Level 3
	*/
	@:overload @:public public function getUserData(n : org.w3c.dom.Node, key : String) : Dynamic;
	
	@:overload @:protected private function getUserDataRecord(n : org.w3c.dom.Node) : java.util.Hashtable<Dynamic, Dynamic>;
	...
	@:overload @:protected @:final private function checkNamespaceWF(qname : String, colon1 : Int, colon2 : Int) : Void;
	
	@:overload @:protected @:final private function checkDOMNSErr(prefix : String, namespace : String) : Void;
	...
	* @param local local part of qualified name
	*/
	@:overload @:protected @:final private function checkQName(prefix : String, local : String) : Void;
	...
	*/
	@:overload @:protected private function setUserData(n : com.sun.org.apache.xerces.internal.dom.NodeImpl, data : Dynamic) : Void;
	
	/**
	* NON-DOM: kept for backward compatibility
	* Retreive user data related to a given node
	*/
	@:overload @:protected private function getUserData(n : com.sun.org.apache.xerces.internal.dom.NodeImpl) : Dynamic;
	
	@:overload @:protected private function addEventListener(node : com.sun.org.apache.xerces.internal.dom.NodeImpl, type : String, listener : org.w3c.dom.events.EventListener, useCapture : Bool) : Void;
	
	@:overload @:protected private function removeEventListener(node : com.sun.org.apache.xerces.internal.dom.NodeImpl, type : String, listener : org.w3c.dom.events.EventListener, useCapture : Bool) : Void;
	
	@:overload @:protected private function copyEventListeners(src : com.sun.org.apache.xerces.internal.dom.NodeImpl, tgt : com.sun.org.apache.xerces.internal.dom.NodeImpl) : Void;
	
	@:overload @:protected private function dispatchEvent(node : com.sun.org.apache.xerces.internal.dom.NodeImpl, event : org.w3c.dom.events.Event) : Bool;
