...
{
	/** Public constructor */
	@:overload @:public public function new(document : com.sun.org.apache.xerces.internal.dom.DocumentImpl, root : org.w3c.dom.Node, whatToShow : Int, nodeFilter : org.w3c.dom.traversal.NodeFilter, entityReferenceExpansion : Bool) : Void;
	...
	*/
	@:overload @:public public function removeNode(node : org.w3c.dom.Node) : Void;
