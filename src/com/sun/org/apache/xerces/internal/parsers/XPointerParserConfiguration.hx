...
*/
extern class XPointerParserConfiguration extends com.sun.org.apache.xerces.internal.parsers.XML11Configuration
{
	...
	@:protected @:static @:final private static var XPOINTER_HANDLER(default, null) : String;
