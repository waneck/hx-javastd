...
@:internal extern class Token implements java.io.Serializable
{
	...
	@:overload @:protected private function addRange(start : Int, end : Int) : Void;
	
	@:overload @:protected private function sortRanges() : Void;
	
	@:overload @:protected private function compactRanges() : Void;
	
	@:overload @:protected private function mergeRanges(tok : com.sun.org.apache.xerces.internal.impl.xpath.regex.Token) : Void;
	
	@:overload @:protected private function subtractRanges(tok : com.sun.org.apache.xerces.internal.impl.xpath.regex.Token) : Void;
	
	@:overload @:protected private function intersectRanges(tok : com.sun.org.apache.xerces.internal.impl.xpath.regex.Token) : Void;
	
	@:overload @:public public function toString() : String;
	
	@:overload @:public public function toString(options : Int) : String;
	
	@:overload @:static @:protected private static function getRange(name : String, positive : Bool) : com.sun.org.apache.xerces.internal.impl.xpath.regex.RangeToken;
	
	@:overload @:static @:protected private static function getRange(name : String, positive : Bool, xs : Bool) : com.sun.org.apache.xerces.internal.impl.xpath.regex.RangeToken;
	
	/**
	* This method is called by only getRange().
	* So this method need not MT-safe.
	*/
	@:overload @:static @:protected private static function registerNonXS(name : String) : Void;
	
	@:overload @:static @:protected private static function isRegisterNonXS(name : String) : Bool;
...
{
	@:overload @:public override public function toString(options : Int) : String;
