...
extern class DateDV extends com.sun.org.apache.xerces.internal.impl.dv.xs.DateTimeDV
{
	...
	*/
	@:overload @:protected override private function parse(str : String) : com.sun.org.apache.xerces.internal.impl.dv.xs.AbstractDateTimeDV.AbstractDateTimeDV_DateTimeData;
