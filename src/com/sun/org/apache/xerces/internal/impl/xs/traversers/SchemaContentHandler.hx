...
@:internal extern class SchemaContentHandler implements org.xml.sax.ContentHandler
{
	...
	*/
	@:overload public function skippedEntity(arg : String) : Void;
	
	@:overload public function reset(schemaDOMParser : com.sun.org.apache.xerces.internal.impl.xs.opti.SchemaDOMParser, symbolTable : com.sun.org.apache.xerces.internal.util.SymbolTable, namespacePrefixes : Bool, stringsInternalized : Bool) : Void;
