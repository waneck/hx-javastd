...
extern class DTDDVFactory
{
	...
	*/
	@:overload @:abstract public function getBuiltInDV(name : String) : com.sun.org.apache.xerces.internal.impl.dv.DatatypeValidator;
	...
	*/
	@:overload @:abstract public function getBuiltInTypes() : java.util.Hashtable<Dynamic, Dynamic>;
