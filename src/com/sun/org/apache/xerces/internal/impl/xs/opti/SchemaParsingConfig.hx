...
extern class SchemaParsingConfig extends com.sun.org.apache.xerces.internal.parsers.BasicParserConfiguration implements com.sun.org.apache.xerces.internal.xni.parser.XMLPullParserConfiguration
{
	...
	*/
	...
	@:protected @:final private var fDatatypeValidatorFactory(default, null) : com.sun.org.apache.xerces.internal.impl.dv.DTDDVFactory;
	
	/** The XML 1.0 Document scanner. */
	@:protected @:final private var fNamespaceScanner(default, null) : com.sun.org.apache.xerces.internal.impl.XMLNSDocumentScannerImpl;
	
	/** The XML 1.0 DTD scanner. */
	@:protected @:final private var fDTDScanner(default, null) : com.sun.org.apache.xerces.internal.impl.XMLDTDScannerImpl;
	...
	@:protected @:final private var fVersionDetector(default, null) : com.sun.org.apache.xerces.internal.impl.XMLVersionDetector;
	
	/** Error reporter. */
	@:protected @:final private var fErrorReporter(default, null) : com.sun.org.apache.xerces.internal.impl.XMLErrorReporter;
	
	/** Entity manager. */
	@:protected @:final private var fEntityManager(default, null) : com.sun.org.apache.xerces.internal.impl.XMLEntityManager;
	
	/** Input Source */
	@:protected private var fInputSource : com.sun.org.apache.xerces.internal.xni.parser.XMLInputSource;
	
	@:protected @:final private var fValidationManager(default, null) : com.sun.org.apache.xerces.internal.impl.validation.ValidationManager;
	...
	*/
	@:overload @:protected @:final private function resetXML10() : Void;
	
	/**
	* Reset all XML 1.1 components before parsing
	*/
	@:overload @:protected @:final private function resetXML11() : Void;
