...
extern class DurationDV extends com.sun.org.apache.xerces.internal.impl.dv.xs.AbstractDateTimeDV
{
	...
	*/
	@:overload private function parse(str : String, durationType : Int) : DateTimeData;
	...
	*/
	@:overload private function compareDates(date1 : DateTimeData, date2 : DateTimeData, strict : Bool) : java.StdTypes.Int16;
