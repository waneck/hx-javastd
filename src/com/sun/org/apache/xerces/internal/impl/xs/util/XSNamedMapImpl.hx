...
extern class XSNamedMapImpl extends java.util.AbstractMap<Dynamic, Dynamic> implements com.sun.org.apache.xerces.internal.xs.XSNamedMap
{
	...
	*/
	@:public @:static @:final public static var EMPTY_MAP(default, null) : com.sun.org.apache.xerces.internal.impl.xs.util.XSNamedMapImpl;
	...
	*/
	@:overload @:public public function new(namespace : String, map : com.sun.org.apache.xerces.internal.util.SymbolHash) : Void;
	...
	*/
	@:overload @:public public function new(namespaces : java.NativeArray<String>, maps : java.NativeArray<com.sun.org.apache.xerces.internal.util.SymbolHash>, num : Int) : Void;
	...
	*/
	@:overload @:public @:synchronized public function item(index : Int) : com.sun.org.apache.xerces.internal.xs.XSObject;
	...
	*/
	...
	@:overload @:public @:synchronized override public function entrySet() : java.util.Set<Dynamic>;
...
{
	@:overload @:public public function new(key : javax.xml.namespace.QName, value : com.sun.org.apache.xerces.internal.xs.XSObject) : Void;
