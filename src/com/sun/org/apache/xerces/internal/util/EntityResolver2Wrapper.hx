...
extern class EntityResolver2Wrapper implements com.sun.org.apache.xerces.internal.impl.ExternalSubsetResolver
{
	...
	private var fEntityResolver : org.xml.sax.ext.EntityResolver2;
	...
	*/
	@:overload public function new(entityResolver : org.xml.sax.ext.EntityResolver2) : Void;
	...
	* @param entityResolver the SAX entity resolver to wrap
	*/
	@:overload public function setEntityResolver(entityResolver : org.xml.sax.ext.EntityResolver2) : Void;
	...
	*/
	@:overload public function getEntityResolver() : org.xml.sax.ext.EntityResolver2;
