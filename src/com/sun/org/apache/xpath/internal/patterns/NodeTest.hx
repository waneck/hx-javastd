...
extern class NodeTest extends com.sun.org.apache.xpath.internal.Expression
{
	...
	*/
	@:public @:static @:final public static var WILD(default, null) : String;
	
	/**
	* The URL to pass to the Node#supports method, to see if the
	* DOM has already been stripped of whitespace nodes.
	*/
	@:public @:static @:final public static var SUPPORTS_PRE_STRIPPING(default, null) : String;
	
	/**
	* This attribute determines which node types are accepted.
	* @serial
	*/
	@:protected private var m_whatToShow : Int;
	...
	*/
	@:public @:static @:final public static var SHOW_BYFUNCTION(default, null) : Int;
	...
	*/
	@:overload @:public public function setWhatToShow(what : Int) : Void;
	...
	*/
	@:overload @:public public function setNamespace(ns : String) : Void;
	
	/**
	* The local name to be tested for.
	*  @serial
	*/
	@:protected private var m_name : String;
	...
	*/
	@:overload @:public public function setLocalName(name : String) : Void;
	
	/**
	* The match score if the pattern consists of just a NodeTest.
	*  @see <a href="http://www.w3.org/TR/xslt#conflict">XSLT Specification - 5.5 Conflict Resolution for Template Rules</a>
	*/
	@:public @:static @:final public static var SCORE_NODETEST(default, null) : com.sun.org.apache.xpath.internal.objects.XNumber;
	
	/**
	* The match score if the pattern pattern has the form NCName:*.
	*  @see <a href="http://www.w3.org/TR/xslt#conflict">XSLT Specification - 5.5 Conflict Resolution for Template Rules</a>
	*/
	@:public @:static @:final public static var SCORE_NSWILD(default, null) : com.sun.org.apache.xpath.internal.objects.XNumber;
	...
	*  @see <a href="http://www.w3.org/TR/xslt#conflict">XSLT Specification - 5.5 Conflict Resolution for Template Rules</a>
	*/
	@:public @:static @:final public static var SCORE_QNAME(default, null) : com.sun.org.apache.xpath.internal.objects.XNumber;
	...
	*  @see <a href="http://www.w3.org/TR/xslt#conflict">XSLT Specification - 5.5 Conflict Resolution for Template Rules</a>
	*/
	@:public @:static @:final public static var SCORE_OTHER(default, null) : com.sun.org.apache.xpath.internal.objects.XNumber;
	
	/**
	* The match score if no match is made.
	*  @see <a href="http://www.w3.org/TR/xslt#conflict">XSLT Specification - 5.5 Conflict Resolution for Template Rules</a>
	*/
	@:public @:static @:final public static var SCORE_NONE(default, null) : com.sun.org.apache.xpath.internal.objects.XNumber;
	...
	*/
	@:overload @:public public function new(whatToShow : Int, namespace : String, name : String) : Void;
	...
	* @param whatToShow Bit set defined mainly by {@link org.w3c.dom.traversal.NodeFilter}.
	*/
	@:overload @:public public function new(whatToShow : Int) : Void;
	...
	* @param whatToShow Bit set defined mainly by {@link org.w3c.dom.traversal.NodeFilter}.
	*/
	@:overload @:public public function initNodeTest(whatToShow : Int) : Void;
	...
	* @param name The local name to be tested.
	*/
	@:overload @:public public function initNodeTest(whatToShow : Int, namespace : String, name : String) : Void;
	
	/**
	* Get the static score for this node test.
	* @return Should be one of the SCORE_XXX constants.
	*/
	@:overload @:public public function getStaticScore() : com.sun.org.apache.xpath.internal.objects.XNumber;
	
	/**
	* Set the static score for this node test.
	* @param score Should be one of the SCORE_XXX constants.
	*/
	@:overload @:public public function setStaticScore(score : com.sun.org.apache.xpath.internal.objects.XNumber) : Void;
	
	/**
	* Static calc of match score.
	*/
	@:overload @:protected private function calcScore() : Void;
	...
	*/
	@:overload @:public public function getDefaultScore() : Float;
	...
	*/
	@:overload @:public @:static public static function getNodeTypeTest(whatToShow : Int) : Int;
	...
	*        {@link com.sun.org.apache.xml.internal.dtm.DTMFilter}.
	*/
	@:overload @:public @:static public static function debugWhatToShow(whatToShow : Int) : Void;
