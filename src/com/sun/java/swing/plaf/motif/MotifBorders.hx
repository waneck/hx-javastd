...
{
	@:overload @:public @:static public static function drawBezel(g : java.awt.Graphics, x : Int, y : Int, w : Int, h : Int, isPressed : Bool, hasFocus : Bool, shadow : java.awt.Color, highlight : java.awt.Color, darkShadow : java.awt.Color, focus : java.awt.Color) : Void;
...
{
	@:overload @:public public function new(control : java.awt.Color, focus : java.awt.Color) : Void;
...
@:native('com$sun$java$swing$plaf$motif$MotifBorders$ButtonBorder') extern class MotifBorders_ButtonBorder extends javax.swing.border.AbstractBorder implements javax.swing.plaf.UIResource
{
	...
	@:overload @:public public function new(shadow : java.awt.Color, highlight : java.awt.Color, darkShadow : java.awt.Color, focus : java.awt.Color) : Void;
...
{
	@:public @:final @:static public static var BORDER_SIZE(default, null) : Int;
	...
	* @see #setComponent
	*/
	@:overload @:public public function component() : javax.swing.JComponent;
	
	@:overload @:protected private function getFrameHighlight() : java.awt.Color;
	
	@:overload @:protected private function getFrameColor() : java.awt.Color;
	
	@:overload @:protected private function getFrameShadow() : java.awt.Color;
	...
	*/
	@:overload @:protected private function drawTopBorder(c : java.awt.Component, g : java.awt.Graphics, x : Int, y : Int, width : Int, height : Int) : Bool;
	
	/** Draws the FrameBorder's left border.
	*/
	@:overload @:protected private function drawLeftBorder(c : java.awt.Component, g : java.awt.Graphics, x : Int, y : Int, width : Int, height : Int) : Bool;
	
	/** Draws the FrameBorder's right border.
	*/
	@:overload @:protected private function drawRightBorder(c : java.awt.Component, g : java.awt.Graphics, x : Int, y : Int, width : Int, height : Int) : Bool;
	
	/** Draws the FrameBorder's bottom border.
	*/
	@:overload @:protected private function drawBottomBorder(c : java.awt.Component, g : java.awt.Graphics, x : Int, y : Int, width : Int, height : Int) : Bool;
	
	@:overload @:protected private function isActiveFrame() : Bool;
...
{
	@:public @:final @:static public static var CORNER_SIZE(default, null) : Int;
	
	/** Constructs an InternalFrameBorder for the InternalFrame
	* <b>aFrame</b>.
	*/
	@:overload @:public public function new(aFrame : javax.swing.JInternalFrame) : Void;
	
	/** Sets the InternalFrameBorder's InternalFrame.
	*/
	@:overload @:public public function setFrame(aFrame : javax.swing.JInternalFrame) : Void;
	
	/** Returns the InternalFrameBorder's InternalFrame.
	* @see #setFrame
	*/
	@:overload @:public public function frame() : javax.swing.JInternalFrame;
	...
	*/
	@:overload @:public public function resizePartWidth() : Int;
	
	/** Draws the InternalFrameBorder's top border.
	*/
	@:overload @:protected override private function drawTopBorder(c : java.awt.Component, g : java.awt.Graphics, x : Int, y : Int, width : Int, height : Int) : Bool;
	
	/** Draws the InternalFrameBorder's left border.
	*/
	@:overload @:protected override private function drawLeftBorder(c : java.awt.Component, g : java.awt.Graphics, x : Int, y : Int, width : Int, height : Int) : Bool;
	
	/** Draws the InternalFrameBorder's right border.
	*/
	@:overload @:protected override private function drawRightBorder(c : java.awt.Component, g : java.awt.Graphics, x : Int, y : Int, width : Int, height : Int) : Bool;
	
	/** Draws the InternalFrameBorder's bottom border.
	*/
	@:overload @:protected override private function drawBottomBorder(c : java.awt.Component, g : java.awt.Graphics, x : Int, y : Int, width : Int, height : Int) : Bool;
	
	@:overload @:protected override private function isActiveFrame() : Bool;
...
@:native('com$sun$java$swing$plaf$motif$MotifBorders$MotifPopupMenuBorder') extern class MotifBorders_MotifPopupMenuBorder extends javax.swing.border.AbstractBorder implements javax.swing.plaf.UIResource
{
	...
	@:protected private var background : java.awt.Color;
	
	@:protected private var foreground : java.awt.Color;
	...
	@:static @:protected @:final private static var GROOVE_HEIGHT(default, null) : Int;
	
	/**
	* Creates a MotifPopupMenuBorder instance
	*
	*/
	@:overload @:public public function new(titleFont : java.awt.Font, bgColor : java.awt.Color, fgColor : java.awt.Color, shadow : java.awt.Color, highlight : java.awt.Color) : Void;
