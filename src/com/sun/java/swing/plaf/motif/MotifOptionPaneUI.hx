...
extern class MotifOptionPaneUI extends javax.swing.plaf.basic.BasicOptionPaneUI
{
	...
	*/
	@:overload override private function createButtonArea() : java.awt.Container;
	
	/**
	* Returns null, CDE/Motif does not impose a minimum size.
	*/
	@:overload override public function getMinimumOptionPaneSize() : java.awt.Dimension;
	...
	*/
	@:overload override private function addIcon(top : java.awt.Container) : Void;
