...
* @since 1.7
*/
@:require(java7) extern class AssociationChangeNotification implements com.sun.nio.sctp.Notification
{
	/**
...
* @since 1.7
*/
@:require(java7) @:native('com$sun$nio$sctp$AssociationChangeNotification$AssocChangeEvent') extern enum AssociationChangeNotification_AssocChangeEvent
{
	/**
