...
* questions.
*/
extern class SctpStandardSocketOptions
{
	/**
...
* @since 1.7
*/
@:require(java7) @:native('com$sun$nio$sctp$SctpStandardSocketOptions$InitMaxStreams') extern class SctpStandardSocketOptions_InitMaxStreams
{
	/**
