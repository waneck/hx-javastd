...
* @since 1.5
*/
@:require(java5) extern interface AnnotationDesc
{
	/**
...
* @since 1.5
*/
@:require(java5) @:native('com$sun$javadoc$AnnotationDesc$ElementValuePair') extern interface AnnotationDesc_ElementValuePair
{
	/**
