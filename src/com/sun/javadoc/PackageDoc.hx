...
*/
@:require(java2) extern interface PackageDoc extends com.sun.javadoc.Doc
{
	/**
	...
	* @since 1.5
	*/
	@:require(java5) @:overload public function enums() : java.NativeArray<com.sun.javadoc.ClassDoc>;
	...
	* @since 1.5
	*/
	@:require(java5) @:overload public function annotationTypes() : java.NativeArray<com.sun.javadoc.AnnotationTypeDoc>;
