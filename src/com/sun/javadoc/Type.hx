...
*/
@:require(java2) extern interface Type
{
	/**
	...
	* @since 1.5
	*/
	@:require(java5) @:overload public function simpleTypeName() : String;
	...
	* @since 1.5
	*/
	@:require(java5) @:overload public function isPrimitive() : Bool;
	...
	* @since 1.5
	*/
	@:require(java5) @:overload public function asParameterizedType() : com.sun.javadoc.ParameterizedType;
	...
	* @since 1.5
	*/
	@:require(java5) @:overload public function asTypeVariable() : com.sun.javadoc.TypeVariable;
	...
	* @since 1.5
	*/
	@:require(java5) @:overload public function asWildcardType() : com.sun.javadoc.WildcardType;
	...
	* @since 1.5
	*/
	@:require(java5) @:overload public function asAnnotationTypeDoc() : com.sun.javadoc.AnnotationTypeDoc;
