...
* @author Robert Field
*/
@:require(java2) extern interface DocErrorReporter
{
	/**
	...
	* @since 1.4
	*/
	@:require(java4) @:overload public function printError(pos : com.sun.javadoc.SourcePosition, msg : String) : Void;
	...
	* @since 1.4
	*/
	@:require(java4) @:overload public function printWarning(pos : com.sun.javadoc.SourcePosition, msg : String) : Void;
	...
	* @since 1.4
	*/
	@:require(java4) @:overload public function printNotice(pos : com.sun.javadoc.SourcePosition, msg : String) : Void;
