...
extern interface Doc extends java.lang.Comparable<Dynamic>
{
	...
	* @since 1.5
	*/
	@:require(java5) @:overload @:public public function isAnnotationTypeElement() : Bool;
	...
	* @since 1.5
	*/
	@:require(java5) @:overload @:public public function isAnnotationType() : Bool;
	...
	* in the result set.
	*/
	@:overload @:public public function isIncluded() : Bool;
	...
	* @since 1.4
	*/
	@:require(java4) @:overload @:public public function position() : com.sun.javadoc.SourcePosition;
