...
extern class JMethod extends com.sun.codemodel.internal.JGenerifiableImpl implements com.sun.codemodel.internal.JDeclaration implements com.sun.codemodel.internal.JAnnotatable implements com.sun.codemodel.internal.JDocCommentable
{
	...
	*/
	@:overload public function params() : java.util.List<com.sun.codemodel.internal.JVar>;
	...
	*/
	@:overload public function param(mods : Int, type : com.sun.codemodel.internal.JType, name : String) : com.sun.codemodel.internal.JVar;
	
	@:overload public function param(type : com.sun.codemodel.internal.JType, name : String) : com.sun.codemodel.internal.JVar;
	
	@:overload public function param(mods : Int, type : Class<Dynamic>, name : String) : com.sun.codemodel.internal.JVar;
	
	@:overload public function param(type : Class<Dynamic>, name : String) : com.sun.codemodel.internal.JVar;
	
	/**
	* @see #varParam(JType, String)
	*/
	@:overload public function varParam(type : Class<Dynamic>, name : String) : com.sun.codemodel.internal.JVar;
	...
	*      method signature.
	*/
	@:overload public function varParam(type : com.sun.codemodel.internal.JType, name : String) : com.sun.codemodel.internal.JVar;
	...
	* for this method signature.
	*/
	@:overload public function hasVarArgs() : Bool;
	...
	*/
	@:overload public function name(n : String) : Void;
	...
	*/
	@:overload public function type(t : com.sun.codemodel.internal.JType) : Void;
	...
	*/
	@:overload public function listParamTypes() : java.NativeArray<com.sun.codemodel.internal.JType>;
	...
	*/
	@:overload public function listVarParamType() : com.sun.codemodel.internal.JType;
	...
	*      If there's no parameter, an empty array will be returned.
	*/
	@:overload public function listParams() : java.NativeArray<com.sun.codemodel.internal.JVar>;
	...
	*/
	@:overload public function listVarParam() : com.sun.codemodel.internal.JVar;
	
	/**
	* Returns true if the method has the specified signature.
	*/
	@:overload public function hasSignature(argTypes : java.NativeArray<com.sun.codemodel.internal.JType>) : Bool;
	...
	*
	*/
	@:overload public function declareDefaultValue(value : com.sun.codemodel.internal.JExpression) : Void;
	...
	*/
	@:overload public function getMods() : com.sun.codemodel.internal.JMods;
	
	@:overload override private function owner() : com.sun.codemodel.internal.JCodeModel;
