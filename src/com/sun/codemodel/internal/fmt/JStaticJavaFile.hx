...
extern class JStaticJavaFile extends com.sun.codemodel.internal.JResourceFile
{
	...
	@:overload public function new(_pkg : com.sun.codemodel.internal.JPackage, _className : String, _source : java.net.URL, _filter : JStaticJavaFile_LineFilter) : Void;
...
*/
@:native('com$sun$codemodel$internal$fmt$JStaticJavaFile$ChainFilter') extern class JStaticJavaFile_ChainFilter implements JStaticJavaFile_LineFilter
{
	@:overload public function new(first : JStaticJavaFile_LineFilter, second : JStaticJavaFile_LineFilter) : Void;
