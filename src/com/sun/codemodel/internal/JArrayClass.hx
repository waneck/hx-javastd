...
* questions.
*/
@:internal extern class JArrayClass extends com.sun.codemodel.internal.JClass
{
	...
	@:overload @:public override public function elementType() : com.sun.codemodel.internal.JType;
