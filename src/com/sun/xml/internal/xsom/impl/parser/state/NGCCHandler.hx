...
extern class NGCCHandler implements com.sun.xml.internal.xsom.impl.parser.state.NGCCEventReceiver
{
	...
	* Event source.
	*/
	private var _source(default, null) : com.sun.xml.internal.xsom.impl.parser.state.NGCCEventSource;
	
	/**
	* This method will be implemented by the generated code
	* and returns a reference to the current runtime.
	*/
	@:overload @:abstract private function getRuntime() : com.sun.xml.internal.xsom.impl.parser.state.NGCCRuntime;
	...
	*/
	...
	@:overload public function spawnChildFromEnterElement(child : com.sun.xml.internal.xsom.impl.parser.state.NGCCEventReceiver, uri : String, localname : String, qname : String, atts : org.xml.sax.Attributes) : Void;
	
	@:overload public function spawnChildFromEnterAttribute(child : com.sun.xml.internal.xsom.impl.parser.state.NGCCEventReceiver, uri : String, localname : String, qname : String) : Void;
	
	@:overload public function spawnChildFromLeaveElement(child : com.sun.xml.internal.xsom.impl.parser.state.NGCCEventReceiver, uri : String, localname : String, qname : String) : Void;
	
	@:overload public function spawnChildFromLeaveAttribute(child : com.sun.xml.internal.xsom.impl.parser.state.NGCCEventReceiver, uri : String, localname : String, qname : String) : Void;
	
	@:overload public function spawnChildFromText(child : com.sun.xml.internal.xsom.impl.parser.state.NGCCEventReceiver, value : String) : Void;
