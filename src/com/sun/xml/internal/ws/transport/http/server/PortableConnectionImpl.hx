...
{
	@:overload @:public public function new(adapter : com.sun.xml.internal.ws.transport.http.HttpAdapter, httpExchange : javax.xml.ws.spi.http.HttpExchange) : Void;
	...
	@:overload @:public public function getServletContext() : Dynamic;
	
	@:overload @:public public function getServletResponse() : Dynamic;
	
	@:overload @:public public function getServletRequest() : Dynamic;
	...
	@:overload @:public public function getExchange() : javax.xml.ws.spi.http.HttpExchange;
