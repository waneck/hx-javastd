...
{
	@:overload public function new(contentId : String, data : java.NativeArray<java.StdTypes.Int8>, start : Int, len : Int, mimeType : String) : Void;
	
	@:overload public function new(contentId : String, data : java.NativeArray<java.StdTypes.Int8>, mimeType : String) : Void;
