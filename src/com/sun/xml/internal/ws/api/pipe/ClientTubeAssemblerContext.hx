...
extern class ClientTubeAssemblerContext
{
	...
	*/
	@:overload @:public public function getService() : com.sun.xml.internal.ws.api.WSService;
	...
	* Nullable incase of backwards compatible usages of this class.
	*/
	@:overload @:public public function getBindingProvider() : com.sun.xml.internal.ws.developer.WSBindingProvider;
	...
	*/
	@:overload @:public public function createClientMUTube(next : com.sun.xml.internal.ws.api.pipe.Tube) : com.sun.xml.internal.ws.api.pipe.Tube;
	...
	*/
	@:overload @:public public function createTransportTube() : com.sun.xml.internal.ws.api.pipe.Tube;
