...
extern class OneWayFeature extends javax.xml.ws.WebServiceFeature
{
	...
	*/
	@:overload @:public public function new(enabled : Bool, replyTo : com.sun.xml.internal.ws.api.addressing.WSEndpointReference) : Void;
	...
	*/
	@:overload @:public public function new(enabled : Bool, replyTo : com.sun.xml.internal.ws.api.addressing.WSEndpointReference, from : com.sun.xml.internal.ws.api.addressing.WSEndpointReference, relatesTo : String) : Void;
	...
	*/
	@:overload @:public public function getReplyTo() : com.sun.xml.internal.ws.api.addressing.WSEndpointReference;
	...
	* @param address
	*/
	@:overload @:public public function setReplyTo(address : com.sun.xml.internal.ws.api.addressing.WSEndpointReference) : Void;
	...
	*/
	@:overload @:public public function setFrom(address : com.sun.xml.internal.ws.api.addressing.WSEndpointReference) : Void;
	...
	*/
	@:overload @:public public function getRelatesToID() : String;
	...
	* @param id
	*/
	@:overload @:public public function setRelatesToID(id : String) : Void;
