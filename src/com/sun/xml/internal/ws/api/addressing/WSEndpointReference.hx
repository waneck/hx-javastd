...
extern class WSEndpointReference implements com.sun.xml.internal.ws.api.model.wsdl.WSDLExtension
{
	...
	*/
	@:overload public function new(epr : javax.xml.ws.EndpointReference, version : com.sun.xml.internal.ws.api.addressing.AddressingVersion) : Void;
	...
	* Do not use this method in a performance critical path.
	*/
	@:overload public function new(epr : javax.xml.ws.EndpointReference) : Void;
	
	/**
	* Creates a {@link WSEndpointReference} that wraps a given infoset.
	*/
	@:overload public function new(infoset : com.sun.xml.internal.stream.buffer.XMLStreamBuffer, version : com.sun.xml.internal.ws.api.addressing.AddressingVersion) : Void;
	
	/**
	* Creates a {@link WSEndpointReference} by parsing an infoset.
	*/
	@:overload public function new(infoset : java.io.InputStream, version : com.sun.xml.internal.ws.api.addressing.AddressingVersion) : Void;
	...
	*/
	@:overload public function new(_in : javax.xml.stream.XMLStreamReader, version : com.sun.xml.internal.ws.api.addressing.AddressingVersion) : Void;
	
	/**
	* @see #WSEndpointReference(String, AddressingVersion)
	*/
	@:overload public function new(address : java.net.URL, version : com.sun.xml.internal.ws.api.addressing.AddressingVersion) : Void;
	
	/**
	* @see #WSEndpointReference(String, AddressingVersion)
	*/
	@:overload public function new(address : java.net.URI, version : com.sun.xml.internal.ws.api.addressing.AddressingVersion) : Void;
	
	/**
	* Creates a {@link WSEndpointReference} that only has an address.
	*/
	@:overload public function new(address : String, version : com.sun.xml.internal.ws.api.addressing.AddressingVersion) : Void;
	...
	*/
	@:overload public function toSpec() : javax.xml.ws.EndpointReference;
	...
	*/
	@:overload public function toSpec<T : javax.xml.ws.EndpointReference>(clazz : Class<T>) : T;
	...
	* headers, etc.
	*/
	@:overload public function getPort<T>(jaxwsService : javax.xml.ws.Service, serviceEndpointInterface : Class<T>, features : java.NativeArray<javax.xml.ws.WebServiceFeature>) : T;
	...
	* headers, etc.
	*/
	@:overload public function createDispatch<T>(jaxwsService : javax.xml.ws.Service, type : Class<T>, mode : javax.xml.ws.Service.Service_Mode, features : java.NativeArray<javax.xml.ws.WebServiceFeature>) : javax.xml.ws.Dispatch<T>;
	...
	* headers, etc.
	*/
	@:overload public function createDispatch(jaxwsService : javax.xml.ws.Service, context : javax.xml.bind.JAXBContext, mode : javax.xml.ws.Service.Service_Mode, features : java.NativeArray<javax.xml.ws.WebServiceFeature>) : javax.xml.ws.Dispatch<Dynamic>;
	
	/**
	* Gets the addressing version of this EPR.
	*/
	@:overload public function getVersion() : com.sun.xml.internal.ws.api.addressing.AddressingVersion;
	...
	*/
	@:overload public function isNone() : Bool;
	...
	*/
	@:overload public function read(localName : String) : javax.xml.stream.XMLStreamReader;
	...
	*      for the root element name.
	*/
	@:overload public function asSource(localName : String) : javax.xml.transform.Source;
	...
	*/
	@:overload public function writeTo(localName : String, contentHandler : org.xml.sax.ContentHandler, errorHandler : org.xml.sax.ErrorHandler, fragment : Bool) : Void;
	...
	*      The returned {@link Source} will use the given local name
	*/
	@:overload public function writeTo(localName : String, w : javax.xml.stream.XMLStreamWriter) : Void;
	...
	*      we can talk.)
	*/
	@:overload public function createHeader(rootTagName : javax.xml.namespace.QName) : com.sun.xml.internal.ws.api.message.Header;
	
	/**
	* Copies all the reference parameters in this EPR as headers
	* to the given {@link HeaderList}.
	*/
	@:overload public function addReferenceParameters(outbound : com.sun.xml.internal.ws.api.message.HeaderList) : Void;
...
{
	@:overload @:abstract public function readAsXMLStreamReader() : javax.xml.stream.XMLStreamReader;
...
@:native('com$sun$xml$internal$ws$api$addressing$WSEndpointReference$Metadata') extern class WSEndpointReference_Metadata
{
	...
	@:overload public function getWsdlSource() : javax.xml.transform.Source;
	
	@:overload public function getWsdliLocation() : String;
