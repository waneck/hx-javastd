...
* questions.
*/
extern interface WSDLFeaturedObject extends com.sun.xml.internal.ws.api.model.wsdl.WSDLObject
{
	/**
	...
	*/
	@:overload public function addFeature(feature : javax.xml.ws.WebServiceFeature) : Void;
