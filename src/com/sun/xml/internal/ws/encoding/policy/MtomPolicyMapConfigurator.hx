...
* questions.
*/
extern class MtomPolicyMapConfigurator implements com.sun.xml.internal.ws.policy.jaxws.spi.PolicyMapConfigurator
{
	/**
...
@:native('com$sun$xml$internal$ws$encoding$policy$MtomPolicyMapConfigurator$MtomAssertion') @:internal extern class MtomPolicyMapConfigurator_MtomAssertion extends com.sun.xml.internal.ws.policy.PolicyAssertion
{
