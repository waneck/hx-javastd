...
extern class WSDLGenerator
{
	...
	*/
	@:overload @:public public function setEndpointAddress(address : String) : Void;
	
	/**
	* Performes the actual WSDL generation
	*/
	@:overload @:public public function doGeneration() : Void;
	
	/**
	* Generates the types section of the WSDL
	*/
	@:overload @:protected private function generateTypes() : Void;
	
	/**
	* Generates the WSDL messages
	*/
	@:overload @:protected private function generateMessages() : Void;
	...
	*/
	@:overload @:protected private function generateSOAPMessages(method : com.sun.xml.internal.ws.model.JavaMethodImpl, binding : com.sun.xml.internal.ws.api.model.soap.SOAPBinding) : Void;
	
	/**
	* Generates the WSDL portType
	*/
	@:overload @:protected private function generatePortType() : Void;
	...
	*/
	@:overload @:protected private function isWrapperStyle(method : com.sun.xml.internal.ws.model.JavaMethodImpl) : Bool;
	...
	*/
	@:overload @:protected private function isRpcLit(method : com.sun.xml.internal.ws.model.JavaMethodImpl) : Bool;
	...
	*/
	@:overload @:protected private function generateParameterOrder(operation : com.sun.xml.internal.ws.wsdl.writer.document.Operation, method : com.sun.xml.internal.ws.model.JavaMethodImpl) : Void;
	...
	* @param method the {@link JavaMethod} to generate the parameterOrder from
	*/
	@:overload @:protected private function generateRpcParameterOrder(operation : com.sun.xml.internal.ws.wsdl.writer.document.Operation, method : com.sun.xml.internal.ws.model.JavaMethodImpl) : Void;
	...
	* @param method the {@link JavaMethod} to generate the parameterOrder from
	*/
	@:overload @:protected private function generateDocumentParameterOrder(operation : com.sun.xml.internal.ws.wsdl.writer.document.Operation, method : com.sun.xml.internal.ws.model.JavaMethodImpl) : Void;
	...
	*/
	@:overload @:protected private function sortMethodParameters(method : com.sun.xml.internal.ws.model.JavaMethodImpl) : java.util.List<com.sun.xml.internal.ws.model.ParameterImpl>;
	...
	*/
	@:overload @:protected private function isBodyParameter(parameter : com.sun.xml.internal.ws.model.ParameterImpl) : Bool;
	
	@:overload @:protected private function isHeaderParameter(parameter : com.sun.xml.internal.ws.model.ParameterImpl) : Bool;
	
	@:overload @:protected private function isAttachmentParameter(parameter : com.sun.xml.internal.ws.model.ParameterImpl) : Bool;
	
	/**
	* Generates the Binding section of the WSDL
	*/
	@:overload @:protected private function generateBinding() : Void;
	
	@:overload @:protected private function generateBindingOperation(method : com.sun.xml.internal.ws.model.JavaMethodImpl, binding : com.sun.xml.internal.ws.wsdl.writer.document.Binding) : Void;
	
	@:overload @:protected private function generateSOAP12BindingOperation(method : com.sun.xml.internal.ws.model.JavaMethodImpl, binding : com.sun.xml.internal.ws.wsdl.writer.document.Binding) : Void;
	
	@:overload @:protected private function splitParameters(bodyParams : java.util.List<com.sun.xml.internal.ws.model.ParameterImpl>, headerParams : java.util.List<com.sun.xml.internal.ws.model.ParameterImpl>, params : java.util.List<com.sun.xml.internal.ws.model.ParameterImpl>) : Void;
	
	@:overload @:protected private function generateSOAPHeaders(writer : com.sun.xml.internal.txw2.TypedXmlWriter, parameters : java.util.List<com.sun.xml.internal.ws.model.ParameterImpl>, message : javax.xml.namespace.QName) : Void;
	
	@:overload @:protected private function generateSOAP12Headers(writer : com.sun.xml.internal.txw2.TypedXmlWriter, parameters : java.util.List<com.sun.xml.internal.ws.model.ParameterImpl>, message : javax.xml.namespace.QName) : Void;
	
	/**
	* Generates the Service section of the WSDL
	*/
	@:overload @:protected private function generateService() : Void;
	
	@:overload @:protected private function generateInputMessage(operation : com.sun.xml.internal.ws.wsdl.writer.document.Operation, method : com.sun.xml.internal.ws.model.JavaMethodImpl) : Void;
	
	@:overload @:protected private function generateOutputMessage(operation : com.sun.xml.internal.ws.wsdl.writer.document.Operation, method : com.sun.xml.internal.ws.model.JavaMethodImpl) : Void;
	...
	*/
	@:overload @:public public function createOutputFile(namespaceUri : String, suggestedFileName : String) : javax.xml.transform.Result;
