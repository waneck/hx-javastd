...
* questions.
*/
extern interface Binding extends com.sun.xml.internal.txw2.TypedXmlWriter extends com.sun.xml.internal.ws.wsdl.writer.document.StartWithExtensionsType
{
	/**
	*
