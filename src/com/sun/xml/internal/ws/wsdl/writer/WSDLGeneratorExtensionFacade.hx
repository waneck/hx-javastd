...
@:internal extern class WSDLGeneratorExtensionFacade extends com.sun.xml.internal.ws.api.wsdl.writer.WSDLGeneratorExtension
{
	...
	@:overload override public function end(ctxt : com.sun.xml.internal.ws.api.wsdl.writer.WSDLGenExtnContext) : Void;
	...
	@:overload override public function addBindingOperationFaultExtension(fault : com.sun.xml.internal.txw2.TypedXmlWriter, method : com.sun.xml.internal.ws.api.model.JavaMethod, ce : com.sun.xml.internal.ws.api.model.CheckedException) : Void;
	
	@:overload override public function addFaultMessageExtension(message : com.sun.xml.internal.txw2.TypedXmlWriter, method : com.sun.xml.internal.ws.api.model.JavaMethod, ce : com.sun.xml.internal.ws.api.model.CheckedException) : Void;
