...
*/
@:internal extern interface PolicyMapKeyHandler
{
	@:overload public function areEqual(locator1 : com.sun.xml.internal.ws.policy.PolicyMapKey, locator2 : com.sun.xml.internal.ws.policy.PolicyMapKey) : Bool;
	
	@:overload public function generateHashCode(locator : com.sun.xml.internal.ws.policy.PolicyMapKey) : Int;
