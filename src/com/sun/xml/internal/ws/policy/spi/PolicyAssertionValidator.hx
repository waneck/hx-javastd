...
* questions.
*/
extern interface PolicyAssertionValidator
{
	/**
...
*/
@:native('com$sun$xml$internal$ws$policy$spi$PolicyAssertionValidator$Fitness') extern enum PolicyAssertionValidator_Fitness
{
	UNKNOWN;
	INVALID;
	UNSUPPORTED;
