...
* questions.
*/
@:internal extern class BuilderHandlerMessageScope extends com.sun.xml.internal.ws.policy.jaxws.BuilderHandler
{
	/**
...
@:native('com$sun$xml$internal$ws$policy$jaxws$BuilderHandlerMessageScope$Scope') extern enum BuilderHandlerMessageScope_Scope
{
	InputMessageScope;
	OutputMessageScope;
	FaultMessageScope;
