...
extern class PolicyWSDLParserExtension extends com.sun.xml.internal.ws.api.wsdl.parser.WSDLParserExtension
{
	...
	*/
	...
	@:overload override public function bindingOperationElements(boundOperation : com.sun.xml.internal.ws.api.model.wsdl.WSDLBoundOperation, reader : javax.xml.stream.XMLStreamReader) : Bool;
	
	@:overload override public function bindingOperationAttributes(boundOperation : com.sun.xml.internal.ws.api.model.wsdl.WSDLBoundOperation, reader : javax.xml.stream.XMLStreamReader) : Void;
