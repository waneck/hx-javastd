...
* questions.
*/
extern class PolicyWSDLParserExtension extends com.sun.xml.internal.ws.api.wsdl.parser.WSDLParserExtension
{
	/**
	...
	*/
	...
	@:overload @:public override public function bindingOperationElements(boundOperation : com.sun.xml.internal.ws.api.model.wsdl.WSDLBoundOperation, reader : javax.xml.stream.XMLStreamReader) : Bool;
	
	@:overload @:public override public function bindingOperationAttributes(boundOperation : com.sun.xml.internal.ws.api.model.wsdl.WSDLBoundOperation, reader : javax.xml.stream.XMLStreamReader) : Void;
...
*/
@:native('com$sun$xml$internal$ws$policy$jaxws$PolicyWSDLParserExtension$HandlerType') extern enum PolicyWSDLParserExtension_HandlerType
{
	PolicyUri;
	AnonymousPolicyId;
...
@:native('com$sun$xml$internal$ws$policy$jaxws$PolicyWSDLParserExtension$PolicyRecordHandler') @:internal extern class PolicyWSDLParserExtension_PolicyRecordHandler
{
