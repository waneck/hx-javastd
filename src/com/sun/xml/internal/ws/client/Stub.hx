...
extern class Stub implements com.sun.xml.internal.ws.developer.WSBindingProvider implements com.sun.xml.internal.ws.client.ResponseContextReceiver
{
	...
	*/
	private var owner(default, null) : com.sun.xml.internal.ws.client.WSServiceDelegate;
	...
	*/
	private var endpointReference : com.sun.xml.internal.ws.api.addressing.WSEndpointReference;
	
	private var binding(default, null) : com.sun.xml.internal.ws.binding.BindingImpl;
	
	private var portInfo(default, null) : com.sun.xml.internal.ws.api.client.WSPortInfo;
	
	/**
	* represents AddressingVersion on binding if enabled, otherwise null;
	*/
	private var addrVersion(default, null) : com.sun.xml.internal.ws.api.addressing.AddressingVersion;
	
	public var requestContext(default, null) : com.sun.xml.internal.ws.client.RequestContext;
	
	private var wsdlPort(default, null) : com.sun.xml.internal.ws.api.model.wsdl.WSDLPort;
	
	private var operationDispatcher : com.sun.xml.internal.ws.wsdl.OperationDispatcher;
	...
	*                               separately as the <tt>defaultEndPointAddress</tt>.
	*/
	@:overload private function new(portInfo : com.sun.xml.internal.ws.api.client.WSPortInfo, binding : com.sun.xml.internal.ws.binding.BindingImpl, defaultEndPointAddress : com.sun.xml.internal.ws.api.EndpointAddress, epr : com.sun.xml.internal.ws.api.addressing.WSEndpointReference) : Void;
	...
	*/
	@:overload @:abstract private function getPortName() : javax.xml.namespace.QName;
	...
	* this stub.
	*/
	@:overload @:final private function getServiceName() : javax.xml.namespace.QName;
	...
	*/
	@:overload @:final public function getExecutor() : java.util.concurrent.Executor;
	...
	*/
	@:overload @:final private function process(packet : com.sun.xml.internal.ws.api.message.Packet, requestContext : com.sun.xml.internal.ws.client.RequestContext, receiver : com.sun.xml.internal.ws.client.ResponseContextReceiver) : com.sun.xml.internal.ws.api.message.Packet;
	...
	*/
	@:overload @:final private function processAsync(request : com.sun.xml.internal.ws.api.message.Packet, requestContext : com.sun.xml.internal.ws.client.RequestContext, completionCallback : com.sun.xml.internal.ws.api.pipe.Fiber.Fiber_CompletionCallback) : Void;
	
	@:overload public function close() : Void;
	
	@:overload @:final public function getBinding() : com.sun.xml.internal.ws.api.WSBinding;
	
	@:overload @:final public function getRequestContext() : java.util.Map<String, Dynamic>;
	
	@:overload @:final public function getResponseContext() : com.sun.xml.internal.ws.client.ResponseContext;
	
	@:overload public function setResponseContext(rc : com.sun.xml.internal.ws.client.ResponseContext) : Void;
	
	@:overload public function toString() : String;
	
	@:overload @:final public function getWSEndpointReference() : com.sun.xml.internal.ws.api.addressing.WSEndpointReference;
	
	@:overload @:final public function getEndpointReference() : javax.xml.ws.wsaddressing.W3CEndpointReference;
	
	@:overload @:final public function getEndpointReference<T : javax.xml.ws.EndpointReference>(clazz : Class<T>) : T;
	
	@:overload public function getManagedObjectManager() : com.sun.org.glassfish.gmbal.ManagedObjectManager;
	
	@:overload @:final public function setOutboundHeaders(headers : java.util.List<com.sun.xml.internal.ws.api.message.Header>) : Void;
	
	@:overload @:final public function setOutboundHeaders(headers : java.NativeArray<com.sun.xml.internal.ws.api.message.Header>) : Void;
	
	@:overload @:final public function getInboundHeaders() : java.util.List<com.sun.xml.internal.ws.api.message.Header>;
	
	@:overload @:final public function setAddress(address : String) : Void;
