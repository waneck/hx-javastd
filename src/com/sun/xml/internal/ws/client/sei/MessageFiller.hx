...
@:native('com$sun$xml$internal$ws$client$sei$MessageFiller$AttachmentFiller') @:internal extern class MessageFiller_AttachmentFiller extends com.sun.xml.internal.ws.client.sei.MessageFiller
{
	...
	@:protected @:final private var getter(default, null) : com.sun.xml.internal.ws.client.sei.ValueGetter;
	
	@:protected @:final private var mimeType(default, null) : String;
	
	@:overload @:protected private function new(param : com.sun.xml.internal.ws.model.ParameterImpl, getter : com.sun.xml.internal.ws.client.sei.ValueGetter) : Void;
	...
	*/
	@:overload @:public @:static public static function createAttachmentFiller(param : com.sun.xml.internal.ws.model.ParameterImpl, getter : com.sun.xml.internal.ws.client.sei.ValueGetter) : com.sun.xml.internal.ws.client.sei.MessageFiller;
...
{
	@:overload @:protected private function new(methodPos : Int, bridge : com.sun.xml.internal.bind.api.Bridge<Dynamic>, getter : com.sun.xml.internal.ws.client.sei.ValueGetter) : Void;
