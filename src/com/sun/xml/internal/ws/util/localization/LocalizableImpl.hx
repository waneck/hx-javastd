...
*/
extern class LocalizableImpl implements com.sun.xml.internal.ws.util.localization.Localizable
{
	@:overload @:public public function new(key : String, arguments : java.NativeArray<Dynamic>, resourceBundleName : String) : Void;
