...
{
	@:overload @:public @:static public static function close(reader : javax.xml.stream.XMLStreamReader) : Void;
	
	@:overload @:public @:static public static function readRest(reader : javax.xml.stream.XMLStreamReader) : Void;
	
	@:overload @:public @:static public static function next(reader : javax.xml.stream.XMLStreamReader) : Int;
	
	@:overload @:public @:static public static function nextElementContent(reader : javax.xml.stream.XMLStreamReader) : Int;
	
	@:overload @:public @:static public static function nextContent(reader : javax.xml.stream.XMLStreamReader) : Int;
	
	/**
	* Skip current element, leaving the cursor at END_ELEMENT of
	* current element.
	*/
	@:overload @:public @:static public static function skipElement(reader : javax.xml.stream.XMLStreamReader) : Void;
	
	/**
	* Skip following siblings, leaving cursor at END_ELEMENT of
	* parent element.
	*/
	@:overload @:public @:static public static function skipSiblings(reader : javax.xml.stream.XMLStreamReader, parent : javax.xml.namespace.QName) : Void;
	
	/*
	* Get the text of an element
	*/
	@:overload @:public @:static public static function getElementText(reader : javax.xml.stream.XMLStreamReader) : String;
	...
	*/
	@:overload @:public @:static public static function getElementQName(reader : javax.xml.stream.XMLStreamReader) : javax.xml.namespace.QName;
	...
	*/
	@:overload @:public @:static public static function getAttributes(reader : javax.xml.stream.XMLStreamReader) : com.sun.xml.internal.ws.streaming.Attributes;
	
	@:overload @:public @:static public static function verifyReaderState(reader : javax.xml.stream.XMLStreamReader, expectedState : Int) : Void;
	
	@:overload @:public @:static public static function verifyTag(reader : javax.xml.stream.XMLStreamReader, namespaceURI : String, localName : String) : Void;
	
	@:overload @:public @:static public static function verifyTag(reader : javax.xml.stream.XMLStreamReader, name : javax.xml.namespace.QName) : Void;
	
	@:overload @:public @:static public static function getStateName(reader : javax.xml.stream.XMLStreamReader) : String;
	
	@:overload @:public @:static public static function getStateName(state : Int) : String;
