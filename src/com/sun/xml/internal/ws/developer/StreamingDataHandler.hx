...
* questions.
*/
extern class StreamingDataHandler extends com.sun.xml.internal.org.jvnet.staxex.StreamingDataHandler
{
	/**
	...
	*/
	@:overload @:public override public function new(o : Dynamic, s : String) : Void;
	
	@:overload @:public override public function new(url : java.net.URL) : Void;
	
	@:overload @:public override public function new(dataSource : javax.activation.DataSource) : Void;
