...
extern class MonitorBase
{
	...
	* true    |    on      |      on       |     off        |     on
	*/
	@:overload @:public public function createManagedObjectManager(endpoint : com.sun.xml.internal.ws.api.server.WSEndpoint<Dynamic>) : com.sun.org.glassfish.gmbal.ManagedObjectManager;
	...
	* </pre>
	*/
	@:overload @:public public function createManagedObjectManager(stub : com.sun.xml.internal.ws.client.Stub) : com.sun.org.glassfish.gmbal.ManagedObjectManager;
	
	@:overload @:public @:static public static function closeMOM(mom : com.sun.org.glassfish.gmbal.ManagedObjectManager) : Void;
...
@:internal extern class RewritingMOM implements com.sun.org.glassfish.gmbal.ManagedObjectManager
{
	...
	@:overload @:public public function setJMXRegistrationDebug(x : Bool) : Void;
	
	@:overload @:public public function isManagedObject(x : Dynamic) : Bool;
