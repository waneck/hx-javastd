...
@:native('com$sun$xml$internal$ws$model$WrapperBeanGenerator$RuntimeWrapperBeanGenerator') @:internal extern class WrapperBeanGenerator_RuntimeWrapperBeanGenerator extends com.sun.xml.internal.ws.model.AbstractWrapperBeanGenerator<java.lang.reflect.Type, Class<Dynamic>, java.lang.reflect.Method, com.sun.xml.internal.ws.model.WrapperBeanGenerator.WrapperBeanGenerator_Field>
{
	...
	@:overload @:protected private function getSafeType(type : java.lang.reflect.Type) : java.lang.reflect.Type;
	
	@:overload @:protected private function getHolderValueType(paramType : java.lang.reflect.Type) : java.lang.reflect.Type;
	
	@:overload @:protected private function isVoidType(type : java.lang.reflect.Type) : Bool;
...
{
	@:overload @:public public function createWrapperBeanMember(paramType : java.lang.reflect.Type, paramName : String, jaxb : java.util.List<java.lang.annotation.Annotation>) : com.sun.xml.internal.ws.model.WrapperBeanGenerator.WrapperBeanGenerator_Field;
...
{
	@:overload @:public public function compareTo(o : com.sun.xml.internal.ws.model.WrapperBeanGenerator.WrapperBeanGenerator_Field) : Int;
