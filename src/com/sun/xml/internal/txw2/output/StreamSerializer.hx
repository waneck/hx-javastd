...
extern class StreamSerializer implements com.sun.xml.internal.txw2.output.XmlSerializer
{
	...
	@:overload @:public public function new(out : java.io.OutputStream, encoding : String) : Void;
	
	@:overload @:public public function new(out : java.io.Writer) : Void;
	
	@:overload @:public public function new(streamResult : javax.xml.transform.stream.StreamResult) : Void;
