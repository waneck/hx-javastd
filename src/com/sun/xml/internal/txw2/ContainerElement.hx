...
@:internal extern class ContainerElement implements java.lang.reflect.InvocationHandler implements com.sun.xml.internal.txw2.TypedXmlWriter
{
	...
	@:overload public function block() : Void;
	...
	@:overload public function commit(includingAllPredecessors : Bool) : Void;
	
	@:overload public function _attribute(localName : String, value : Dynamic) : Void;
	
	@:overload public function _attribute(nsUri : String, localName : String, value : Dynamic) : Void;
	
	@:overload public function _attribute(attributeName : javax.xml.namespace.QName, value : Dynamic) : Void;
	
	@:overload public function _namespace(uri : String) : Void;
	
	@:overload public function _namespace(uri : String, prefix : String) : Void;
	
	@:overload public function _namespace(uri : String, requirePrefix : Bool) : Void;
	
	@:overload public function _pcdata(value : Dynamic) : Void;
	
	@:overload public function _cdata(value : Dynamic) : Void;
	
	@:overload public function _comment(value : Dynamic) : Void;
	...
	@:overload public function _cast<T : com.sun.xml.internal.txw2.TypedXmlWriter>(facadeType : Class<T>) : T;
