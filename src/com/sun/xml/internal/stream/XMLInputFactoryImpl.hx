...
extern class XMLInputFactoryImpl extends javax.xml.stream.XMLInputFactory
{
	...
	* @throws XMLStreamException
	*/
	@:overload @:public override public function createXMLEventReader(reader : javax.xml.stream.XMLStreamReader) : javax.xml.stream.XMLEventReader;
	
	@:overload @:public override public function createXMLStreamReader(inputstream : java.io.InputStream) : javax.xml.stream.XMLStreamReader;
	
	@:overload @:public override public function createXMLStreamReader(reader : java.io.Reader) : javax.xml.stream.XMLStreamReader;
	
	@:overload @:public override public function createXMLStreamReader(systemId : String, reader : java.io.Reader) : javax.xml.stream.XMLStreamReader;
