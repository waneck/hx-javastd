...
* questions.
*/
@:internal extern class GetterSetterPropertySeed<TypeT, ClassDeclT, FieldT, MethodT> implements com.sun.xml.internal.bind.v2.model.impl.PropertySeed<TypeT, ClassDeclT, FieldT, MethodT>
{
	/**
