...
* questions.
*/
extern interface RuntimeNonElement extends com.sun.xml.internal.bind.v2.model.core.NonElement<java.lang.reflect.Type, Class<Dynamic>> extends com.sun.xml.internal.bind.v2.model.runtime.RuntimeTypeInfo
{
	/**
