...
*/
extern interface ArrayInfo<T, C> extends com.sun.xml.internal.bind.v2.model.core.NonElement<T, C>
{
	/**
	...
	* @return  never null
	*/
	@:overload public function getItemType() : com.sun.xml.internal.bind.v2.model.core.NonElement<T, C>;
