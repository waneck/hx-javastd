...
{
	@:overload @:public public function getTypes() : java.util.List<com.sun.xml.internal.bind.v2.model.impl.TypeRefImpl<TypeT, ClassDeclT>>;
	
	/**
	* Used by {@link PropertyInfoImpl} to create new instances of {@link TypeRef}
	*/
	@:overload @:protected private function createTypeRef(name : javax.xml.namespace.QName, type : TypeT, isNillable : Bool, defaultValue : String) : com.sun.xml.internal.bind.v2.model.impl.TypeRefImpl<TypeT, ClassDeclT>;
	
	@:overload @:public public function isValueList() : Bool;
	
	@:overload @:public public function isRequired() : Bool;
	
	@:overload @:public override public function ref() : java.util.List<com.sun.xml.internal.bind.v2.model.core.TypeInfo<TypeT, ClassDeclT>>;
