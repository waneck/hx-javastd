...
* questions.
*/
extern interface AttributePropertyInfo<T, C> extends com.sun.xml.internal.bind.v2.model.core.PropertyInfo<T, C> extends com.sun.xml.internal.bind.v2.model.core.NonElementRef<T, C>
{
	/**
