...
@:internal extern class TypeInfoImpl<TypeT, ClassDeclT, FieldT, MethodT> implements com.sun.xml.internal.bind.v2.model.core.TypeInfo<TypeT, ClassDeclT> implements com.sun.xml.internal.bind.v2.model.annotation.Locatable
{
	...
	*/
	private var owner(default, null) : com.sun.xml.internal.bind.v2.model.impl.TypeInfoSetImpl<TypeT, ClassDeclT, FieldT, MethodT>;
	...
	*/
	private var builder : com.sun.xml.internal.bind.v2.model.impl.ModelBuilder<TypeT, ClassDeclT, FieldT, MethodT>;
	
	@:overload private function new(builder : com.sun.xml.internal.bind.v2.model.impl.ModelBuilder<TypeT, ClassDeclT, FieldT, MethodT>, upstream : com.sun.xml.internal.bind.v2.model.annotation.Locatable) : Void;
	
	@:overload public function getUpstream() : com.sun.xml.internal.bind.v2.model.annotation.Locatable;
	
	@:overload @:final private function nav() : com.sun.xml.internal.bind.v2.model.nav.Navigator<TypeT, ClassDeclT, FieldT, MethodT>;
	
	@:overload @:final private function reader() : com.sun.xml.internal.bind.v2.model.annotation.AnnotationReader<TypeT, ClassDeclT, FieldT, MethodT>;
	...
	*      if none was found.
	*/
	@:overload @:final private function parseElementName(clazz : ClassDeclT) : javax.xml.namespace.QName;
	
	@:overload @:final private function parseTypeName(clazz : ClassDeclT) : javax.xml.namespace.QName;
	...
	*      't' is pre-computed.
	*/
	@:overload @:final private function parseTypeName(clazz : ClassDeclT, t : javax.xml.bind.annotation.XmlType) : javax.xml.namespace.QName;
