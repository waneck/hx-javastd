...
* questions.
*/
@:internal extern class RuntimeTypeRefImpl extends com.sun.xml.internal.bind.v2.model.impl.TypeRefImpl<java.lang.reflect.Type, Class<Dynamic>> implements com.sun.xml.internal.bind.v2.model.runtime.RuntimeTypeRef
{
	/**
