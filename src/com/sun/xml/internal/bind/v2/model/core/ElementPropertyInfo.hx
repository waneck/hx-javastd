...
* questions.
*/
extern interface ElementPropertyInfo<T, C> extends com.sun.xml.internal.bind.v2.model.core.PropertyInfo<T, C>
{
	/**
	...
	*/
	@:overload public function getTypes() : java.util.List<com.sun.xml.internal.bind.v2.model.core.TypeRef<T, C>>;
