...
{
	@:overload @:public public function new(builder : com.sun.xml.internal.bind.v2.model.impl.ModelBuilder<TypeT, ClassDeclT, FieldT, MethodT>, upstream : com.sun.xml.internal.bind.v2.model.annotation.Locatable, arrayType : TypeT) : Void;
	
	/**
	* Computes the type name of the array from that of the item type.
	*/
	@:overload @:public @:static public static function calcArrayTypeName(n : javax.xml.namespace.QName) : javax.xml.namespace.QName;
	
	@:overload @:public public function getItemType() : com.sun.xml.internal.bind.v2.model.core.NonElement<TypeT, ClassDeclT>;
	
	@:overload @:public public function getTypeName() : javax.xml.namespace.QName;
	
	@:overload @:public public function isSimpleType() : Bool;
	
	@:overload @:public override public function getType() : TypeT;
