...
{
	@:overload public function form(value : String) : LocalElement;
	
	@:overload public function name(value : String) : LocalElement;
	
	@:overload public function ref(value : javax.xml.namespace.QName) : LocalElement;
