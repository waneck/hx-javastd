...
* questions.
*/
@:internal extern class SingleReferenceNodeProperty<BeanT, ValueT> extends com.sun.xml.internal.bind.v2.runtime.property.PropertyImpl<BeanT>
{
	@:overload public function new(context : com.sun.xml.internal.bind.v2.runtime.JAXBContextImpl, prop : com.sun.xml.internal.bind.v2.model.runtime.RuntimeReferencePropertyInfo) : Void;
	
	@:overload override public function reset(bean : BeanT) : Void;
	
	@:overload override public function getIdValue(beanT : BeanT) : String;
