...
@:internal extern class PropertyImpl<BeanT> implements com.sun.xml.internal.bind.v2.runtime.property.Property<BeanT>
{
	...
	* Name of this field.
	*/
	@:protected @:final private var fieldName(default, null) : String;
	
	@:overload @:public public function new(context : com.sun.xml.internal.bind.v2.runtime.JAXBContextImpl, prop : com.sun.xml.internal.bind.v2.model.runtime.RuntimePropertyInfo) : Void;
	
	@:overload @:public public function getInfo() : com.sun.xml.internal.bind.v2.model.runtime.RuntimePropertyInfo;
	
	@:overload @:public public function serializeBody(o : BeanT, w : com.sun.xml.internal.bind.v2.runtime.XMLSerializer, outerPeer : Dynamic) : Void;
	
	@:overload @:public public function serializeURIs(o : BeanT, w : com.sun.xml.internal.bind.v2.runtime.XMLSerializer) : Void;
	
	@:overload @:public public function hasSerializeURIAction() : Bool;
	
	@:overload @:public public function getElementPropertyAccessor(nsUri : String, localName : String) : com.sun.xml.internal.bind.v2.runtime.reflect.Accessor<Dynamic, Dynamic>;
	...
	* by this property.
	*/
	@:overload @:public public function buildChildElementUnmarshallers(chain : com.sun.xml.internal.bind.v2.runtime.property.UnmarshallerChain, handlers : com.sun.xml.internal.bind.v2.util.QNameMap<com.sun.xml.internal.bind.v2.runtime.unmarshaller.ChildLoader>) : Void;
