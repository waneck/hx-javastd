...
extern class UnmarshallerImpl extends javax.xml.bind.helpers.AbstractUnmarshallerImpl implements javax.xml.bind.ValidationEventHandler implements java.io.Closeable
{
	...
	*/
	...
	@:overload private function unmarshal(reader : org.xml.sax.XMLReader, source : org.xml.sax.InputSource) : Dynamic;
	...
	@:overload @:final public function getEventHandler() : javax.xml.bind.ValidationEventHandler;
	...
	*/
	...
	@:overload @:final public function unmarshal(source : javax.xml.transform.sax.SAXSource) : Dynamic;
	...
	*/
	...
	@:overload public function createUnmarshalException(e : org.xml.sax.SAXException) : javax.xml.bind.UnmarshalException;
