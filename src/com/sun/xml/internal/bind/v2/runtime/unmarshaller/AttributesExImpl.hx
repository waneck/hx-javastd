...
* questions.
*/
extern class AttributesExImpl extends com.sun.xml.internal.bind.util.AttributesImpl implements com.sun.xml.internal.bind.v2.runtime.unmarshaller.AttributesEx
{
	/**
