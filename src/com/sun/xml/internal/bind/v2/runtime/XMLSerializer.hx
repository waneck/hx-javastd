...
extern class XMLSerializer extends com.sun.xml.internal.bind.v2.runtime.Coordinator
{
	...
	*/
	@:public @:final public var grammar(default, null) : com.sun.xml.internal.bind.v2.runtime.JAXBContextImpl;
	
	@:public @:final public var nameList(default, null) : com.sun.xml.internal.bind.v2.runtime.NameList;
	
	@:public @:final public var knownUri2prefixIndexMap(default, null) : java.NativeArray<Int>;
	
	@:public public var attachmentMarshaller : javax.xml.bind.attachment.AttachmentMarshaller;
	...
	*/
	@:overload @:public public function getCachedBase64DataInstance() : com.sun.xml.internal.bind.v2.runtime.unmarshaller.Base64Data;
	
	@:overload @:public public function reportError(ve : javax.xml.bind.ValidationEvent) : Void;
	...
	*/
	@:overload @:public @:final public function reportError(fieldName : String, t : java.lang.Throwable) : Void;
	
	@:overload @:public public function startElement(tagName : com.sun.xml.internal.bind.v2.runtime.Name, outerPeer : Dynamic) : Void;
	
	@:overload @:public public function startElement(nsUri : String, localName : String, preferredPrefix : String, outerPeer : Dynamic) : Void;
	...
	*/
	@:overload @:public public function startElementForce(nsUri : String, localName : String, forcedPrefix : String, outerPeer : Dynamic) : Void;
	
	@:overload @:public public function endNamespaceDecls(innerPeer : Dynamic) : Void;
	
	/**
	* Switches to the "marshal child texts/elements" mode.
	* This method has to be called after the 1st pass is completed.
	*/
	@:overload @:public public function endAttributes() : Void;
	...
	*/
	...
	@:overload @:public public function leafElement(tagName : com.sun.xml.internal.bind.v2.runtime.Name, data : String, fieldName : String) : Void;
	
	@:overload @:public public function leafElement(tagName : com.sun.xml.internal.bind.v2.runtime.Name, data : com.sun.xml.internal.bind.v2.runtime.output.Pcdata, fieldName : String) : Void;
	
	@:overload @:public public function leafElement(tagName : com.sun.xml.internal.bind.v2.runtime.Name, data : Int, fieldName : String) : Void;
	...
	*/
	@:overload @:public public function text(text : String, fieldName : String) : Void;
	
	/**
	* The {@link #text(String, String)} method that takes {@link Pcdata}.
	*/
	@:overload @:public public function text(text : com.sun.xml.internal.bind.v2.runtime.output.Pcdata, fieldName : String) : Void;
	
	@:overload @:public public function attribute(uri : String, local : String, value : String) : Void;
	
	@:overload @:public public function attribute(name : com.sun.xml.internal.bind.v2.runtime.Name, value : java.lang.CharSequence) : Void;
	
	@:overload @:public public function getNamespaceContext() : com.sun.xml.internal.bind.v2.runtime.NamespaceContext2;
	
	@:overload @:public public function onID(owner : Dynamic, value : String) : String;
	
	@:overload @:public public function onIDREF(obj : Dynamic) : String;
	
	@:overload @:public public function childAsRoot(obj : Dynamic) : Void;
	...
	*/
	@:overload @:public @:final public function childAsSoleContent(child : Dynamic, fieldName : String) : Void;
	...
	*      with 'o'.
	*/
	@:overload @:public @:final public function childAsXsiType(child : Dynamic, fieldName : String, expected : com.sun.xml.internal.bind.v2.runtime.JaxBeanInfo<Dynamic>, nillable : Bool) : Void;
	
	@:overload @:public public function attWildcardAsURIs(attributes : java.util.Map<javax.xml.namespace.QName, String>, fieldName : String) : Void;
	
	@:overload @:public public function attWildcardAsAttributes(attributes : java.util.Map<javax.xml.namespace.QName, String>, fieldName : String) : Void;
	...
	* </pre>
	*/
	@:overload @:public @:final public function writeXsiNilTrue() : Void;
	
	@:overload @:public public function writeDom<E>(element : E, domHandler : javax.xml.bind.annotation.DomHandler<E, Dynamic>, parentBean : Dynamic, fieldName : String) : Void;
	
	@:overload @:public public function getIdentityTransformer() : javax.xml.transform.Transformer;
	
	@:overload @:public public function setPrefixMapper(prefixMapper : com.sun.xml.internal.bind.marshaller.NamespacePrefixMapper) : Void;
	...
	*/
	@:overload @:public public function startDocument(out : com.sun.xml.internal.bind.v2.runtime.output.XmlOutput, fragment : Bool, schemaLocation : String, noNsSchemaLocation : String) : Void;
	...
	*/
	@:overload @:public public function addInscopeBinding(nsUri : String, prefix : String) : Void;
	...
	*/
	@:overload @:public public function setExpectedMimeType(expectedMimeType : javax.activation.MimeType) : javax.activation.MimeType;
	
	@:overload @:public public function setInlineBinaryFlag(value : Bool) : Bool;
	
	@:overload @:public public function getInlineBinaryFlag() : Bool;
	
	@:overload @:public public function setSchemaType(st : javax.xml.namespace.QName) : javax.xml.namespace.QName;
	
	@:overload @:public public function getSchemaType() : javax.xml.namespace.QName;
	
	@:overload @:public public function setObjectIdentityCycleDetection(val : Bool) : Void;
	
	@:overload @:public public function getObjectIdentityCycleDetection() : Bool;
	
	@:overload @:public public function handleError(e : java.lang.Exception) : Bool;
	
	@:overload @:public public function handleError(e : java.lang.Exception, source : Dynamic, fieldName : String) : Bool;
	...
	*/
	@:overload @:public public function errorMissingId(obj : Dynamic) : Void;
	
	@:overload @:public public function getCurrentLocation(fieldName : String) : javax.xml.bind.ValidationEventLocator;
	...
	*/
	@:overload @:public public function getCurrentProperty() : com.sun.xml.internal.bind.v2.runtime.property.Property<Dynamic>;
	
	/**
	* Takes care of cleaning the currentProperty. Must be called from the same thread that created the XMLSerializer.
	*/
	@:overload @:public public function clearCurrentProperty() : Void;
	
	/**
	* When called from within the realm of the marshaller, this method
	* returns the current {@link XMLSerializer} in charge.
	*/
	@:overload @:public @:static public static function getInstance() : com.sun.xml.internal.bind.v2.runtime.XMLSerializer;
