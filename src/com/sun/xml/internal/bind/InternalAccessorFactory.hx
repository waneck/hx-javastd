...
* questions.
*/
extern interface InternalAccessorFactory extends com.sun.xml.internal.bind.AccessorFactory
{
	/**
	...
	*/
	@:overload public function createFieldAccessor(bean : Class<Dynamic>, f : java.lang.reflect.Field, readOnly : Bool, supressWarnings : Bool) : com.sun.xml.internal.bind.v2.runtime.reflect.Accessor<Dynamic, Dynamic>;
