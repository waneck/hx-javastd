...
* questions.
*/
extern interface AccessorFactory
{
	/**
	...
	*/
	@:overload public function createFieldAccessor(bean : Class<Dynamic>, f : java.lang.reflect.Field, readOnly : Bool) : com.sun.xml.internal.bind.v2.runtime.reflect.Accessor<Dynamic, Dynamic>;
