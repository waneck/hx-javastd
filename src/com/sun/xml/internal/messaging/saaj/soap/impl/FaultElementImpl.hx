...
* questions.
*/
extern class FaultElementImpl extends com.sun.org.apache.xerces.internal.dom.ElementImpl implements javax.xml.soap.SOAPFaultElement
{
	@:overload @:protected private function new(ownerDoc : com.sun.xml.internal.messaging.saaj.soap.SOAPDocumentImpl, qname : com.sun.xml.internal.messaging.saaj.soap.name.NameImpl) : Void;
	
	@:overload @:protected private function new(ownerDoc : com.sun.xml.internal.messaging.saaj.soap.SOAPDocumentImpl, qname : javax.xml.namespace.QName) : Void;
	
	@:overload @:protected @:abstract private function isStandardFaultElement() : Bool;
