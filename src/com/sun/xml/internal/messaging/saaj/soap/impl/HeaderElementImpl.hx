...
extern class HeaderElementImpl extends com.sun.xml.internal.messaging.saaj.soap.impl.ElementImpl implements javax.xml.soap.SOAPHeaderElement
{
	...
	private static var MUST_UNDERSTAND_ATTRIBUTE_LOCAL_NAME : javax.xml.soap.Name;
	...
	@:overload @:abstract private function getActorAttributeName() : com.sun.xml.internal.messaging.saaj.soap.name.NameImpl;
	
	@:overload @:abstract private function getRoleAttributeName() : com.sun.xml.internal.messaging.saaj.soap.name.NameImpl;
	
	@:overload @:abstract private function getMustunderstandAttributeName() : com.sun.xml.internal.messaging.saaj.soap.name.NameImpl;
	
	@:overload @:abstract private function getMustunderstandAttributeValue(str : String) : Bool;
	
	@:overload @:abstract private function getMustunderstandLiteralValue(mu : Bool) : String;
	
	@:overload @:abstract private function getRelayAttributeName() : com.sun.xml.internal.messaging.saaj.soap.name.NameImpl;
	
	@:overload @:abstract private function getRelayAttributeValue(str : String) : Bool;
	
	@:overload @:abstract private function getRelayLiteralValue(mu : Bool) : String;
	...
	@:overload public function setRole(roleUri : String) : Void;
	
	@:overload public function getActor() : String;
	
	@:overload public function getRole() : String;
	
	@:overload public function setMustUnderstand(mustUnderstand : Bool) : Void;
	
	@:overload public function getMustUnderstand() : Bool;
	
	@:overload public function setRelay(relay : Bool) : Void;
	
	@:overload public function getRelay() : Bool;
	...
	* @since DOM Level 3
	*/
	@:overload @:public @:public override public function isEqualNode(arg : Node) : Bool;
	...
	* @since DOM Level 3
	*/
	@:overload @:public @:public override public function compareDocumentPosition(other : Node) : java.StdTypes.Int16;
	...
	* @since DOM Level 3
	*/
	@:overload @:public @:public override public function insertBefore(newChild : Node, refChild : Node) : Node;
	...
	* @since DOM Level 3
	*/
	@:overload @:public @:public override public function removeChild(oldChild : Node) : Node;
	...
	* @since SAAJ 1.3
	*/
	@:require(java3) @:overload override public function setElementQName(newName : javax.xml.namespace.QName) : SOAPElement;
	...
	*/
	@:overload @:public public function addChildElement(element : SOAPElement) : SOAPElement;
	...
	* @since DOM Level 3
	*/
	@:overload @:public @:public override public function appendChild(newChild : Node) : Node;
	...
	* @since DOM Level 3
	*/
	@:overload @:public @:public override public function replaceChild(newChild : Node, oldChild : Node) : Node;
	...
	* @since DOM Level 3
	*/
	@:overload @:public @:public override public function isSameNode(other : Node) : Bool;
