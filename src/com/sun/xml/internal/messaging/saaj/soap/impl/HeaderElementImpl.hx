...
{
	@:protected @:static private static var RELAY_ATTRIBUTE_LOCAL_NAME : javax.xml.soap.Name;
	
	@:protected @:static private static var MUST_UNDERSTAND_ATTRIBUTE_LOCAL_NAME : javax.xml.soap.Name;
	...
	@:overload @:protected @:abstract private function getActorAttributeName() : com.sun.xml.internal.messaging.saaj.soap.name.NameImpl;
	
	@:overload @:protected @:abstract private function getRoleAttributeName() : com.sun.xml.internal.messaging.saaj.soap.name.NameImpl;
	
	@:overload @:protected @:abstract private function getMustunderstandAttributeName() : com.sun.xml.internal.messaging.saaj.soap.name.NameImpl;
	
	@:overload @:protected @:abstract private function getMustunderstandAttributeValue(str : String) : Bool;
	
	@:overload @:protected @:abstract private function getMustunderstandLiteralValue(mu : Bool) : String;
	
	@:overload @:protected @:abstract private function getRelayAttributeName() : com.sun.xml.internal.messaging.saaj.soap.name.NameImpl;
	
	@:overload @:protected @:abstract private function getRelayAttributeValue(str : String) : Bool;
	
	@:overload @:protected @:abstract private function getRelayLiteralValue(mu : Bool) : String;
	
	@:overload @:protected @:abstract private function getActorOrRole() : String;
	...
	@:overload @:public public function setRole(roleUri : String) : Void;
	
	@:overload @:public public function getActor() : String;
	
	@:overload @:public public function getRole() : String;
	...
	@:overload @:public public function setRelay(relay : Bool) : Void;
	
	@:overload @:public public function getRelay() : Bool;
