...
* questions.
*/
extern class EnvelopeImpl extends com.sun.xml.internal.messaging.saaj.soap.impl.ElementImpl implements com.sun.xml.internal.messaging.saaj.soap.Envelope
{
	/**
	...
	* @since DOM Level 3
	*/
	@:overload @:public @:public @:public @:public @:public override public function isEqualNode(arg : Node) : Bool;
	...
	* @since DOM Level 3
	*/
	@:overload @:public @:public @:public @:public @:public override public function compareDocumentPosition(other : Node) : java.StdTypes.Int16;
	...
	* @since DOM Level 3
	*/
	@:overload @:public @:public @:public @:public @:public override public function insertBefore(newChild : Node, refChild : Node) : Node;
	...
	* <code>null</code>.
	*/
	@:overload @:public @:public @:public @:public override public function getParentNode() : Node;
	...
	* @since DOM Level 3
	*/
	@:overload @:public @:public @:public @:public @:public override public function removeChild(oldChild : Node) : Node;
	...
	*/
	@:overload @:public @:public @:public @:public override public function getNextSibling() : Node;
	...
	*/
	@:overload @:public @:public @:public @:public override public function cloneNode(deep : Bool) : Node;
	...
	* @since DOM Level 3
	*/
	@:overload @:public @:public @:public @:public @:public override public function appendChild(newChild : Node) : Node;
	...
	* this returns <code>null</code>.
	*/
	@:overload @:public @:public @:public @:public override public function getPreviousSibling() : Node;
	...
	* @since DOM Level 3
	*/
	@:overload @:public @:public @:public @:public @:public override public function replaceChild(newChild : Node, oldChild : Node) : Node;
	...
	*/
	@:overload @:public override public function setParentElement(parent : javax.xml.soap.SOAPElement) : Void;
	...
	* @since DOM Level 3
	*/
	@:overload @:public @:public @:public @:public @:public override public function isSameNode(other : Node) : Bool;
	...
	* <code>null</code>.
	*/
	@:overload @:public @:public @:public @:public override public function getLastChild() : Node;
