...
* questions.
*/
extern class DetailImpl extends com.sun.xml.internal.messaging.saaj.soap.impl.FaultElementImpl implements javax.xml.soap.Detail
{
	@:overload @:public public function new(ownerDoc : com.sun.xml.internal.messaging.saaj.soap.SOAPDocumentImpl, detailName : com.sun.xml.internal.messaging.saaj.soap.name.NameImpl) : Void;
	
	@:overload @:protected @:abstract private function createDetailEntry(name : javax.xml.soap.Name) : javax.xml.soap.DetailEntry;
	
	@:overload @:protected @:abstract private function createDetailEntry(name : javax.xml.namespace.QName) : javax.xml.soap.DetailEntry;
	
	@:overload @:public public function addDetailEntry(name : javax.xml.soap.Name) : javax.xml.soap.DetailEntry;
	
	@:overload @:public public function addDetailEntry(qname : javax.xml.namespace.QName) : javax.xml.soap.DetailEntry;
	...
	*                          namespace
	*/
	@:overload @:public override public function addNamespaceDeclaration(prefix : String, uri : String) : javax.xml.soap.SOAPElement;
	...
	*                          <code>SOAPElement</code> object
	*/
	@:overload @:public override public function addChildElement(localName : String) : javax.xml.soap.SOAPElement;
	...
	* @since SAAJ 1.3
	*/
	@:require(java3) @:overload @:public override public function addAttribute(qname : javax.xml.namespace.QName, value : String) : javax.xml.soap.SOAPElement;
	...
	*                          <code>SOAPElement</code> object
	*/
	@:overload @:public override public function addChildElement(localName : String, prefix : String, uri : String) : javax.xml.soap.SOAPElement;
	...
	* @since SAAJ 1.2
	*/
	@:require(java2) @:overload @:public @:abstract override public function removeContents() : Void;
	...
	* @since SAAJ 1.3
	*/
	@:require(java3) @:overload @:public override public function setElementQName(newName : javax.xml.namespace.QName) : javax.xml.soap.SOAPElement;
	...
	*                          <code>SOAPElement</code> object
	*/
	@:overload @:public override public function addChildElement(localName : String, prefix : String) : javax.xml.soap.SOAPElement;
	...
	* @since SAAJ 1.3
	*/
	@:require(java3) @:overload @:public override public function addChildElement(qname : javax.xml.namespace.QName) : javax.xml.soap.SOAPElement;
