...
{
	@:overload public function new(ownerDoc : com.sun.xml.internal.messaging.saaj.soap.SOAPDocumentImpl, detailName : com.sun.xml.internal.messaging.saaj.soap.name.NameImpl) : Void;
	
	@:overload @:abstract private function createDetailEntry(name : javax.xml.soap.Name) : javax.xml.soap.DetailEntry;
	
	@:overload @:abstract private function createDetailEntry(name : javax.xml.namespace.QName) : javax.xml.soap.DetailEntry;
	
	@:overload public function addDetailEntry(name : javax.xml.soap.Name) : javax.xml.soap.DetailEntry;
	
	@:overload public function addDetailEntry(qname : javax.xml.namespace.QName) : javax.xml.soap.DetailEntry;
	...
	@:overload override private function circumventBug5034339(element : javax.xml.soap.SOAPElement) : javax.xml.soap.SOAPElement;
	...
	*                          <code>SOAPElement</code> object
	*/
	@:overload @:public override public function addChildElement(localName : String) : SOAPElement;
	...
	* @since SAAJ 1.3
	*/
	@:require(java3) @:overload @:public override public function setElementQName(newName : javax.xml.namespace.QName) : SOAPElement;
