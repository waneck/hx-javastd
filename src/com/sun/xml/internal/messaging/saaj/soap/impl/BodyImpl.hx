...
{
	@:overload @:protected private function new(ownerDoc : com.sun.xml.internal.messaging.saaj.soap.SOAPDocumentImpl, bodyName : com.sun.xml.internal.messaging.saaj.soap.name.NameImpl) : Void;
	
	@:overload @:protected @:abstract private function getFaultName(name : String) : com.sun.xml.internal.messaging.saaj.soap.name.NameImpl;
	
	@:overload @:protected @:abstract private function isFault(child : javax.xml.soap.SOAPElement) : Bool;
	
	@:overload @:protected @:abstract private function createBodyElement(name : javax.xml.soap.Name) : javax.xml.soap.SOAPBodyElement;
	
	@:overload @:protected @:abstract private function createBodyElement(name : javax.xml.namespace.QName) : javax.xml.soap.SOAPBodyElement;
	
	@:overload @:protected @:abstract private function createFaultElement() : javax.xml.soap.SOAPFault;
	...
	@:overload @:public public function addFault(faultCode : javax.xml.soap.Name, faultString : String, locale : java.util.Locale) : javax.xml.soap.SOAPFault;
	
	@:overload @:public public function addFault(faultCode : javax.xml.namespace.QName, faultString : String, locale : java.util.Locale) : javax.xml.soap.SOAPFault;
	
	@:overload @:public public function addFault(faultCode : javax.xml.soap.Name, faultString : String) : javax.xml.soap.SOAPFault;
	
	@:overload @:public public function addFault(faultCode : javax.xml.namespace.QName, faultString : String) : javax.xml.soap.SOAPFault;
	
	@:overload @:protected private function findFault() : javax.xml.soap.SOAPElement;
	...
	@:overload @:public public function addBodyElement(qname : javax.xml.namespace.QName) : javax.xml.soap.SOAPBodyElement;
	...
	@:overload @:public public function addDocument(document : org.w3c.dom.Document) : javax.xml.soap.SOAPBodyElement;
	...
	@:overload @:public public function extractContentAsDocument() : org.w3c.dom.Document;
