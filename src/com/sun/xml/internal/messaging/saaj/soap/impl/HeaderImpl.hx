...
* questions.
*/
extern class HeaderImpl extends com.sun.xml.internal.messaging.saaj.soap.impl.ElementImpl implements javax.xml.soap.SOAPHeader
{
	private static var MUST_UNDERSTAND_ONLY(default, null) : Bool;
	...
	@:overload @:abstract private function createHeaderElement(name : javax.xml.soap.Name) : javax.xml.soap.SOAPHeaderElement;
	
	@:overload @:abstract private function createHeaderElement(name : javax.xml.namespace.QName) : javax.xml.soap.SOAPHeaderElement;
	
	@:overload @:abstract private function getNotUnderstoodName() : com.sun.xml.internal.messaging.saaj.soap.name.NameImpl;
	
	@:overload @:abstract private function getUpgradeName() : com.sun.xml.internal.messaging.saaj.soap.name.NameImpl;
	
	@:overload @:abstract private function getSupportedEnvelopeName() : com.sun.xml.internal.messaging.saaj.soap.name.NameImpl;
	
	@:overload public function addHeaderElement(name : javax.xml.soap.Name) : javax.xml.soap.SOAPHeaderElement;
	
	@:overload public function addHeaderElement(name : javax.xml.namespace.QName) : javax.xml.soap.SOAPHeaderElement;
	...
	@:overload private function getHeaderElementsForActor(actor : String, detach : Bool, mustUnderstand : Bool) : java.util.Iterator<Dynamic>;
	
	@:overload private function getHeaderElements(actor : String, detach : Bool, mustUnderstand : Bool) : java.util.Iterator<Dynamic>;
	
	@:overload override public function setParentElement(element : javax.xml.soap.SOAPElement) : Void;
	
	@:overload override public function addChildElement(localName : String) : javax.xml.soap.SOAPElement;
	
	@:overload public function examineAllHeaderElements() : java.util.Iterator<Dynamic>;
	
	@:overload public function examineMustUnderstandHeaderElements(actor : String) : java.util.Iterator<Dynamic>;
	
	@:overload public function extractAllHeaderElements() : java.util.Iterator<Dynamic>;
	
	@:overload public function addUpgradeHeaderElement(supportedSoapUris : java.util.Iterator<Dynamic>) : javax.xml.soap.SOAPHeaderElement;
	
	@:overload public function addUpgradeHeaderElement(supportedSoapUri : String) : javax.xml.soap.SOAPHeaderElement;
	
	@:overload public function addUpgradeHeaderElement(supportedSoapUris : java.NativeArray<String>) : javax.xml.soap.SOAPHeaderElement;
	
	@:overload override private function convertToSoapElement(element : org.w3c.dom.Element) : javax.xml.soap.SOAPElement;
	...
	* <code>null</code>.
	*/
	@:overload @:public override public function getFirstChild() : Node;
	...
	* @since SAAJ 1.3
	*/
	@:require(java3) @:overload override public function createQName(localName : String, prefix : String) : javax.xml.namespace.QName;
	...
	* @since DOM Level 3
	*/
	@:overload @:public override public function isEqualNode(arg : Node) : Bool;
	...
	* @since DOM Level 3
	*/
	@:overload @:public override public function compareDocumentPosition(other : Node) : java.StdTypes.Int16;
	...
	* @since SAAJ 1.3
	*/
	@:require(java3) @:overload override public function getElementQName() : javax.xml.namespace.QName;
	...
	*/
	@:overload override public function removeAttribute(name : javax.xml.soap.Name) : Bool;
	...
	*         object
	*/
	@:overload override public function getChildElements() : java.util.Iterator<Dynamic>;
	...
	* @since DOM Level 3
	*/
	@:overload @:public override public function insertBefore(newChild : Node, refChild : Node) : Node;
	...
	* <code>null</code>.
	*/
	@:overload @:public override public function getParentNode() : Node;
	...
	*/
	@:overload override public function addAttribute(name : javax.xml.soap.Name, value : String) : SOAPElement;
	...
	* @since SAAJ 1.3
	*/
	@:require(java3) @:overload override public function removeAttribute(qname : javax.xml.namespace.QName) : Bool;
	...
	* @since DOM Level 2
	*/
	@:overload override public function removeAttributeNS(namespaceURI : String, localName : String) : Void;
	...
	* @since DOM Level 3
	*/
	@:overload override public function setIdAttributeNode(idAttr : org.w3c.dom.Attr, isId : Bool) : Void;
	...
	*                          namespace
	*/
	@:overload override public function addNamespaceDeclaration(prefix : String, uri : String) : SOAPElement;
	...
	* @since DOM Level 3
	*/
	@:overload @:public override public function removeChild(oldChild : Node) : Node;
	...
	* @since SAAJ 1.3
	*/
	@:require(java3) @:overload override public function addAttribute(qname : javax.xml.namespace.QName, value : String) : SOAPElement;
	...
	*         <code>SOAPElement</code> object
	*/
	@:overload override public function getNamespacePrefixes() : java.util.Iterator<Dynamic>;
	...
	* @since DOM Level 3
	*/
	@:overload override public function setIdAttributeNS(namespaceURI : String, localName : String, isId : Bool) : Void;
	...
	*                          <code>SOAPElement</code> object
	*/
	@:overload override public function addChildElement(localName : String, prefix : String, uri : String) : SOAPElement;
	...
	*/
	@:overload override public function getAttributeValue(name : javax.xml.soap.Name) : String;
	...
	*/
	@:overload override public function getEncodingStyle() : String;
	...
	* @since SAAJ 1.2
	*/
	@:require(java2) @:overload @:abstract override public function removeContents() : Void;
	...
	* @since DOM Level 2
	*/
	@:overload override public function setAttributeNodeNS(newAttr : org.w3c.dom.Attr) : org.w3c.dom.Attr;
	...
	* @since SAAJ 1.3
	*/
	@:require(java3) @:overload override public function getAllAttributesAsQNames() : java.util.Iterator<Dynamic>;
	...
	*/
	@:overload override public function addChildElement(name : javax.xml.soap.Name) : SOAPElement;
	
	/**
	* The node immediately following this node. If there is no such node,
	* this returns <code>null</code>.
	*/
	@:overload @:public override public function getNextSibling() : Node;
	...
	*/
	@:overload @:public override public function cloneNode(deep : Bool) : Node;
	...
	* @since SAAJ 1.3
	*/
	@:require(java3) @:overload override public function getChildElements(qname : javax.xml.namespace.QName) : java.util.Iterator<Dynamic>;
	...
	*   of the element.
	*/
	@:overload override public function removeAttributeNode(oldAttr : org.w3c.dom.Attr) : org.w3c.dom.Attr;
	...
	* @since DOM Level 3
	*/
	@:overload override public function setIdAttribute(name : String, isId : Bool) : Void;
	...
	*/
	@:overload override public function getChildElements(name : javax.xml.soap.Name) : java.util.Iterator<Dynamic>;
	...
	*/
	@:overload public function addChildElement(element : SOAPElement) : SOAPElement;
	...
	* @since SAAJ 1.3
	*/
	@:require(java3) @:overload public function addNotUnderstoodHeaderElement(name : javax.xml.namespace.QName) : javax.xml.soap.SOAPHeaderElement;
	...
	*/
	@:overload override public function getAllAttributes() : java.util.Iterator<Dynamic>;
	...
	* @since DOM Level 3
	*/
	@:overload @:public override public function appendChild(newChild : Node) : Node;
	...
	* this returns <code>null</code>.
	*/
	@:overload @:public override public function getPreviousSibling() : Node;
	...
	*         <code>SOAPElement</code> object
	*/
	@:overload override public function getElementName() : javax.xml.soap.Name;
	...
	*   elements.
	*/
	@:overload override public function setAttributeNode(newAttr : org.w3c.dom.Attr) : org.w3c.dom.Attr;
	...
	*   NO_MODIFICATION_ALLOWED_ERR: Raised if this node is readonly.
	*/
	@:overload override public function removeAttribute(name : String) : Void;
	...
	*                          <code>SOAPElement</code> object
	*/
	@:overload override public function addChildElement(localName : String, prefix : String) : SOAPElement;
	...
	* @since SAAJ 1.3
	*/
	@:require(java3) @:overload override public function getAttributeValue(qname : javax.xml.namespace.QName) : String;
	...
	* @since SAAJ 1.3
	*/
	@:require(java3) @:overload override public function addChildElement(qname : javax.xml.namespace.QName) : SOAPElement;
	...
	* @since SAAJ 1.2
	*/
	@:require(java2) @:overload override public function setValue(value : String) : Void;
	...
	*/
	@:overload override public function addTextNode(text : String) : SOAPElement;
	...
	* @since DOM Level 3
	*/
	@:overload @:public override public function replaceChild(newChild : Node, oldChild : Node) : Node;
	...
	*/
	@:overload override public function getElementsByTagName(name : String) : org.w3c.dom.NodeList;
	...
	*        the given prefix
	*/
	@:overload override public function getNamespaceURI(prefix : String) : String;
	...
	* @since DOM Level 3
	*/
	@:overload @:public override public function isSameNode(other : Node) : Bool;
	...
	* @since SAAJ 1.2
	*/
	@:require(java2) @:overload override public function getVisibleNamespacePrefixes() : java.util.Iterator<Dynamic>;
	
	/**
	* The last child of this node. If there is no such node, this returns
	* <code>null</code>.
	*/
	@:overload @:public override public function getLastChild() : Node;
	...
	*         removed successfully; <code>false</code> if it was not
	*/
	@:overload override public function removeNamespaceDeclaration(prefix : String) : Bool;
	
	/**
	*  The type information associated with this element.
	* @since DOM Level 3
	*/
	@:overload override public function getSchemaTypeInfo() : org.w3c.dom.TypeInfo;
