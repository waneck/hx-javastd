...
{
	@:protected @:static @:final private static var MUST_UNDERSTAND_ONLY(default, null) : Bool;
	...
	@:overload @:protected @:abstract private function createHeaderElement(name : javax.xml.soap.Name) : javax.xml.soap.SOAPHeaderElement;
	
	@:overload @:protected @:abstract private function createHeaderElement(name : javax.xml.namespace.QName) : javax.xml.soap.SOAPHeaderElement;
	
	@:overload @:protected @:abstract private function getNotUnderstoodName() : com.sun.xml.internal.messaging.saaj.soap.name.NameImpl;
	
	@:overload @:protected @:abstract private function getUpgradeName() : com.sun.xml.internal.messaging.saaj.soap.name.NameImpl;
	
	@:overload @:protected @:abstract private function getSupportedEnvelopeName() : com.sun.xml.internal.messaging.saaj.soap.name.NameImpl;
	
	@:overload @:public public function addHeaderElement(name : javax.xml.soap.Name) : javax.xml.soap.SOAPHeaderElement;
	
	@:overload @:public public function addHeaderElement(name : javax.xml.namespace.QName) : javax.xml.soap.SOAPHeaderElement;
	...
	@:overload @:protected private function getHeaderElementsForActor(actor : String, detach : Bool, mustUnderstand : Bool) : java.util.Iterator<Dynamic>;
	
	@:overload @:protected private function getHeaderElements(actor : String, detach : Bool, mustUnderstand : Bool) : java.util.Iterator<Dynamic>;
	...
	@:overload @:public public function examineAllHeaderElements() : java.util.Iterator<Dynamic>;
	
	@:overload @:public public function examineMustUnderstandHeaderElements(actor : String) : java.util.Iterator<Dynamic>;
	
	@:overload @:public public function extractAllHeaderElements() : java.util.Iterator<Dynamic>;
	
	@:overload @:public public function addUpgradeHeaderElement(supportedSoapUris : java.util.Iterator<Dynamic>) : javax.xml.soap.SOAPHeaderElement;
	
	@:overload @:public public function addUpgradeHeaderElement(supportedSoapUri : String) : javax.xml.soap.SOAPHeaderElement;
	
	@:overload @:public public function addUpgradeHeaderElement(supportedSoapUris : java.NativeArray<String>) : javax.xml.soap.SOAPHeaderElement;
