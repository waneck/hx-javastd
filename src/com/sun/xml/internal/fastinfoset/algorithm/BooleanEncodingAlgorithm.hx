...
extern class BooleanEncodingAlgorithm extends com.sun.xml.internal.fastinfoset.algorithm.BuiltInEncodingAlgorithm
{
	...
	@:overload @:public public function getPrimtiveLengthFromOctetLength(octetLength : Int, firstOctet : Int) : Int;
	
	@:overload @:public @:final public function decodeFromBytesToBooleanArray(bdata : java.NativeArray<Bool>, bstart : Int, blength : Int, b : java.NativeArray<java.StdTypes.Int8>, start : Int, length : Int) : Void;
	
	@:overload @:public override public function encodeToBytes(array : Dynamic, astart : Int, alength : Int, b : java.NativeArray<java.StdTypes.Int8>, start : Int) : Void;
	
	@:overload @:public public function encodeToBytesFromBooleanArray(array : java.NativeArray<Bool>, astart : Int, alength : Int, b : java.NativeArray<java.StdTypes.Int8>, start : Int) : Void;
