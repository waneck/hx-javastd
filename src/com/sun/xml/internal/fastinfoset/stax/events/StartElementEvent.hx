...
extern class StartElementEvent extends com.sun.xml.internal.fastinfoset.stax.events.EventBase implements javax.xml.stream.events.StartElement
{
	...
	*/
	...
	@:overload @:public public function addAttribute(attr : javax.xml.stream.events.Attribute) : Void;
	
	@:overload @:public public function addAttributes(attrs : java.util.Iterator<Dynamic>) : Void;
	
	@:overload @:public public function addNamespace(namespace : javax.xml.stream.events.Namespace) : Void;
	
	@:overload @:public public function addNamespaces(namespaces : java.util.Iterator<Dynamic>) : Void;
