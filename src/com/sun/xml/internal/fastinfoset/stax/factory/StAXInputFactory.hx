...
extern class StAXInputFactory extends javax.xml.stream.XMLInputFactory
{
	...
	*/
	@:overload override public function createXMLStreamReader(xmlfile : java.io.Reader) : javax.xml.stream.XMLStreamReader;
	
	@:overload override public function createXMLStreamReader(s : java.io.InputStream) : javax.xml.stream.XMLStreamReader;
	
	@:overload override public function createXMLStreamReader(systemId : String, xmlfile : java.io.Reader) : javax.xml.stream.XMLStreamReader;
	...
	* @throws XMLStreamException
	*/
	@:overload override public function createXMLEventReader(streamReader : javax.xml.stream.XMLStreamReader) : javax.xml.stream.XMLEventReader;
