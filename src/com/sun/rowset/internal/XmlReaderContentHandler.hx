...
extern class XmlReaderContentHandler extends org.xml.sax.helpers.DefaultHandler
{
	...
	*/
	@:overload @:public public function new(r : javax.sql.RowSet) : Void;
	...
	*/
	@:overload @:public override public function startElement(uri : String, lName : String, qName : String, attributes : org.xml.sax.Attributes) : Void;
	...
	* @exception SAXException if a general SAX error occurs
	*/
	@:overload @:public override public function endElement(uri : String, lName : String, qName : String) : Void;
	...
	*/
	@:overload @:public override public function warning(err : org.xml.sax.SAXParseException) : Void;
