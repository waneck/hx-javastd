...
extern class XmlReaderContentHandler extends org.xml.sax.helpers.DefaultHandler
{
	...
	*/
	@:overload public function startElement(uri : String, lName : String, qName : String, attributes : org.xml.sax.Attributes) : Void;
	...
	* @exception SAXException if a general SAX error occurs
	*/
	@:overload public function endElement(uri : String, lName : String, qName : String) : Void;
