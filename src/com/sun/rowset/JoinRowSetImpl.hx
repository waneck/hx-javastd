...
extern class JoinRowSetImpl extends com.sun.rowset.WebRowSetImpl implements javax.sql.rowset.JoinRowSet
{
	...
	*/
	@:overload @:public public function setJoinType(type : Int) : Void;
	...
	* @since 1.2
	*/
	@:require(java2) @:overload @:public override public function getObject(columnIndex : Int) : Dynamic;
	...
	* @see DatabaseMetaData#updatesAreDetected
	*/
	@:overload @:public override public function columnUpdated(indexColumn : Int) : Bool;
	...
	*            rowset is <code>ResultSet.CONCUR_READ_ONLY</code>
	*/
	@:overload @:public override public function updateCharacterStream(columnName : String, x : java.io.Reader, length : Int) : Void;
	...
	*/
	@:overload @:public override public function getRef(columnName : String) : java.sql.Ref;
	...
	*/
	@:overload @:public override public function getBlob(columnName : String) : java.sql.Blob;
	...
	*/
	@:overload @:public override public function getClob(columnName : String) : java.sql.Clob;
	...
	*/
	@:overload @:public override public function getArray(columnName : String) : java.sql.Array;
	...
	* @see #getKeyColumns
	*/
	@:overload @:public override public function setKeyColumns(cols : java.NativeArray<Int>) : Void;
	...
	*          contents to XML
	*/
	@:overload @:public override public function writeXml(rs : java.sql.ResultSet, writer : java.io.Writer) : Void;
	...
	*          contents to XML
	*/
	@:overload @:public override public function writeXml(writer : java.io.Writer) : Void;
	...
	*/
	@:overload @:public override public function readXml(reader : java.io.Reader) : Void;
	...
	*/
	@:overload @:public override public function readXml(iStream : java.io.InputStream) : Void;
	...
	*/
	@:overload @:public override public function writeXml(oStream : java.io.OutputStream) : Void;
	...
	* @throws IOException if an IO exception occurs
	*/
	@:overload @:public override public function writeXml(rs : java.sql.ResultSet, oStream : java.io.OutputStream) : Void;
	...
	*/
	@:overload @:public override public function addRowSetListener(listener : javax.sql.RowSetListener) : Void;
	...
	*/
	@:overload @:public override public function removeRowSetListener(listener : javax.sql.RowSetListener) : Void;
