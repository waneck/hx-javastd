...
{
	@:overload @:public public function new(_in : org.omg.CORBA.portable.InputStream) : Void;
	...
	*/
	...
	@:overload @:public override public function read_value(clz : Class<Dynamic>) : java.io.Serializable;
	
	@:overload @:public override public function read_value(factory : org.omg.CORBA.portable.BoxedValueHelper) : java.io.Serializable;
	
	@:overload @:public override public function read_value(rep_id : String) : java.io.Serializable;
	...
	@:overload @:protected private function narrow() : org.omg.CORBA_2_3.portable.InputStream;
	
	@:overload @:public public function getProxiedInputStream() : org.omg.CORBA.portable.InputStream;
	
	//@:protected @:final private var _in(default, null) : org.omg.CORBA.portable.InputStream;
