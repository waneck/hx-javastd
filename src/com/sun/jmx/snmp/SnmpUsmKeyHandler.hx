...
* @since 1.5
*/
@:require(java5) extern interface SnmpUsmKeyHandler
{
	/**
	...
	*/
	@:overload public function password_to_key(algoName : java.lang.String.String, password : java.lang.String.String) : java.NativeArray<java.StdTypes.Int8>;
	...
	* @exception IllegalArgumentException If the algorithm is unknown.
	*/
	@:overload public function localizeAuthKey(algoName : java.lang.String.String, key : java.NativeArray<java.StdTypes.Int8>, engineId : com.sun.jmx.snmp.SnmpEngineId.SnmpEngineId) : java.NativeArray<java.StdTypes.Int8>;
	...
	* @exception IllegalArgumentException If the algorithm is unknown.
	*/
	@:overload public function localizePrivKey(algoName : java.lang.String.String, key : java.NativeArray<java.StdTypes.Int8>, engineId : com.sun.jmx.snmp.SnmpEngineId.SnmpEngineId, keysize : Int) : java.NativeArray<java.StdTypes.Int8>;
	...
	* @exception IllegalArgumentException If the algorithm is unknown.
	*/
	@:overload public function calculateAuthDelta(algoName : java.lang.String.String, oldKey : java.NativeArray<java.StdTypes.Int8>, newKey : java.NativeArray<java.StdTypes.Int8>, random : java.NativeArray<java.StdTypes.Int8>) : java.NativeArray<java.StdTypes.Int8>;
	...
	* @exception IllegalArgumentException If the algorithm is unknown.
	*/
	@:overload public function calculatePrivDelta(algoName : java.lang.String.String, oldKey : java.NativeArray<java.StdTypes.Int8>, newKey : java.NativeArray<java.StdTypes.Int8>, random : java.NativeArray<java.StdTypes.Int8>, deltaSize : Int) : java.NativeArray<java.StdTypes.Int8>;
