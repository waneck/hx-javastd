...
*/
extern interface SnmpMibSubRequest extends com.sun.jmx.snmp.agent.SnmpMibRequest.SnmpMibRequest
{
	/**
	...
	*
	*/
	@:overload public function registerGetException(varbind : SnmpVarBind, exception : com.sun.jmx.snmp.SnmpStatusException.SnmpStatusException) : Void;
	...
	*
	*/
	@:overload public function registerSetException(varbind : SnmpVarBind, exception : com.sun.jmx.snmp.SnmpStatusException.SnmpStatusException) : Void;
	...
	*
	*/
	@:overload public function registerCheckException(varbind : SnmpVarBind, exception : com.sun.jmx.snmp.SnmpStatusException.SnmpStatusException) : Void;
