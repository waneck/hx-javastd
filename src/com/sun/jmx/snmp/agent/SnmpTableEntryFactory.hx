...
**/
extern interface SnmpTableEntryFactory extends com.sun.jmx.snmp.agent.SnmpTableCallbackHandler.SnmpTableCallbackHandler
{
	/**
	...
	*
	**/
	@:overload public function createNewEntry(request : com.sun.jmx.snmp.agent.SnmpMibSubRequest.SnmpMibSubRequest, rowOid : SnmpOid, depth : Int, meta : com.sun.jmx.snmp.agent.SnmpMibTable.SnmpMibTable) : Void;
