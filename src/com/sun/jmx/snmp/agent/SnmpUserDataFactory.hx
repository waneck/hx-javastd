...
*
**/
extern interface SnmpUserDataFactory
{
	/**
	...
	* @since 1.5
	**/
	@:require(java5) @:overload public function allocateUserData(requestPdu : com.sun.jmx.snmp.SnmpPdu.SnmpPdu) : java.lang.Object.Object;
	...
	* @since 1.5
	**/
	@:require(java5) @:overload public function releaseUserData(userData : java.lang.Object.Object, responsePdu : com.sun.jmx.snmp.SnmpPdu.SnmpPdu) : Void;
