...
**/
extern class SnmpStandardObjectServer implements java.io.Serializable.Serializable
{
	/**
	...
	*  the MIB node.
	*/
	@:overload public function get(meta : com.sun.jmx.snmp.agent.SnmpStandardMetaServer.SnmpStandardMetaServer, req : com.sun.jmx.snmp.agent.SnmpMibSubRequest.SnmpMibSubRequest, depth : Int) : Void;
	...
	*  the MIB node.
	*/
	@:overload public function set(meta : com.sun.jmx.snmp.agent.SnmpStandardMetaServer.SnmpStandardMetaServer, req : com.sun.jmx.snmp.agent.SnmpMibSubRequest.SnmpMibSubRequest, depth : Int) : Void;
	...
	*  the MIB node.
	*/
	@:overload public function check(meta : com.sun.jmx.snmp.agent.SnmpStandardMetaServer.SnmpStandardMetaServer, req : com.sun.jmx.snmp.agent.SnmpMibSubRequest.SnmpMibSubRequest, depth : Int) : Void;
