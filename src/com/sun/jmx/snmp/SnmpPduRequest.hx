...
*/
extern class SnmpPduRequest extends SnmpPduPacket implements com.sun.jmx.snmp.SnmpPduRequestType.SnmpPduRequestType
{
	/**
	...
	* @since 1.5
	*/
	@:require(java5) @:overload public function setErrorIndex(i : Int) : Void;
	...
	* @since 1.5
	*/
	@:require(java5) @:overload public function setErrorStatus(i : Int) : Void;
	...
	* @since 1.5
	*/
	@:require(java5) @:overload public function getErrorIndex() : Int;
	...
	* @since 1.5
	*/
	@:require(java5) @:overload public function getErrorStatus() : Int;
