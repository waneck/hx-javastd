...
*/
extern class Enumerated implements java.io.Serializable.Serializable
{
	/**
	...
	*/
	@:overload public function new(valueString : java.lang.String.String) : Void;
	...
	*/
	@:overload public function valueIndexes() : java.util.Enumeration.Enumeration<Dynamic>;
	...
	*/
	@:overload public function valueStrings() : java.util.Enumeration.Enumeration<Dynamic>;
	...
	*/
	@:overload public function equals(obj : java.lang.Object.Object) : Bool;
	...
	*/
	@:overload @:abstract private function getIntTable() : java.util.Hashtable.Hashtable<Dynamic, Dynamic>;
	...
	* @return An hashtable for read-only purpose
	*/
	@:overload @:abstract private function getStringTable() : java.util.Hashtable.Hashtable<Dynamic, Dynamic>;
