...
* @since 1.5
*/
@:require(java5) extern interface SnmpEngineFactory
{
	/**
	...
	*/
	@:overload public function createEngine(p : com.sun.jmx.snmp.SnmpEngineParameters.SnmpEngineParameters) : com.sun.jmx.snmp.SnmpEngine.SnmpEngine;
	...
	* @return The newly created SnmpEngine.
	*/
	@:overload public function createEngine(p : com.sun.jmx.snmp.SnmpEngineParameters.SnmpEngineParameters, ipacl : com.sun.jmx.snmp.InetAddressAcl.InetAddressAcl) : com.sun.jmx.snmp.SnmpEngine.SnmpEngine;
