...
//// SNMP Runtime import
////
@:internal extern class SnmpSubBulkRequestHandler extends com.sun.jmx.snmp.daemon.SnmpSubRequestHandler.SnmpSubRequestHandler
{
	/**
	* The constuctor initialize the subrequest with the whole varbind list contained
	* in the original request.
	*/
	@:overload private function new(engine : com.sun.jmx.snmp.SnmpEngine.SnmpEngine, server : com.sun.jmx.snmp.daemon.SnmpAdaptorServer.SnmpAdaptorServer, incRequest : com.sun.jmx.snmp.internal.SnmpIncomingRequest.SnmpIncomingRequest, agent : com.sun.jmx.snmp.agent.SnmpMibAgent.SnmpMibAgent, req : com.sun.jmx.snmp.SnmpPdu.SnmpPdu, nonRepeat : Int, maxRepeat : Int, R : Int) : Void;
	
	/**
	* The constuctor initialize the subrequest with the whole varbind list contained
	* in the original request.
	*/
	@:overload private function new(server : com.sun.jmx.snmp.daemon.SnmpAdaptorServer.SnmpAdaptorServer, agent : com.sun.jmx.snmp.agent.SnmpMibAgent.SnmpMibAgent, req : com.sun.jmx.snmp.SnmpPdu.SnmpPdu, nonRepeat : Int, maxRepeat : Int, R : Int) : Void;
