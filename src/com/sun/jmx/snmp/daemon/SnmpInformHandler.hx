...
*/
extern interface SnmpInformHandler extends SnmpDefinitions
{
	/**
	...
	*/
	@:overload @:abstract public function processSnmpPollData(request : SnmpInformRequest, errStatus : Int, errIndex : Int, vblist : SnmpVarBindList) : Void;
	...
	* @param request The <CODE>SnmpInformRequest</CODE> associated with this callback.
	*/
	@:overload @:abstract public function processSnmpPollTimeout(request : SnmpInformRequest) : Void;
	...
	*/
	@:overload @:abstract public function processSnmpInternalError(request : SnmpInformRequest, errmsg : java.lang.String.String) : Void;
