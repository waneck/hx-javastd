...
* @since 1.5
*/
@:require(java5) extern class SnmpParams implements SnmpDefinitions
{
	/**
	...
	*/
	@:overload @:abstract public function allowSnmpSets() : Bool;
	...
	*/
	@:overload public function setProtocolVersion(protocolversion : Int) : Void;
