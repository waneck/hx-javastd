...
* @since 1.5
*/
@:require(java5) extern interface SnmpAccessControlModel extends com.sun.jmx.snmp.internal.SnmpModel.SnmpModel
{
	/**
	...
	*/
	@:overload public function checkAccess(version : Int, principal : java.lang.String.String, securityLevel : Int, pduType : Int, securityModel : Int, contextName : java.NativeArray<java.StdTypes.Int8>, oid : SnmpOid) : Void;
	...
	*/
	@:overload public function checkPduAccess(version : Int, principal : java.lang.String.String, securityLevel : Int, pduType : Int, securityModel : Int, contextName : java.NativeArray<java.StdTypes.Int8>, pdu : com.sun.jmx.snmp.SnmpPdu.SnmpPdu) : Void;
	...
	*/
	@:overload public function enableSnmpV1V2SetRequest() : Bool;
	...
	*/
	@:overload public function disableSnmpV1V2SetRequest() : Bool;
	...
	*/
	@:overload public function isSnmpV1V2SetRequestAuthorized() : Bool;
