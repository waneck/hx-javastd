...
*/
extern interface SnmpSecuritySubSystem extends com.sun.jmx.snmp.internal.SnmpSubSystem.SnmpSubSystem
{
	/**
	...
	*/
	@:overload public function createSecurityCache(id : Int) : com.sun.jmx.snmp.internal.SnmpSecurityCache.SnmpSecurityCache;
	...
	*/
	@:overload public function releaseSecurityCache(id : Int, cache : com.sun.jmx.snmp.internal.SnmpSecurityCache.SnmpSecurityCache) : Void;
