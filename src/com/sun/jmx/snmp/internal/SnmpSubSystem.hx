...
*/
extern interface SnmpSubSystem
{
	/**
	...
	*/
	@:overload public function addModel(id : Int, model : com.sun.jmx.snmp.internal.SnmpModel.SnmpModel) : Void;
	...
	*/
	@:overload public function removeModel(id : Int) : com.sun.jmx.snmp.internal.SnmpModel.SnmpModel;
	...
	* @return The model.
	*/
	@:overload public function getModel(id : Int) : com.sun.jmx.snmp.internal.SnmpModel.SnmpModel;
	
	/**
	* Returns the set of model Ids that have been registered within the sub system.
	*/
	@:overload public function getModelIds() : java.NativeArray<Int>;
	
	/**
	* Returns the set of model names that have been registered within the sub system.
	*/
	@:overload public function getModelNames() : java.NativeArray<java.lang.String.String>;
