...
* @since 1.5
*/
@:require(java5) extern interface SnmpMsgProcessingSubSystem extends com.sun.jmx.snmp.internal.SnmpSubSystem.SnmpSubSystem
{
	/**
	...
	*/
	@:overload public function setSecuritySubSystem(security : com.sun.jmx.snmp.internal.SnmpSecuritySubSystem.SnmpSecuritySubSystem) : Void;
	...
	*/
	@:overload public function getIncomingRequest(model : Int, factory : com.sun.jmx.snmp.SnmpPduFactory.SnmpPduFactory) : com.sun.jmx.snmp.internal.SnmpIncomingRequest.SnmpIncomingRequest;
	...
	*/
	@:overload public function getOutgoingRequest(model : Int, factory : com.sun.jmx.snmp.SnmpPduFactory.SnmpPduFactory) : com.sun.jmx.snmp.internal.SnmpOutgoingRequest.SnmpOutgoingRequest;
	...
	* @return The pdu.
	*/
	@:overload public function getRequestPdu(model : Int, p : com.sun.jmx.snmp.SnmpParams.SnmpParams, type : Int) : com.sun.jmx.snmp.SnmpPdu.SnmpPdu;
	...
	*/
	@:overload public function getIncomingResponse(model : Int, factory : com.sun.jmx.snmp.SnmpPduFactory.SnmpPduFactory) : com.sun.jmx.snmp.internal.SnmpIncomingResponse.SnmpIncomingResponse;
	...
	*/
	@:overload public function decode(version : Int, pdu : java.NativeArray<java.StdTypes.Int8>) : com.sun.jmx.snmp.internal.SnmpDecryptedPdu.SnmpDecryptedPdu;
	...
	* @return The encoded bytes number.
	*/
	@:overload public function encode(version : Int, pdu : com.sun.jmx.snmp.internal.SnmpDecryptedPdu.SnmpDecryptedPdu, outputBytes : java.NativeArray<java.StdTypes.Int8>) : Int;
