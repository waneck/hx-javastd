...
* @since 1.5
*/
@:require(java5) extern interface SnmpSecurityParameters
{
	/**
	...
	*/
	@:overload public function encode(outputBytes : java.NativeArray<java.StdTypes.Int8>) : Int;
	
	/**
	* BER decoding of security parameters.
	* @param params Encoded parameters.
	*/
	@:overload public function decode(params : java.NativeArray<java.StdTypes.Int8>) : Void;
