...
@:internal extern class JDMInformItem extends com.sun.jmx.snmp.IPAcl.SimpleNode.SimpleNode
{
	private var comm : com.sun.jmx.snmp.IPAcl.JDMInformCommunity.JDMInformCommunity;
	...
	@:overload public function getCommunity() : com.sun.jmx.snmp.IPAcl.JDMInformCommunity.JDMInformCommunity;
