...
@:internal extern class JDMAccess extends com.sun.jmx.snmp.IPAcl.SimpleNode.SimpleNode
{
	...
	@:overload private function putPermission(entry : com.sun.jmx.snmp.IPAcl.AclEntryImpl.AclEntryImpl) : Void;
