...
@:internal extern class JDMTrapItem extends com.sun.jmx.snmp.IPAcl.SimpleNode.SimpleNode
{
	private var comm : com.sun.jmx.snmp.IPAcl.JDMTrapCommunity.JDMTrapCommunity;
	...
	@:overload public function getCommunity() : com.sun.jmx.snmp.IPAcl.JDMTrapCommunity.JDMTrapCommunity;
