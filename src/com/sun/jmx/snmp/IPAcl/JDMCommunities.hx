...
@:internal extern class JDMCommunities extends com.sun.jmx.snmp.IPAcl.SimpleNode.SimpleNode
{
	...
	@:overload public function buildCommunities(entry : com.sun.jmx.snmp.IPAcl.AclEntryImpl.AclEntryImpl) : Void;
