...
*/
@:internal extern class NetMaskImpl extends com.sun.jmx.snmp.IPAcl.PrincipalImpl.PrincipalImpl implements java.security.acl.Group.Group implements java.io.Serializable.Serializable
{
	private var subnet : java.NativeArray<java.StdTypes.Int8>;
	...
	*/
	@:overload public function new(a : java.lang.String.String, prefix : Int) : Void;
