...
* @since 1.6
*/
@:require(java6) extern interface SourcePositions
{
	/**
	...
	*/
	@:overload public function getStartPosition(file : com.sun.source.tree.CompilationUnitTree, tree : com.sun.source.tree.Tree) : haxe.Int64;
	...
	*/
	@:overload public function getEndPosition(file : com.sun.source.tree.CompilationUnitTree, tree : com.sun.source.tree.Tree) : haxe.Int64;
