...
@:require(java6) extern class TreeScanner<R, P> implements com.sun.source.tree.TreeVisitor<R, P>
{
	/** Scan a single node.
	*/
	@:overload public function scan(node : com.sun.source.tree.Tree, p : P) : R;
	
	/** Scan a list of nodes.
	*/
	@:overload public function scan(nodes : java.lang.Iterable<com.sun.source.tree.Tree>, p : P) : R;
	...
	*/
	@:overload public function reduce(r1 : R, r2 : R) : R;
