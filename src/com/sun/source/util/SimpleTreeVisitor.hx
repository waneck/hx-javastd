...
@:require(java6) extern class SimpleTreeVisitor<R, P> implements com.sun.source.tree.TreeVisitor<R, P>
{
	...
	@:overload @:protected private function defaultAction(node : com.sun.source.tree.Tree, p : P) : R;
	
	@:overload @:public @:final public function visit(node : com.sun.source.tree.Tree, p : P) : R;
	
	@:overload @:public @:final public function visit(nodes : java.lang.Iterable<com.sun.source.tree.Tree>, p : P) : R;
