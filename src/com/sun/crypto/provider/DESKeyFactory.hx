...
* questions.
*/
extern class DESKeyFactory extends javax.crypto.SecretKeyFactorySpi
{
	/**
	* Empty constructor
	*/
	...
	*/
	@:overload private function engineGetKeySpec(key : javax.crypto.SecretKey, keySpec : Class<Dynamic>) : java.security.spec.KeySpec;
