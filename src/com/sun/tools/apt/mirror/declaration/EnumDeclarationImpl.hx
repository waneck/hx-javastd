...
*/
extern class EnumDeclarationImpl extends com.sun.tools.apt.mirror.declaration.ClassDeclarationImpl implements com.sun.mirror.declaration.EnumDeclaration
{
	/**
	* {@inheritDoc}
	*/
