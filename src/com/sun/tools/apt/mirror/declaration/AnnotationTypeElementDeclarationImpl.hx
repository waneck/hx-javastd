...
* questions.
*/
extern class AnnotationTypeElementDeclarationImpl extends com.sun.tools.apt.mirror.declaration.MethodDeclarationImpl implements com.sun.mirror.declaration.AnnotationTypeElementDeclaration
{
	/**
	* {@inheritDoc}
	*/
