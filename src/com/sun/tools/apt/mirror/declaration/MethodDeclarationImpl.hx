...
* questions.
*/
extern class MethodDeclarationImpl extends com.sun.tools.apt.mirror.declaration.ExecutableDeclarationImpl implements com.sun.mirror.declaration.MethodDeclaration
{
	/**
	* {@inheritDoc}
	*/
