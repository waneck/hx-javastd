...
*/
extern class AnnotationTypeDeclarationImpl extends com.sun.tools.apt.mirror.declaration.InterfaceDeclarationImpl implements com.sun.mirror.declaration.AnnotationTypeDeclaration
{
	/**
	* {@inheritDoc}
	*/
