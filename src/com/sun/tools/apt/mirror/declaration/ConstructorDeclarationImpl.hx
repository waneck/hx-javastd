...
* questions.
*/
extern class ConstructorDeclarationImpl extends com.sun.tools.apt.mirror.declaration.ExecutableDeclarationImpl implements com.sun.mirror.declaration.ConstructorDeclaration
{
	/**
	* {@inheritDoc}
