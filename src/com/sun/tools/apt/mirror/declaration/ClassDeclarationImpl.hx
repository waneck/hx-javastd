...
*/
extern class ClassDeclarationImpl extends com.sun.tools.apt.mirror.declaration.TypeDeclarationImpl implements com.sun.mirror.declaration.ClassDeclaration
{
	/**
	* {@inheritDoc}
