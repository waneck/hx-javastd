...
* this sample code.
*/
@:internal extern interface EventNotifier
{
	@:overload public function vmStartEvent(e : com.sun.jdi.event.VMStartEvent) : Void;
	...
	@:overload public function breakpointEvent(e : com.sun.jdi.event.BreakpointEvent) : Void;
	
	@:overload public function fieldWatchEvent(e : com.sun.jdi.event.WatchpointEvent) : Void;
	
	@:overload public function stepEvent(e : com.sun.jdi.event.StepEvent) : Void;
	
	@:overload public function exceptionEvent(e : com.sun.jdi.event.ExceptionEvent) : Void;
	
	@:overload public function methodEntryEvent(e : com.sun.jdi.event.MethodEntryEvent) : Void;
	
	@:overload public function methodExitEvent(e : com.sun.jdi.event.MethodExitEvent) : Bool;
