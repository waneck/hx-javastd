...
extern interface NGCCEventSource
{
	...
	*/
	@:overload public function replace(_old : com.sun.tools.internal.jxc.gen.config.NGCCEventReceiver, _new : com.sun.tools.internal.jxc.gen.config.NGCCEventReceiver) : Int;
