...
extern class NGCCInterleaveFilter implements com.sun.tools.internal.jxc.gen.config.NGCCEventSource implements com.sun.tools.internal.jxc.gen.config.NGCCEventReceiver
{
	...
	*/
	@:overload private function new(parent : com.sun.tools.internal.jxc.gen.config.NGCCHandler, cookie : Int) : Void;
	
	@:overload private function setHandlers(receivers : java.NativeArray<com.sun.tools.internal.jxc.gen.config.NGCCEventReceiver>) : Void;
	
	/** event receiverse. */
	private var _receivers : java.NativeArray<com.sun.tools.internal.jxc.gen.config.NGCCEventReceiver>;
	
	@:overload public function replace(oldHandler : com.sun.tools.internal.jxc.gen.config.NGCCEventReceiver, newHandler : com.sun.tools.internal.jxc.gen.config.NGCCEventReceiver) : Int;
	...
	*      null.
	*/
	@:overload public function joinByEnterElement(source : com.sun.tools.internal.jxc.gen.config.NGCCEventReceiver, uri : String, local : String, qname : String, atts : org.xml.sax.Attributes) : Void;
	
	@:overload public function joinByLeaveElement(source : com.sun.tools.internal.jxc.gen.config.NGCCEventReceiver, uri : String, local : String, qname : String) : Void;
	
	@:overload public function joinByEnterAttribute(source : com.sun.tools.internal.jxc.gen.config.NGCCEventReceiver, uri : String, local : String, qname : String) : Void;
	
	@:overload public function joinByLeaveAttribute(source : com.sun.tools.internal.jxc.gen.config.NGCCEventReceiver, uri : String, local : String, qname : String) : Void;
	
	@:overload public function joinByText(source : com.sun.tools.internal.jxc.gen.config.NGCCEventReceiver, value : String) : Void;
