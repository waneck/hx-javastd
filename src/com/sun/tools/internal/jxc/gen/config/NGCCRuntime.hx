...
extern class NGCCRuntime implements org.xml.sax.ContentHandler implements com.sun.tools.internal.jxc.gen.config.NGCCEventSource
{
	...
	*/
	@:overload @:public public function setRootHandler(rootHandler : com.sun.tools.internal.jxc.gen.config.NGCCHandler) : Void;
	...
	*/
	...
	@:overload @:public public function replace(o : com.sun.tools.internal.jxc.gen.config.NGCCEventReceiver, n : com.sun.tools.internal.jxc.gen.config.NGCCEventReceiver) : Int;
