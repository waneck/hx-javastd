...
extern interface JavaCompiler
{
	...
	*/
	@:overload public function bind(rootTypes : java.util.Collection<com.sun.tools.internal.xjc.api.Reference>, additionalElementDecls : java.util.Map<javax.xml.namespace.QName, com.sun.tools.internal.xjc.api.Reference>, defaultNamespaceRemap : String, source : com.sun.mirror.apt.AnnotationProcessorEnvironment) : com.sun.tools.internal.xjc.api.J2SJAXBModel;
