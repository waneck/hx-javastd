...
@:internal extern class AbstractListField extends com.sun.tools.internal.xjc.generator.bean.field.AbstractField
{
	...
	private var field : com.sun.codemodel.internal.JFieldVar;
	...
	* Otherwise null.
	*/
	private var primitiveType(default, null) : com.sun.codemodel.internal.JPrimitiveType;
	
	private var listT(default, null) : com.sun.codemodel.internal.JClass;
	
	/**
	* Call {@link #generate()} method right after this.
	*/
	@:overload private function new(outline : com.sun.tools.internal.xjc.generator.bean.ClassOutlineImpl, prop : com.sun.tools.internal.xjc.model.CPropertyInfo, eagerInstanciation : Bool) : Void;
	
	@:overload @:final private function generate() : Void;
	...
	*/
	@:overload @:abstract private function getCoreListType() : com.sun.codemodel.internal.JClass;
	
	/** Generates accessor methods. */
	@:overload @:abstract private function generateAccessors() : Void;
...
@:native('com$sun$tools$internal$xjc$generator$bean$field$AbstractListField$Accessor') extern class AbstractListField_Accessor extends com.sun.tools.internal.xjc.generator.bean.field.AbstractField.AbstractField_Accessor
{
	...
	*/
	private var field(default, null) : com.sun.codemodel.internal.JFieldRef;
	
	@:overload override private function new($target : com.sun.codemodel.internal.JExpression) : Void;
	
	@:overload @:final private function unbox(exp : com.sun.codemodel.internal.JExpression) : com.sun.codemodel.internal.JExpression;
	
	@:overload @:final private function box(exp : com.sun.codemodel.internal.JExpression) : com.sun.codemodel.internal.JExpression;
	...
	*/
	@:overload @:final private function ref(canBeNull : Bool) : com.sun.codemodel.internal.JExpression;
