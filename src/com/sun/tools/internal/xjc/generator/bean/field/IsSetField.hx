...
{
	@:overload private function new(outline : com.sun.tools.internal.xjc.generator.bean.ClassOutlineImpl, prop : com.sun.tools.internal.xjc.model.CPropertyInfo, core : com.sun.tools.internal.xjc.outline.FieldOutline, unsetMethod : Bool, issetMethod : Bool) : Void;
