...
* questions.
*/
extern class UntypedListField extends com.sun.tools.internal.xjc.generator.bean.field.AbstractListField
{
	/**
	* @param coreList
...
@:native('com$sun$tools$internal$xjc$generator$bean$field$UntypedListField$Accessor') @:internal extern class UntypedListField_Accessor extends com.sun.tools.internal.xjc.generator.bean.field.AbstractListField.AbstractListField_Accessor
{
