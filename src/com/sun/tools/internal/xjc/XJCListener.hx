...
extern class XJCListener implements com.sun.xml.internal.bind.api.ErrorListener
{
	...
	* @since 2.0.1
	*/
	@:require(java0) @:overload @:public public function generatedFile(fileName : String, current : Int, total : Int) : Void;
	...
	*/
	@:overload @:public public function compiled(outline : com.sun.tools.internal.xjc.outline.Outline) : Void;
	...
	* @since 2.1 EA2
	*/
	@:require(java1) @:overload @:public public function error(exception : org.xml.sax.SAXParseException) : Void;
