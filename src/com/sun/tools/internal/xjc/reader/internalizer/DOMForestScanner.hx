...
extern class DOMForestScanner
{
	...
	* this forest.
	*/
	@:overload @:public public function new(_forest : com.sun.tools.internal.xjc.reader.internalizer.DOMForest) : Void;
...
*/
@:native('com$sun$tools$internal$xjc$reader$internalizer$DOMForestScanner$LocationResolver') @:internal extern class DOMForestScanner_LocationResolver extends org.xml.sax.helpers.XMLFilterImpl implements org.xml.sax.Locator
{
