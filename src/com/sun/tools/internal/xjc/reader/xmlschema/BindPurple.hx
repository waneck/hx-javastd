...
* questions.
*/
extern class BindPurple extends com.sun.tools.internal.xjc.reader.xmlschema.ColorBinder
{
	/**
	...
	*/
	...
	@:overload @:public override public function empty(ct : com.sun.xml.internal.xsom.XSContentType) : Void;
