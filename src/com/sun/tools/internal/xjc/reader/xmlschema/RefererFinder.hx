...
{
	@:overload public function getReferer(src : com.sun.xml.internal.xsom.XSComponent) : java.util.Set<com.sun.xml.internal.xsom.XSComponent>;
	
	@:overload public function schemaSet(xss : com.sun.xml.internal.xsom.XSSchemaSet) : Void;
	
	@:overload public function schema(xs : com.sun.xml.internal.xsom.XSSchema) : Void;
	
	@:overload public function elementDecl(e : com.sun.xml.internal.xsom.XSElementDecl) : Void;
	
	@:overload public function complexType(ct : com.sun.xml.internal.xsom.XSComplexType) : Void;
