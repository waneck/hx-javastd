...
* questions.
*/
@:internal extern class RefererFinder implements com.sun.xml.internal.xsom.visitor.XSVisitor
{
	@:overload @:public public function getReferer(src : com.sun.xml.internal.xsom.XSComponent) : java.util.Set<com.sun.xml.internal.xsom.XSComponent>;
	
	@:overload @:public public function schemaSet(xss : com.sun.xml.internal.xsom.XSSchemaSet) : Void;
	
	@:overload @:public public function schema(xs : com.sun.xml.internal.xsom.XSSchema) : Void;
	
	@:overload @:public public function elementDecl(e : com.sun.xml.internal.xsom.XSElementDecl) : Void;
	
	@:overload @:public public function complexType(ct : com.sun.xml.internal.xsom.XSComplexType) : Void;
	...
	@:overload @:public public function identityConstraint(decl : com.sun.xml.internal.xsom.XSIdentityConstraint) : Void;
