...
* questions.
*/
extern class XMLSchemaInternalizationLogic implements com.sun.tools.internal.xjc.reader.internalizer.InternalizationLogic
{
...
*/
@:native('com$sun$tools$internal$xjc$reader$xmlschema$parser$XMLSchemaInternalizationLogic$ReferenceFinder') @:internal extern class XMLSchemaInternalizationLogic_ReferenceFinder extends com.sun.tools.internal.xjc.reader.internalizer.AbstractReferenceFinderImpl
{
