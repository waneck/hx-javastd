...
{
	@:overload private function new(model : com.sun.tools.internal.xjc.model.Model, source : com.sun.xml.internal.xsom.XSComponent, locator : org.xml.sax.Locator, customizations : com.sun.tools.internal.xjc.model.CCustomizations) : Void;
