...
extern class CPropertyInfo implements com.sun.xml.internal.bind.v2.model.core.PropertyInfo<com.sun.tools.internal.xjc.model.nav.NType, com.sun.tools.internal.xjc.model.nav.NClass> implements com.sun.tools.internal.xjc.model.CCustomizable
{
	...
	*/
	@:public public var baseType : com.sun.codemodel.internal.JType;
	...
	*/
	@:public public var realization : com.sun.tools.internal.xjc.generator.bean.field.FieldRenderer;
	...
	*/
	@:public public var defaultValue : com.sun.tools.internal.xjc.model.CDefaultValue;
	
	@:overload @:protected private function new(name : String, collection : Bool, source : com.sun.xml.internal.xsom.XSComponent, customizations : com.sun.tools.internal.xjc.model.CCustomizations, locator : org.xml.sax.Locator) : Void;
	
	@:overload @:public public function parent() : com.sun.tools.internal.xjc.model.CTypeInfo;
	...
	*/
	...
	@:overload @:public @:abstract public function getAdapter() : com.sun.tools.internal.xjc.model.CAdapter;
	...
	*/
	@:overload @:public public function getName(isPublic : Bool) : String;
	...
	* dangerous method.
	*/
	@:overload @:public public function setName(isPublic : Bool, newName : String) : Void;
	
	@:overload @:public public function displayName() : String;
	
	@:overload @:public public function isCollection() : Bool;
	
	@:overload @:public @:abstract public function ref() : java.util.Collection<com.sun.tools.internal.xjc.model.CTypeInfo>;
	...
	*/
	...
	@:overload @:public @:abstract public function accept<V>(visitor : com.sun.tools.internal.xjc.model.CPropertyVisitor<V>) : V;
	
	/**
	* Checks if the given {@link TypeUse} would need an explicit {@link XmlSchemaType}
	* annotation with the given type name.
	*/
	@:overload @:protected @:static private static function needsExplicitTypeName(type : com.sun.tools.internal.xjc.model.TypeUse, typeName : javax.xml.namespace.QName) : Bool;
	...
	*/
	@:overload @:public public function collectElementNames(table : java.util.Map<javax.xml.namespace.QName, com.sun.tools.internal.xjc.model.CPropertyInfo>) : javax.xml.namespace.QName;
