...
extern class CClassInfo extends com.sun.tools.internal.xjc.model.AbstractCElement implements com.sun.xml.internal.bind.v2.model.core.ClassInfo<com.sun.tools.internal.xjc.model.nav.NType, com.sun.tools.internal.xjc.model.nav.NClass> implements com.sun.tools.internal.xjc.model.CClassInfoParent implements com.sun.tools.internal.xjc.model.CClass implements com.sun.tools.internal.xjc.model.nav.NClass
{
	...
	*/
	...
	@:overload @:public public function hasAttributeWildcard() : Bool;
	
	@:overload @:public public function hasAttributeWildcard(hasAttributeWildcard : Bool) : Void;
	
	@:overload @:public public function hasSubClasses() : Bool;
	
	/**
	* Returns true if a new attribute wildcard property needs to be
	* declared on this class.
	*/
	@:overload @:public public function declaresAttributeWildcard() : Bool;
	
	/**
	* Returns true if this class inherits a wildcard attribute property
	* from its ancestor classes.
	*/
	@:overload @:public public function inheritsAttributeWildcard() : Bool;
	...
	*/
	@:overload @:public public function getProperties() : java.util.List<com.sun.tools.internal.xjc.model.CPropertyInfo>;
	
	@:overload @:public public function hasValueProperty() : Bool;
	
	/**
	* Gets a propery by name.
	*/
	@:overload @:public public function getProperty(name : String) : com.sun.tools.internal.xjc.model.CPropertyInfo;
	...
	*/
	...
	@:overload @:public public function setOrdered(value : Bool) : Void;
	...
	*/
	...
	@:overload @:public public function parent() : com.sun.tools.internal.xjc.model.CClassInfoParent;
	
	@:overload @:public public function setUserSpecifiedImplClass(implClass : String) : Void;
	...
	* Adds a new property.
	*/
	@:overload @:public public function addProperty(prop : com.sun.tools.internal.xjc.model.CPropertyInfo) : Void;
	...
	*/
	@:overload @:public public function setBaseClass(base : com.sun.tools.internal.xjc.model.CClass) : Void;
	...
	* @see #getRefBaseClass()
	*/
	@:overload @:public public function getBaseClass() : com.sun.tools.internal.xjc.model.CClassInfo;
	
	@:overload @:public public function getRefBaseClass() : com.sun.tools.internal.xjc.model.CClassRef;
	
	/**
	* Enumerates all the sub-classes of this class.
	*/
	@:overload @:public public function listSubclasses() : java.util.Iterator<com.sun.tools.internal.xjc.model.CClassInfo>;
	
	@:overload @:public override public function getSubstitutionHead() : com.sun.tools.internal.xjc.model.CClassInfo;
	
	@:overload @:public public function _implements(c : com.sun.codemodel.internal.JClass) : Void;
	
	/** Creates a new constructor declaration and adds it. */
	@:overload @:public public function addConstructor(fieldNames : java.NativeArray<String>) : Void;
	
	/** list all constructor declarations. */
	@:overload @:public public function getConstructors() : java.util.Collection<com.sun.tools.internal.xjc.model.Constructor>;
	
	@:overload @:public @:final public function accept<T>(visitor : com.sun.tools.internal.xjc.model.CClassInfoParent.CClassInfoParent_Visitor<T>) : T;
	
	@:overload @:public public function getOwnerPackage() : com.sun.codemodel.internal.JPackage;
	
	@:overload @:public @:final override public function getType() : com.sun.tools.internal.xjc.model.nav.NClass;
	
	@:overload @:public @:final override public function toType(o : com.sun.tools.internal.xjc.outline.Outline, aspect : com.sun.tools.internal.xjc.outline.Aspect) : com.sun.codemodel.internal.JClass;
