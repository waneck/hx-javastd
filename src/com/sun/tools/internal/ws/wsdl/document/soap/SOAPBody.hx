...
* questions.
*/
extern class SOAPBody extends com.sun.tools.internal.ws.wsdl.framework.ExtensionImpl
{
	/**
	...
	*/
	...
	@:overload @:public public function getParts() : String;
	
	@:overload @:public public function setParts(s : String) : Void;
