...
* questions.
*/
extern class HTTPBinding extends com.sun.tools.internal.ws.wsdl.framework.ExtensionImpl
{
	/**
	...
	*/
	...
	@:overload @:public public function getVerb() : String;
	
	@:overload @:public public function setVerb(s : String) : Void;
