...
* questions.
*/
extern class SOAPBinding extends com.sun.tools.internal.ws.wsdl.framework.ExtensionImpl
{
	/**
	...
	*/
	...
	@:overload @:public public function getTransport() : String;
	
	@:overload @:public public function setTransport(s : String) : Void;
