...
extern class Messager extends com.sun.tools.javac.util.Log implements com.sun.javadoc.DocErrorReporter
{
	...
	@:overload public static function preRegister(context : com.sun.tools.javac.util.Context, programName : String, errWriter : java.io.PrintWriter, warnWriter : java.io.PrintWriter, noticeWriter : java.io.PrintWriter) : Void;
	
	/**
	* Constructor
	* @param programName  Name of the program (for error messages).
	*/
	@:overload private function new(context : com.sun.tools.javac.util.Context, programName : String) : Void;
	...
	*/
	@:overload private function new(context : com.sun.tools.javac.util.Context, programName : String, errWriter : java.io.PrintWriter, warnWriter : java.io.PrintWriter, noticeWriter : java.io.PrintWriter) : Void;
	
	@:overload override private function getDefaultMaxErrors() : Int;
	
	@:overload override private function getDefaultMaxWarnings() : Int;
	...
	*/
	@:overload public function error(pos : com.sun.javadoc.SourcePosition, key : String, a1 : String) : Void;
	...
	*/
	@:overload public function error(pos : com.sun.javadoc.SourcePosition, key : String, a1 : String, a2 : String) : Void;
	...
	*/
	@:overload public function error(pos : com.sun.javadoc.SourcePosition, key : String, a1 : String, a2 : String, a3 : String) : Void;
	...
	* @param key selects message from resource
	*/
	@:overload public function warning(pos : com.sun.javadoc.SourcePosition, key : String) : Void;
	...
	* @param a1 first argument
	*/
	@:overload public function warning(pos : com.sun.javadoc.SourcePosition, key : String, a1 : String) : Void;
	...
	* @param a2 second argument
	*/
	@:overload public function warning(pos : com.sun.javadoc.SourcePosition, key : String, a1 : String, a2 : String) : Void;
	...
	* @param a3 third argument
	*/
	@:overload public function warning(pos : com.sun.javadoc.SourcePosition, key : String, a1 : String, a2 : String, a3 : String) : Void;
	...
	* @param a3 third argument
	*/
	@:overload public function warning(pos : com.sun.javadoc.SourcePosition, key : String, a1 : String, a2 : String, a3 : String, a4 : String) : Void;
	...
	*/
	@:overload public function nerrors() : Int;
	
	/**
	* Return total number of warnings, including those recorded
	* in the compilation log.
	*/
	@:overload public function nwarnings() : Int;
	
	/**
	* Print exit message.
	*/
	@:overload public function exitNotice() : Void;
