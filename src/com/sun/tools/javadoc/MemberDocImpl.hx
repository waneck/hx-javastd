...
extern class MemberDocImpl extends com.sun.tools.javadoc.ProgramElementDocImpl implements com.sun.javadoc.MemberDoc
{
	...
	* constructor.
	*/
	@:overload @:public public function new(env : com.sun.tools.javadoc.DocEnv, sym : com.sun.tools.javac.code.Symbol, doc : String, tree : com.sun.tools.javac.tree.JCTree, lineMap : com.sun.tools.javac.util.Position.Position_LineMap) : Void;
	
	/**
	* Returns true if this field was synthesized by the compiler.
	*/
	@:overload @:public @:abstract public function isSynthetic() : Bool;
