...
*/
@:internal extern class SerialFieldTagImpl extends com.sun.tools.javadoc.TagImpl implements com.sun.javadoc.SerialFieldTag implements java.lang.Comparable<Dynamic>
{
	/**
