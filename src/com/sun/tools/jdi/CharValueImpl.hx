...
* questions.
*/
extern class CharValueImpl extends com.sun.tools.jdi.PrimitiveValueImpl implements com.sun.jdi.CharValue
{
	@:overload @:public override public function equals(obj : Dynamic) : Bool;
	
	@:overload @:public override public function hashCode() : Int;
	
	@:overload @:public public function compareTo(obj : com.sun.jdi.CharValue) : Int;
