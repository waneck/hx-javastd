...
* questions.
*/
extern class ShortValueImpl extends com.sun.tools.jdi.PrimitiveValueImpl implements com.sun.jdi.ShortValue
{
	@:overload @:public override public function equals(obj : Dynamic) : Bool;
	
	@:overload @:public override public function hashCode() : Int;
	
	@:overload @:public public function compareTo(obj : com.sun.jdi.ShortValue) : Int;
	
	@:overload @:public override public function type() : com.sun.jdi.Type;
	
	@:overload @:public public function value() : java.StdTypes.Int16;
