...
extern class SequenceGen implements com.sun.tools.corba.se.idl.SequenceGen implements com.sun.tools.corba.se.idl.toJavaPortable.JavaGenerator
{
	...
	*
	**/
	@:overload public function generate(symbolTable : java.util.Hashtable<Dynamic, Dynamic>, s : com.sun.tools.corba.se.idl.SequenceEntry, stream : java.io.PrintWriter) : Void;
