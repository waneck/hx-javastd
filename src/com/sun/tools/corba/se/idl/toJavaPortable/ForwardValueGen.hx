...
extern class ForwardValueGen implements com.sun.tools.corba.se.idl.ForwardValueGen implements com.sun.tools.corba.se.idl.toJavaPortable.JavaGenerator
{
	/**
	...
	*
	**/
	@:overload @:public public function generate(symbolTable : java.util.Hashtable<Dynamic, Dynamic>, v : com.sun.tools.corba.se.idl.ForwardValueEntry, str : java.io.PrintWriter) : Void;
	...
	**/
	...
	@:protected private var v : com.sun.tools.corba.se.idl.ForwardValueEntry;
