...
extern class PrimitiveGen implements com.sun.tools.corba.se.idl.PrimitiveGen implements com.sun.tools.corba.se.idl.toJavaPortable.JavaGenerator
{
	...
	**/
	@:overload public function generate(symbolTable : java.util.Hashtable<Dynamic, Dynamic>, e : com.sun.tools.corba.se.idl.PrimitiveEntry, stream : java.io.PrintWriter) : Void;
