...
*/
//// NOTES:
extern class PrimitiveEntry extends com.sun.tools.corba.se.idl.SymtabEntry
{
	/**
	...
	**/
	...
	@:overload @:protected private function new(that : com.sun.tools.corba.se.idl.PrimitiveEntry) : Void;
