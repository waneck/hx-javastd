...
*/
//// NOTES:
extern class ExceptionEntry extends com.sun.tools.corba.se.idl.StructEntry
{
	/**
	...
	**/
	...
	@:overload @:protected private function new(that : com.sun.tools.corba.se.idl.ExceptionEntry) : Void;
