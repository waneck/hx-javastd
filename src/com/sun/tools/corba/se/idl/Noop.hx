...
{
	@:overload public function generate(symbolTable : java.util.Hashtable<Dynamic, Dynamic>, entry : com.sun.tools.corba.se.idl.AttributeEntry, stream : java.io.PrintWriter) : Void;
	
	@:overload public function generate(symbolTable : java.util.Hashtable<Dynamic, Dynamic>, entry : com.sun.tools.corba.se.idl.ConstEntry, stream : java.io.PrintWriter) : Void;
	
	@:overload public function generate(symbolTable : java.util.Hashtable<Dynamic, Dynamic>, entry : com.sun.tools.corba.se.idl.EnumEntry, stream : java.io.PrintWriter) : Void;
	...
	@:overload public function generate(symbolTable : java.util.Hashtable<Dynamic, Dynamic>, entry : com.sun.tools.corba.se.idl.ForwardEntry, stream : java.io.PrintWriter) : Void;
	
	@:overload public function generate(symbolTable : java.util.Hashtable<Dynamic, Dynamic>, entry : com.sun.tools.corba.se.idl.ForwardValueEntry, stream : java.io.PrintWriter) : Void;
	
	@:overload public function generate(symbolTable : java.util.Hashtable<Dynamic, Dynamic>, entry : com.sun.tools.corba.se.idl.IncludeEntry, stream : java.io.PrintWriter) : Void;
	
	@:overload public function generate(symbolTable : java.util.Hashtable<Dynamic, Dynamic>, entry : com.sun.tools.corba.se.idl.InterfaceEntry, stream : java.io.PrintWriter) : Void;
	
	@:overload public function generate(symbolTable : java.util.Hashtable<Dynamic, Dynamic>, entry : com.sun.tools.corba.se.idl.ValueEntry, stream : java.io.PrintWriter) : Void;
	
	@:overload public function generate(symbolTable : java.util.Hashtable<Dynamic, Dynamic>, entry : com.sun.tools.corba.se.idl.ValueBoxEntry, stream : java.io.PrintWriter) : Void;
	
	@:overload public function generate(symbolTable : java.util.Hashtable<Dynamic, Dynamic>, entry : com.sun.tools.corba.se.idl.MethodEntry, stream : java.io.PrintWriter) : Void;
	...
	@:overload public function generate(symbolTable : java.util.Hashtable<Dynamic, Dynamic>, entry : com.sun.tools.corba.se.idl.ParameterEntry, stream : java.io.PrintWriter) : Void;
	
	@:overload public function generate(symbolTable : java.util.Hashtable<Dynamic, Dynamic>, entry : com.sun.tools.corba.se.idl.PragmaEntry, stream : java.io.PrintWriter) : Void;
	
	@:overload public function generate(symbolTable : java.util.Hashtable<Dynamic, Dynamic>, entry : com.sun.tools.corba.se.idl.PrimitiveEntry, stream : java.io.PrintWriter) : Void;
	
	@:overload public function generate(symbolTable : java.util.Hashtable<Dynamic, Dynamic>, entry : com.sun.tools.corba.se.idl.SequenceEntry, stream : java.io.PrintWriter) : Void;
	
	@:overload public function generate(symbolTable : java.util.Hashtable<Dynamic, Dynamic>, entry : com.sun.tools.corba.se.idl.StringEntry, stream : java.io.PrintWriter) : Void;
	
	@:overload public function generate(symbolTable : java.util.Hashtable<Dynamic, Dynamic>, entry : com.sun.tools.corba.se.idl.StructEntry, stream : java.io.PrintWriter) : Void;
	
	@:overload public function generate(symbolTable : java.util.Hashtable<Dynamic, Dynamic>, entry : com.sun.tools.corba.se.idl.TypedefEntry, stream : java.io.PrintWriter) : Void;
	
	@:overload public function generate(symbolTable : java.util.Hashtable<Dynamic, Dynamic>, entry : com.sun.tools.corba.se.idl.UnionEntry, stream : java.io.PrintWriter) : Void;
	
	@:overload public function generate(symbolTable : java.util.Hashtable<Dynamic, Dynamic>, entry : com.sun.tools.corba.se.idl.NativeEntry, stream : java.io.PrintWriter) : Void;
