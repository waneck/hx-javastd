...
extern class CharacterRangeTable_attribute extends com.sun.tools.classfile.Attribute
{
	...
	*/
	public static var CRT_STATEMENT(default, null) : Int;
	
	public static var CRT_BLOCK(default, null) : Int;
	
	public static var CRT_ASSIGNMENT(default, null) : Int;
	
	public static var CRT_FLOW_CONTROLLER(default, null) : Int;
	
	public static var CRT_FLOW_TARGET(default, null) : Int;
	
	public static var CRT_INVOKE(default, null) : Int;
	
	public static var CRT_CREATE(default, null) : Int;
	
	public static var CRT_BRANCH_TRUE(default, null) : Int;
...
@:native('com$sun$tools$classfile$CharacterRangeTable_attribute$Entry') extern class CharacterRangeTable_attribute_Entry
{
	...
	public var character_range_start(default, null) : Int;
	
	public var character_range_end(default, null) : Int;
