...
{
	@:overload public function new(constant_pool : com.sun.tools.classfile.ConstantPool, default_value : com.sun.tools.classfile.Annotation.Annotation_element_value) : Void;
