...
*/
////javax.tools;
extern interface DisassemblerTool extends javax.tools.Tool extends javax.tools.OptionChecker
{
	/**
...
*/
@:native('com$sun$tools$javap$DisassemblerTool$DisassemblerTask') @:internal extern interface DisassemblerTool_DisassemblerTask extends java.util.concurrent.Callable<Null<Bool>>
{
	/**
