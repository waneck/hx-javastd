...
* questions.
*/
extern class AnnotationProxyMaker
{
	/**
	* Returns a dynamic proxy for an annotation mirror.
	*/
	@:native('generateAnnotation') @:overload @:public @:static public static function _generateAnnotation<A : java.lang.annotation.Annotation>(anno : com.sun.tools.javac.code.Attribute.Attribute_Compound, annoType : Class<A>) : A;
	
	
}
@:native('com$sun$tools$javac$model$AnnotationProxyMaker$ValueVisitor') @:internal extern class AnnotationProxyMaker_ValueVisitor implements com.sun.tools.javac.code.Attribute.Attribute_Visitor
{
...
* type.
*/
@:native('com$sun$tools$javac$model$AnnotationProxyMaker$MirroredTypeExceptionProxy') @:internal extern class AnnotationProxyMaker_MirroredTypeExceptionProxy extends sun.reflect.annotation.ExceptionProxy
{
...
* types.
*/
@:native('com$sun$tools$javac$model$AnnotationProxyMaker$MirroredTypesExceptionProxy') @:internal extern class AnnotationProxyMaker_MirroredTypesExceptionProxy extends sun.reflect.annotation.ExceptionProxy
{
	@:overload @:public public function toString() : String;
