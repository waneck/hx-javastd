...
extern class AnnotationProxyMaker
{
	...
	*/
	@:native('generateAnnotation') @:overload public static function _generateAnnotation<A : java.lang.annotation.Annotation>(anno : com.sun.tools.javac.code.Attribute.Attribute_Compound, annoType : Class<A>) : A;
