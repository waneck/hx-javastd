...
extern class Flags
{
	@:overload @:public @:static public static function toString(flags : haxe.Int64) : String;
	
	@:overload @:public @:static public static function asFlagSet(mask : haxe.Int64) : java.util.EnumSet<com.sun.tools.javac.code.Flags.Flags_Flag>;
	...
	*/
	...
	@:public @:static @:final public static var STRICTFP(default, null) : Int;
	
	/* Flag that marks a symbol synthetic, added in classfile v49.0. */
	@:public @:static @:final public static var SYNTHETIC(default, null) : Int;
	...
	*  classfile v49.0. */
	...
	@:public @:static @:final public static var StandardFlags(default, null) : Int;
	
	@:public @:static @:final public static var ModifierFlags(default, null) : Int;
	...
	*/
	@:public @:static @:final public static var DEPRECATED(default, null) : Int;
	
	/** Flag is set for a variable symbol if the variable's definition
	*  has an initializer part.
	*/
	@:public @:static @:final public static var HASINIT(default, null) : Int;
	...
	*/
	@:public @:static @:final public static var IPROXY(default, null) : Int;
	...
	*  other cases.
	*/
	@:public @:static @:final public static var NOOUTERTHIS(default, null) : Int;
	
	/** Flag is set for package symbols if a package has a member or
	*  directory and therefore exists.
	*/
	@:public @:static @:final public static var EXISTS(default, null) : Int;
	
	/** Flag is set for compiler-generated compound classes
	*  representing multiple variable bounds
	*/
	@:public @:static @:final public static var COMPOUND(default, null) : Int;
	
	/** Flag is set for class symbols if a class file was found for this class.
	*/
	@:public @:static @:final public static var CLASS_SEEN(default, null) : Int;
	
	/** Flag is set for class symbols if a source file was found for this
	*  class.
	*/
	@:public @:static @:final public static var SOURCE_SEEN(default, null) : Int;
	...
	*/
	@:public @:static @:final public static var UNATTRIBUTED(default, null) : Int;
	
	/** Flag for synthesized default constructors of anonymous classes.
	*/
	@:public @:static @:final public static var ANONCONSTR(default, null) : Int;
	
	/** Flag for class symbols to indicate it has been checked and found
	*  acyclic.
	*/
	@:public @:static @:final public static var ACYCLIC(default, null) : Int;
	
	/** Flag that marks bridge methods.
	*/
	@:public @:static @:final public static var BRIDGE(default, null) : haxe.Int64;
	
	/** Flag that marks formal parameters.
	*/
	@:public @:static @:final public static var PARAMETER(default, null) : haxe.Int64;
	
	/** Flag that marks varargs methods.
	*/
	@:public @:static @:final public static var VARARGS(default, null) : haxe.Int64;
	
	/** Flag for annotation type symbols to indicate it has been
	*  checked and found acyclic.
	*/
	@:public @:static @:final public static var ACYCLIC_ANN(default, null) : haxe.Int64;
	
	/** Flag that marks a generated default constructor.
	*/
	@:public @:static @:final public static var GENERATEDCONSTR(default, null) : haxe.Int64;
	...
	*/
	@:public @:static @:final public static var HYPOTHETICAL(default, null) : haxe.Int64;
	
	/**
	* Flag that marks an internal proprietary class.
	*/
	@:public @:static @:final public static var PROPRIETARY(default, null) : haxe.Int64;
	
	/**
	* Flag that marks a a multi-catch parameter
	*/
	@:public @:static @:final public static var UNION(default, null) : haxe.Int64;
	
	/**
	* Flag that marks a signature-polymorphic invoke method.
	* (These occur inside java.lang.invoke.MethodHandle.)
	*/
	@:public @:static @:final public static var POLYMORPHIC_SIGNATURE(default, null) : haxe.Int64;
	
	/**
	* Flag that marks a special kind of bridge methods (the ones that
	* come from restricted supertype bounds)
	*/
	@:public @:static @:final public static var OVERRIDE_BRIDGE(default, null) : haxe.Int64;
	
	/**
	* Flag that marks an 'effectively final' local variable
	*/
	@:public @:static @:final public static var EFFECTIVELY_FINAL(default, null) : haxe.Int64;
	
	/**
	* Flag that marks non-override equivalent methods with the same signature
	*/
	@:public @:static @:final public static var CLASH(default, null) : haxe.Int64;
	
	/** Modifier masks.
	*/
	@:public @:static @:final public static var AccessFlags(default, null) : Int;
	
	@:public @:static @:final public static var LocalVarFlags(default, null) : haxe.Int64;
	
	@:overload @:public @:static public static function asModifierSet(flags : haxe.Int64) : java.util.Set<javax.lang.model.element.Modifier>;
	
	@:overload @:public @:static public static function isStatic(symbol : com.sun.tools.javac.code.Symbol) : Bool;
	
	@:overload @:public @:static public static function isEnum(symbol : com.sun.tools.javac.code.Symbol) : Bool;
	
	@:overload @:public @:static public static function isConstant(symbol : com.sun.tools.javac.code.Symbol.Symbol_VarSymbol) : Bool;
