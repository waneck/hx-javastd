...
*/
extern interface DiagnosticFormatter<D>
{
	/**
...
*/
@:native('com$sun$tools$javac$api$DiagnosticFormatter$PositionKind') extern enum DiagnosticFormatter_PositionKind
{
	/**
	* Start position
	*/
...
*/
@:native('com$sun$tools$javac$api$DiagnosticFormatter$Configuration') @:internal extern interface DiagnosticFormatter_Configuration
{
	/**
	...
	*/
	@:overload @:public public function setVisible(visibleParts : java.util.Set<com.sun.tools.javac.api.DiagnosticFormatter.DiagnosticFormatter_Configuration_DiagnosticPart>) : Void;
...
*/
@:native('com$sun$tools$javac$api$DiagnosticFormatter$Configuration$DiagnosticPart') extern enum DiagnosticFormatter_Configuration_DiagnosticPart
{
	/**
...
* diagnostic (or both).
*/
@:native('com$sun$tools$javac$api$DiagnosticFormatter$Configuration$MultilineLimit') extern enum DiagnosticFormatter_Configuration_MultilineLimit
{
	/**
