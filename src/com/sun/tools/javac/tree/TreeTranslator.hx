...
extern class TreeTranslator extends com.sun.tools.javac.tree.JCTree.JCTree_Visitor
{
	...
	*/
	@:overload public function translateVarDefs(trees : com.sun.tools.javac.util.List<JCVariableDecl>) : com.sun.tools.javac.util.List<JCVariableDecl>;
	
	/**  Visitor method: translate a list of type parameters.
	*/
	@:overload public function translateTypeParams(trees : com.sun.tools.javac.util.List<JCTypeParameter>) : com.sun.tools.javac.util.List<JCTypeParameter>;
	
	/**  Visitor method: translate a list of case parts of switch statements.
	*/
	@:overload public function translateCases(trees : com.sun.tools.javac.util.List<JCCase>) : com.sun.tools.javac.util.List<JCCase>;
	
	/**  Visitor method: translate a list of catch clauses in try statements.
	*/
	@:overload public function translateCatchers(trees : com.sun.tools.javac.util.List<JCCatch>) : com.sun.tools.javac.util.List<JCCatch>;
	
	/**  Visitor method: translate a list of catch clauses in try statements.
	*/
	@:overload public function translateAnnotations(trees : com.sun.tools.javac.util.List<JCAnnotation>) : com.sun.tools.javac.util.List<JCAnnotation>;
