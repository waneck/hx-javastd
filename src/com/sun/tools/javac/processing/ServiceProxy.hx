...
* questions.
*/
@:internal extern class ServiceProxy
{
	/**
...
*
*/
@:native('com$sun$tools$javac$processing$ServiceProxy$ServiceConfigurationError') @:internal extern class ServiceProxy_ServiceConfigurationError extends java.lang.Error
{
