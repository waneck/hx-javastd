...
*/
extern class FieldWriterImpl extends com.sun.tools.doclets.formats.html.AbstractMemberWriter implements com.sun.tools.doclets.internal.toolkit.FieldWriter implements com.sun.tools.doclets.internal.toolkit.MemberSummaryWriter
{
	...
	* {@inheritDoc}
	*/
	@:overload @:public public function getFieldDocTreeHeader(field : com.sun.javadoc.FieldDoc, fieldDetailsTree : com.sun.tools.doclets.internal.toolkit.Content) : com.sun.tools.doclets.internal.toolkit.Content;
	
	/**
	* {@inheritDoc}
	*/
	@:overload @:public public function getSignature(field : com.sun.javadoc.FieldDoc) : com.sun.tools.doclets.internal.toolkit.Content;
	
	/**
	* {@inheritDoc}
	*/
	@:overload @:public public function addDeprecated(field : com.sun.javadoc.FieldDoc, fieldDocTree : com.sun.tools.doclets.internal.toolkit.Content) : Void;
	
	/**
	* {@inheritDoc}
	*/
	@:overload @:public public function addComments(field : com.sun.javadoc.FieldDoc, fieldDocTree : com.sun.tools.doclets.internal.toolkit.Content) : Void;
	
	/**
	* {@inheritDoc}
	*/
	@:overload @:public public function addTags(field : com.sun.javadoc.FieldDoc, fieldDocTree : com.sun.tools.doclets.internal.toolkit.Content) : Void;
	
	/**
	* {@inheritDoc}
	*/
	@:overload @:public public function getFieldDetails(fieldDetailsTree : com.sun.tools.doclets.internal.toolkit.Content) : com.sun.tools.doclets.internal.toolkit.Content;
