...
extern class ConstructorWriterImpl extends com.sun.tools.doclets.formats.html.AbstractExecutableMemberWriter implements com.sun.tools.doclets.internal.toolkit.ConstructorWriter implements com.sun.tools.doclets.internal.toolkit.MemberSummaryWriter
{
	...
	* {@inheritDoc}
	*/
	@:overload @:public public function getConstructorDetailsTreeHeader(classDoc : com.sun.javadoc.ClassDoc, memberDetailsTree : com.sun.tools.doclets.internal.toolkit.Content) : com.sun.tools.doclets.internal.toolkit.Content;
	
	/**
	* {@inheritDoc}
	*/
	@:overload @:public public function getConstructorDocTreeHeader(constructor : com.sun.javadoc.ConstructorDoc, constructorDetailsTree : com.sun.tools.doclets.internal.toolkit.Content) : com.sun.tools.doclets.internal.toolkit.Content;
	
	/**
	* {@inheritDoc}
	*/
	@:overload @:public public function getSignature(constructor : com.sun.javadoc.ConstructorDoc) : com.sun.tools.doclets.internal.toolkit.Content;
	
	/**
	* {@inheritDoc}
	*/
	@:overload @:public override public function setSummaryColumnStyle(tdTree : com.sun.tools.doclets.formats.html.markup.HtmlTree) : Void;
	
	/**
	* {@inheritDoc}
	*/
	@:overload @:public public function addDeprecated(constructor : com.sun.javadoc.ConstructorDoc, constructorDocTree : com.sun.tools.doclets.internal.toolkit.Content) : Void;
	
	/**
	* {@inheritDoc}
	*/
	@:overload @:public public function addComments(constructor : com.sun.javadoc.ConstructorDoc, constructorDocTree : com.sun.tools.doclets.internal.toolkit.Content) : Void;
	
	/**
	* {@inheritDoc}
	*/
	@:overload @:public public function addTags(constructor : com.sun.javadoc.ConstructorDoc, constructorDocTree : com.sun.tools.doclets.internal.toolkit.Content) : Void;
	
	/**
	* {@inheritDoc}
	*/
	@:overload @:public public function getConstructorDetails(constructorDetailsTree : com.sun.tools.doclets.internal.toolkit.Content) : com.sun.tools.doclets.internal.toolkit.Content;
	
	/**
	* {@inheritDoc}
	*/
	@:overload @:public public function getConstructorDoc(constructorDocTree : com.sun.tools.doclets.internal.toolkit.Content, isLastContent : Bool) : com.sun.tools.doclets.internal.toolkit.Content;
	...
	*/
	@:overload @:public public function setFoundNonPubConstructor(foundNonPubConstructor : Bool) : Void;
