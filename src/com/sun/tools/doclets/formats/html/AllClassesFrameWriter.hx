...
extern class AllClassesFrameWriter extends com.sun.tools.doclets.formats.html.HtmlDocletWriter
{
	...
	*/
	@:public @:static @:final public static var OUTPUT_FILE_NAME_FRAMES(default, null) : String;
	
	/**
	* The name of the output file without frames
	*/
	@:public @:static @:final public static var OUTPUT_FILE_NAME_NOFRAMES(default, null) : String;
	...
	*/
	@:overload @:protected private function buildAllClassesFile(wantFrames : Bool) : Void;
	...
	* @param wantFrames True if we want frames.
	*/
	@:overload @:protected private function addAllClasses(content : com.sun.tools.doclets.internal.toolkit.Content, wantFrames : Bool) : Void;
	...
	*/
	@:overload @:protected private function addContents(classlist : java.util.List<com.sun.javadoc.Doc>, wantFrames : Bool, content : com.sun.tools.doclets.internal.toolkit.Content) : Void;
