...
@:require(java5) extern class PropertyBuilder extends com.sun.tools.doclets.internal.toolkit.builders.AbstractMemberBuilder
{
	...
	*/
	@:overload public static function getInstance(configuration : com.sun.tools.doclets.internal.toolkit.Configuration, classDoc : com.sun.javadoc.ClassDoc, writer : com.sun.tools.doclets.internal.toolkit.PropertyWriter) : com.sun.tools.doclets.internal.toolkit.builders.PropertyBuilder;
	...
	*/
	@:overload public function buildPropertyDoc(node : com.sun.tools.doclets.internal.toolkit.builders.XMLNode, memberDetailsTree : com.sun.tools.doclets.internal.toolkit.Content) : Void;
	...
	* @param fieldDocTree the content tree to which the documentation will be added
	*/
	@:overload public function buildPropertyComments(node : com.sun.tools.doclets.internal.toolkit.builders.XMLNode, fieldDocTree : com.sun.tools.doclets.internal.toolkit.Content) : Void;
	...
	* @return the field writer for this builder.
	*/
	@:overload public function getWriter() : com.sun.tools.doclets.internal.toolkit.PropertyWriter;
