...
@:require(java5) extern class TagletWriter
{
	...
	*/
	private var isFirstSentence : Bool;
	
	/**
	* @return an instance of the output object.
	*/
	@:overload @:abstract public function getOutputInstance() : com.sun.tools.doclets.internal.toolkit.taglets.TagletOutput;
	
	/**
	* Returns the output for the DocRoot inline tag.
	* @return the output for the DocRoot inline tag.
	*/
	@:overload @:abstract private function getDocRootOutput() : com.sun.tools.doclets.internal.toolkit.taglets.TagletOutput;
	...
	*/
	@:overload @:abstract private function deprecatedTagOutput(doc : com.sun.javadoc.Doc) : com.sun.tools.doclets.internal.toolkit.taglets.TagletOutput;
	...
	*/
	@:overload @:abstract private function getMsgRetriever() : com.sun.tools.doclets.internal.toolkit.util.MessageRetriever;
	...
	* @return the header for the param tags.
	*/
	@:overload @:abstract private function getParamHeader(header : String) : com.sun.tools.doclets.internal.toolkit.taglets.TagletOutput;
	...
	*/
	@:overload @:abstract private function paramTagOutput(paramTag : com.sun.javadoc.ParamTag, paramName : String) : com.sun.tools.doclets.internal.toolkit.taglets.TagletOutput;
	...
	*/
	@:overload @:abstract private function returnTagOutput(returnTag : com.sun.javadoc.Tag) : com.sun.tools.doclets.internal.toolkit.taglets.TagletOutput;
	...
	*/
	@:overload @:abstract private function seeTagOutput(holder : com.sun.javadoc.Doc, seeTags : java.NativeArray<com.sun.javadoc.SeeTag>) : com.sun.tools.doclets.internal.toolkit.taglets.TagletOutput;
	...
	*/
	@:overload @:abstract private function simpleTagOutput(simpleTags : java.NativeArray<com.sun.javadoc.Tag>, header : String) : com.sun.tools.doclets.internal.toolkit.taglets.TagletOutput;
	...
	*/
	@:overload @:abstract private function simpleTagOutput(simpleTag : com.sun.javadoc.Tag, header : String) : com.sun.tools.doclets.internal.toolkit.taglets.TagletOutput;
	...
	* @return the header for the throws tag.
	*/
	@:overload @:abstract private function getThrowsHeader() : com.sun.tools.doclets.internal.toolkit.taglets.TagletOutput;
	...
	*/
	@:overload @:abstract private function throwsTagOutput(throwsTag : com.sun.javadoc.ThrowsTag) : com.sun.tools.doclets.internal.toolkit.taglets.TagletOutput;
	...
	*/
	@:overload @:abstract private function throwsTagOutput(throwsType : com.sun.javadoc.Type) : com.sun.tools.doclets.internal.toolkit.taglets.TagletOutput;
	...
	*/
	@:overload @:abstract private function valueTagOutput(field : com.sun.javadoc.FieldDoc, constantVal : String, includeLink : Bool) : com.sun.tools.doclets.internal.toolkit.taglets.TagletOutput;
	...
	*/
	@:overload @:abstract public function commentTagsToOutput(holderTag : com.sun.javadoc.Tag, tags : java.NativeArray<com.sun.javadoc.Tag>) : com.sun.tools.doclets.internal.toolkit.taglets.TagletOutput;
	...
	* @return the {@link TagletOutput} representing the comments.
	*/
	@:overload @:abstract public function commentTagsToOutput(holderDoc : com.sun.javadoc.Doc, tags : java.NativeArray<com.sun.javadoc.Tag>) : com.sun.tools.doclets.internal.toolkit.taglets.TagletOutput;
	...
	* @return the {@link TagletOutput} representing the comments.
	*/
	@:overload @:abstract public function commentTagsToOutput(holderTag : com.sun.javadoc.Tag, holderDoc : com.sun.javadoc.Doc, tags : java.NativeArray<com.sun.javadoc.Tag>, isFirstSentence : Bool) : com.sun.tools.doclets.internal.toolkit.taglets.TagletOutput;
	...
	*/
	@:overload @:abstract public function getTagletOutputInstance() : com.sun.tools.doclets.internal.toolkit.taglets.TagletOutput;
