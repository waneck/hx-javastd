...
extern class GIFImageWriter extends javax.imageio.ImageWriter
{
	...
	@:overload override public function canWriteSequence() : Bool;
	...
	*/
	...
	@:overload override public function write(sm : javax.imageio.metadata.IIOMetadata, iioimage : javax.imageio.IIOImage, p : javax.imageio.ImageWriteParam) : Void;
...
{
	@:overload override public function setCompressionMode(mode : Int) : Void;
