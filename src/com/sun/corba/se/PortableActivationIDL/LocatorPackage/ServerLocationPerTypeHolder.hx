...
{
	public var value : com.sun.corba.se.PortableActivationIDL.LocatorPackage.ServerLocationPerType;
	
	@:overload public function new() : Void;
	
	@:overload public function new(initialValue : com.sun.corba.se.PortableActivationIDL.LocatorPackage.ServerLocationPerType) : Void;
