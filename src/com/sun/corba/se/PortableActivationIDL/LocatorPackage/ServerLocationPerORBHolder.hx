...
{
	public var value : com.sun.corba.se.PortableActivationIDL.LocatorPackage.ServerLocationPerORB;
	
	@:overload public function new() : Void;
	
	@:overload public function new(initialValue : com.sun.corba.se.PortableActivationIDL.LocatorPackage.ServerLocationPerORB) : Void;
