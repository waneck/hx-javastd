...
{
	@:public public var value : com.sun.corba.se.PortableActivationIDL.LocatorPackage.ServerLocationPerORB;
	
	@:overload @:public public function new() : Void;
	
	@:overload @:public public function new(initialValue : com.sun.corba.se.PortableActivationIDL.LocatorPackage.ServerLocationPerORB) : Void;
