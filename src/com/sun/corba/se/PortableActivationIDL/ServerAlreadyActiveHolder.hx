...
{
	public var value : com.sun.corba.se.PortableActivationIDL.ServerAlreadyActive;
	
	@:overload public function new() : Void;
	
	@:overload public function new(initialValue : com.sun.corba.se.PortableActivationIDL.ServerAlreadyActive) : Void;
