...
*/
extern class ServerAlreadyActiveHolder implements org.omg.CORBA.portable.Streamable
{
	@:public public var value : com.sun.corba.se.PortableActivationIDL.ServerAlreadyActive;
	
	@:overload @:public public function new() : Void;
	
	@:overload @:public public function new(initialValue : com.sun.corba.se.PortableActivationIDL.ServerAlreadyActive) : Void;
