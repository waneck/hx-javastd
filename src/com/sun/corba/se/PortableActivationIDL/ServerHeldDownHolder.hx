...
{
	public var value : com.sun.corba.se.PortableActivationIDL.ServerHeldDown;
	
	@:overload public function new() : Void;
	
	@:overload public function new(initialValue : com.sun.corba.se.PortableActivationIDL.ServerHeldDown) : Void;
