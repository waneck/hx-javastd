...
{
	public var value : com.sun.corba.se.PortableActivationIDL.ServerAlreadyInstalled;
	
	@:overload public function new() : Void;
	
	@:overload public function new(initialValue : com.sun.corba.se.PortableActivationIDL.ServerAlreadyInstalled) : Void;
