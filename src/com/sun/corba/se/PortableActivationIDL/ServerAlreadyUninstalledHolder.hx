...
{
	public var value : com.sun.corba.se.PortableActivationIDL.ServerAlreadyUninstalled;
	
	@:overload public function new() : Void;
	
	@:overload public function new(initialValue : com.sun.corba.se.PortableActivationIDL.ServerAlreadyUninstalled) : Void;
