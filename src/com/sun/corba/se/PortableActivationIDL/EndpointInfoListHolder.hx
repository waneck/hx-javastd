...
{
	@:public public var value : java.NativeArray<com.sun.corba.se.PortableActivationIDL.EndPointInfo>;
	
	@:overload @:public public function new() : Void;
	
	@:overload @:public public function new(initialValue : java.NativeArray<com.sun.corba.se.PortableActivationIDL.EndPointInfo>) : Void;
