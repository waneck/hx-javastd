...
{
	public var value : com.sun.corba.se.PortableActivationIDL.RepositoryPackage.ServerDef;
	
	@:overload public function new() : Void;
	
	@:overload public function new(initialValue : com.sun.corba.se.PortableActivationIDL.RepositoryPackage.ServerDef) : Void;
