...
{
	public var value : com.sun.corba.se.PortableActivationIDL.EndPointInfo;
	
	@:overload public function new() : Void;
	
	@:overload public function new(initialValue : com.sun.corba.se.PortableActivationIDL.EndPointInfo) : Void;
