...
{
	public var value : com.sun.corba.se.PortableActivationIDL.InitialNameService;
	
	@:overload public function new() : Void;
	
	@:overload public function new(initialValue : com.sun.corba.se.PortableActivationIDL.InitialNameService) : Void;
