...
{
	public var value : com.sun.corba.se.PortableActivationIDL.Activator;
	
	@:overload public function new() : Void;
	
	@:overload public function new(initialValue : com.sun.corba.se.PortableActivationIDL.Activator) : Void;
