...
{
	public var value : com.sun.corba.se.PortableActivationIDL.InvalidORBid;
	
	@:overload public function new() : Void;
	
	@:overload public function new(initialValue : com.sun.corba.se.PortableActivationIDL.InvalidORBid) : Void;
