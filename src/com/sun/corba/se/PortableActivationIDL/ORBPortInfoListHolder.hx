...
{
	public var value : java.NativeArray<com.sun.corba.se.PortableActivationIDL.ORBPortInfo>;
	
	@:overload public function new() : Void;
	
	@:overload public function new(initialValue : java.NativeArray<com.sun.corba.se.PortableActivationIDL.ORBPortInfo>) : Void;
