...
{
	public var value : com.sun.corba.se.PortableActivationIDL.ServerNotActive;
	
	@:overload public function new() : Void;
	
	@:overload public function new(initialValue : com.sun.corba.se.PortableActivationIDL.ServerNotActive) : Void;
