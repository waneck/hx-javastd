...
@:internal extern class DynValueCommonImpl extends com.sun.corba.se.impl.dynamicany.DynAnyComplexImpl implements org.omg.DynamicAny.DynValueCommon
{
	...
	@:overload override public function set_members(value : java.NativeArray<org.omg.DynamicAny.NameValuePair>) : Void;
	
	@:overload override public function set_members_as_dyn_any(value : java.NativeArray<org.omg.DynamicAny.NameDynAnyPair>) : Void;
