...
extern class IDLJavaSerializationInputStream extends com.sun.corba.se.impl.encoding.CDRInputStreamBase
{
	...
	@:overload override public function init(orb : org.omg.CORBA.ORB, byteBuffer : java.nio.ByteBuffer, bufSize : Int, littleEndian : Bool, bufferManager : com.sun.corba.se.impl.encoding.BufferManagerRead) : Void;
	...
	@:overload override public function read_value(clz : Class<Dynamic>) : java.io.Serializable;
	
	@:overload override public function read_value(factory : org.omg.CORBA.portable.BoxedValueHelper) : java.io.Serializable;
	
	@:overload override public function read_value(rep_id : String) : java.io.Serializable;
	...
	@:overload override public function consumeEndian() : Void;
