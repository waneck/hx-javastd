...
extern class IDLJavaSerializationInputStream extends com.sun.corba.se.impl.encoding.CDRInputStreamBase
{
	...
	@:overload @:public override public function init(orb : org.omg.CORBA.ORB, byteBuffer : java.nio.ByteBuffer, bufSize : Int, littleEndian : Bool, bufferManager : com.sun.corba.se.impl.encoding.BufferManagerRead) : Void;
	...
	@:overload @:public override public function consumeEndian() : Void;
