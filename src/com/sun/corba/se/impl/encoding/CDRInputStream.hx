...
extern class CDRInputStream extends org.omg.CORBA_2_3.portable.InputStream implements com.sun.corba.se.impl.encoding.MarshalInputStream implements org.omg.CORBA.DataInputStream implements org.omg.CORBA.portable.ValueInputStream
{
	...
	*/
	@:protected private var messageMediator : com.sun.corba.se.spi.protocol.CorbaMessageMediator;
	
	@:overload @:public public function new() : Void;
	
	@:overload @:public public function new(is : com.sun.corba.se.impl.encoding.CDRInputStream) : Void;
	
	@:overload @:public public function new(orb : org.omg.CORBA.ORB, byteBuffer : java.nio.ByteBuffer, size : Int, littleEndian : Bool, version : com.sun.corba.se.spi.ior.iiop.GIOPVersion, encodingVersion : java.StdTypes.Int8, bufMgr : com.sun.corba.se.impl.encoding.BufferManagerRead) : Void;
	...
	@:overload @:public @:final override public function read_wchar() : java.StdTypes.Char16;
	...
	@:overload @:public @:final override public function read_wstring() : String;
	...
	@:overload @:public @:final override public function read_octet_array(value : java.NativeArray<java.StdTypes.Int8>, offset : Int, length : Int) : Void;
	...
	@:overload @:public @:final override public function read_Object() : org.omg.CORBA.Object;
	
	@:overload @:public @:final override public function read_TypeCode() : org.omg.CORBA.TypeCode;
	
	@:overload @:public @:final override public function read_any() : org.omg.CORBA.Any;
	
	@:overload @:public @:final override public function read_Principal() : org.omg.CORBA.Principal;
	
	@:overload @:public @:final override public function read() : Int;
	
	@:overload @:public @:final override public function read_fixed() : java.math.BigDecimal;
	
	@:overload @:public @:final override public function read_Context() : org.omg.CORBA.Context;
	
	@:overload @:public @:final override public function read_Object(clz : Class<Dynamic>) : org.omg.CORBA.Object;
	
	@:overload @:public @:final override public function orb() : org.omg.CORBA.ORB;
	
	@:overload @:public @:final override public function read_value() : java.io.Serializable;
	
	@:overload @:public @:final override public function read_value(clz : Class<Dynamic>) : java.io.Serializable;
	
	@:overload @:public @:final override public function read_value(factory : org.omg.CORBA.portable.BoxedValueHelper) : java.io.Serializable;
	
	@:overload @:public @:final override public function read_value(rep_id : String) : java.io.Serializable;
	
	@:overload @:public @:final override public function read_value(value : java.io.Serializable) : java.io.Serializable;
	
	@:overload @:public @:final override public function read_abstract_interface() : Dynamic;
	
	@:overload @:public @:final override public function read_abstract_interface(clz : Class<Dynamic>) : Dynamic;
	
	@:overload @:public @:final public function consumeEndian() : Void;
	
	@:overload @:public @:final public function getPosition() : Int;
	
	@:overload @:public @:final public function read_Abstract() : Dynamic;
	
	@:overload @:public @:final public function read_Value() : java.io.Serializable;
	
	@:overload @:public @:final public function read_any_array(seq : org.omg.CORBA.AnySeqHolder, offset : Int, length : Int) : Void;
	
	@:overload @:public @:final public function read_boolean_array(seq : org.omg.CORBA.BooleanSeqHolder, offset : Int, length : Int) : Void;
	
	@:overload @:public @:final public function read_char_array(seq : org.omg.CORBA.CharSeqHolder, offset : Int, length : Int) : Void;
	
	@:overload @:public @:final public function read_wchar_array(seq : org.omg.CORBA.WCharSeqHolder, offset : Int, length : Int) : Void;
	
	@:overload @:public @:final public function read_octet_array(seq : org.omg.CORBA.OctetSeqHolder, offset : Int, length : Int) : Void;
	
	@:overload @:public @:final public function read_short_array(seq : org.omg.CORBA.ShortSeqHolder, offset : Int, length : Int) : Void;
	
	@:overload @:public @:final public function read_ushort_array(seq : org.omg.CORBA.UShortSeqHolder, offset : Int, length : Int) : Void;
	
	@:overload @:public @:final public function read_long_array(seq : org.omg.CORBA.LongSeqHolder, offset : Int, length : Int) : Void;
	
	@:overload @:public @:final public function read_ulong_array(seq : org.omg.CORBA.ULongSeqHolder, offset : Int, length : Int) : Void;
	
	@:overload @:public @:final public function read_ulonglong_array(seq : org.omg.CORBA.ULongLongSeqHolder, offset : Int, length : Int) : Void;
	
	@:overload @:public @:final public function read_longlong_array(seq : org.omg.CORBA.LongLongSeqHolder, offset : Int, length : Int) : Void;
	
	@:overload @:public @:final public function read_float_array(seq : org.omg.CORBA.FloatSeqHolder, offset : Int, length : Int) : Void;
	
	@:overload @:public @:final public function read_double_array(seq : org.omg.CORBA.DoubleSeqHolder, offset : Int, length : Int) : Void;
	...
	@:overload @:public @:final override public function mark(readlimit : Int) : Void;
	...
	@:overload @:public @:abstract public function dup() : com.sun.corba.se.impl.encoding.CDRInputStream;
	
	@:overload @:public @:final public function read_fixed(digits : java.StdTypes.Int16, scale : java.StdTypes.Int16) : java.math.BigDecimal;
	...
	@:overload @:protected @:final private function setByteBufferWithInfo(bbwi : com.sun.corba.se.impl.encoding.ByteBufferWithInfo) : Void;
	...
	*/
	...
	@:overload @:public @:final public function getBufferLength() : Int;
	
	@:overload @:protected @:final private function setBufferLength(value : Int) : Void;
	
	@:overload @:protected @:final private function getIndex() : Int;
	
	@:overload @:protected @:final private function setIndex(value : Int) : Void;
	
	@:overload @:public @:final public function orb(orb : org.omg.CORBA.ORB) : Void;
	
	@:overload @:public @:final public function getGIOPVersion() : com.sun.corba.se.spi.ior.iiop.GIOPVersion;
	
	@:overload @:public @:final public function getBufferManager() : com.sun.corba.se.impl.encoding.BufferManagerRead;
	
	@:overload @:public public function getCodeBase() : com.sun.org.omg.SendingContext.CodeBase;
	
	@:overload @:protected private function createCharBTCConverter() : com.sun.corba.se.impl.encoding.CodeSetConversion.CodeSetConversion_BTCConverter;
	
	@:overload @:protected @:abstract private function createWCharBTCConverter() : com.sun.corba.se.impl.encoding.CodeSetConversion.CodeSetConversion_BTCConverter;
	...
	*/
	...
	@:overload @:public public function start_value() : Void;
...
{
	@:overload @:public @:static public static function newInputStream(orb : com.sun.corba.se.spi.orb.ORB, version : com.sun.corba.se.spi.ior.iiop.GIOPVersion, encodingVersion : java.StdTypes.Int8) : com.sun.corba.se.impl.encoding.CDRInputStreamBase;
