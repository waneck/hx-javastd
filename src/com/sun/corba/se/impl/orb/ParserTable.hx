...
{
	@:overload @:public @:static public static function get() : com.sun.corba.se.impl.orb.ParserTable;
	
	@:overload @:public public function getParserData() : java.NativeArray<com.sun.corba.se.spi.orb.ParserData>;
...
@:native('com$sun$corba$se$impl$orb$ParserTable$TestBadServerIdHandler') extern class ParserTable_TestBadServerIdHandler implements com.sun.corba.se.impl.oa.poa.BadServerIdHandler
{
	...
	@:overload @:public public function handle(objectKey : com.sun.corba.se.spi.ior.ObjectKey) : Void;
...
@:native('com$sun$corba$se$impl$orb$ParserTable$TestORBSocketFactory') extern class ParserTable_TestORBSocketFactory implements com.sun.corba.se.spi.transport.ORBSocketFactory
{
	...
	@:overload @:public public function createServerSocket(type : String, a : java.net.InetSocketAddress) : java.net.ServerSocket;
	
	@:overload @:public public function createSocket(type : String, a : java.net.InetSocketAddress) : java.net.Socket;
...
{
	@:overload @:public public function equals(other : org.omg.CORBA.Object) : Bool;
	
	@:overload @:public public function pre_init(info : org.omg.PortableInterceptor.ORBInitInfo) : Void;
	
	@:overload @:public public function post_init(info : org.omg.PortableInterceptor.ORBInitInfo) : Void;
...
@:native('com$sun$corba$se$impl$orb$ParserTable$TestAcceptor1') extern class ParserTable_TestAcceptor1 implements com.sun.corba.se.pept.transport.Acceptor
{
	...
	@:overload @:public public function setUseSelectThreadForConnections(x : Bool) : Void;
	
	@:overload @:public public function shouldUseSelectThreadForConnections() : Bool;
	
	@:overload @:public public function setUseWorkerThreadForConnections(x : Bool) : Void;
	
	@:overload @:public public function shouldUseWorkerThreadForConnections() : Bool;
	...
	@:overload @:public public function finishCreatingMessageMediator(xbroker : com.sun.corba.se.pept.broker.Broker, xconnection : com.sun.corba.se.pept.transport.Connection, messageMediator : com.sun.corba.se.pept.protocol.MessageMediator) : com.sun.corba.se.pept.protocol.MessageMediator;
