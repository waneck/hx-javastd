...
extern class CDREncapsCodec extends org.omg.CORBA.LocalObject implements org.omg.IOP.Codec
{
	...
	*/
	@:overload @:public public function new(orb : org.omg.CORBA.ORB, major : Int, minor : Int) : Void;
	
	/**
	* Convert the given any into a CDR encapsulated octet sequence
	*/
	@:overload @:public public function encode(data : org.omg.CORBA.Any) : java.NativeArray<java.StdTypes.Int8>;
	
	/**
	* Decode the given octet sequence into an any based on a CDR
	* encapsulated octet sequence.
	*/
	@:overload @:public public function decode(data : java.NativeArray<java.StdTypes.Int8>) : org.omg.CORBA.Any;
	
	/**
	* Convert the given any into a CDR encapsulated octet sequence.  Only
	* the data is stored.  The type code is not.
	*/
	@:overload @:public public function encode_value(data : org.omg.CORBA.Any) : java.NativeArray<java.StdTypes.Int8>;
	...
	*/
	@:overload @:public public function decode_value(data : java.NativeArray<java.StdTypes.Int8>, tc : org.omg.CORBA.TypeCode) : org.omg.CORBA.Any;
