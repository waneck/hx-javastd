...
{
	private var piCurrentPushed : Bool;
	
	/*
	**********************************************************************
	* Access protection
	**********************************************************************/
	private static var MID_TARGET(default, null) : Int;
	
	private static var MID_EFFECTIVE_TARGET(default, null) : Int;
	
	private static var MID_EFFECTIVE_PROFILE(default, null) : Int;
	
	private static var MID_RECEIVED_EXCEPTION(default, null) : Int;
	
	private static var MID_RECEIVED_EXCEPTION_ID(default, null) : Int;
	
	private static var MID_GET_EFFECTIVE_COMPONENT(default, null) : Int;
	
	private static var MID_GET_EFFECTIVE_COMPONENTS(default, null) : Int;
	
	private static var MID_GET_REQUEST_POLICY(default, null) : Int;
	
	private static var MID_ADD_REQUEST_SERVICE_CONTEXT(default, null) : Int;
	...
	*/
	@:overload private function new(myORB : com.sun.corba.se.spi.orb.ORB) : Void;
	
	/**
	* The object which the client called to perform the operation.
	*/
	@:overload public function target() : org.omg.CORBA.Object;
	...
	* remain unchanged.
	*/
	@:overload public function effective_target() : org.omg.CORBA.Object;
	...
	* profile.
	*/
	@:overload public function effective_profile() : org.omg.IOP.TaggedProfile;
	
	/**
	* Contains the exception to be returned to the client.
	*/
	@:overload public function received_exception() : org.omg.CORBA.Any;
	
	/**
	* The CORBA::RepositoryId of the exception to be returned to the client.
	*/
	@:overload public function received_exception_id() : String;
	...
	*/
	@:overload public function get_effective_component(id : Int) : org.omg.IOP.TaggedComponent;
	
	/**
	* Returns all the tagged components with the given ID from the profile
	* selected for this request.
	*/
	@:overload public function get_effective_components(id : Int) : java.NativeArray<org.omg.IOP.TaggedComponent>;
	
	/**
	* Returns the given policy in effect for this operation.
	*/
	@:overload public function get_request_policy(type : Int) : org.omg.CORBA.Policy;
	...
	*/
	@:overload public function add_request_service_context(service_context : org.omg.IOP.ServiceContext, replace : Bool) : Void;
	...
	**********************************************************************/
	@:overload private function setInfo(messageMediator : com.sun.corba.se.pept.protocol.MessageMediator) : Void;
	...
	*/
	@:overload private function setDIIRequest(req : org.omg.CORBA.Request) : Void;
	...
	*/
	@:overload private function setDIIInitiate(diiInitiate : Bool) : Void;
	
	/**
	* See comment for setDIIInitiate
	*/
	@:overload private function isDIIInitiate() : Bool;
	...
	*/
	@:overload private function setPICurrentPushed(piCurrentPushed : Bool) : Void;
	
	@:overload private function isPICurrentPushed() : Bool;
