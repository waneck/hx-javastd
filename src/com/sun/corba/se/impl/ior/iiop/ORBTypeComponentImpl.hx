...
* questions.
*/
extern class ORBTypeComponentImpl extends com.sun.corba.se.spi.ior.TaggedComponentBase implements com.sun.corba.se.spi.ior.iiop.ORBTypeComponent
{
	...
	@:overload @:public public function new(ORBType : Int) : Void;
