...
extern class OldJIDLObjectKeyTemplate extends com.sun.corba.se.impl.ior.OldObjectKeyTemplateBase
{
	...
	*/
	public static var NULL_PATCH_VERSION(default, null) : java.StdTypes.Int8;
	...
	@:overload public function new(orb : com.sun.corba.se.spi.orb.ORB, magic : Int, scid : Int, serverid : Int) : Void;
