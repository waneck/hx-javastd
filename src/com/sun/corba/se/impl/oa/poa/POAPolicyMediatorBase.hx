...
extern class POAPolicyMediatorBase implements com.sun.corba.se.impl.oa.poa.POAPolicyMediator
{
	...
	*/
	...
	@:protected private var isImplicit : Bool;
	
	@:protected private var isUnique : Bool;
	
	@:protected private var isSystemId : Bool;
	
	@:overload @:public @:final public function getPolicies() : com.sun.corba.se.impl.oa.poa.Policies;
	
	@:overload @:public @:final public function getScid() : Int;
	
	@:overload @:public @:final public function getServerId() : Int;
	
	@:overload @:public @:final public function getInvocationServant(id : java.NativeArray<java.StdTypes.Int8>, operation : String) : Dynamic;
	
	@:overload @:protected @:final private function setDelegate(servant : org.omg.PortableServer.Servant, id : java.NativeArray<java.StdTypes.Int8>) : Void;
	
	@:overload @:public @:synchronized public function newSystemId() : java.NativeArray<java.StdTypes.Int8>;
	
	@:overload @:protected @:abstract private function internalGetServant(id : java.NativeArray<java.StdTypes.Int8>, operation : String) : Dynamic;
