...
extern class AnyImpl extends org.omg.CORBA.Any
{
	...
	*/
	...
	@:overload public function new(orb : com.sun.corba.se.spi.orb.ORB, obj : org.omg.CORBA.Any) : Void;
	...
	*/
	@:overload public function equal(otherAny : org.omg.CORBA.Any) : Bool;
	...
	* See the description of the <a href="#anyOps">general Any operations.</a>
	*/
	@:overload public function insert_any(a : org.omg.CORBA.Any) : Void;
	...
	*/
	@:overload public function createTypeCodeForClass(c : Class<Dynamic>, tcORB : com.sun.corba.se.spi.orb.ORB) : org.omg.CORBA.TypeCode;
	
	@:overload public function extractAny(memberType : org.omg.CORBA.TypeCode, orb : com.sun.corba.se.spi.orb.ORB) : org.omg.CORBA.Any;
	
	@:overload public static function extractAnyFromStream(memberType : org.omg.CORBA.TypeCode, input : org.omg.CORBA.portable.InputStream, orb : com.sun.corba.se.spi.orb.ORB) : org.omg.CORBA.Any;
...
{
	@:overload public function new(theStream : com.sun.corba.se.impl.encoding.EncapsInputStream) : Void;
