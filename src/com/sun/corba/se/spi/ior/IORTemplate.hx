...
* questions.
*/
extern interface IORTemplate extends java.util.List<Dynamic> extends com.sun.corba.se.spi.ior.IORFactory extends com.sun.corba.se.spi.ior.MakeImmutable
{
