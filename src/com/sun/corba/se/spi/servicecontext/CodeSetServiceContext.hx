...
* questions.
*/
extern class CodeSetServiceContext extends com.sun.corba.se.spi.servicecontext.ServiceContext
{
	@:overload @:public public function new(csc : com.sun.corba.se.impl.encoding.CodeSetComponentInfo.CodeSetComponentInfo_CodeSetContext) : Void;
