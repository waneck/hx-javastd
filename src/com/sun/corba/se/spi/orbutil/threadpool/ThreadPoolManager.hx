...
* questions.
*/
extern interface ThreadPoolManager extends java.io.Closeable
{
	/**
	...
	* as a parameter
	*/
	@:overload @:public public function getThreadPool(threadpoolId : String) : com.sun.corba.se.spi.orbutil.threadpool.ThreadPool;
	...
	* as a parameter
	*/
	@:overload @:public public function getThreadPool(numericIdForThreadpool : Int) : com.sun.corba.se.spi.orbutil.threadpool.ThreadPool;
	...
	* dedicated threadpool for EJB beans
	*/
	@:overload @:public public function getThreadPoolNumericId(threadpoolId : String) : Int;
	
	/**
	* Return a String Id for a numericId of a threadpool managed by the threadpool
	* manager
	*/
	@:overload @:public public function getThreadPoolStringId(numericIdForThreadpool : Int) : String;
	
	/**
	* Returns the first instance of ThreadPool in the ThreadPoolManager
	*/
	@:overload @:public public function getDefaultThreadPool() : com.sun.corba.se.spi.orbutil.threadpool.ThreadPool;
	
	/**
	* Return an instance of ThreadPoolChooser based on the componentId that was
	* passed as argument
	*/
	@:overload @:public public function getThreadPoolChooser(componentId : String) : com.sun.corba.se.spi.orbutil.threadpool.ThreadPoolChooser;
	...
	*/
	@:overload @:public public function getThreadPoolChooser(componentIndex : Int) : com.sun.corba.se.spi.orbutil.threadpool.ThreadPoolChooser;
	...
	*/
	@:overload @:public public function setThreadPoolChooser(componentId : String, aThreadPoolChooser : com.sun.corba.se.spi.orbutil.threadpool.ThreadPoolChooser) : Void;
	...
	*/
	@:overload @:public public function getThreadPoolChooserNumericId(componentId : String) : Int;
