...
{
	public var value : com.sun.corba.se.spi.activation.NoSuchEndPoint;
	
	@:overload public function new() : Void;
	
	@:overload public function new(initialValue : com.sun.corba.se.spi.activation.NoSuchEndPoint) : Void;
