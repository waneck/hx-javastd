...
{
	public var value : com.sun.corba.se.spi.activation.ServerAlreadyActive;
	
	@:overload public function new() : Void;
	
	@:overload public function new(initialValue : com.sun.corba.se.spi.activation.ServerAlreadyActive) : Void;
