...
{
	public var value : com.sun.corba.se.spi.activation.ServerHeldDown;
	
	@:overload public function new() : Void;
	
	@:overload public function new(initialValue : com.sun.corba.se.spi.activation.ServerHeldDown) : Void;
