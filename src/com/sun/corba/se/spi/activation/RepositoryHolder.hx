...
{
	@:public public var value : com.sun.corba.se.spi.activation.Repository;
	
	@:overload @:public public function new() : Void;
	
	@:overload @:public public function new(initialValue : com.sun.corba.se.spi.activation.Repository) : Void;
