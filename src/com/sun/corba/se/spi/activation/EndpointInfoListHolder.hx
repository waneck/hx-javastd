...
{
	public var value : java.NativeArray<com.sun.corba.se.spi.activation.EndPointInfo>;
	
	@:overload public function new() : Void;
	
	@:overload public function new(initialValue : java.NativeArray<com.sun.corba.se.spi.activation.EndPointInfo>) : Void;
