...
{
	@:public public var value : java.NativeArray<com.sun.corba.se.spi.activation.EndPointInfo>;
	
	@:overload @:public public function new() : Void;
	
	@:overload @:public public function new(initialValue : java.NativeArray<com.sun.corba.se.spi.activation.EndPointInfo>) : Void;
