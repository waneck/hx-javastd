...
*/
extern class ServerLocationHolder implements org.omg.CORBA.portable.Streamable
{
	@:public public var value : com.sun.corba.se.spi.activation.LocatorPackage.ServerLocation;
	
	@:overload @:public public function new() : Void;
	
	@:overload @:public public function new(initialValue : com.sun.corba.se.spi.activation.LocatorPackage.ServerLocation) : Void;
