...
{
	public var value : com.sun.corba.se.spi.activation.RepositoryPackage.ServerDef;
	
	@:overload public function new() : Void;
	
	@:overload public function new(initialValue : com.sun.corba.se.spi.activation.RepositoryPackage.ServerDef) : Void;
