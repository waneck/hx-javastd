...
* questions.
*/
extern class MidiOutDeviceProvider extends com.sun.media.sound.AbstractMidiDeviceProvider
{
	/**
...
*/
@:native('com$sun$media$sound$MidiOutDeviceProvider$MidiOutDeviceInfo') @:internal extern class MidiOutDeviceProvider_MidiOutDeviceInfo extends com.sun.media.sound.AbstractMidiDeviceProvider.AbstractMidiDeviceProvider_Info
{
