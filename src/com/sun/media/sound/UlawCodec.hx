...
* questions.
*/
extern class UlawCodec extends com.sun.media.sound.SunCodec
{
	/**
...
@:native('com$sun$media$sound$UlawCodec$UlawCodecStream') @:internal extern class UlawCodec_UlawCodecStream extends javax.sound.sampled.AudioInputStream
{
	/**
