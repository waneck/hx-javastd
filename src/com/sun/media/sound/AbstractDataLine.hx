...
@:internal extern class AbstractDataLine extends com.sun.media.sound.AbstractLine implements javax.sound.sampled.DataLine
{
	...
	*/
	...
	/*final*/
	private var defaultBufferSize : Int;
	...
	*/
	@:overload private function new(info : javax.sound.sampled.DataLine.DataLine_Info, mixer : com.sun.media.sound.AbstractMixer, controls : java.NativeArray<javax.sound.sampled.Control>) : Void;
	
	/**
	* Constructs a new AbstractLine.
	*/
	@:overload private function new(info : javax.sound.sampled.DataLine.DataLine_Info, mixer : com.sun.media.sound.AbstractMixer, controls : java.NativeArray<javax.sound.sampled.Control>, format : javax.sound.sampled.AudioFormat, bufferSize : Int) : Void;
	...
	*/
	@:overload public function setBufferSize(newSize : Int) : Int;
	...
	*/
	@:overload private function isStartedRunning() : Bool;
	
	/**
	* This method sets the active state and generates
	* events if it changes.
	*/
	@:overload private function setActive(active : Bool) : Void;
	
	/**
	* This method sets the started state and generates
	* events if it changes.
	*/
	@:overload private function setStarted(started : Bool) : Void;
	...
	*/
	@:overload private function setEOM() : Void;
