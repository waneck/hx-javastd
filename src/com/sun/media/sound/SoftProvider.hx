...
* questions.
*/
extern class SoftProvider extends javax.sound.midi.spi.MidiDeviceProvider
{
	/**
	...
	*/
	@:protected @:final @:static private static var softinfo(default, null) : javax.sound.midi.MidiDevice.MidiDevice_Info;
