...
extern class SoftSincResampler extends com.sun.media.sound.SoftAbstractResampler
{
	...
	@:overload public static function wHanning(size : Int, offset : Single) : java.NativeArray<Single>;
	
	@:overload public static function sincTable(size : Int, offset : Single, scale : Single) : java.NativeArray<Single>;
