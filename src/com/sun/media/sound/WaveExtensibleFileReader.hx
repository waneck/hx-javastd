...
@:native('com$sun$media$sound$WaveExtensibleFileReader$GUID') @:internal extern class WaveExtensibleFileReader_GUID
{
	...
	@:overload @:public @:static public static function read(riff : com.sun.media.sound.RIFFReader) : com.sun.media.sound.WaveExtensibleFileReader.WaveExtensibleFileReader_GUID;
