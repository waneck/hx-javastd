...
* @since 1.5
*/
@:require(java5) extern interface PrimitiveType extends com.sun.mirror.type.TypeMirror
{
	/**
...
*/
@:native('com$sun$mirror$type$PrimitiveType$Kind') extern enum PrimitiveType_Kind
{
