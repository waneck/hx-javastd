...
* questions.
*/
extern interface ClassType extends com.sun.jdi.ReferenceType
{
	/**
	...
	*/
	@:overload public function newInstance(thread : com.sun.jdi.ThreadReference, method : com.sun.jdi.Method, arguments : java.util.List<com.sun.jdi.Value>, options : Int) : com.sun.jdi.ObjectReference;
