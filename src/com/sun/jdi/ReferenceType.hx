...
extern interface ReferenceType extends com.sun.jdi.Type extends java.lang.Comparable<com.sun.jdi.ReferenceType> extends com.sun.jdi.Accessible
{
	...
	* @since 1.4
	*/
	@:require(java4) @:overload public function sourceNames(stratum : String) : java.util.List<String>;
	...
	* @since 1.4
	*/
	@:require(java4) @:overload public function sourcePaths(stratum : String) : java.util.List<String>;
	...
	* prepared.
	*/
	@:overload public function allMethods() : java.util.List<com.sun.jdi.Method>;
	...
	* this object's class.
	*/
	@:overload public function getValue(field : com.sun.jdi.Field) : com.sun.jdi.Value;
	...
	*/
	@:overload public function getValues(fields : java.util.List<com.sun.jdi.Field>) : java.util.Map<com.sun.jdi.Field, com.sun.jdi.Value>;
	...
	* @since 1.4
	*/
	@:require(java4) @:overload public function availableStrata() : java.util.List<String>;
	...
	* @since 1.4
	*/
	@:require(java4) @:overload public function defaultStratum() : String;
	...
	* @since 1.6
	*/
	@:require(java6) @:overload public function instances(maxInstances : haxe.Int64) : java.util.List<com.sun.jdi.ObjectReference>;
	...
	* @since 1.6
	*/
	@:require(java6) @:overload public function majorVersion() : Int;
	...
	* @since 1.6
	*/
	@:require(java6) @:overload public function minorVersion() : Int;
	...
	* @since 1.6
	*/
	@:require(java6) @:overload public function constantPoolCount() : Int;
	...
	* @since 1.6
	*/
	@:require(java6) @:overload public function constantPool() : java.NativeArray<java.StdTypes.Int8>;
