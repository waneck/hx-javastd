...
* questions.
*/
extern interface StackFrame extends com.sun.jdi.Mirror extends com.sun.jdi.Locatable
{
	/**
	...
	*/
	@:overload public function setValue(variable : com.sun.jdi.LocalVariable, value : com.sun.jdi.Value) : Void;
	...
	* @since 1.6
	*/
	@:require(java6) @:overload public function getArgumentValues() : java.util.List<com.sun.jdi.Value>;
