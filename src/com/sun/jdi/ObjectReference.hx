...
* questions.
*/
extern interface ObjectReference extends com.sun.jdi.Value
{
	/**
	...
	* @throws VMCannotBeModifiedException if the VirtualMachine is read-only - see {@link VirtualMachine#canBeModified()}.
	*/
	@:overload public function invokeMethod(thread : com.sun.jdi.ThreadReference, method : com.sun.jdi.Method, arguments : java.util.List<com.sun.jdi.Value>, options : Int) : com.sun.jdi.Value;
	...
	*/
	@:overload public function disableCollection() : Void;
	...
	* -see {@link VirtualMachine#canBeModified()}.
	*/
	@:overload public function enableCollection() : Void;
