...
* questions.
*/
extern interface AttachingConnector extends com.sun.jdi.connect.Connector
{
	/**
	...
	*/
	@:overload public function attach(arguments : java.util.Map<String, com.sun.jdi.connect.Connector.Connector_Argument>) : com.sun.jdi.VirtualMachine;
