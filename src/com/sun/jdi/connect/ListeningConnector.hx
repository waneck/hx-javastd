...
* questions.
*/
extern interface ListeningConnector extends com.sun.jdi.connect.Connector
{
	/**
	...
	*/
	@:overload public function startListening(arguments : java.util.Map<String, com.sun.jdi.connect.Connector.Connector_Argument>) : String;
	...
	* connector arguments is invalid.
	*/
	@:overload public function stopListening(arguments : java.util.Map<String, com.sun.jdi.connect.Connector.Connector_Argument>) : Void;
	...
	* connector arguments is invalid.
	*/
	@:overload public function accept(arguments : java.util.Map<String, com.sun.jdi.connect.Connector.Connector_Argument>) : com.sun.jdi.VirtualMachine;
