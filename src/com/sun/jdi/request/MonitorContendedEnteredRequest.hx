...
* @since  1.6
*/
@:require(java6) extern interface MonitorContendedEnteredRequest extends com.sun.jdi.request.EventRequest
{
	/**
	...
	*/
	@:overload public function addThreadFilter(thread : com.sun.jdi.ThreadReference) : Void;
	...
	* Filters may be added only to disabled requests.
	*/
	@:overload public function addInstanceFilter(instance : com.sun.jdi.ObjectReference) : Void;
