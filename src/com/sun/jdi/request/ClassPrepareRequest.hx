...
* @since  1.3
*/
@:require(java3) extern interface ClassPrepareRequest extends com.sun.jdi.request.EventRequest
{
	/**
	...
	* Filters may be added only to disabled requests.
	*/
	@:require(java6) @:overload public function addSourceNameFilter(sourceNamePattern : String) : Void;
