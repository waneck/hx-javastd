...
extern interface ThreadReference extends com.sun.jdi.ObjectReference
{
	...
	* @since 1.6
	*/
	@:require(java6) @:overload public function ownedMonitorsAndFrames() : java.util.List<com.sun.jdi.MonitorInfo>;
	...
	*
	* @since 1.4 */
	@:require(java4) @:overload public function popFrames(frame : com.sun.jdi.StackFrame) : Void;
	...
	* @since 1.6
	*/
	@:require(java6) @:overload public function forceEarlyReturn(value : com.sun.jdi.Value) : Void;
