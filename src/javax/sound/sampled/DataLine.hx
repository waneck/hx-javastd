...
* @since 1.3
*/
@:require(java3) extern interface DataLine extends javax.sound.sampled.Line
{
	/**
...
* @since 1.3
*/
@:require(java3) @:native('javax$sound$sampled$DataLine$Info') extern class DataLine_Info extends javax.sound.sampled.Line.Line_Info
{
	/**
