...
* @since 1.3
*/
@:require(java3) extern class FloatControl extends javax.sound.sampled.Control
{
	/**
...
* @since 1.3
*/
@:require(java3) @:native('javax$sound$sampled$FloatControl$Type') extern class FloatControl_Type extends javax.sound.sampled.Control.Control_Type
{
	/**
