...
* questions.
*/
extern interface IIOWriteWarningListener extends java.util.EventListener
{
	/**
	...
	*/
	@:overload public function warningOccurred(source : javax.imageio.ImageWriter, imageIndex : Int, warning : String) : Void;
