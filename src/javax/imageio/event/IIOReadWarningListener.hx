...
* questions.
*/
extern interface IIOReadWarningListener extends java.util.EventListener
{
	/**
	...
	*/
	@:overload public function warningOccurred(source : javax.imageio.ImageReader, warning : String) : Void;
