...
* questions.
*/
extern interface IIOReadUpdateListener extends java.util.EventListener
{
	/**
	...
	*/
	@:overload public function passStarted(source : javax.imageio.ImageReader, theImage : java.awt.image.BufferedImage, pass : Int, minPass : Int, maxPass : Int, minX : Int, minY : Int, periodX : Int, periodY : Int, bands : java.NativeArray<Int>) : Void;
	...
	*/
	@:overload public function imageUpdate(source : javax.imageio.ImageReader, theImage : java.awt.image.BufferedImage, minX : Int, minY : Int, width : Int, height : Int, periodX : Int, periodY : Int, bands : java.NativeArray<Int>) : Void;
	...
	*/
	@:overload public function passComplete(source : javax.imageio.ImageReader, theImage : java.awt.image.BufferedImage) : Void;
	...
	* @see #passStarted
	*/
	@:overload public function thumbnailPassStarted(source : javax.imageio.ImageReader, theThumbnail : java.awt.image.BufferedImage, pass : Int, minPass : Int, maxPass : Int, minX : Int, minY : Int, periodX : Int, periodY : Int, bands : java.NativeArray<Int>) : Void;
	...
	* @see #imageUpdate
	*/
	@:overload public function thumbnailUpdate(source : javax.imageio.ImageReader, theThumbnail : java.awt.image.BufferedImage, minX : Int, minY : Int, width : Int, height : Int, periodX : Int, periodY : Int, bands : java.NativeArray<Int>) : Void;
	...
	* @see #passComplete
	*/
	@:overload public function thumbnailPassComplete(source : javax.imageio.ImageReader, theThumbnail : java.awt.image.BufferedImage) : Void;
