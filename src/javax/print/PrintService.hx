...
extern interface PrintService
{
	...
	*      this PrintService.
	*/
	@:overload public function isAttributeValueSupported(attrval : javax.print.attribute.Attribute, flavor : javax.print.DocFlavor, attributes : javax.print.attribute.AttributeSet) : Bool;
