...
extern class JobStateReason extends javax.print.attribute.EnumSyntax implements javax.print.attribute.Attribute
{
	...
	*/
	public static var JOB_INCOMING(default, null) : JobStateReason;
	...
	*/
	public static var JOB_DATA_INSUFFICIENT(default, null) : JobStateReason;
	...
	* objects.
	*/
	public static var DOCUMENT_ACCESS_ERROR(default, null) : JobStateReason;
	...
	*/
	public static var SUBMISSION_INTERRUPTED(default, null) : JobStateReason;
	
	/**
	* The printer is transmitting the job to the output device.
	*/
	public static var JOB_OUTGOING(default, null) : JobStateReason;
	...
	*/
	public static var JOB_HOLD_UNTIL_SPECIFIED(default, null) : JobStateReason;
	...
	*/
	public static var RESOURCES_ARE_NOT_READY(default, null) : JobStateReason;
	...
	*/
	public static var PRINTER_STOPPED_PARTLY(default, null) : JobStateReason;
	
	/**
	* The value of the printer's {@link PrinterState PrinterState} attribute
	* ia STOPPED.
	*/
	public static var PRINTER_STOPPED(default, null) : JobStateReason;
	
	/**
	* The job is in the PROCESSING state, but more specifically, the printer
	* ia interpreting the document data.
	*/
	public static var JOB_INTERPRETING(default, null) : JobStateReason;
	
	/**
	* The job is in the PROCESSING state, but more specifically, the printer
	* has queued the document data.
	*/
	public static var JOB_QUEUED(default, null) : JobStateReason;
	...
	* representation.
	*/
	public static var JOB_TRANSFORMING(default, null) : JobStateReason;
	...
	*/
	public static var JOB_QUEUED_FOR_MARKER(default, null) : JobStateReason;
	...
	*/
	public static var JOB_PRINTING(default, null) : JobStateReason;
	...
	* supported.
	*/
	public static var JOB_CANCELED_BY_USER(default, null) : JobStateReason;
	...
	*/
	public static var JOB_CANCELED_BY_OPERATOR(default, null) : JobStateReason;
	...
	*/
	public static var JOB_CANCELED_AT_DEVICE(default, null) : JobStateReason;
	...
	*/
	public static var ABORTED_BY_SYSTEM(default, null) : JobStateReason;
	...
	*/
	public static var UNSUPPORTED_COMPRESSION(default, null) : JobStateReason;
	...
	*/
	public static var COMPRESSION_ERROR(default, null) : JobStateReason;
	...
	*/
	public static var UNSUPPORTED_DOCUMENT_FORMAT(default, null) : JobStateReason;
	...
	*/
	public static var DOCUMENT_FORMAT_ERROR(default, null) : JobStateReason;
	...
	*/
	public static var PROCESSING_TO_STOP_POINT(default, null) : JobStateReason;
	...
	*/
	public static var SERVICE_OFF_LINE(default, null) : JobStateReason;
	
	/**
	* The job completed successfully. This value should be supported.
	*/
	public static var JOB_COMPLETED_SUCCESSFULLY(default, null) : JobStateReason;
	
	/**
	* The job completed with warnings. This value should be supported if the
	* implementation detects warnings.
	*/
	public static var JOB_COMPLETED_WITH_WARNINGS(default, null) : JobStateReason;
	...
	*/
	public static var JOB_COMPLETED_WITH_ERRORS(default, null) : JobStateReason;
	...
	*/
	public static var JOB_RESTARTABLE(default, null) : JobStateReason;
	...
	*/
	public static var QUEUED_IN_DEVICE(default, null) : JobStateReason;
