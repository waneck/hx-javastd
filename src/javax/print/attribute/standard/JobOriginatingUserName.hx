...
* questions.
*/
extern class JobOriginatingUserName extends javax.print.attribute.TextSyntax implements javax.print.attribute.PrintJobAttribute
{
	/**
	...
	*/
	@:overload @:public public function new(userName : String, locale : java.util.Locale) : Void;
