...
* questions.
*/
extern class PrinterLocation extends javax.print.attribute.TextSyntax implements javax.print.attribute.PrintServiceAttribute
{
	/**
	...
	*/
	@:overload @:public public function new(location : String, locale : java.util.Locale) : Void;
