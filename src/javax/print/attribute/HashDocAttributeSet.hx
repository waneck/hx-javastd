...
* questions.
*/
extern class HashDocAttributeSet extends javax.print.attribute.HashAttributeSet implements javax.print.attribute.DocAttributeSet implements java.io.Serializable
{
	/**
