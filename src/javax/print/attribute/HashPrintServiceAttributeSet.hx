...
* questions.
*/
extern class HashPrintServiceAttributeSet extends javax.print.attribute.HashAttributeSet implements javax.print.attribute.PrintServiceAttributeSet implements java.io.Serializable
{
	/**
