...
extern interface StubDelegate
{
	...
	*/
	@:overload public function readObject(self : javax.rmi.CORBA.Stub, s : java.io.ObjectInputStream) : Void;
	
	/**
	* Delegation call for
	* <a href="{@docRoot}/serialized-form.html#javax.rmi.CORBA.Stub"><code>Stub.writeObject(java.io.ObjectOutputStream)</code></a>.
	*/
	@:overload public function writeObject(self : javax.rmi.CORBA.Stub, s : java.io.ObjectOutputStream) : Void;
