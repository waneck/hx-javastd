...
extern interface ValueHandler
{
	...
	**/
	@:overload public function writeValue(out : org.omg.CORBA.portable.OutputStream, value : java.io.Serializable) : Void;
	...
	**/
	@:overload public function readValue(_in : org.omg.CORBA.portable.InputStream, offset : Int, clz : Class<Dynamic>, repositoryID : String, sender : org.omg.SendingContext.RunTime) : java.io.Serializable;
