...
* @since 1.4
*/
@:require(java4) extern interface XAConnection extends javax.sql.PooledConnection
{
	/**
	...
	* @since 1.4
	*/
	@:require(java4) @:overload public function getXAResource() : javax.transaction.xa.XAResource;
