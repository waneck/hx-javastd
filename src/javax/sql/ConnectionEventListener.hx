...
* @since 1.4
*/
@:require(java4) extern interface ConnectionEventListener extends java.util.EventListener
{
	/**
	...
	* the event
	*/
	@:overload public function connectionClosed(event : javax.sql.ConnectionEvent) : Void;
	...
	*/
	@:overload public function connectionErrorOccurred(event : javax.sql.ConnectionEvent) : Void;
