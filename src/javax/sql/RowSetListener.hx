...
* @since 1.4
*/
@:require(java4) extern interface RowSetListener extends java.util.EventListener
{
	/**
	...
	*/
	@:overload public function rowSetChanged(event : javax.sql.RowSetEvent) : Void;
	...
	*         the <code>RowSet</code> object that is the source of the event
	*/
	@:overload public function rowChanged(event : javax.sql.RowSetEvent) : Void;
	...
	*         the <code>RowSet</code> object that is the source of the event
	*/
	@:overload public function cursorMoved(event : javax.sql.RowSetEvent) : Void;
