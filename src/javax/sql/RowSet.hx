...
* @since 1.4
*/
@:require(java4) extern interface RowSet extends java.sql.ResultSet
{
	/**
	...
	* @see #getPassword
	*/
	@:overload public function setPassword(password : String) : Void;
	...
	* @exception SQLException if a database access error occurs
	*/
	@:overload public function setNull(paramIndex : Int, sqlType : Int, typeName : String) : Void;
	...
	* @see java.sql.Types
	*/
	@:overload public function setObject(parameterIndex : Int, x : Dynamic, targetSqlType : Int, scaleOrLength : Int) : Void;
	...
	* @exception SQLException if a database access error occurs
	*/
	@:overload public function setRef(i : Int, x : java.sql.Ref) : Void;
	...
	* @exception SQLException if a database access error occurs
	*/
	@:overload public function setBlob(i : Int, x : java.sql.Blob) : Void;
	...
	* @exception SQLException if a database access error occurs
	*/
	@:overload public function setClob(i : Int, x : java.sql.Clob) : Void;
	...
	* @exception SQLException if a database access error occurs
	*/
	@:overload public function setArray(i : Int, x : java.sql.Array) : Void;
