...
* @since 1.6
*/
@:require(java6) extern interface StatementEventListener extends java.util.EventListener
{
	/**
	...
	* @since 1.6
	*/
	@:require(java6) @:overload public function statementClosed(event : javax.sql.StatementEvent) : Void;
	...
	* @since 1.6
	*/
	@:require(java6) @:overload public function statementErrorOccurred(event : javax.sql.StatementEvent) : Void;
