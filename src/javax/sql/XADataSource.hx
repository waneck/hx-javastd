...
* @since 1.4
*/
@:require(java4) extern interface XADataSource extends javax.sql.CommonDataSource
{
	/**
	...
	* @since 1.4
	*/
	@:require(java4) @:overload public function getXAConnection() : javax.sql.XAConnection;
	...
	* @since 1.4
	*/
	@:require(java4) @:overload public function getXAConnection(user : String, password : String) : javax.sql.XAConnection;
