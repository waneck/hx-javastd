...
extern class StreamReaderDelegate implements javax.xml.stream.XMLStreamReader
{
	...
	*/
	@:overload @:public public function setParent(reader : javax.xml.stream.XMLStreamReader) : Void;
	
	/**
	* Get the parent of this instance.
	* @return the parent or null if none is set
	*/
	@:overload @:public public function getParent() : javax.xml.stream.XMLStreamReader;
