...
{
	@:overload @:public @:final public function marshal(obj : Dynamic, os : java.io.OutputStream) : Void;
	
	@:overload @:public public function marshal(jaxbElement : Dynamic, output : java.io.File) : Void;
	
	@:overload @:public @:final public function marshal(obj : Dynamic, w : java.io.Writer) : Void;
	
	@:overload @:public @:final public function marshal(obj : Dynamic, handler : org.xml.sax.ContentHandler) : Void;
	
	@:overload @:public @:final public function marshal(obj : Dynamic, node : org.w3c.dom.Node) : Void;
	...
	*/
	@:overload @:public public function getNode(obj : Dynamic) : org.w3c.dom.Node;
	...
	*/
	@:overload @:protected private function getEncoding() : String;
	...
	* documentation
	*/
	@:overload @:protected private function setEncoding(encoding : String) : Void;
	...
	*/
	@:overload @:protected private function getSchemaLocation() : String;
	...
	*/
	@:overload @:protected private function setSchemaLocation(location : String) : Void;
	...
	* been set
	*/
	@:overload @:protected private function getNoNSSchemaLocation() : String;
	...
	*/
	@:overload @:protected private function setNoNSSchemaLocation(location : String) : Void;
	...
	* it hasn't been set.
	*/
	@:overload @:protected private function isFormattedOutput() : Bool;
	...
	*/
	@:overload @:protected private function setFormattedOutput(v : Bool) : Void;
	...
	* it hasn't been set.
	*/
	@:overload @:protected private function isFragment() : Bool;
	...
	*/
	@:overload @:protected private function setFragment(v : Bool) : Void;
	...
	*/
	@:overload @:protected private function getJavaEncoding(encoding : String) : String;
	...
	*/
	...
	@:overload @:public public function marshal(obj : Dynamic, writer : javax.xml.stream.XMLEventWriter) : Void;
	
	@:overload @:public public function marshal(obj : Dynamic, writer : javax.xml.stream.XMLStreamWriter) : Void;
	...
	@:overload @:public public function setAttachmentMarshaller(am : javax.xml.bind.attachment.AttachmentMarshaller) : Void;
	
	@:overload @:public public function getAttachmentMarshaller() : javax.xml.bind.attachment.AttachmentMarshaller;
	
	@:overload @:public public function setListener(listener : javax.xml.bind.Marshaller.Marshaller_Listener) : Void;
	
	@:overload @:public public function getListener() : javax.xml.bind.Marshaller.Marshaller_Listener;
