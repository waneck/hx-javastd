...
*/
@:require(java6) extern interface URIDereferencer
{
	/**
	...
	*/
	@:overload public function dereference(uriReference : javax.xml.crypto.URIReference, context : javax.xml.crypto.XMLCryptoContext) : javax.xml.crypto.Data;
