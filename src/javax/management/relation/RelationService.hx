...
* questions.
*/
extern class RelationService extends javax.management.NotificationBroadcasterSupport implements javax.management.relation.RelationServiceMBean implements javax.management.MBeanRegistration implements javax.management.NotificationListener
{
	/**
	* Constructor.
	*
