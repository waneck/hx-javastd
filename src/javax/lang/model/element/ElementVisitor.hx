...
* @since 1.6
*/
@:require(java6) extern interface ElementVisitor<R, P>
{
	/**
	* Visits an element.
	...
	*/
	@:overload public function visit(e : javax.lang.model.element.Element, p : P) : R;
	...
	* @return a visitor-specified result
	*/
	@:overload public function visit(e : javax.lang.model.element.Element) : R;
