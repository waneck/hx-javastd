...
* @since 1.6
*/
@:require(java6) extern interface TypeVisitor<R, P>
{
	/**
	* Visits a type.
	...
	*/
	@:overload public function visit(t : javax.lang.model.type.TypeMirror, p : P) : R;
	...
	* @return  a visitor-specified result
	*/
	@:overload public function visit(t : javax.lang.model.type.TypeMirror) : R;
