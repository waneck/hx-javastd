...
* @author Rob Weltman
*/
@:require(java5) extern interface SaslServer
{
	/**
	...
	*/
	@:overload @:public @:abstract public function evaluateResponse(response : java.NativeArray<java.StdTypes.Int8>) : java.NativeArray<java.StdTypes.Int8>;
