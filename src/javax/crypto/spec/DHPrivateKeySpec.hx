...
* questions.
*/
extern class DHPrivateKeySpec implements java.security.spec.KeySpec
{
	/**
	...
	*/
	@:overload @:public public function new(x : java.math.BigInteger, p : java.math.BigInteger, g : java.math.BigInteger) : Void;
