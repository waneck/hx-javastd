...
extern interface AccessibleStreamable
{
	...
	* this object supports.
	*/
	@:overload public function getMimeTypes() : java.NativeArray<java.awt.datatransfer.DataFlavor>;
	...
	*/
	@:overload public function getStream(flavor : java.awt.datatransfer.DataFlavor) : java.io.InputStream;
