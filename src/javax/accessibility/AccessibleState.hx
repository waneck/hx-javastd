...
* questions.
*/
extern class AccessibleState extends javax.accessibility.AccessibleBundle
{
	/**
	...
	*/
	public static var ACTIVE(default, null) : AccessibleState;
	...
	*/
	public static var PRESSED(default, null) : AccessibleState;
	...
	* @see AccessibleRole#PUSH_BUTTON
	*/
	public static var ARMED(default, null) : AccessibleState;
	...
	*/
	public static var BUSY(default, null) : AccessibleState;
	...
	*/
	public static var CHECKED(default, null) : AccessibleState;
	...
	* @see #ENABLED
	*/
	public static var EDITABLE(default, null) : AccessibleState;
	...
	*/
	public static var EXPANDABLE(default, null) : AccessibleState;
	...
	* @see AccessibleRole#TREE
	*/
	public static var COLLAPSED(default, null) : AccessibleState;
	...
	* @see AccessibleRole#TREE
	*/
	public static var EXPANDED(default, null) : AccessibleState;
	...
	*/
	public static var ENABLED(default, null) : AccessibleState;
	...
	* @see #FOCUSED
	*/
	public static var FOCUSABLE(default, null) : AccessibleState;
	
	/**
	* Indicates this object currently has the keyboard focus.
	* @see #FOCUSABLE
	*/
	public static var FOCUSED(default, null) : AccessibleState;
	...
	*/
	public static var ICONIFIED(default, null) : AccessibleState;
	...
	* @see AccessibleRole#DIALOG
	*/
	public static var MODAL(default, null) : AccessibleState;
	...
	*/
	public static var OPAQUE(default, null) : AccessibleState;
	...
	*/
	public static var RESIZABLE(default, null) : AccessibleState;
	...
	*/
	public static var MULTISELECTABLE(default, null) : AccessibleState;
	...
	* @see AccessibleSelection
	*/
	public static var SELECTABLE(default, null) : AccessibleState;
	...
	* @see AccessibleSelection
	*/
	public static var SELECTED(default, null) : AccessibleState;
	...
	* @see #VISIBLE
	*/
	public static var SHOWING(default, null) : AccessibleState;
	...
	* @see #SHOWING
	*/
	public static var VISIBLE(default, null) : AccessibleState;
	...
	* @see AccessibleRole#PROGRESS_BAR
	*/
	public static var VERTICAL(default, null) : AccessibleState;
	...
	* @see AccessibleRole#PROGRESS_BAR
	*/
	public static var HORIZONTAL(default, null) : AccessibleState;
	
	/**
	* Indicates this (text) object can contain only a single line of text
	*/
	public static var SINGLE_LINE(default, null) : AccessibleState;
	
	/**
	* Indicates this (text) object can contain multiple lines of text
	*/
	public static var MULTI_LINE(default, null) : AccessibleState;
	...
	*
	*/
	@:require(java5) public static var TRANSIENT(default, null) : AccessibleState;
	...
	* @since 1.5
	*/
	@:require(java5) public static var MANAGES_DESCENDANTS(default, null) : AccessibleState;
	...
	* @since 1.5
	*/
	@:require(java5) public static var INDETERMINATE(default, null) : AccessibleState;
	...
	* @since 1.5
	*/
	@:require(java5) public static var TRUNCATED(default, null) : AccessibleState;
