...
extern class X509ExtendedKeyManager implements javax.net.ssl.X509KeyManager
{
	...
	*          are no matches.
	*/
	@:overload public function chooseEngineClientAlias(keyType : java.NativeArray<String>, issuers : java.NativeArray<java.security.Principal>, engine : javax.net.ssl.SSLEngine) : String;
