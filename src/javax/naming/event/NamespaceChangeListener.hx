...
* @since 1.3
*/
@:require(java3) extern interface NamespaceChangeListener extends javax.naming.event.NamingListener
{
	/**
	...
	*/
	@:overload public function objectAdded(evt : javax.naming.event.NamingEvent) : Void;
	...
	*/
	@:overload public function objectRemoved(evt : javax.naming.event.NamingEvent) : Void;
	...
	*/
	@:overload public function objectRenamed(evt : javax.naming.event.NamingEvent) : Void;
