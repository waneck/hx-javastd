...
* @since 1.3
*/
@:require(java3) extern interface NamingListener extends java.util.EventListener
{
	/**
	...
	*/
	@:overload public function namingExceptionThrown(evt : javax.naming.event.NamingExceptionEvent) : Void;
