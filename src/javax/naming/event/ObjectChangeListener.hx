...
* @since 1.3
*/
@:require(java3) extern interface ObjectChangeListener extends javax.naming.event.NamingListener
{
	/**
	...
	*/
	@:overload public function objectChanged(evt : javax.naming.event.NamingEvent) : Void;
