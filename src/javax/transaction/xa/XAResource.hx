...
extern interface XAResource
{
	...
	*/
	@:overload public function commit(xid : javax.transaction.xa.Xid, onePhase : Bool) : Void;
	...
	* XAER_PROTO, or XA_RB*.
	*/
	@:overload public function end(xid : javax.transaction.xa.Xid, flags : Int) : Void;
	...
	* XAER_PROTO.
	*/
	@:overload public function forget(xid : javax.transaction.xa.Xid) : Void;
	...
	*/
	@:overload public function getTransactionTimeout() : Int;
	...
	*/
	@:overload public function prepare(xid : javax.transaction.xa.Xid) : Int;
	...
	*
	*/
	@:overload public function recover(flag : Int) : java.NativeArray<javax.transaction.xa.Xid>;
	...
	*/
	@:overload public function rollback(xid : javax.transaction.xa.Xid) : Void;
	...
	*/
	@:overload public function setTransactionTimeout(seconds : Int) : Bool;
	...
	*
	*/
	@:overload public function start(xid : javax.transaction.xa.Xid, flags : Int) : Void;
