...
extern interface Xid
{
	...
	*/
	@:overload public function getFormatId() : Int;
	...
	*/
	@:overload public function getGlobalTransactionId() : java.NativeArray<java.StdTypes.Int8>;
	...
	* @return Global transaction identifier.
	*/
	@:overload public function getBranchQualifier() : java.NativeArray<java.StdTypes.Int8>;
