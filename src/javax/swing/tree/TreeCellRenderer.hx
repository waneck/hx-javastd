...
extern interface TreeCellRenderer
{
	...
	*/
	@:overload public function getTreeCellRendererComponent(tree : javax.swing.JTree, value : Dynamic, selected : Bool, expanded : Bool, leaf : Bool, row : Int, hasFocus : Bool) : java.awt.Component;
