...
@:native('javax$swing$tree$VariableHeightLayoutCache$TreeStateNode') @:internal extern class VariableHeightLayoutCache_TreeStateNode extends javax.swing.tree.DefaultMutableTreeNode
{
	...
	*/
	@:overload public function getNodeBounds(placeIn : java.awt.Rectangle) : java.awt.Rectangle;
	
	/**
	* @return x location to draw node at.
	*/
	@:overload public function getXOrigin() : Int;
	
	/**
	* Returns the y origin the user object will be drawn at.
	*/
	@:overload public function getYOrigin() : Int;
	...
	*/
	@:overload public function hasValidSize() : Bool;
	...
	*/
	@:overload public function hasBeenExpanded() : Bool;
	...
	*/
	@:overload public function getModelChildCount() : Int;
	
	/**
	* Returns the number of visible children, that is the number of
	* children that are expanded, or leafs.
	*/
	@:overload public function getVisibleChildCount() : Int;
	
	/**
	* Toggles the receiver between expanded and collapsed.
	*/
	@:overload public function toggleExpanded() : Void;
	
	/**
	* Makes the receiver visible, but invoking
	* <code>expandParentAndReceiver</code> on the superclass.
	*/
	@:overload public function makeVisible() : Void;
	
	/**
	* Expands the receiver.
	*/
	@:overload public function expand() : Void;
	
	/**
	* Collapses the receiver.
	*/
	@:overload public function collapse() : Void;
	...
	* <I>newYOrigin</I>.
	*/
	@:overload private function setYOrigin(newYOrigin : Int) : Void;
	
	/**
	* Shifts the y origin by <code>offset</code>.
	*/
	@:overload private function shiftYOriginBy(offset : Int) : Void;
	
	/**
	* Updates the receivers preferredSize by invoking
	* <code>updatePreferredSize</code> with an argument of -1.
	*/
	@:overload private function updatePreferredSize() : Void;
	...
	* loaded.
	*/
	@:overload private function getLoadedChildren(createIfNeeded : Bool) : java.util.Enumeration<Dynamic>;
	...
	*/
	@:overload private function expand(adjustTree : Bool) : Void;
	
	/**
	* Collapses this node in the tree.  If <I>adjustTree</I> is
	* true the tree and selection are updated accordingly.
	*/
	@:overload private function collapse(adjustTree : Bool) : Void;
