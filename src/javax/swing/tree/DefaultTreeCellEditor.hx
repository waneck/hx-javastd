...
extern class DefaultTreeCellEditor implements java.awt.event.ActionListener implements javax.swing.tree.TreeCellEditor implements javax.swing.event.TreeSelectionListener
{
	...
	@:protected private var realEditor : javax.swing.tree.TreeCellEditor;
	
	/** Renderer, used to get border and offsets from. */
	@:protected private var renderer : javax.swing.tree.DefaultTreeCellRenderer;
	
	/** Editing container, will contain the <code>editorComponent</code>. */
	@:protected private var editingContainer : java.awt.Container;
	
	/**
	* Component used in editing, obtained from the
	* <code>editingContainer</code>.
	*/
	@:transient @:protected private var editingComponent : java.awt.Component;
	...
	*/
	@:protected private var canEdit : Bool;
	...
	*/
	...
	@:protected @:transient private var tree : javax.swing.JTree;
	
	/** Last path that was selected. */
	@:protected @:transient private var lastPath : javax.swing.tree.TreePath;
	
	/** Used before starting the editing session. */
	@:protected @:transient private var timer : javax.swing.Timer;
	
	/**
	* Row that was last passed into
	* <code>getTreeCellEditorComponent</code>.
	*/
	@:protected @:transient private var lastRow : Int;
	
	/** True if the border selection color should be drawn. */
	@:protected private var borderSelectionColor : java.awt.Color;
	
	/** Icon to use when editing. */
	@:protected @:transient private var editingIcon : javax.swing.Icon;
	...
	*/
	@:overload @:public public function new(tree : javax.swing.JTree, renderer : javax.swing.tree.DefaultTreeCellRenderer, editor : javax.swing.tree.TreeCellEditor) : Void;
	...
	*/
	@:overload @:public public function getTreeCellEditorComponent(tree : javax.swing.JTree, value : Dynamic, isSelected : Bool, expanded : Bool, leaf : Bool, row : Int) : java.awt.Component;
	...
	*/
	@:overload @:protected private function setTree(newTree : javax.swing.JTree) : Void;
	...
	*/
	@:overload @:protected private function shouldStartEditingTimer(event : java.util.EventObject) : Bool;
	
	/**
	* Starts the editing timer.
	*/
	@:overload @:protected private function startEditingTimer() : Void;
	...
	* @param event the event being studied
	*/
	@:overload @:protected private function canEditImmediately(event : java.util.EventObject) : Bool;
	...
	*/
	@:overload @:protected private function inHitRegion(x : Int, y : Int) : Bool;
	
	@:overload @:protected private function determineOffset(tree : javax.swing.JTree, value : Dynamic, isSelected : Bool, expanded : Bool, leaf : Bool, row : Int) : Void;
	...
	* <code>editingContainer</code>.
	*/
	@:overload @:protected private function prepareForEditing() : Void;
	
	/**
	* Creates the container to manage placement of
	* <code>editingComponent</code>.
	*/
	@:overload @:protected private function createContainer() : java.awt.Container;
	...
	*/
	@:overload @:protected private function createTreeCellEditor() : javax.swing.tree.TreeCellEditor;
...
@:native('javax$swing$tree$DefaultTreeCellEditor$DefaultTextField') extern class DefaultTreeCellEditor_DefaultTextField extends javax.swing.JTextField
{
	...
	* @since 1.4
	*/
	@:require(java4) @:overload @:public public function new(border : javax.swing.border.Border) : Void;
	...
	*/
	@:overload @:public override public function getBorder() : javax.swing.border.Border;
