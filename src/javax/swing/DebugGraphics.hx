...
extern class DebugGraphics extends java.awt.Graphics
{
	...
	@:public @:static @:final public static var LOG_OPTION(default, null) : Int;
	
	/** Flash graphics operations. */
	@:public @:static @:final public static var FLASH_OPTION(default, null) : Int;
	
	/** Show buffered operations in a separate <code>Frame</code>. */
	@:public @:static @:final public static var BUFFERED_OPTION(default, null) : Int;
	
	/** Don't debug graphics operations. */
	@:public @:static @:final public static var NONE_OPTION(default, null) : Int;
	...
	*/
	@:overload @:public public function new(graphics : java.awt.Graphics, component : javax.swing.JComponent) : Void;
	...
	* @param graphics  the Graphics context to slow down
	*/
	@:overload @:public public function new(graphics : java.awt.Graphics) : Void;
	...
	*/
	@:overload @:public @:static public static function setFlashColor(flashColor : java.awt.Color) : Void;
	
	/**
	* Returns the Color used to flash drawing operations.
	* @see #setFlashColor
	*/
	@:overload @:public @:static public static function flashColor() : java.awt.Color;
	
	/**
	* Sets the time delay of drawing operation flashing.
	*/
	@:overload @:public @:static public static function setFlashTime(flashTime : Int) : Void;
	
	/**
	* Returns the time delay of drawing operation flashing.
	* @see #setFlashTime
	*/
	@:overload @:public @:static public static function flashTime() : Int;
	
	/**
	* Sets the number of times that drawing operations will flash.
	*/
	@:overload @:public @:static public static function setFlashCount(flashCount : Int) : Void;
	
	/** Returns the number of times that drawing operations will flash.
	* @see #setFlashCount
	*/
	@:overload @:public @:static public static function flashCount() : Int;
	
	/** Sets the stream to which the DebugGraphics logs drawing operations.
	*/
	@:overload @:public @:static public static function setLogStream(stream : java.io.PrintStream) : Void;
	
	/** Returns the stream to which the DebugGraphics logs drawing operations.
	* @see #setLogStream
	*/
	@:overload @:public @:static public static function logStream() : java.io.PrintStream;
	
	/** Sets the Font used for text drawing operations.
	*/
	@:overload @:public override public function setFont(aFont : java.awt.Font) : Void;
	...
	*/
	@:overload @:public override public function setColor(aColor : java.awt.Color) : Void;
	...
	*/
	@:overload @:public override public function setXORMode(aColor : java.awt.Color) : Void;
	...
	*/
	@:overload @:public override public function setClip(x : Int, y : Int, width : Int, height : Int) : Void;
	...
	* Overrides <code>Graphics.setClip</code>.
	*/
	@:overload @:public override public function setClip(clip : java.awt.Shape) : Void;
	...
	*/
	@:overload @:public override public function drawOval(x : Int, y : Int, width : Int, height : Int) : Void;
	...
	*/
	@:overload @:public override public function drawString(aString : String, x : Int, y : Int) : Void;
	...
	* Overrides <code>Graphics.drawImage</code>.
	*/
	@:overload @:public override public function drawImage(img : java.awt.Image, x : Int, y : Int, bgcolor : java.awt.Color, observer : java.awt.image.ImageObserver) : Bool;
	
	/**
	* Overrides <code>Graphics.drawImage</code>.
	*/
	@:overload @:public override public function drawImage(img : java.awt.Image, x : Int, y : Int, width : Int, height : Int, bgcolor : java.awt.Color, observer : java.awt.image.ImageObserver) : Bool;
	...
	*/
	@:overload @:public override public function copyArea(x : Int, y : Int, width : Int, height : Int, destX : Int, destY : Int) : Void;
	...
	*/
	@:overload @:public public function isDrawingBuffer() : Bool;
	...
	*/
	@:overload @:public public function setDebugOptions(options : Int) : Void;
	
	/** Returns the current debugging options for this DebugGraphics.
	* @see #setDebugOptions
	*/
	@:overload @:public public function getDebugOptions() : Int;
