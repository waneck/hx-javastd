...
@:internal extern class ImageScalingHelper
{
	...
	*                  center.
	*/
	@:overload public static function paint(g : java.awt.Graphics, x : Int, y : Int, w : Int, h : Int, image : java.awt.Image, sInsets : java.awt.Insets, dInsets : java.awt.Insets, paintType : ImageScalingHelper_PaintType, mask : Int) : Void;
