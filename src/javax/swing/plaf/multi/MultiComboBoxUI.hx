...
extern class MultiComboBoxUI extends javax.swing.plaf.ComboBoxUI
{
	...
	*/
	@:overload public function isFocusTraversable(a : javax.swing.JComboBox<Dynamic>) : Bool;
	
	/**
	* Invokes the <code>setPopupVisible</code> method on each UI handled by this object.
	*/
	@:overload public function setPopupVisible(a : javax.swing.JComboBox<Dynamic>, b : Bool) : Void;
	...
	* the UI obtained from the default <code>LookAndFeel</code>
	*/
	@:overload public function isPopupVisible(a : javax.swing.JComboBox<Dynamic>) : Bool;
