...
* questions.
*/
extern class MultiComboBoxUI extends javax.swing.plaf.ComboBoxUI
{
	/**
	...
	*/
	@:overload @:public override public function isFocusTraversable(a : javax.swing.JComboBox<Dynamic>) : Bool;
	
	/**
	* Invokes the <code>setPopupVisible</code> method on each UI handled by this object.
	*/
	@:overload @:public override public function setPopupVisible(a : javax.swing.JComboBox<Dynamic>, b : Bool) : Void;
	...
	* the UI obtained from the default <code>LookAndFeel</code>
	*/
	@:overload @:public override public function isPopupVisible(a : javax.swing.JComboBox<Dynamic>) : Bool;
