...
* questions.
*/
extern class MultiPopupMenuUI extends javax.swing.plaf.PopupMenuUI
{
	/**
	...
	* @since 1.3
	*/
	@:require(java3) @:overload @:public override public function isPopupTrigger(a : java.awt.event.MouseEvent) : Bool;
	...
	* @since 1.4
	*/
	@:require(java4) @:overload @:public override public function getPopup(a : javax.swing.JPopupMenu, b : Int, c : Int) : javax.swing.Popup;
