...
{
	@:transient @:protected private var collapsedIcon : javax.swing.Icon;
	
	@:transient @:protected private var expandedIcon : javax.swing.Icon;
	
	/** Distance between left margin and where vertical dashes will be
	* drawn. */
	@:protected private var leftChildIndent : Int;
	
	/** Distance to add to leftChildIndent to determine where cell
	* contents will be drawn. */
	@:protected private var rightChildIndent : Int;
	
	/** Total distance that will be indented.  The sum of leftChildIndent
	* and rightChildIndent. */
	@:protected private var totalChildIndent : Int;
	
	/** Minimum preferred size. */
	@:protected private var preferredMinSize : java.awt.Dimension;
	
	/** Index of the row that was last selected. */
	@:protected private var lastSelectedRow : Int;
	
	/** Component that we're going to be drawing into. */
	@:protected private var tree : javax.swing.JTree;
	
	/** Renderer that is being used to do the actual cell drawing. */
	@:transient @:protected private var currentCellRenderer : javax.swing.tree.TreeCellRenderer;
	
	/** Set to true if the renderer that is currently in the tree was
	* created by this instance. */
	@:protected private var createdRenderer : Bool;
	...
	* created by this instance. */
	@:protected private var createdCellEditor : Bool;
	...
	* the node should be selected before editing, used in completeEditing. */
	@:protected private var stopEditingInCompleteEditing : Bool;
	
	/** Used to paint the TreeCellRenderer. */
	@:protected private var rendererPane : javax.swing.CellRendererPane;
	
	/** Size needed to completely display all the nodes. */
	@:protected private var preferredSize : java.awt.Dimension;
	
	/** Is the preferredSize valid? */
	@:protected private var validCachedPreferredSize : Bool;
	
	/** Object responsible for handling sizing and expanded issues. */
	@:protected private var treeState : javax.swing.tree.AbstractLayoutCache;
	
	/** Used for minimizing the drawing of vertical lines. */
	@:protected private var drawingCache : java.util.Hashtable<javax.swing.tree.TreePath, Null<Bool>>;
	...
	* and if the root handles are visible. */
	@:protected private var depthOffset : Int;
	
	/** When editing, this will be the Component that is doing the actual
	* editing. */
	@:protected private var editingComponent : java.awt.Component;
	
	/** Path that is being edited. */
	@:protected private var editingPath : javax.swing.tree.TreePath;
	
	/** Row that is being edited. Should only be referenced if
	* editingComponent is not null. */
	@:protected private var editingRow : Int;
	
	/** Set to true if the editor has a different size than the renderer. */
	@:protected private var editorHasDifferentSize : Bool;
	
	@:overload @:public @:static public static function createUI(x : javax.swing.JComponent) : javax.swing.plaf.ComponentUI;
	
	@:overload @:public public function new() : Void;
	
	@:overload @:protected private function getHashColor() : java.awt.Color;
	
	@:overload @:protected private function setHashColor(color : java.awt.Color) : Void;
	
	@:overload @:public public function setLeftChildIndent(newAmount : Int) : Void;
	
	@:overload @:public public function getLeftChildIndent() : Int;
	
	@:overload @:public public function setRightChildIndent(newAmount : Int) : Void;
	
	@:overload @:public public function getRightChildIndent() : Int;
	
	@:overload @:public public function setExpandedIcon(newG : javax.swing.Icon) : Void;
	
	@:overload @:public public function getExpandedIcon() : javax.swing.Icon;
	
	@:overload @:public public function setCollapsedIcon(newG : javax.swing.Icon) : Void;
	
	@:overload @:public public function getCollapsedIcon() : javax.swing.Icon;
	
	/**
	* Updates the componentListener, if necessary.
	*/
	@:overload @:protected private function setLargeModel(largeModel : Bool) : Void;
	
	@:overload @:protected private function isLargeModel() : Bool;
	
	/**
	* Sets the row height, this is forwarded to the treeState.
	*/
	@:overload @:protected private function setRowHeight(rowHeight : Int) : Void;
	...
	*/
	@:overload @:protected private function setCellRenderer(tcr : javax.swing.tree.TreeCellRenderer) : Void;
	
	/**
	* Return currentCellRenderer, which will either be the trees
	* renderer, or defaultCellRenderer, which ever wasn't null.
	*/
	@:overload @:protected private function getCellRenderer() : javax.swing.tree.TreeCellRenderer;
	
	/**
	* Sets the TreeModel.
	*/
	@:overload @:protected private function setModel(model : javax.swing.tree.TreeModel) : Void;
	
	@:overload @:protected private function getModel() : javax.swing.tree.TreeModel;
	
	/**
	* Sets the root to being visible.
	*/
	@:overload @:protected private function setRootVisible(newValue : Bool) : Void;
	
	@:overload @:protected private function isRootVisible() : Bool;
	
	/**
	* Determines whether the node handles are to be displayed.
	*/
	@:overload @:protected private function setShowsRootHandles(newValue : Bool) : Void;
	
	@:overload @:protected private function getShowsRootHandles() : Bool;
	
	/**
	* Sets the cell editor.
	*/
	@:overload @:protected private function setCellEditor(editor : javax.swing.tree.TreeCellEditor) : Void;
	
	@:overload @:protected private function getCellEditor() : javax.swing.tree.TreeCellEditor;
	
	/**
	* Configures the receiver to allow, or not allow, editing.
	*/
	@:overload @:protected private function setEditable(newValue : Bool) : Void;
	
	@:overload @:protected private function isEditable() : Bool;
	
	/**
	* Resets the selection model. The appropriate listener are installed
	* on the model.
	*/
	@:overload @:protected private function setSelectionModel(newLSM : javax.swing.tree.TreeSelectionModel) : Void;
	
	@:overload @:protected private function getSelectionModel() : javax.swing.tree.TreeSelectionModel;
	...
	*/
	@:overload @:public override public function getPathBounds(tree : javax.swing.JTree, path : javax.swing.tree.TreePath) : java.awt.Rectangle;
	
	/**
	* Returns the path for passed in row.  If row is not visible
	* null is returned.
	*/
	@:overload @:public override public function getPathForRow(tree : javax.swing.JTree, row : Int) : javax.swing.tree.TreePath;
	...
	* currently visible.
	*/
	@:overload @:public override public function getRowForPath(tree : javax.swing.JTree, path : javax.swing.tree.TreePath) : Int;
	
	/**
	* Returns the number of rows that are being displayed.
	*/
	@:overload @:public override public function getRowCount(tree : javax.swing.JTree) : Int;
	...
	*/
	@:overload @:public override public function getClosestPathForLocation(tree : javax.swing.JTree, x : Int, y : Int) : javax.swing.tree.TreePath;
	
	/**
	* Returns true if the tree is being edited.  The item that is being
	* edited can be returned by getEditingPath().
	*/
	@:overload @:public override public function isEditing(tree : javax.swing.JTree) : Bool;
	...
	*/
	@:overload @:public override public function stopEditing(tree : javax.swing.JTree) : Bool;
	
	/**
	* Cancels the current editing session.
	*/
	@:overload @:public override public function cancelEditing(tree : javax.swing.JTree) : Void;
	
	/**
	* Selects the last item in path and tries to edit it.  Editing will
	* fail if the CellEditor won't allow it for the selected item.
	*/
	@:overload @:public override public function startEditingAtPath(tree : javax.swing.JTree, path : javax.swing.tree.TreePath) : Void;
	
	/**
	* Returns the path to the element that is being edited.
	*/
	@:overload @:public override public function getEditingPath(tree : javax.swing.JTree) : javax.swing.tree.TreePath;
	...
	*/
	@:overload @:protected private function prepareForUIInstall() : Void;
	
	/**
	* Invoked from installUI after all the defaults/listeners have been
	* installed.
	*/
	@:overload @:protected private function completeUIInstall() : Void;
	...
	*/
	@:overload @:protected private function createNodeDimensions() : javax.swing.tree.AbstractLayoutCache.AbstractLayoutCache_NodeDimensions;
	...
	*/
	@:overload @:protected private function createSelectionModelPropertyChangeListener() : java.beans.PropertyChangeListener;
	
	/**
	* Creates the listener that updates the display based on selection change
	* methods.
	*/
	@:overload @:protected private function createTreeSelectionListener() : javax.swing.event.TreeSelectionListener;
	
	/**
	* Creates a listener to handle events from the current editor.
	*/
	@:overload @:protected private function createCellEditorListener() : javax.swing.event.CellEditorListener;
	...
	*/
	@:overload @:protected private function createTreeExpansionListener() : javax.swing.event.TreeExpansionListener;
	
	/**
	* Creates the object responsible for managing what is expanded, as
	* well as the size of nodes.
	*/
	@:overload @:protected private function createLayoutCache() : javax.swing.tree.AbstractLayoutCache;
	
	/**
	* Returns the renderer pane that renderer components are placed in.
	*/
	@:overload @:protected private function createCellRendererPane() : javax.swing.CellRendererPane;
	
	/**
	* Creates a default cell editor.
	*/
	@:overload @:protected private function createDefaultCellEditor() : javax.swing.tree.TreeCellEditor;
	
	/**
	* Returns the default cell renderer that is used to do the
	* stamping of each node.
	*/
	@:overload @:protected private function createDefaultCellRenderer() : javax.swing.tree.TreeCellRenderer;
	...
	*/
	...
	@:overload @:protected private function prepareForUIUninstall() : Void;
	
	@:overload @:protected private function completeUIUninstall() : Void;
	...
	* @since 1.7
	*/
	@:require(java7) @:overload @:protected private function isDropLine(loc : javax.swing.JTree.JTree_DropLocation) : Bool;
	...
	* @since 1.7
	*/
	@:require(java7) @:overload @:protected private function paintDropLine(g : java.awt.Graphics) : Void;
	...
	* @since 1.7
	*/
	@:require(java7) @:overload @:protected private function getDropLineRect(loc : javax.swing.JTree.JTree_DropLocation) : java.awt.Rectangle;
	...
	*/
	@:overload @:protected private function paintHorizontalPartOfLeg(g : java.awt.Graphics, clipBounds : java.awt.Rectangle, insets : java.awt.Insets, bounds : java.awt.Rectangle, path : javax.swing.tree.TreePath, row : Int, isExpanded : Bool, hasBeenExpanded : Bool, isLeaf : Bool) : Void;
	
	/**
	* Paints the vertical part of the leg. The receiver should
	* NOT modify <code>clipBounds</code>, <code>insets</code>.<p>
	*/
	@:overload @:protected private function paintVerticalPartOfLeg(g : java.awt.Graphics, clipBounds : java.awt.Rectangle, insets : java.awt.Insets, path : javax.swing.tree.TreePath) : Void;
	
	/**
	* Paints the expand (toggle) part of a row. The receiver should
	* NOT modify <code>clipBounds</code>, or <code>insets</code>.
	*/
	@:overload @:protected private function paintExpandControl(g : java.awt.Graphics, clipBounds : java.awt.Rectangle, insets : java.awt.Insets, bounds : java.awt.Rectangle, path : javax.swing.tree.TreePath, row : Int, isExpanded : Bool, hasBeenExpanded : Bool, isLeaf : Bool) : Void;
	
	/**
	* Paints the renderer part of a row. The receiver should
	* NOT modify <code>clipBounds</code>, or <code>insets</code>.
	*/
	@:overload @:protected private function paintRow(g : java.awt.Graphics, clipBounds : java.awt.Rectangle, insets : java.awt.Insets, bounds : java.awt.Rectangle, path : javax.swing.tree.TreePath, row : Int, isExpanded : Bool, hasBeenExpanded : Bool, isLeaf : Bool) : Void;
	
	/**
	* Returns true if the expand (toggle) control should be drawn for
	* the specified row.
	*/
	@:overload @:protected private function shouldPaintExpandControl(path : javax.swing.tree.TreePath, row : Int, isExpanded : Bool, hasBeenExpanded : Bool, isLeaf : Bool) : Bool;
	
	/**
	* Paints a vertical line.
	*/
	@:overload @:protected private function paintVerticalLine(g : java.awt.Graphics, c : javax.swing.JComponent, x : Int, top : Int, bottom : Int) : Void;
	
	/**
	* Paints a horizontal line.
	*/
	@:overload @:protected private function paintHorizontalLine(g : java.awt.Graphics, c : javax.swing.JComponent, y : Int, left : Int, right : Int) : Void;
	
	/**
	* The vertical element of legs between nodes starts at the bottom of the
	* parent node by default.  This method makes the leg start below that.
	*/
	@:overload @:protected private function getVerticalLegBuffer() : Int;
	...
	*/
	@:overload @:protected private function getHorizontalLegBuffer() : Int;
	
	@:overload @:protected private function drawCentered(c : java.awt.Component, graphics : java.awt.Graphics, icon : javax.swing.Icon, x : Int, y : Int) : Void;
	
	@:overload @:protected private function drawDashedHorizontalLine(g : java.awt.Graphics, y : Int, x1 : Int, x2 : Int) : Void;
	
	@:overload @:protected private function drawDashedVerticalLine(g : java.awt.Graphics, x : Int, y1 : Int, y2 : Int) : Void;
	...
	* @since 1.5
	*/
	@:require(java5) @:overload @:protected private function getRowX(row : Int, depth : Int) : Int;
	
	/**
	* Makes all the nodes that are expanded in JTree expanded in LayoutCache.
	* This invokes updateExpandedDescendants with the root path.
	*/
	@:overload @:protected private function updateLayoutCacheExpandedNodes() : Void;
	...
	* to the tree state.
	*/
	@:overload @:protected private function updateExpandedDescendants(path : javax.swing.tree.TreePath) : Void;
	
	/**
	* Returns a path to the last child of <code>parent</code>.
	*/
	@:overload @:protected private function getLastChildPath(parent : javax.swing.tree.TreePath) : javax.swing.tree.TreePath;
	
	/**
	* Updates how much each depth should be offset by.
	*/
	@:overload @:protected private function updateDepthOffset() : Void;
	...
	*/
	@:overload @:protected private function updateCellEditor() : Void;
	
	/**
	* Messaged from the tree we're in when the renderer has changed.
	*/
	@:overload @:protected private function updateRenderer() : Void;
	
	/**
	* Resets the TreeState instance based on the tree we're providing the
	* look and feel for.
	*/
	@:overload @:protected private function configureLayoutCache() : Void;
	
	/**
	* Marks the cached size as being invalid, and messages the
	* tree with <code>treeDidChange</code>.
	*/
	@:overload @:protected private function updateSize() : Void;
	...
	*/
	@:overload @:protected private function updateCachedPreferredSize() : Void;
	
	/**
	* Messaged from the VisibleTreeNode after it has been expanded.
	*/
	@:overload @:protected private function pathWasExpanded(path : javax.swing.tree.TreePath) : Void;
	
	/**
	* Messaged from the VisibleTreeNode after it has collapsed.
	*/
	@:overload @:protected private function pathWasCollapsed(path : javax.swing.tree.TreePath) : Void;
	
	/**
	* Ensures that the rows identified by beginRow through endRow are
	* visible.
	*/
	@:overload @:protected private function ensureRowsAreVisible(beginRow : Int, endRow : Int) : Void;
	
	/** Sets the preferred minimum size.
	*/
	@:overload @:public public function setPreferredMinSize(newSize : java.awt.Dimension) : Void;
	
	/** Returns the minimum preferred size.
	*/
	@:overload @:public public function getPreferredMinSize() : java.awt.Dimension;
	...
	*/
	@:overload @:public public function getPreferredSize(c : javax.swing.JComponent, checkConsistency : Bool) : java.awt.Dimension;
	...
	* editing.
	*/
	@:overload @:protected private function completeEditing() : Void;
	...
	*/
	@:overload @:protected private function completeEditing(messageStop : Bool, messageCancel : Bool, messageTree : Bool) : Void;
	...
	*/
	@:overload @:protected private function startEditing(path : javax.swing.tree.TreePath, event : java.awt.event.MouseEvent) : Bool;
	...
	* the row.
	*/
	@:overload @:protected private function checkForClickInExpandControl(path : javax.swing.tree.TreePath, mouseX : Int, mouseY : Int) : Void;
	...
	*/
	@:overload @:protected private function isLocationInExpandControl(path : javax.swing.tree.TreePath, mouseX : Int, mouseY : Int) : Bool;
	
	/**
	* Messaged when the user clicks the particular row, this invokes
	* toggleExpandState.
	*/
	@:overload @:protected private function handleExpandControlClick(path : javax.swing.tree.TreePath, mouseX : Int, mouseY : Int) : Void;
	...
	*/
	@:overload @:protected private function toggleExpandState(path : javax.swing.tree.TreePath) : Void;
	
	/**
	* Returning true signifies a mouse event on the node should toggle
	* the selection of only the row under mouse.
	*/
	@:overload @:protected private function isToggleSelectionEvent(event : java.awt.event.MouseEvent) : Bool;
	
	/**
	* Returning true signifies a mouse event on the node should select
	* from the anchor point.
	*/
	@:overload @:protected private function isMultiSelectEvent(event : java.awt.event.MouseEvent) : Bool;
	...
	*/
	@:overload @:protected private function isToggleEvent(event : java.awt.event.MouseEvent) : Bool;
	...
	*/
	@:overload @:protected private function selectPathForEvent(path : javax.swing.tree.TreePath, event : java.awt.event.MouseEvent) : Void;
	
	/**
	* @return true if the node at <code>row</code> is a leaf.
	*/
	@:overload @:protected private function isLeaf(row : Int) : Bool;
	
	/**
	* Updates the lead row of the selection.
	* @since 1.7
	*/
	@:require(java7) @:overload @:protected private function updateLeadSelectionRow() : Void;
	...
	* @since 1.7
	*/
	@:require(java7) @:overload @:protected private function getLeadSelectionRow() : Int;
...
@:native('javax$swing$plaf$basic$BasicTreeUI$TreeExpansionHandler') extern class BasicTreeUI_TreeExpansionHandler implements javax.swing.event.TreeExpansionListener
{
	...
	*/
	@:overload @:public public function treeExpanded(event : javax.swing.event.TreeExpansionEvent) : Void;
	
	/**
	* Called whenever an item in the tree has been collapsed.
	*/
	@:overload @:public public function treeCollapsed(event : javax.swing.event.TreeExpansionEvent) : Void;
...
@:native('javax$swing$plaf$basic$BasicTreeUI$ComponentHandler') extern class BasicTreeUI_ComponentHandler extends java.awt.event.ComponentAdapter implements java.awt.event.ActionListener
{
	...
	* adjusting. */
	@:protected private var timer : javax.swing.Timer;
	
	/** ScrollBar that is being adjusted. */
	@:protected private var scrollBar : javax.swing.JScrollBar;
	
	@:overload @:public override public function componentMoved(e : java.awt.event.ComponentEvent) : Void;
	
	/**
	* Creates, if necessary, and starts a Timer to check if need to
	* resize the bounds.
	*/
	@:overload @:protected private function startTimer() : Void;
	
	/**
	* Returns the JScrollPane housing the JTree, or null if one isn't
	* found.
	*/
	@:overload @:protected private function getScrollPane() : javax.swing.JScrollPane;
...
@:native('javax$swing$plaf$basic$BasicTreeUI$TreeSelectionHandler') extern class BasicTreeUI_TreeSelectionHandler implements javax.swing.event.TreeSelectionListener
{
	...
	*/
	@:overload @:public public function valueChanged(event : javax.swing.event.TreeSelectionEvent) : Void;
...
@:native('javax$swing$plaf$basic$BasicTreeUI$KeyHandler') extern class BasicTreeUI_KeyHandler extends java.awt.event.KeyAdapter
{
	...
	@:protected private var repeatKeyAction : javax.swing.Action;
	
	/** Set to true while keyPressed is active. */
	@:protected private var isKeyDown : Bool;
...
@:native('javax$swing$plaf$basic$BasicTreeUI$NodeDimensionsHandler') extern class BasicTreeUI_NodeDimensionsHandler extends javax.swing.tree.AbstractLayoutCache.AbstractLayoutCache_NodeDimensions
{
	...
	*/
	@:overload @:public override public function getNodeDimensions(value : Dynamic, row : Int, depth : Int, expanded : Bool, size : java.awt.Rectangle) : java.awt.Rectangle;
	
	/**
	* @return amount to indent the given row.
	*/
	@:overload @:protected private function getRowX(row : Int, depth : Int) : Int;
...
@:native('javax$swing$plaf$basic$BasicTreeUI$MouseHandler') extern class BasicTreeUI_MouseHandler extends java.awt.event.MouseAdapter implements java.awt.event.MouseMotionListener
{
	...
	* @since 1.4
	*/
	@:require(java4) @:overload @:public override public function mouseMoved(e : java.awt.event.MouseEvent) : Void;
...
@:native('javax$swing$plaf$basic$BasicTreeUI$TreeTraverseAction') extern class BasicTreeUI_TreeTraverseAction extends javax.swing.AbstractAction
{
	...
	* collapse. */
	...
	@:overload @:public public function new(direction : Int, name : String) : Void;
...
@:native('javax$swing$plaf$basic$BasicTreeUI$MouseInputHandler') extern class BasicTreeUI_MouseInputHandler implements javax.swing.event.MouseInputListener
{
	...
	@:protected private var source : java.awt.Component;
	
	/** Destination that receives all events. */
	@:protected private var destination : java.awt.Component;
	
	@:overload @:public public function new(source : java.awt.Component, destination : java.awt.Component, event : java.awt.event.MouseEvent) : Void;
	...
	@:overload @:protected private function removeFromSource() : Void;
...
@:native('javax$swing$plaf$basic$BasicTreeUI$TreeTransferHandler') @:internal extern class BasicTreeUI_TreeTransferHandler extends javax.swing.TransferHandler implements javax.swing.plaf.UIResource implements java.util.Comparator<javax.swing.tree.TreePath>
{
	...
	*/
	...
	@:overload @:public public function compare(o1 : javax.swing.tree.TreePath, o2 : javax.swing.tree.TreePath) : Int;
...
{
	@:overload @:public override public function isEnabled(o : Dynamic) : Bool;
