...
extern class BasicSplitPaneUI extends javax.swing.plaf.SplitPaneUI
{
	...
	* with this object.
	*/
	@:protected @:static @:final private static var NON_CONTINUOUS_DIVIDER(default, null) : String;
	
	/**
	* How far (relative) the divider does move when it is moved around by
	* the cursor keys on the keyboard.
	*/
	@:protected @:static private static var KEYBOARD_DIVIDER_MOVE_OFFSET : Int;
	...
	*/
	@:protected private var layoutManager : javax.swing.plaf.basic.BasicSplitPaneUI.BasicSplitPaneUI_BasicHorizontalLayoutManager;
	
	/**
	* Instance of the divider for this JSplitPane.
	*/
	@:protected private var divider : javax.swing.plaf.basic.BasicSplitPaneDivider;
	...
	* is being used.
	*/
	@:protected private var nonContinuousLayoutDivider : java.awt.Component;
	
	/**
	* Set to true in startDragging if any of the children
	* (not including the nonContinuousLayoutDivider) are heavy weights.
	*/
	@:protected private var draggingHW : Bool;
	
	/**
	* Location of the divider when the dragging session began.
	*/
	@:protected private var beginDragDividerLocation : Int;
	...
	* @deprecated As of Java 2 platform v1.3.
	*/
	@:protected private var homeKey : javax.swing.KeyStroke;
	...
	* @deprecated As of Java 2 platform v1.3.
	*/
	@:protected private var endKey : javax.swing.KeyStroke;
	...
	* @deprecated As of Java 2 platform v1.3.
	*/
	@:protected private var dividerResizeToggleKey : javax.swing.KeyStroke;
	...
	* @deprecated As of Java 2 platform v1.3.
	*/
	@:protected private var keyboardUpLeftListener : java.awt.event.ActionListener;
	...
	* @deprecated As of Java 2 platform v1.3.
	*/
	@:protected private var keyboardDownRightListener : java.awt.event.ActionListener;
	...
	* @deprecated As of Java 2 platform v1.3.
	*/
	@:protected private var keyboardHomeListener : java.awt.event.ActionListener;
	...
	* @deprecated As of Java 2 platform v1.3.
	*/
	@:protected private var keyboardEndListener : java.awt.event.ActionListener;
	...
	* @deprecated As of Java 2 platform v1.3.
	*/
	@:protected private var keyboardResizeToggleListener : java.awt.event.ActionListener;
	...
	* @deprecated As of Java 2 platform v1.3.
	*/
	@:overload @:protected private function createKeyboardUpLeftListener() : java.awt.event.ActionListener;
	...
	* @deprecated As of Java 2 platform v1.3.
	*/
	@:overload @:protected private function createKeyboardDownRightListener() : java.awt.event.ActionListener;
	...
	* @deprecated As of Java 2 platform v1.3.
	*/
	@:overload @:protected private function createKeyboardHomeListener() : java.awt.event.ActionListener;
	...
	* @deprecated As of Java 2 platform v1.3.
	*/
	@:overload @:protected private function createKeyboardEndListener() : java.awt.event.ActionListener;
	...
	* @deprecated As of Java 2 platform v1.3.
	*/
	@:overload @:protected private function createKeyboardResizeToggleListener() : java.awt.event.ActionListener;
	...
	*/
	@:overload @:public public function setContinuousLayout(b : Bool) : Void;
	
	/**
	* Returns the last drag location of the JSplitPane.
	*/
	@:overload @:public public function getLastDragLocation() : Int;
	
	/**
	* Set the last drag location of the JSplitPane.
	*/
	@:overload @:public public function setLastDragLocation(l : Int) : Void;
	
	/**
	* Returns the divider between the top Components.
	*/
	@:overload @:public public function getDivider() : javax.swing.plaf.basic.BasicSplitPaneDivider;
	
	/**
	* Returns the default non continuous layout divider, which is an
	* instance of {@code Canvas} that fills in the background with dark gray.
	*/
	@:overload @:protected private function createDefaultNonContinuousLayoutDivider() : java.awt.Component;
	...
	* be a heavy weight.
	*/
	@:overload @:protected private function setNonContinuousLayoutDivider(newDivider : java.awt.Component) : Void;
	
	/**
	* Sets the divider to use.
	*/
	@:overload @:protected private function setNonContinuousLayoutDivider(newDivider : java.awt.Component, rememberSizes : Bool) : Void;
	...
	* dragging session.
	*/
	@:overload @:public public function getNonContinuousLayoutDivider() : java.awt.Component;
	
	/**
	* Returns the splitpane this instance is currently contained
	* in.
	*/
	@:overload @:public public function getSplitPane() : javax.swing.JSplitPane;
	
	/**
	* Creates the default divider.
	*/
	@:overload @:public public function createDefaultDivider() : javax.swing.plaf.basic.BasicSplitPaneDivider;
	
	/**
	* Messaged to reset the preferred sizes.
	*/
	@:overload @:public override public function resetToPreferredSizes(jc : javax.swing.JSplitPane) : Void;
	
	/**
	* Sets the location of the divider to location.
	*/
	@:overload @:public override public function setDividerLocation(jc : javax.swing.JSplitPane, location : Int) : Void;
	
	/**
	* Returns the location of the divider, which may differ from what
	* the splitpane thinks the location of the divider is.
	*/
	@:overload @:public override public function getDividerLocation(jc : javax.swing.JSplitPane) : Int;
	
	/**
	* Gets the minimum location of the divider.
	*/
	@:overload @:public override public function getMinimumDividerLocation(jc : javax.swing.JSplitPane) : Int;
	
	/**
	* Gets the maximum location of the divider.
	*/
	@:overload @:public override public function getMaximumDividerLocation(jc : javax.swing.JSplitPane) : Int;
	
	/**
	* Called when the specified split pane has finished painting
	* its children.
	*/
	@:overload @:public override public function finishedPaintingChildren(sp : javax.swing.JSplitPane, g : java.awt.Graphics) : Void;
	
	/**
	* @inheritDoc
	*/
	@:overload @:public override public function paint(g : java.awt.Graphics, jc : javax.swing.JComponent) : Void;
	
	/**
	* Returns the preferred size for the passed in component,
	* This is passed off to the current layoutmanager.
	*/
	@:overload @:public override public function getPreferredSize(jc : javax.swing.JComponent) : java.awt.Dimension;
	
	/**
	* Returns the minimum size for the passed in component,
	* This is passed off to the current layoutmanager.
	*/
	@:overload @:public override public function getMinimumSize(jc : javax.swing.JComponent) : java.awt.Dimension;
	
	/**
	* Returns the maximum size for the passed in component,
	* This is passed off to the current layoutmanager.
	*/
	@:overload @:public override public function getMaximumSize(jc : javax.swing.JComponent) : java.awt.Dimension;
	
	/**
	* Returns the insets. The insets are returned from the border insets
	* of the current border.
	*/
	@:overload @:public public function getInsets(jc : javax.swing.JComponent) : java.awt.Insets;
	
	/**
	* Resets the layout manager based on orientation and messages it
	* with invalidateLayout to pull in appropriate Components.
	*/
	@:overload @:protected private function resetLayoutManager() : Void;
	
	/**
	* Should be messaged before the dragging session starts, resets
	* lastDragLocation and dividerSize.
	*/
	@:overload @:protected private function startDragging() : Void;
	...
	* divider.
	*/
	@:overload @:protected private function getDividerBorderSize() : Int;
...
{
	@:overload @:public override public function focusGained(ev : java.awt.event.FocusEvent) : Void;
	
	@:overload @:public override public function focusLost(ev : java.awt.event.FocusEvent) : Void;
...
@:native('javax$swing$plaf$basic$BasicSplitPaneUI$BasicHorizontalLayoutManager') extern class BasicSplitPaneUI_BasicHorizontalLayoutManager implements java.awt.LayoutManager2
{
	...
	@:protected private var sizes : java.NativeArray<Int>;
	
	@:protected private var components : java.NativeArray<java.awt.Component>;
	...
	* divider).
	*/
	@:overload @:public public function addLayoutComponent(place : String, component : java.awt.Component) : Void;
	...
	*/
	@:overload @:public public function minimumLayoutSize(container : java.awt.Container) : java.awt.Dimension;
	...
	* be messaged.
	*/
	@:overload @:public public function invalidateLayout(c : java.awt.Container) : Void;
	...
	*/
	@:overload @:protected private function resetSizeAt(index : Int) : Void;
	
	/**
	* Sets the sizes to <code>newSizes</code>.
	*/
	@:overload @:protected private function setSizes(newSizes : java.NativeArray<Int>) : Void;
	
	/**
	* Returns the sizes of the components.
	*/
	@:overload @:protected private function getSizes() : java.NativeArray<Int>;
	
	/**
	* Returns the width of the passed in Components preferred size.
	*/
	@:overload @:protected private function getPreferredSizeOfComponent(c : java.awt.Component) : Int;
	
	/**
	* Returns the width of the passed in component.
	*/
	@:overload @:protected private function getSizeOfComponent(c : java.awt.Component) : Int;
	
	/**
	* Returns the available width based on the container size and
	* Insets.
	*/
	@:overload @:protected private function getAvailableSize(containerSize : java.awt.Dimension, insets : java.awt.Insets) : Int;
	
	/**
	* Returns the left inset, unless the Insets are null in which case
	* 0 is returned.
	*/
	@:overload @:protected private function getInitialLocation(insets : java.awt.Insets) : Int;
	...
	*/
	@:overload @:protected private function setComponentToSize(c : java.awt.Component, size : Int, location : Int, insets : java.awt.Insets, containerSize : java.awt.Dimension) : Void;
	...
	* SplitPane.
	*/
	@:overload @:protected private function updateComponents() : Void;
...
@:native('javax$swing$plaf$basic$BasicSplitPaneUI$Handler') @:internal extern class BasicSplitPaneUI_Handler implements java.awt.event.FocusListener implements java.beans.PropertyChangeListener
{
	...
	*/
	...
	@:overload @:public public function focusGained(ev : java.awt.event.FocusEvent) : Void;
	
	@:overload @:public public function focusLost(ev : java.awt.event.FocusEvent) : Void;
...
{
	@:overload @:public override public function actionPerformed(ev : java.awt.event.ActionEvent) : Void;
