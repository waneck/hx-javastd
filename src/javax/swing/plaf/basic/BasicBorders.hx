...
extern class BasicBorders
{
	...
	* @author Amy Fowler
	*/
	@:overload public static function getButtonBorder() : javax.swing.border.Border;
	
	@:overload public static function getRadioButtonBorder() : javax.swing.border.Border;
	
	@:overload public static function getToggleButtonBorder() : javax.swing.border.Border;
	
	@:overload public static function getMenuBarBorder() : javax.swing.border.Border;
	
	@:overload public static function getSplitPaneBorder() : javax.swing.border.Border;
	
	/**
	* Returns a border instance for a JSplitPane divider
	* @since 1.3
	*/
	@:require(java3) @:overload public static function getSplitPaneDividerBorder() : javax.swing.border.Border;
	
	@:overload public static function getTextFieldBorder() : javax.swing.border.Border;
	
	@:overload public static function getProgressBarBorder() : javax.swing.border.Border;
