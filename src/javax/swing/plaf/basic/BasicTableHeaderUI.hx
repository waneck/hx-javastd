...
extern class BasicTableHeaderUI extends javax.swing.plaf.TableHeaderUI
{
	...
	@:protected private var header : javax.swing.table.JTableHeader;
	...
	* @since 1.6
	*/
	@:require(java6) @:overload @:protected private function getRolloverColumn() : Int;
	...
	* @since 1.6
	*/
	@:require(java6) @:overload @:protected private function rolloverColumnUpdated(oldColumn : Int, newColumn : Int) : Void;
...
{
	@:public @:static @:final public static var TOGGLE_SORT_ORDER(default, null) : String;
	
	@:public @:static @:final public static var SELECT_COLUMN_TO_LEFT(default, null) : String;
	
	@:public @:static @:final public static var SELECT_COLUMN_TO_RIGHT(default, null) : String;
	
	@:public @:static @:final public static var MOVE_COLUMN_LEFT(default, null) : String;
	
	@:public @:static @:final public static var MOVE_COLUMN_RIGHT(default, null) : String;
	
	@:public @:static @:final public static var RESIZE_LEFT(default, null) : String;
	
	@:public @:static @:final public static var RESIZE_RIGHT(default, null) : String;
	
	@:public @:static @:final public static var FOCUS_TABLE(default, null) : String;
