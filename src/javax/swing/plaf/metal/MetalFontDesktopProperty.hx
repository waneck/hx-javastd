...
*
*/
@:internal extern class MetalFontDesktopProperty extends com.sun.java.swing.plaf.windows.DesktopProperty
{
	/**
	...
	*/
	@:overload @:protected override private function getDefaultValue() : Dynamic;
