...
@:native('javax$swing$plaf$metal$MetalUtils$GradientPainter') @:internal extern class MetalUtils_GradientPainter extends sun.swing.CachedPainter
{
	...
	* ever created.
	*/
	@:public @:static @:final public static var INSTANCE(default, null) : javax.swing.plaf.metal.MetalUtils.MetalUtils_GradientPainter;
	
	@:overload @:public public function paint(c : java.awt.Component, g : java.awt.Graphics2D, gradient : java.util.List<Dynamic>, x : Int, y : Int, w : Int, h : Int, isVertical : Bool) : Void;
	...
	@:overload @:protected override private function paintImage(c : java.awt.Component, g : java.awt.Graphics, x : Int, y : Int, imageW : Int, imageH : Int, image : java.awt.Image, args : java.NativeArray<Dynamic>) : Void;
