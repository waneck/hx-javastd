...
* questions.
*/
extern class SynthPopupMenuUI extends javax.swing.plaf.basic.BasicPopupMenuUI implements java.beans.PropertyChangeListener implements javax.swing.plaf.synth.SynthUI
{
	/**
