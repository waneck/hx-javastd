...
* questions.
*/
extern class SynthToolTipUI extends javax.swing.plaf.basic.BasicToolTipUI implements java.beans.PropertyChangeListener implements javax.swing.plaf.synth.SynthUI
{
	/**
	...
	* @inheritDoc
	*/
	@:overload @:protected override private function installDefaults(c : javax.swing.JComponent) : Void;
	
	/**
	* @inheritDoc
	*/
	@:overload @:protected override private function uninstallDefaults(c : javax.swing.JComponent) : Void;
	
	/**
	* @inheritDoc
	*/
	@:overload @:protected override private function installListeners(c : javax.swing.JComponent) : Void;
