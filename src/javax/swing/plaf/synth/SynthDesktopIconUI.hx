...
* @since 1.7
*/
@:require(java7) extern class SynthDesktopIconUI extends javax.swing.plaf.basic.BasicDesktopIconUI implements javax.swing.plaf.synth.SynthUI implements java.beans.PropertyChangeListener
{
	/**
...
@:native('javax$swing$plaf$synth$SynthDesktopIconUI$Handler') @:internal extern class SynthDesktopIconUI_Handler implements java.awt.event.ActionListener
{
