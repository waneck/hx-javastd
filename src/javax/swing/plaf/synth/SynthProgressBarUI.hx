...
* questions.
*/
extern class SynthProgressBarUI extends javax.swing.plaf.basic.BasicProgressBarUI implements javax.swing.plaf.synth.SynthUI implements java.beans.PropertyChangeListener
{
	/**
