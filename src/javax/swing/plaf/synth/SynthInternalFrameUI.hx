...
* @since 1.7
*/
@:require(java7) extern class SynthInternalFrameUI extends javax.swing.plaf.basic.BasicInternalFrameUI implements javax.swing.plaf.synth.SynthUI implements java.beans.PropertyChangeListener
{
	/**
