...
* questions.
*/
extern class SynthOptionPaneUI extends javax.swing.plaf.basic.BasicOptionPaneUI implements java.beans.PropertyChangeListener implements javax.swing.plaf.synth.SynthUI
{
	/**
	...
	* @inheritDoc
	*/
	@:overload @:protected override private function getSizeButtonsToSameWidth() : Bool;
	...
	* {@link #addIcon}.
	*/
	@:overload @:protected override private function createMessageArea() : java.awt.Container;
