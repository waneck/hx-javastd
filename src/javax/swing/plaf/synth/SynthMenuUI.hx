...
* questions.
*/
extern class SynthMenuUI extends javax.swing.plaf.basic.BasicMenuUI implements java.beans.PropertyChangeListener implements javax.swing.plaf.synth.SynthUI
{
	/**
