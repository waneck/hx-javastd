...
{
	@:overload @:public @:static public static function getEtchedBorderUIResource() : javax.swing.border.Border;
	
	@:overload @:public @:static public static function getLoweredBevelBorderUIResource() : javax.swing.border.Border;
	
	@:overload @:public @:static public static function getRaisedBevelBorderUIResource() : javax.swing.border.Border;
	
	@:overload @:public @:static public static function getBlackLineBorderUIResource() : javax.swing.border.Border;
	...
	*/
	@:overload @:public public function new(delegate : javax.swing.border.Border) : Void;
...
@:native('javax$swing$plaf$BorderUIResource$EmptyBorderUIResource') extern class BorderUIResource_EmptyBorderUIResource extends javax.swing.border.EmptyBorder implements javax.swing.plaf.UIResource
{
	...
	@:overload @:public public function new(insets : java.awt.Insets) : Void;
...
@:native('javax$swing$plaf$BorderUIResource$BevelBorderUIResource') extern class BorderUIResource_BevelBorderUIResource extends javax.swing.border.BevelBorder implements javax.swing.plaf.UIResource
{
	...
	@:overload @:public public function new(bevelType : Int, highlightOuter : java.awt.Color, highlightInner : java.awt.Color, shadowOuter : java.awt.Color, shadowInner : java.awt.Color) : Void;
...
{
	@:overload @:public public function new(top : Int, left : Int, bottom : Int, right : Int, color : java.awt.Color) : Void;
