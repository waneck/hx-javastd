...
*/
@:native('javax$swing$event$DocumentEvent$EventType') extern class DocumentEvent_EventType
{
	/**
	* Insert type.
	*/
...
*/
@:native('javax$swing$event$DocumentEvent$ElementChange') extern interface DocumentEvent_ElementChange
{
	/**
