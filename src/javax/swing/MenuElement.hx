...
extern interface MenuElement
{
	...
	*  Process a key event.
	*/
	@:overload @:public public function processKeyEvent(event : java.awt.event.KeyEvent, path : java.NativeArray<javax.swing.MenuElement>, manager : javax.swing.MenuSelectionManager) : Void;
