...
extern interface BoundedRangeModel
{
	...
	*/
	@:overload public function setMinimum(newMinimum : Int) : Void;
	...
	* @see #addChangeListener
	*/
	@:overload public function setMaximum(newMaximum : Int) : Void;
	...
	* @see #setValue
	*/
	@:overload public function setExtent(newExtent : Int) : Void;
	...
	* @see #setValueIsAdjusting
	*/
	@:overload public function setRangeProperties(value : Int, extent : Int, min : Int, max : Int, adjusting : Bool) : Void;
	...
	*/
	@:overload public function addChangeListener(x : javax.swing.event.ChangeListener) : Void;
	...
	* @see #addChangeListener
	*/
	@:overload public function removeChangeListener(x : javax.swing.event.ChangeListener) : Void;
