...
*/
extern class Box extends javax.swing.JComponent implements javax.accessibility.Accessible
{
	/**
...
* Please see {@link java.beans.XMLEncoder}.
*/
@:native('javax$swing$Box$Filler') extern class Box_Filler extends javax.swing.JComponent implements javax.accessibility.Accessible
{
	/**
