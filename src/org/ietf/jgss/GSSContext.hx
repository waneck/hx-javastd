...
extern interface GSSContext
{
	...
	*   {@link GSSException#FAILURE GSSException.FAILURE}
	*/
	@:overload @:public public function acceptSecContext(inToken : java.NativeArray<java.StdTypes.Int8>, offset : Int, len : Int) : java.NativeArray<java.StdTypes.Int8>;
	...
	*   {@link GSSException#FAILURE GSSException.FAILURE}
	*/
	@:overload @:public public function verifyMIC(inToken : java.NativeArray<java.StdTypes.Int8>, tokOffset : Int, tokLen : Int, inMsg : java.NativeArray<java.StdTypes.Int8>, msgOffset : Int, msgLen : Int, msgProp : org.ietf.jgss.MessageProp) : Void;
