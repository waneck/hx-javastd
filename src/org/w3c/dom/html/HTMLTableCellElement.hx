...
extern interface HTMLTableCellElement extends org.w3c.dom.html.HTMLElement
{
	...
	*/
	@:overload @:public public function getCellIndex() : Int;
	
	/**
	*  Abbreviation for header cells. See the  abbr attribute definition in
	* HTML 4.0.
	*/
	@:overload @:public public function getAbbr() : String;
	
	@:overload @:public public function setAbbr(abbr : String) : Void;
	...
	* HTML 4.0.
	*/
	@:overload @:public public function getAxis() : String;
	
	@:overload @:public public function setAxis(axis : String) : Void;
	...
	* definition in HTML 4.0.
	*/
	@:overload @:public public function getColSpan() : Int;
	
	@:overload @:public public function setColSpan(colSpan : Int) : Void;
	
	/**
	*  List of <code>id</code> attribute values for header cells. See the
	* headers attribute definition in HTML 4.0.
	*/
	@:overload @:public public function getHeaders() : String;
	
	@:overload @:public public function setHeaders(headers : String) : Void;
	...
	* 4.0. This attribute is deprecated in HTML 4.0.
	*/
	@:overload @:public public function getNoWrap() : Bool;
	
	@:overload @:public public function setNoWrap(noWrap : Bool) : Void;
	
	/**
	*  Number of rows spanned by cell. See the  rowspan attribute definition
	* in HTML 4.0.
	*/
	@:overload @:public public function getRowSpan() : Int;
	
	@:overload @:public public function setRowSpan(rowSpan : Int) : Void;
	...
	*/
	...
	@:overload @:public public function setScope(scope : String) : Void;
