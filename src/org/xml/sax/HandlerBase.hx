...
*/
@:require(java0) extern class HandlerBase implements org.xml.sax.EntityResolver implements org.xml.sax.DTDHandler implements org.xml.sax.DocumentHandler implements org.xml.sax.ErrorHandler
{
	/**
