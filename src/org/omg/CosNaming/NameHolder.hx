...
*/
extern class NameHolder implements org.omg.CORBA.portable.Streamable
{
	@:public public var value : java.NativeArray<org.omg.CosNaming.NameComponent>;
	
	@:overload @:public public function new() : Void;
	
	@:overload @:public public function new(initialValue : java.NativeArray<org.omg.CosNaming.NameComponent>) : Void;
