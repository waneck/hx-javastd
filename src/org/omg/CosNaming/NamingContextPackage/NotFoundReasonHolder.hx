...
{
	public var value : org.omg.CosNaming.NamingContextPackage.NotFoundReason;
	
	@:overload public function new() : Void;
	
	@:overload public function new(initialValue : org.omg.CosNaming.NamingContextPackage.NotFoundReason) : Void;
