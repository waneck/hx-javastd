...
{
	public var value : org.omg.CosNaming.NamingContextPackage.AlreadyBound;
	
	@:overload public function new() : Void;
	
	@:overload public function new(initialValue : org.omg.CosNaming.NamingContextPackage.AlreadyBound) : Void;
