...
{
	public var value : org.omg.CosNaming.NamingContextPackage.NotEmpty;
	
	@:overload public function new() : Void;
	
	@:overload public function new(initialValue : org.omg.CosNaming.NamingContextPackage.NotEmpty) : Void;
