...
{
	@:public public var value : org.omg.CosNaming.NamingContextPackage.CannotProceed;
	
	@:overload @:public public function new() : Void;
	
	@:overload @:public public function new(initialValue : org.omg.CosNaming.NamingContextPackage.CannotProceed) : Void;
