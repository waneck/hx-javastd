...
* List of Bindings.
*/
extern class BindingListHolder implements org.omg.CORBA.portable.Streamable
{
	@:public public var value : java.NativeArray<org.omg.CosNaming.Binding>;
	
	@:overload @:public public function new() : Void;
	
	@:overload @:public public function new(initialValue : java.NativeArray<org.omg.CosNaming.Binding>) : Void;
