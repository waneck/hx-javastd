...
{
	@:overload @:public @:static public static function insert(a : org.omg.CORBA.Any, that : java.NativeArray<haxe.Int64>) : Void;
	
	@:overload @:public @:static public static function extract(a : org.omg.CORBA.Any) : java.NativeArray<haxe.Int64>;
	...
	@:overload @:public @:static public static function read(istream : org.omg.CORBA.portable.InputStream) : java.NativeArray<haxe.Int64>;
	
	@:overload @:public @:static public static function write(ostream : org.omg.CORBA.portable.OutputStream, value : java.NativeArray<haxe.Int64>) : Void;
