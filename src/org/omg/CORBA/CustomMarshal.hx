...
* questions.
*/
extern interface CustomMarshal
{
	/**
	...
	*/
	@:overload public function marshal(os : org.omg.CORBA.DataOutputStream) : Void;
	...
	*/
	@:overload public function unmarshal(is : org.omg.CORBA.DataInputStream) : Void;
