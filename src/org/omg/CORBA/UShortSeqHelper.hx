...
{
	@:overload public static function insert(a : org.omg.CORBA.Any, that : java.NativeArray<java.StdTypes.Int16>) : Void;
	
	@:overload public static function extract(a : org.omg.CORBA.Any) : java.NativeArray<java.StdTypes.Int16>;
	
	@:overload @:synchronized public static function type() : org.omg.CORBA.TypeCode;
	
	@:overload public static function id() : String;
	
	@:overload public static function read(istream : org.omg.CORBA.portable.InputStream) : java.NativeArray<java.StdTypes.Int16>;
	
	@:overload public static function write(ostream : org.omg.CORBA.portable.OutputStream, value : java.NativeArray<java.StdTypes.Int16>) : Void;
