...
extern class TCKind
{
	...
	*/
	@:public @:static @:final public static var _tk_null(default, null) : Int;
	
	/**
	* The <code>int</code> constant for the IDL data type <code>void</code>.
	*/
	@:public @:static @:final public static var _tk_void(default, null) : Int;
	
	/**
	* The <code>int</code> constant for the IDL data type <code>short</code>.
	*/
	@:public @:static @:final public static var _tk_short(default, null) : Int;
	
	/**
	* The <code>int</code> constant for the IDL data type <code>long</code>.
	*/
	@:public @:static @:final public static var _tk_long(default, null) : Int;
	
	/**
	* The <code>int</code> constant for the IDL data type <code>ushort</code>.
	*/
	@:public @:static @:final public static var _tk_ushort(default, null) : Int;
	
	/**
	* The <code>int</code> constant for the IDL data type <code>ulong</code>.
	*/
	@:public @:static @:final public static var _tk_ulong(default, null) : Int;
	
	/**
	* The <code>int</code> constant for the IDL data type <code>float</code>.
	*/
	@:public @:static @:final public static var _tk_float(default, null) : Int;
	
	/**
	* The <code>int</code> constant for the IDL data type <code>double</code>.
	*/
	@:public @:static @:final public static var _tk_double(default, null) : Int;
	
	/**
	* The <code>int</code> constant for the IDL data type <code>boolean</code>.
	*/
	@:public @:static @:final public static var _tk_boolean(default, null) : Int;
	
	/**
	* The <code>int</code> constant for the IDL data type <code>char</code>.
	*/
	@:public @:static @:final public static var _tk_char(default, null) : Int;
	
	/**
	* The <code>int</code> constant for the IDL data type <code>octet</code>.
	*/
	@:public @:static @:final public static var _tk_octet(default, null) : Int;
	
	/**
	* The <code>int</code> constant for the IDL data type <code>any</code>.
	*/
	@:public @:static @:final public static var _tk_any(default, null) : Int;
	
	/**
	* The <code>int</code> constant for the IDL data type <code>TypeCode</code>.
	*/
	@:public @:static @:final public static var _tk_TypeCode(default, null) : Int;
	
	/**
	* The <code>int</code> constant for the IDL data type <code>Principal</code>.
	*/
	@:public @:static @:final public static var _tk_Principal(default, null) : Int;
	
	/**
	* The <code>int</code> constant for the IDL data type <code>objref</code>.
	*/
	@:public @:static @:final public static var _tk_objref(default, null) : Int;
	
	/**
	* The <code>int</code> constant for the IDL data type <code>struct</code>.
	*/
	@:public @:static @:final public static var _tk_struct(default, null) : Int;
	
	/**
	* The <code>int</code> constant for the IDL data type <code>union</code>.
	*/
	@:public @:static @:final public static var _tk_union(default, null) : Int;
	
	/**
	* The <code>int</code> constant for the IDL data type <code>enum</code>.
	*/
	@:public @:static @:final public static var _tk_enum(default, null) : Int;
	
	/**
	* The <code>int</code> constant for the IDL data type <code>string</code>.
	*/
	@:public @:static @:final public static var _tk_string(default, null) : Int;
	
	/**
	* The <code>int</code> constant for the IDL data type <code>sequence</code>.
	*/
	@:public @:static @:final public static var _tk_sequence(default, null) : Int;
	
	/**
	* The <code>int</code> constant for the IDL data type <code>array</code>.
	*/
	@:public @:static @:final public static var _tk_array(default, null) : Int;
	
	/**
	* The <code>int</code> constant for the IDL data type <code>alias</code>.
	*/
	@:public @:static @:final public static var _tk_alias(default, null) : Int;
	
	/**
	* The <code>int</code> constant for the IDL data type <code>except</code>.
	*/
	@:public @:static @:final public static var _tk_except(default, null) : Int;
	
	/**
	* The <code>int</code> constant for the IDL data type <code>longlong</code>.
	*/
	@:public @:static @:final public static var _tk_longlong(default, null) : Int;
	
	/**
	* The <code>int</code> constant for the IDL data type <code>ulonglong</code>.
	*/
	@:public @:static @:final public static var _tk_ulonglong(default, null) : Int;
	
	/**
	* The <code>int</code> constant for the IDL data type <code>longdouble</code>.
	*/
	@:public @:static @:final public static var _tk_longdouble(default, null) : Int;
	
	/**
	* The <code>int</code> constant for the IDL data type <code>wchar</code>.
	*/
	@:public @:static @:final public static var _tk_wchar(default, null) : Int;
	
	/**
	* The <code>int</code> constant for the IDL data type <code>wstring</code>.
	*/
	@:public @:static @:final public static var _tk_wstring(default, null) : Int;
	
	/**
	* The <code>int</code> constant for the IDL data type <code>fixed</code>.
	*/
	@:public @:static @:final public static var _tk_fixed(default, null) : Int;
	
	/**
	* The <code>int</code> constant for the IDL data type <code>value</code>.
	*/
	@:public @:static @:final public static var _tk_value(default, null) : Int;
	
	/**
	* The <code>int</code> constant for the IDL data type <code>value_box</code>.
	*/
	@:public @:static @:final public static var _tk_value_box(default, null) : Int;
	
	/**
	* The <code>int</code> constant for the IDL data type <code>native</code>.
	*/
	@:public @:static @:final public static var _tk_native(default, null) : Int;
	
	/**
	* The <code>int</code> constant for the IDL data type <code>abstract interface</code>.
	*/
	@:public @:static @:final public static var _tk_abstract_interface(default, null) : Int;
	
	/**
	* The <code>TCKind</code> constant whose <code>value</code> field is
	* initialized with <code>TCKind._tk_null</code>.
	*/
	@:public @:static @:final public static var tk_null(default, null) : org.omg.CORBA.TCKind;
	
	/**
	* The <code>TCKind</code> constant whose <code>value</code> field is
	* initialized with <code>TCKind._tk_void</code>.
	*/
	@:public @:static @:final public static var tk_void(default, null) : org.omg.CORBA.TCKind;
	
	/**
	* The <code>TCKind</code> constant whose <code>value</code> field is
	* initialized with <code>TCKind._tk_short</code>.
	*/
	@:public @:static @:final public static var tk_short(default, null) : org.omg.CORBA.TCKind;
	
	/**
	* The <code>TCKind</code> constant whose <code>value</code> field is
	* initialized with <code>TCKind._tk_long</code>.
	*/
	@:public @:static @:final public static var tk_long(default, null) : org.omg.CORBA.TCKind;
	
	/**
	* The <code>TCKind</code> constant whose <code>value</code> field is
	* initialized with <code>TCKind._tk_ushort</code>.
	*/
	@:public @:static @:final public static var tk_ushort(default, null) : org.omg.CORBA.TCKind;
	
	/**
	* The <code>TCKind</code> constant whose <code>value</code> field is
	* initialized with <code>TCKind._tk_ulong</code>.
	*/
	@:public @:static @:final public static var tk_ulong(default, null) : org.omg.CORBA.TCKind;
	
	/**
	* The <code>TCKind</code> constant whose <code>value</code> field is
	* initialized with <code>TCKind._tk_float</code>.
	*/
	@:public @:static @:final public static var tk_float(default, null) : org.omg.CORBA.TCKind;
	
	/**
	* The <code>TCKind</code> constant whose <code>value</code> field is
	* initialized with <code>TCKind._tk_double</code>.
	*/
	@:public @:static @:final public static var tk_double(default, null) : org.omg.CORBA.TCKind;
	
	/**
	* The <code>TCKind</code> constant whose <code>value</code> field is
	* initialized with <code>TCKind._tk_boolean</code>.
	*/
	@:public @:static @:final public static var tk_boolean(default, null) : org.omg.CORBA.TCKind;
	
	/**
	* The <code>TCKind</code> constant whose <code>value</code> field is
	* initialized with <code>TCKind._tk_char</code>.
	*/
	@:public @:static @:final public static var tk_char(default, null) : org.omg.CORBA.TCKind;
	
	/**
	* The <code>TCKind</code> constant whose <code>value</code> field is
	* initialized with <code>TCKind._tk_octet</code>.
	*/
	@:public @:static @:final public static var tk_octet(default, null) : org.omg.CORBA.TCKind;
	
	/**
	* The <code>TCKind</code> constant whose <code>value</code> field is
	* initialized with <code>TCKind._tk_any</code>.
	*/
	@:public @:static @:final public static var tk_any(default, null) : org.omg.CORBA.TCKind;
	
	/**
	* The <code>TCKind</code> constant whose <code>value</code> field is
	* initialized with <code>TCKind._tk_TypeCode</code>.
	*/
	@:public @:static @:final public static var tk_TypeCode(default, null) : org.omg.CORBA.TCKind;
	
	/**
	* The <code>TCKind</code> constant whose <code>value</code> field is
	* initialized with <code>TCKind._tk_Principal</code>.
	*/
	@:public @:static @:final public static var tk_Principal(default, null) : org.omg.CORBA.TCKind;
	
	/**
	* The <code>TCKind</code> constant whose <code>value</code> field is
	* initialized with <code>TCKind._tk_objref</code>.
	*/
	@:public @:static @:final public static var tk_objref(default, null) : org.omg.CORBA.TCKind;
	
	/**
	* The <code>TCKind</code> constant whose <code>value</code> field is
	* initialized with <code>TCKind._tk_struct</code>.
	*/
	@:public @:static @:final public static var tk_struct(default, null) : org.omg.CORBA.TCKind;
	
	/**
	* The <code>TCKind</code> constant whose <code>value</code> field is
	* initialized with <code>TCKind._tk_union</code>.
	*/
	@:public @:static @:final public static var tk_union(default, null) : org.omg.CORBA.TCKind;
	
	/**
	* The <code>TCKind</code> constant whose <code>value</code> field is
	* initialized with <code>TCKind._tk_enum</code>.
	*/
	@:public @:static @:final public static var tk_enum(default, null) : org.omg.CORBA.TCKind;
	
	/**
	* The <code>TCKind</code> constant whose <code>value</code> field is
	* initialized with <code>TCKind._tk_string</code>.
	*/
	@:public @:static @:final public static var tk_string(default, null) : org.omg.CORBA.TCKind;
	
	/**
	* The <code>TCKind</code> constant whose <code>value</code> field is
	* initialized with <code>TCKind._tk_sequence</code>.
	*/
	@:public @:static @:final public static var tk_sequence(default, null) : org.omg.CORBA.TCKind;
	
	/**
	* The <code>TCKind</code> constant whose <code>value</code> field is
	* initialized with <code>TCKind._tk_array</code>.
	*/
	@:public @:static @:final public static var tk_array(default, null) : org.omg.CORBA.TCKind;
	
	/**
	* The <code>TCKind</code> constant whose <code>value</code> field is
	* initialized with <code>TCKind._tk_alias</code>.
	*/
	@:public @:static @:final public static var tk_alias(default, null) : org.omg.CORBA.TCKind;
	
	/**
	* The <code>TCKind</code> constant whose <code>value</code> field is
	* initialized with <code>TCKind._tk_except</code>.
	*/
	@:public @:static @:final public static var tk_except(default, null) : org.omg.CORBA.TCKind;
	
	/**
	* The <code>TCKind</code> constant whose <code>value</code> field is
	* initialized with <code>TCKind._tk_longlong</code>.
	*/
	@:public @:static @:final public static var tk_longlong(default, null) : org.omg.CORBA.TCKind;
	
	/**
	* The <code>TCKind</code> constant whose <code>value</code> field is
	* initialized with <code>TCKind._tk_ulonglong</code>.
	*/
	@:public @:static @:final public static var tk_ulonglong(default, null) : org.omg.CORBA.TCKind;
	
	/**
	* The <code>TCKind</code> constant whose <code>value</code> field is
	* initialized with <code>TCKind._tk_longdouble</code>.
	*/
	@:public @:static @:final public static var tk_longdouble(default, null) : org.omg.CORBA.TCKind;
	
	/**
	* The <code>TCKind</code> constant whose <code>value</code> field is
	* initialized with <code>TCKind._tk_wchar</code>.
	*/
	@:public @:static @:final public static var tk_wchar(default, null) : org.omg.CORBA.TCKind;
	
	/**
	* The <code>TCKind</code> constant whose <code>value</code> field is
	* initialized with <code>TCKind._tk_wstring</code>.
	*/
	@:public @:static @:final public static var tk_wstring(default, null) : org.omg.CORBA.TCKind;
	
	/**
	* The <code>TCKind</code> constant whose <code>value</code> field is
	* initialized with <code>TCKind._tk_fixed</code>.
	*/
	@:public @:static @:final public static var tk_fixed(default, null) : org.omg.CORBA.TCKind;
	
	/**
	* The <code>TCKind</code> constant whose <code>value</code> field is
	* initialized with <code>TCKind._tk_value</code>.
	*/
	@:public @:static @:final public static var tk_value(default, null) : org.omg.CORBA.TCKind;
	
	/**
	* The <code>TCKind</code> constant whose <code>value</code> field is
	* initialized with <code>TCKind._tk_value_box</code>.
	*/
	@:public @:static @:final public static var tk_value_box(default, null) : org.omg.CORBA.TCKind;
	
	/**
	* The <code>TCKind</code> constant whose <code>value</code> field is
	* initialized with <code>TCKind._tk_native</code>.
	*/
	@:public @:static @:final public static var tk_native(default, null) : org.omg.CORBA.TCKind;
	
	/**
	* The <code>TCKind</code> constant whose <code>value</code> field is
	* initialized with <code>TCKind._tk_abstract_interface</code>.
	*/
	@:public @:static @:final public static var tk_abstract_interface(default, null) : org.omg.CORBA.TCKind;
	...
	*/
	@:overload @:public @:static public static function from_int(i : Int) : org.omg.CORBA.TCKind;
