...
*/
extern class CurrentHolder implements org.omg.CORBA.portable.Streamable
{
	@:public public var value : org.omg.CORBA.Current;
	
	@:overload @:public public function new() : Void;
	
	@:overload @:public public function new(initialValue : org.omg.CORBA.Current) : Void;
