...
*/
extern class WCharSeqHolder implements org.omg.CORBA.portable.Streamable
{
	@:public public var value : java.NativeArray<java.StdTypes.Char16>;
	
	@:overload @:public public function new() : Void;
	
	@:overload @:public public function new(initialValue : java.NativeArray<java.StdTypes.Char16>) : Void;
