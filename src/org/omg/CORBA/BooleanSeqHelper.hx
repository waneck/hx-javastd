...
{
	@:overload public static function insert(a : org.omg.CORBA.Any, that : java.NativeArray<Bool>) : Void;
	
	@:overload public static function extract(a : org.omg.CORBA.Any) : java.NativeArray<Bool>;
	
	@:overload @:synchronized public static function type() : org.omg.CORBA.TypeCode;
	
	@:overload public static function id() : String;
	
	@:overload public static function read(istream : org.omg.CORBA.portable.InputStream) : java.NativeArray<Bool>;
	
	@:overload public static function write(ostream : org.omg.CORBA.portable.OutputStream, value : java.NativeArray<Bool>) : Void;
