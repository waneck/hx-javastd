...
*/
extern interface InvokeHandler
{
	/**
	...
	*/
	@:overload public function _invoke(method : String, input : org.omg.CORBA.portable.InputStream, handler : org.omg.CORBA.portable.ResponseHandler) : org.omg.CORBA.portable.OutputStream;
