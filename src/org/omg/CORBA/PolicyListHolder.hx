...
{
	@:public public var value : java.NativeArray<org.omg.CORBA.Policy>;
	
	@:overload @:public public function new() : Void;
	
	@:overload @:public public function new(initialValue : java.NativeArray<org.omg.CORBA.Policy>) : Void;
