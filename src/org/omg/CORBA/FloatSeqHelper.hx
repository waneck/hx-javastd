...
*   </ul>
*/
extern class FloatSeqHelper
{
	@:overload @:public @:static public static function insert(a : org.omg.CORBA.Any, that : java.NativeArray<Single>) : Void;
	
	@:overload @:public @:static public static function extract(a : org.omg.CORBA.Any) : java.NativeArray<Single>;
	...
	@:overload @:public @:static public static function read(istream : org.omg.CORBA.portable.InputStream) : java.NativeArray<Single>;
	
	@:overload @:public @:static public static function write(ostream : org.omg.CORBA.portable.OutputStream, value : java.NativeArray<Single>) : Void;
