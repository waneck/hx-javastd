...
extern class DefinitionKind implements org.omg.CORBA.portable.IDLEntity
{
	...
	*/
	public static var dk_none(default, null) : DefinitionKind;
	...
	*/
	public static var dk_all(default, null) : DefinitionKind;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object is an Attribute.
	*/
	public static var dk_Attribute(default, null) : DefinitionKind;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object is a constant.
	*/
	public static var dk_Constant(default, null) : DefinitionKind;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object is an Exception.
	*/
	public static var dk_Exception(default, null) : DefinitionKind;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object is an Interface.
	*/
	public static var dk_Interface(default, null) : DefinitionKind;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object is a Module.
	*/
	public static var dk_Module(default, null) : DefinitionKind;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object is an Operation.
	*/
	public static var dk_Operation(default, null) : DefinitionKind;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object is a Typedef.
	*/
	public static var dk_Typedef(default, null) : DefinitionKind;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object is an Alias.
	*/
	public static var dk_Alias(default, null) : DefinitionKind;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object is a Struct.
	*/
	public static var dk_Struct(default, null) : DefinitionKind;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object is a Union.
	*/
	public static var dk_Union(default, null) : DefinitionKind;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object is an Enum.
	*/
	public static var dk_Enum(default, null) : DefinitionKind;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object is a Primitive.
	*/
	public static var dk_Primitive(default, null) : DefinitionKind;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object is a String.
	*/
	public static var dk_String(default, null) : DefinitionKind;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object is a Sequence.
	*/
	public static var dk_Sequence(default, null) : DefinitionKind;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object is an Array.
	*/
	public static var dk_Array(default, null) : DefinitionKind;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object is a Repository.
	*/
	public static var dk_Repository(default, null) : DefinitionKind;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object is a Wstring.
	*/
	public static var dk_Wstring(default, null) : DefinitionKind;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object is a Fixed value.
	*/
	public static var dk_Fixed(default, null) : DefinitionKind;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object is a Value.
	*/
	public static var dk_Value(default, null) : DefinitionKind;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object is a ValueBox.
	*/
	public static var dk_ValueBox(default, null) : DefinitionKind;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object is a ValueMember.
	*/
	public static var dk_ValueMember(default, null) : DefinitionKind;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object is a Native value.
	*/
	public static var dk_Native(default, null) : DefinitionKind;
	
	/**
* The static instance of <code>DefinitionKind</code> indicating that an
* Interface Repository object represents an abstract interface.
*/
	public static var dk_AbstractInterface(default, null) : DefinitionKind;
...
.
	...
	*         <code>DefinitionKind</code>
	*/
	@:overload public static function from_int(i : Int) : DefinitionKind;
