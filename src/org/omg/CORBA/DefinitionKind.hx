...
extern class DefinitionKind implements org.omg.CORBA.portable.IDLEntity
{
	...
	*/
	@:public @:static @:final public static var _dk_none(default, null) : Int;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object has no definition kind.
	*/
	@:public @:static @:final public static var dk_none(default, null) : org.omg.CORBA.DefinitionKind;
	...
	*/
	@:public @:static @:final public static var dk_all(default, null) : org.omg.CORBA.DefinitionKind;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object is an Attribute.
	*/
	@:public @:static @:final public static var dk_Attribute(default, null) : org.omg.CORBA.DefinitionKind;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object is a constant.
	*/
	@:public @:static @:final public static var dk_Constant(default, null) : org.omg.CORBA.DefinitionKind;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object is an Exception.
	*/
	@:public @:static @:final public static var dk_Exception(default, null) : org.omg.CORBA.DefinitionKind;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object is an Interface.
	*/
	@:public @:static @:final public static var dk_Interface(default, null) : org.omg.CORBA.DefinitionKind;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object is a Module.
	*/
	@:public @:static @:final public static var dk_Module(default, null) : org.omg.CORBA.DefinitionKind;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object is an Operation.
	*/
	@:public @:static @:final public static var dk_Operation(default, null) : org.omg.CORBA.DefinitionKind;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object is a Typedef.
	*/
	@:public @:static @:final public static var dk_Typedef(default, null) : org.omg.CORBA.DefinitionKind;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object is an Alias.
	*/
	@:public @:static @:final public static var dk_Alias(default, null) : org.omg.CORBA.DefinitionKind;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object is a Struct.
	*/
	@:public @:static @:final public static var dk_Struct(default, null) : org.omg.CORBA.DefinitionKind;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object is a Union.
	*/
	@:public @:static @:final public static var dk_Union(default, null) : org.omg.CORBA.DefinitionKind;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object is an Enum.
	*/
	@:public @:static @:final public static var dk_Enum(default, null) : org.omg.CORBA.DefinitionKind;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object is a Primitive.
	*/
	@:public @:static @:final public static var dk_Primitive(default, null) : org.omg.CORBA.DefinitionKind;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object is a String.
	*/
	@:public @:static @:final public static var dk_String(default, null) : org.omg.CORBA.DefinitionKind;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object is a Sequence.
	*/
	@:public @:static @:final public static var dk_Sequence(default, null) : org.omg.CORBA.DefinitionKind;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object is an Array.
	*/
	@:public @:static @:final public static var dk_Array(default, null) : org.omg.CORBA.DefinitionKind;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object is a Repository.
	*/
	@:public @:static @:final public static var dk_Repository(default, null) : org.omg.CORBA.DefinitionKind;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object is a Wstring.
	*/
	@:public @:static @:final public static var dk_Wstring(default, null) : org.omg.CORBA.DefinitionKind;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object is a Fixed value.
	*/
	@:public @:static @:final public static var dk_Fixed(default, null) : org.omg.CORBA.DefinitionKind;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object is a Value.
	*/
	@:public @:static @:final public static var dk_Value(default, null) : org.omg.CORBA.DefinitionKind;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object is a ValueBox.
	*/
	@:public @:static @:final public static var dk_ValueBox(default, null) : org.omg.CORBA.DefinitionKind;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object is a ValueMember.
	*/
	@:public @:static @:final public static var dk_ValueMember(default, null) : org.omg.CORBA.DefinitionKind;
	
	/**
	* The static instance of <code>DefinitionKind</code> indicating that an
	* Interface Repository object is a Native value.
	*/
	@:public @:static @:final public static var dk_Native(default, null) : org.omg.CORBA.DefinitionKind;
	
	/**
* The static instance of <code>DefinitionKind</code> indicating that an
* Interface Repository object represents an abstract interface.
*/
	@:public @:static @:final public static var dk_AbstractInterface(default, null) : org.omg.CORBA.DefinitionKind;
...
.
	...
	*         <code>DefinitionKind</code>
	*/
	@:overload @:public @:static public static function from_int(i : Int) : org.omg.CORBA.DefinitionKind;
