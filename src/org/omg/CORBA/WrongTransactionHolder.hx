...
*/
extern class WrongTransactionHolder implements org.omg.CORBA.portable.Streamable
{
	@:public public var value : org.omg.CORBA.WrongTransaction;
	
	@:overload @:public public function new() : Void;
	
	@:overload @:public public function new(initialValue : org.omg.CORBA.WrongTransaction) : Void;
