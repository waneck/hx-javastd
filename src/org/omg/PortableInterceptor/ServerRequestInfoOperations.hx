...
*/
extern interface ServerRequestInfoOperations extends org.omg.PortableInterceptor.RequestInfoOperations
{
	/**
	...
	*/
	@:overload public function adapter_id() : java.NativeArray<java.StdTypes.Int8>;
