...
{
	public var value : org.omg.PortableInterceptor.IORInterceptor_3_0;
	
	@:overload public function new() : Void;
	
	@:overload public function new(initialValue : org.omg.PortableInterceptor.IORInterceptor_3_0) : Void;
