...
{
	@:public public var value : org.omg.PortableInterceptor.ObjectReferenceFactory;
	
	@:overload @:public public function new() : Void;
	
	@:overload @:public public function new(initialValue : org.omg.PortableInterceptor.ObjectReferenceFactory) : Void;
