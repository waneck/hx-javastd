...
*/
extern interface IORInterceptor_3_0Operations extends org.omg.PortableInterceptor.IORInterceptorOperations
{
	...
	*/
	@:overload public function components_established(info : org.omg.PortableInterceptor.IORInfo) : Void;
	...
	*/
	@:overload public function adapter_manager_state_changed(id : Int, state : java.StdTypes.Int16) : Void;
	...
	*/
	@:overload public function adapter_state_changed(templates : java.NativeArray<org.omg.PortableInterceptor.ObjectReferenceTemplate>, state : java.StdTypes.Int16) : Void;
