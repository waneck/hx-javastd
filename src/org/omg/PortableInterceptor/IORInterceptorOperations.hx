...
* @see IORInfo
*/
extern interface IORInterceptorOperations extends org.omg.PortableInterceptor.InterceptorOperations
{
	/**
	...
	*/
	@:overload public function establish_components(info : org.omg.PortableInterceptor.IORInfo) : Void;
