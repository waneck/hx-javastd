...
{
	@:public public var value : org.omg.PortableInterceptor.ObjectReferenceTemplate;
	
	@:overload @:public public function new() : Void;
	
	@:overload @:public public function new(initialValue : org.omg.PortableInterceptor.ObjectReferenceTemplate) : Void;
