...
{
	@:overload public static function insert(a : org.omg.CORBA.Any, that : org.omg.PortableInterceptor.Current) : Void;
	
	@:overload public static function extract(a : org.omg.CORBA.Any) : org.omg.PortableInterceptor.Current;
	
	@:overload @:synchronized public static function type() : org.omg.CORBA.TypeCode;
	
	@:overload public static function id() : String;
	
	@:overload public static function read(istream : org.omg.CORBA.portable.InputStream) : org.omg.PortableInterceptor.Current;
	
	@:overload public static function write(ostream : org.omg.CORBA.portable.OutputStream, value : org.omg.PortableInterceptor.Current) : Void;
	
	@:overload public static function narrow(obj : org.omg.CORBA.Object) : org.omg.PortableInterceptor.Current;
	
	@:overload public static function unchecked_narrow(obj : org.omg.CORBA.Object) : org.omg.PortableInterceptor.Current;
