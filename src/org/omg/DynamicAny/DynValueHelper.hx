...
*/
extern class DynValueHelper
{
	@:overload @:public @:static public static function insert(a : org.omg.CORBA.Any, that : org.omg.DynamicAny.DynValue) : Void;
	
	@:overload @:public @:static public static function extract(a : org.omg.CORBA.Any) : org.omg.DynamicAny.DynValue;
	...
	@:overload @:public @:static public static function read(istream : org.omg.CORBA.portable.InputStream) : org.omg.DynamicAny.DynValue;
	
	@:overload @:public @:static public static function write(ostream : org.omg.CORBA.portable.OutputStream, value : org.omg.DynamicAny.DynValue) : Void;
	
	@:overload @:public @:static public static function narrow(obj : org.omg.CORBA.Object) : org.omg.DynamicAny.DynValue;
	
	@:overload @:public @:static public static function unchecked_narrow(obj : org.omg.CORBA.Object) : org.omg.DynamicAny.DynValue;
